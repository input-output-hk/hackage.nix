    ...
    in {
      ...
      components = {
        accelerate-examples = {
          ...
          ] ++ pkgs.lib.optional _flags.cuda hsPkgs.accelerate-cuda) ++ pkgs.lib.optional _flags.llvm-cpu hsPkgs.accelerate-llvm-native) ++ pkgs.lib.optional _flags.llvm-ptx hsPkgs.accelerate-llvm-ptx) ++ pkgs.lib.optional _flags.cilk hsPkgs.accelerate-icc-opencl) ++ optionals _flags.codespeed [
            hsPkgs.aeson
            hsPkgs.bytestring
            hsPkgs.HTTP
            hsPkgs.http-types
