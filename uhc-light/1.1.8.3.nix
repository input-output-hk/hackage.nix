...
let
    ...
    in {
      package = {
        ...
        description = "A 'light' variant of UHC including only an API and an executable for compiling to Core representation. This version is just to test the infrastructure. Later versions will provide a fleshing out of the API and completion of the now rudimentary platform independent (Haskell) interpreted running etc..";
        buildType = "Simple";
      };
      components = {
        uhc-light = {
