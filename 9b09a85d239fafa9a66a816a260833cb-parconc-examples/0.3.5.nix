      ...
      components = {
        exes = {
          ...
          "fwaccel" = {
            depends  = [
              hsPkgs.base
            ] ++ pkgs.lib.optional _flags.accelerate hsPkgs.accelerate;
          };
          "fwaccel-gpu" = {
            depends  = ([
              hsPkgs.base
            ] ++ pkgs.lib.optional _flags.accelerate hsPkgs.accelerate) ++ pkgs.lib.optional _flags.cuda hsPkgs.accelerate-cuda;
          };
          "mandel" = {
            depends  = ([
              hsPkgs.base
          ...
          "ping" = {
            ...
            ] ++ pkgs.lib.optional (compiler.isGhc && compiler.version.le "7.6") hsPkgs.ghc-prim) ++ pkgs.lib.optionals _flags.distributed [
