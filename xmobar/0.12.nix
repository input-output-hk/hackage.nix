        ...
        exes = {
          xmobar = {
            depends  = (((([
              ...
              hsPkgs.utf8-string
              hsPkgs.X11-xft
            ]) ++ pkgs.lib.optional (_flags.with_utf8 || _flags.all_extensions) hsPkgs.utf8-string) ++ pkgs.lib.optional (_flags.with_inotify || _flags.all_extensions) hsPkgs.hinotify) ++ pkgs.lib.optional (_flags.with_mpd || _flags.all_extensions) hsPkgs.libmpd;
