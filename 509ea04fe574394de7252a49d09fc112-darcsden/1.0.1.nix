        ...
        exes = {
          darcsden = {
            depends  = ((([
              ...
              hsPkgs.darcs
            ]) ++ pkgs.lib.optional _flags.highlightingkate hsPkgs.highlighting-kate) ++ pkgs.lib.optional _flags.highlighter hsPkgs.highlighter) ++ pkgs.lib.optional _flags.ssh hsPkgs.ssh;
          };
          darcsden-ssh = {
            depends  = [
              hsPkgs.darcs
