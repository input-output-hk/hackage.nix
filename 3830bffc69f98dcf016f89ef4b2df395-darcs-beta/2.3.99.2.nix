    ...
    components = {
      ...
      exes = {
        ...
        "unit" = {
          ...
          ]) ++ pkgs.lib.optional (!system.isWindows) (hsPkgs.unix)) ++ pkgs.lib.optional (_flags.mmap && !system.isWindows) (hsPkgs.mmap)) ++ pkgs.lib.optional (_flags.terminfo && !system.isWindows) (hsPkgs.terminfo);
        };
      };
    };
  }