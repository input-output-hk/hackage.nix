      ...
      components = {
        hsdev = {
          depends  = (((([
            ...
            hsPkgs.ghc-boot
            hsPkgs.directory
          ] ++ pkgs.lib.optional _flags.docs hsPkgs.haddock-api)) ++ optionals (compiler.isGhc && compiler.isGhc) ([
            hsPkgs.ghc
            hsPkgs.ghc-boot
            hsPkgs.directory
          ] ++ pkgs.lib.optional _flags.docs hsPkgs.haddock-api)) ++ optionals compiler.isGhc ([
            hsPkgs.ghc
