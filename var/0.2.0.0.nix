      ...
      components = {
        var = {
          depends  = ((([
            hsPkgs.base
            hsPkgs.transformers
          ] ++ pkgs.lib.optional _flags.safe-st hsPkgs.base) ++ pkgs.lib.optional _flags.ghc-conc-sync hsPkgs.base) ++ pkgs.lib.optional _flags.strict-modifyref hsPkgs.base) ++ pkgs.lib.optional compiler.isGhc hsPkgs.ghc-prim;
        };
        tests = {
          properties = {
            depends  = [
