    ...
    in {
      ...
      components = {
        "accelerate-examples" = {
          ...
          ] ++ pkgs.lib.optional _flags.llvm-cpu hsPkgs.accelerate-llvm-native) ++ pkgs.lib.optional _flags.llvm-ptx hsPkgs.accelerate-llvm-ptx) ++ pkgs.lib.optionals _flags.codespeed [
            hsPkgs.aeson
            hsPkgs.bytestring
            hsPkgs.HTTP
            hsPkgs.http-types
