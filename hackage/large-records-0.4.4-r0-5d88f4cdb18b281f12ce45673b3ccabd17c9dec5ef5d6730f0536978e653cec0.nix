{ system
  ...
  , ... }:
  {
    ...
    package = {
      specVersion = "2.4";
      identifier = { name = "large-records"; version = "0.4.4"; };
    ...
    components = {
      "library" = {
        ...
        ] ++ pkgs.lib.optional (flags.rdp) (hsPkgs."record-dot-preprocessor" or (errorHandler.buildDepError "record-dot-preprocessor"));
        buildable = true;
      };
      tests = {
        "test-large-records" = {
          ...
          ] ++ pkgs.lib.optional (compiler.isGhc && compiler.version.ge "9.10") (hsPkgs."ghc-internal" or (errorHandler.buildDepError "ghc-internal"))) ++ pkgs.lib.optional (flags.rdp) (hsPkgs."record-dot-preprocessor" or (errorHandler.buildDepError "record-dot-preprocessor"));
          buildable = true;
        };
      };
    };
