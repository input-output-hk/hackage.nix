{ system
  ...
  , ... }:
  {
    flags = { directory-ospath-streaming = true; };
    package = {
      specVersion = "2.4";
      identifier = { name = "stan"; version = "0.2.1.0"; };
      license = "MPL-2.0";
    ...
    components = {
      "library" = {
        ...
        ] ++ pkgs.lib.optional (flags.directory-ospath-streaming) (hsPkgs."directory-ospath-streaming" or (errorHandler.buildDepError "directory-ospath-streaming"));
        buildable = true;
      };
      sublibs = {
        "target" = {
