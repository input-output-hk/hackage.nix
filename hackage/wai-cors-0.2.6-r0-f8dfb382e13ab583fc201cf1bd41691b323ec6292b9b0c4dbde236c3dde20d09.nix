      ...
      tests = {
        "phantomjs" = {
          depends = ([
            ...
            ] ++ (pkgs.lib).optional (compiler.isGhc && (compiler.version).lt "7.8") (hsPkgs."filepath" or (errorHandler.buildDepError "filepath"))) ++ (pkgs.lib).optionals (!(flags.wai-1 || flags.wai-2 || compiler.isGhc && (compiler.version).lt "7.10")) [
