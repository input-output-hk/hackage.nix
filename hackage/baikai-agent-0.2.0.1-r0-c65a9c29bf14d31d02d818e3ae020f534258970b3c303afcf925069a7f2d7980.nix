{ system
  ...
  , ... }:
  {
    ...
    package = {
      specVersion = "3.4";
      identifier = { name = "baikai-agent"; version = "0.2.0.1"; };
    ...
    components = {
      ...
      tests = {
        "baikai-agent-test" = {
          ...
          build-tools = [
            (hsPkgs.pkgsBuildBuild.baikai-agent.components.exes.baikai or (pkgs.pkgsBuildBuild.baikai or (errorHandler.buildToolDepError "baikai-agent:baikai")))
          ];
          buildable = true;
        };
      };
