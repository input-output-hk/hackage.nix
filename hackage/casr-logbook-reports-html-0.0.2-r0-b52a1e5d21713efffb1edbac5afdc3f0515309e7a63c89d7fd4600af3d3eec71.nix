...
in { system, compiler, flags, pkgs, hsPkgs, pkgconfPkgs, ... }:
  {
    ...
    package = {
      specVersion = "1.10";
      identifier = { name = "casr-logbook-reports-html"; version = "0.0.2"; };
    ...
    components = {
      "library" = {
        depends = [
          ...
          (hsPkgs."casr-logbook-types" or (buildDepError "casr-logbook-types"))
          (hsPkgs."casr-logbook-html" or (buildDepError "casr-logbook-html"))
