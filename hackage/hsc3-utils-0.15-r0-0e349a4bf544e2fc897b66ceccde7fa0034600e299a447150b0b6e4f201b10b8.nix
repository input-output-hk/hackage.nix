{ system, compiler, flags, pkgs, hsPkgs, pkgconfPkgs, ... }:
  {
    ...
    components = {
      ...
      exes = {
        "hsc3-hash-at" = { depends = [ (hsPkgs.base) (hsPkgs.hsc3-rw) ]; };
        "hsc3-hash-paren" = { depends = [ (hsPkgs.base) (hsPkgs.hsc3-rw) ]; };
        "hsc3-id-rewrite" = { depends = [ (hsPkgs.base) (hsPkgs.hsc3-rw) ]; };
        "hsc3-id-clear" = { depends = [ (hsPkgs.base) (hsPkgs.hsc3-rw) ]; };
