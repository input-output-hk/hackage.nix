{ system, compiler, flags, pkgs, hsPkgs, pkgconfPkgs, ... }:
  {
    ...
    package = {
      specVersion = "1.10";
      identifier = { name = "scotty"; version = "0.11.2"; };
      ...
      tests = {
        "spec" = {
          depends = [
            ...
            (hsPkgs."text" or ((hsPkgs.pkgs-errors).buildDepError "text"))
            (hsPkgs."wai" or ((hsPkgs.pkgs-errors).buildDepError "wai"))
            ] ++ (pkgs.lib).optional (flags.hpc-coveralls) (hsPkgs."hpc-coveralls" or ((hsPkgs.pkgs-errors).buildDepError "hpc-coveralls"));
          build-tools = [
            (hsPkgs.buildPackages.hspec-discover or (pkgs.buildPackages.hspec-discover or ((hsPkgs.pkgs-errors).buildToolDepError "hspec-discover")))
            ] ++ (pkgs.lib).optional (flags.hpc-coveralls) (hsPkgs.buildPackages.hpc-coveralls or (pkgs.buildPackages.hpc-coveralls or ((hsPkgs.pkgs-errors).buildToolDepError "hpc-coveralls")));
          buildable = true;
          };
        };
      };
