  ...
  , ... }:
  {
    ...
    components = {
      "library" = {
        ...
        ] ++ pkgs.lib.optional (system.isWindows) (hsPkgs."unix-compat" or (errorHandler.buildDepError "unix-compat"))) ++ pkgs.lib.optional (!system.isWindows) (hsPkgs."unix" or (errorHandler.buildDepError "unix"))) ++ pkgs.lib.optionals (flags.http) [
      ...
      exes = {
        "witnesses" = {
          depends = pkgs.lib.optional (system.isWindows) (hsPkgs."unix-compat" or (errorHandler.buildDepError "unix-compat"));
        ...
        "unit" = {
          ...
          ]) ++ pkgs.lib.optional (system.isWindows) (hsPkgs."unix-compat" or (errorHandler.buildDepError "unix-compat"))) ++ pkgs.lib.optional (!system.isWindows) (hsPkgs."unix" or (errorHandler.buildDepError "unix"))) ++ pkgs.lib.optional (flags.mmap && !system.isWindows) (hsPkgs."mmap" or (errorHandler.buildDepError "mmap"))) ++ pkgs.lib.optional (flags.terminfo && !system.isWindows) (hsPkgs."terminfo" or (errorHandler.buildDepError "terminfo"));
