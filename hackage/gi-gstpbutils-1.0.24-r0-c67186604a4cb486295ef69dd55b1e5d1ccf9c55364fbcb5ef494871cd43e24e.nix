  ...
  , ... }:
  {
    ...
    package = {
      ...
      setup-depends = [
        ...
        (hsPkgs.buildPackages.gi-gstaudio or (pkgs.buildPackages.gi-gstaudio or (errorHandler.setupDepError "gi-gstaudio")))
        (hsPkgs.buildPackages.gi-gstvideo or (pkgs.buildPackages.gi-gstvideo or (errorHandler.setupDepError "gi-gstvideo")))
        (hsPkgs.buildPackages.gi-gsttag or (pkgs.buildPackages.gi-gsttag or (errorHandler.setupDepError "gi-gsttag")))
