{ system
  ...
  , ... }:
  {
    ...
    package = {
      specVersion = "3.4";
      identifier = { name = "moonlight-triangulation"; version = "1.4.0.5"; };
      license = "MIT";
      ...
      tests = {
        ...
        "moonlight-triangulation-zigzag-test" = {
          depends = [
            ...
            (hsPkgs."moonlight-homology" or (errorHandler.buildDepError "moonlight-homology"))
            (hsPkgs."moonlight-triangulation".components.sublibs.dcel or (errorHandler.buildDepError "moonlight-triangulation:dcel"))
            (hsPkgs."moonlight-triangulation".components.sublibs.zigzag or (errorHandler.buildDepError "moonlight-triangulation:zigzag"))
            (hsPkgs."tasty" or (errorHandler.buildDepError "tasty"))
            (hsPkgs."tasty-hunit" or (errorHandler.buildDepError "tasty-hunit"))
            (hsPkgs."vector" or (errorHandler.buildDepError "vector"))
          ];
