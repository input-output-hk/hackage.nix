  ...
  , ... }:
  {
    ...
    components = {
      "library" = {
        ...
        build-tools = pkgs.lib.optional (system.isOsx) (hsPkgs.pkgsBuildBuild.cpphs.components.exes.cpphs or (pkgs.pkgsBuildBuild.cpphs or (errorHandler.buildToolDepError "cpphs:cpphs")));
        buildable = true;
      };
      tests = {
        "sanity" = {
