{ system, compiler, flags, pkgs, hsPkgs, pkgconfPkgs, ... }:
  {
    ...
    package = {
      specVersion = "0";
      identifier = { name = "Encode"; version = "1.3.1"; };
    ...
    components = {
      "library" = { depends = [ (hsPkgs.Cabal) (hsPkgs.base) (hsPkgs.mtl) ]; };
      exes = {
        "encode" = { depends = [ (hsPkgs.Cabal) (hsPkgs.base) (hsPkgs.mtl) ]; };
        "decode" = { depends = [ (hsPkgs.Cabal) (hsPkgs.base) (hsPkgs.mtl) ]; };
        };
      };
    }