{ system
  ...
  , ... }:
  {
    ...
    package = {
      specVersion = "2.4";
      identifier = { name = "pms-infra-filesystem"; version = "0.0.1.0"; };
      license = "Apache-2.0";
      ...
      tests = {
        "pms-infra-filesystem-test" = {
          depends = [
            ...
            (hsPkgs."directory" or (errorHandler.buildDepError "directory"))
            (hsPkgs."pms-domain-model" or (errorHandler.buildDepError "pms-domain-model"))
            (hsPkgs."pms-infra-filesystem" or (errorHandler.buildDepError "pms-infra-filesystem"))
          ];
          build-tools = [
