{ system
  ...
  , ... }:
  {
    flags = { python-interop = false; };
    package = {
      specVersion = "3.0";
      identifier = { name = "wireform-proto"; version = "0.1.0.0"; };
    ...
    components = {
      ...
      exes = {
        ...
        "wireform-proto-python-interop" = {
          ...
          buildable = if !flags.python-interop then false else true;
        };
      };
      tests = {
        "wireform-proto-test" = {
