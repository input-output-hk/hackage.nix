{ system
  ...
  , ... }:
  {
    flags = { warnings-as-errors = false; fuzz-targets = false; };
    package = {
      specVersion = "3.4";
      identifier = { name = "moonlight-triangulation"; version = "0.1.0.0"; };
      license = "MIT";
    ...
    components = {
      ...
      exes = {
        "moonlight-triangulation-fuzz-decode" = {
          depends = [
            (hsPkgs."base" or (errorHandler.buildDepError "base"))
            (hsPkgs."bytestring" or (errorHandler.buildDepError "bytestring"))
            (hsPkgs."containers" or (errorHandler.buildDepError "containers"))
          ...
          buildable = if !flags.fuzz-targets then false else true;
        };
        "moonlight-triangulation-fuzz-constraints" = {
          depends = [
            (hsPkgs."base" or (errorHandler.buildDepError "base"))
            (hsPkgs."bytestring" or (errorHandler.buildDepError "bytestring"))
            (hsPkgs."containers" or (errorHandler.buildDepError "containers"))
        ...
        "moonlight-triangulation-fuzz-refinement" = {
          depends = [
            (hsPkgs."base" or (errorHandler.buildDepError "base"))
            (hsPkgs."bytestring" or (errorHandler.buildDepError "bytestring"))
            (hsPkgs."containers" or (errorHandler.buildDepError "containers"))
