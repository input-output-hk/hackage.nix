{ system
  ...
  , ... }:
  {
    ...
    package = {
      specVersion = "1.10";
      identifier = { name = "integer-logarithms"; version = "1.0.2.2"; };
      license = "MIT";
    ...
    components = {
      "library" = {
        ...
        ] ++ pkgs.lib.optional (!(compiler.isGhc && compiler.version.ge "7.10")) (hsPkgs."nats" or (errorHandler.buildDepError "nats"))) ++ (if flags.integer-gmp
          then [
