{ system
  ...
  , ... }:
  {
    ...
    package = {
      specVersion = "1.12";
      identifier = { name = "valida-base"; version = "0.1.0"; };
      license = "MIT";
      ...
      description = "This is a zero dependency version of the valida package. It is equivalent to valida == 0.1.0. Check out the README at github <https://github.com/TotallyNotChase/valida#readme>!";
      buildType = "Simple";
    };
    components = {
      "library" = {
