  ...
  , ... }:
  {
    ...
    components = {
      "library" = {
        ...
        ] ++ pkgs.lib.optional (system.isWindows) (hsPkgs."Win32" or (errorHandler.buildDepError "Win32"))) ++ pkgs.lib.optional (compiler.isGhc && compiler.version.lt "7.8") (hsPkgs."base-orphans" or (errorHandler.buildDepError "base-orphans"))) ++ (if compiler.isGhc && compiler.version.lt "7.6"
          then [
