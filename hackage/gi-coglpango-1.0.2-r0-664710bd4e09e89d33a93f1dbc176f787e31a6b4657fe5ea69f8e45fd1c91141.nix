{ system
  ...
  , ... }:
  {
    ...
    package = {
      specVersion = "2.0";
      identifier = { name = "gi-coglpango"; version = "1.0.2"; };
      ...
      setup-depends = [
        ...
        (hsPkgs.pkgsBuildBuild.gi-cogl or (pkgs.pkgsBuildBuild.gi-cogl or (errorHandler.setupDepError "gi-cogl")))
        (hsPkgs.pkgsBuildBuild.gi-pango or (pkgs.pkgsBuildBuild.gi-pango or (errorHandler.setupDepError "gi-pango")))
        (hsPkgs.pkgsBuildBuild.gi-pangocairo or (pkgs.pkgsBuildBuild.gi-pangocairo or (errorHandler.setupDepError "gi-pangocairo")))
      ];
    };
    components = {
      "library" = {
