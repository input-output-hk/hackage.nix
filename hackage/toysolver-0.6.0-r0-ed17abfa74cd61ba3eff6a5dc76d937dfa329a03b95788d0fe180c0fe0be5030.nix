    ...
    components = {
      "library" = {
        depends = (([
          ...
          ] ++ (pkgs.lib).optional (flags.withzlib) (hsPkgs."zlib" or ((hsPkgs.pkgs-errors).buildDepError "zlib"))) ++ (pkgs.lib).optional (flags.opencl) (hsPkgs."OpenCL" or ((hsPkgs.pkgs-errors).buildDepError "OpenCL"))) ++ (pkgs.lib).optional (compiler.isGhc && true) (hsPkgs."ghc-prim" or ((hsPkgs.pkgs-errors).buildDepError "ghc-prim"));
        buildable = true;
        };
      exes = {
        "toysolver" = {
        ...
        "toyfmf" = {
          depends = (pkgs.lib).optionals (flags.buildtoyfmf) (([
            ...
            then [
              ...
              (hsPkgs."transformers-compat" or ((hsPkgs.pkgs-errors).buildDepError "transformers-compat"))
              ])) ++ (pkgs.lib).optional (compiler.isGhc && (compiler.version).ge "8.4") (hsPkgs."logic-TPTP" or ((hsPkgs.pkgs-errors).buildDepError "logic-TPTP")));
