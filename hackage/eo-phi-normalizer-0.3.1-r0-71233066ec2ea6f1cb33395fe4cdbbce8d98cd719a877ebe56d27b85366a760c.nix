{ system
  ...
  , ... }:
  {
    ...
    package = {
      specVersion = "1.24";
      identifier = { name = "eo-phi-normalizer"; version = "0.3.1"; };
      ...
      setup-depends = [
        ...
        (hsPkgs.buildPackages.string-interpolate or (pkgs.buildPackages.string-interpolate or (errorHandler.setupDepError "string-interpolate")))
      ];
    };
    components = {
      "library" = {
