{ system, compiler, flags, pkgs, hsPkgs, pkgconfPkgs, ... }:
  {
    ...
    package = {
      specVersion = "1.8";
      identifier = { name = "idris"; version = "0.12.2"; };
      ...
      "library" = {
        depends = (((((([
          ...
          then [ (hsPkgs.zlib) (hsPkgs.process) ]
            ...
            (hsPkgs.process)
            ])) ++ (pkgs.lib).optional (system.isLinux) (hsPkgs.unix)) ++ (pkgs.lib).optional (system.isFreebsd) (hsPkgs.unix)) ++ (pkgs.lib).optional (system.isOsx) (hsPkgs.unix)) ++ (pkgs.lib).optional (system.isWindows) (hsPkgs.Win32)) ++ (pkgs.lib).optional (flags.ffi) (hsPkgs.libffi)) ++ (pkgs.lib).optional (flags.gmp) (hsPkgs.libffi);
