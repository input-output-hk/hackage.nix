{ system, compiler, flags, pkgs, hsPkgs, pkgconfPkgs, ... }:
  {
    ...
    components = {
      "library" = {
        ...
        libs = (pkgs.lib).optionals (!system.isWindows) ((pkgs.lib).optional (!system.isOsx) (pkgs."OpenCL" or ((hsPkgs.pkgs-errors).sysDepError "OpenCL")));
        frameworks = (pkgs.lib).optionals (!system.isWindows) ((pkgs.lib).optional (system.isOsx) (pkgs."OpenCL" or ((hsPkgs.pkgs-errors).sysDepError "OpenCL")));
        build-tools = [
