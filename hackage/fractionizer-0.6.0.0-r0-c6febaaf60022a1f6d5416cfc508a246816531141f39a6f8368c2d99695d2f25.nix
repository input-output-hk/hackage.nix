{ system
  ...
  , ... }:
  {
    ...
    package = {
      specVersion = "2.4";
      identifier = { name = "fractionizer"; version = "0.6.0.0"; };
      license = "MIT";
      ...
      homepage = "";
      url = "";
      synopsis = "Allows to approximate the fractional numbers in the range [0.005, 1) or better [0.005, sqrt (2/3)] with sum of two unit fractions of special types.";
