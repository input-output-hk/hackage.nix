{ system
  ...
  , ... }:
  {
    ...
    package = {
      specVersion = "1.12";
      identifier = { name = "sandwich-slack"; version = "0.1.0.0"; };
      ...
      url = "";
      synopsis = "Slack integration for Sandwich";
      description = "Please see the README on GitHub at <https://github.com/codedownio/sandwich-slack#readme>";
      buildType = "Simple";
    };
    components = {
      "library" = {
