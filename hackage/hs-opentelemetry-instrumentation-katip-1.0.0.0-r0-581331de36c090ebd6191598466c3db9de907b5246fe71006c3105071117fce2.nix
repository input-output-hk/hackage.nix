{ system
  ...
  , ... }:
  {
    ...
    components = {
      ...
      tests = {
        "hs-opentelemetry-instrumentation-katip-test" = {
          depends = [
            (hsPkgs."base" or (errorHandler.buildDepError "base"))
            (hsPkgs."hs-opentelemetry-api" or (errorHandler.buildDepError "hs-opentelemetry-api"))
            (hsPkgs."hs-opentelemetry-exporter-in-memory" or (errorHandler.buildDepError "hs-opentelemetry-exporter-in-memory"))
            (hsPkgs."hs-opentelemetry-instrumentation-katip" or (errorHandler.buildDepError "hs-opentelemetry-instrumentation-katip"))
