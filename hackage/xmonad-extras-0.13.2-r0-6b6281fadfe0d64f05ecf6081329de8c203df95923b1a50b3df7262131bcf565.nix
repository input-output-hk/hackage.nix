    ...
    components = {
      "library" = {
        depends = (((([
          ...
          ]) ++ (pkgs.lib).optional (flags.with_regex_posix) (hsPkgs."regex-posix" or (errorHandler.buildDepError "regex-posix"))) ++ (pkgs.lib).optionals (flags.with_template_haskell && flags.with_hlist) [
