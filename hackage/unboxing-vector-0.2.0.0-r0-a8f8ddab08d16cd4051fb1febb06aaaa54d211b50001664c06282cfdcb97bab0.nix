{ system
  ...
  , ... }:
  {
    flags = { mono-traversable = true; };
    package = {
      specVersion = "1.12";
      identifier = { name = "unboxing-vector"; version = "0.2.0.0"; };
    ...
    components = {
      "library" = {
        ...
        ] ++ pkgs.lib.optional (flags.mono-traversable) (hsPkgs."mono-traversable" or (errorHandler.buildDepError "mono-traversable"));
        buildable = true;
      };
      tests = {
