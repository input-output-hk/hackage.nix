{ system
  ...
  , ... }:
  {
    ...
    package = {
      specVersion = "1.24";
      identifier = { name = "gi-webkit2webextension"; version = "4.0.24"; };
      ...
      setup-depends = [
        ...
        (hsPkgs.buildPackages.gi-soup or (pkgs.buildPackages.gi-soup or (errorHandler.buildToolDepError "gi-soup")))
        (hsPkgs.buildPackages.gi-gio or (pkgs.buildPackages.gi-gio or (errorHandler.buildToolDepError "gi-gio")))
        (hsPkgs.buildPackages.gi-javascriptcore or (pkgs.buildPackages.gi-javascriptcore or (errorHandler.buildToolDepError "gi-javascriptcore")))
