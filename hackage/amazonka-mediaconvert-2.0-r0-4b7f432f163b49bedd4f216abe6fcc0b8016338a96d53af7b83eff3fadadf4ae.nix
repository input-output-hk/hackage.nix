{ system
  ...
  , ... }:
  {
    ...
    package = {
      specVersion = "2.2";
      identifier = { name = "amazonka-mediaconvert"; version = "2.0"; };
      license = "MPL-2.0";
    ...
    components = {
      ...
      tests = {
        "amazonka-mediaconvert-test" = {
          depends = [
            (hsPkgs."amazonka-core" or (errorHandler.buildDepError "amazonka-core"))
            (hsPkgs."amazonka-mediaconvert" or (errorHandler.buildDepError "amazonka-mediaconvert"))
