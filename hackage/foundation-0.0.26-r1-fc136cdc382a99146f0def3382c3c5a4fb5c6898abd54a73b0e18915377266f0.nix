{ system
  ...
  , ... }:
  {
    ...
    package = {
      specVersion = "1.18";
      identifier = { name = "foundation"; version = "0.0.26"; };
    ...
    components = {
      "library" = {
        depends = [
          ...
          ] ++ (pkgs.lib).optionals (!(compiler.isGhc && (compiler.version).lt "8.0" || compiler.isGhcjs && true)) ([
          (hsPkgs."base" or (errorHandler.buildDepError "base"))
          (hsPkgs."ghc-prim" or (errorHandler.buildDepError "ghc-prim"))
          ] ++ (pkgs.lib).optional (system.isWindows) (hsPkgs."Win32" or (errorHandler.buildDepError "Win32")));
        libs = (pkgs.lib).optionals (!(compiler.isGhc && (compiler.version).lt "8.0" || compiler.isGhcjs && true)) ((pkgs.lib).optionals (system.isWindows) ((pkgs.lib).optional (system.isI386) (pkgs."gcc" or (errorHandler.sysDepError "gcc"))));
        buildable = if compiler.isGhc && (compiler.version).lt "8.0" || compiler.isGhcjs && true
          then false
          else true;
        };
      tests = {
