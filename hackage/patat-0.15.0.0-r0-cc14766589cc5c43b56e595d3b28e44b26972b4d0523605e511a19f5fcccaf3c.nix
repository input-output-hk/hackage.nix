{ system
  ...
  , ... }:
  {
    ...
    package = {
      specVersion = "1.10";
      identifier = { name = "patat"; version = "0.15.0.0"; };
    ...
    components = {
      ...
      tests = {
        ...
        "patat-goldplate" = {
          ...
          build-tools = [
            (hsPkgs.pkgsBuildBuild.patat.components.exes.patat or (pkgs.pkgsBuildBuild.patat or (errorHandler.buildToolDepError "patat:patat")))
          ];
          buildable = true;
        };
      };
