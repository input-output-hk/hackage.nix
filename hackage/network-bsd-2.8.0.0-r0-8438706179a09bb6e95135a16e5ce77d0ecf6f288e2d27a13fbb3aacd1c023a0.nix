...
in { system, compiler, flags, pkgs, hsPkgs, pkgconfPkgs, ... }:
  {
    ...
    package = {
      specVersion = "1.22";
      identifier = { name = "network-bsd"; version = "2.8.0.0"; };
      ...
      description = "This package reexports the \"Network.BSD\" module split from the <https://hackage.haskell.org/package/network-2.8.0.0 network-2.8.0.0> package.\n\nSee newer versions of <https://hackage.haskell.org/package/network-bsd network-bsd> for more information.";
      buildType = "Simple";
      };
    components = {
      "library" = {
