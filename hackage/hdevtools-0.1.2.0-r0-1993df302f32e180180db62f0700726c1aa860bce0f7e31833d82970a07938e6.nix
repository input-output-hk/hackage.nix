      ...
      exes = {
        "hdevtools" = {
          depends = (([
            ...
            ] ++ (pkgs.lib).optional (compiler.isGhc && false) (hsPkgs."Cabal" or (buildDepError "Cabal"))) ++ (pkgs.lib).optional (compiler.isGhc && (compiler.version).ge "7.7") (hsPkgs."Cabal" or (buildDepError "Cabal"))) ++ (pkgs.lib).optionals (compiler.isGhc && (compiler.version).ge "7.9") [
