{ system, compiler, flags, pkgs, hsPkgs, pkgconfPkgs, ... }:
  {
    ...
    package = {
      specVersion = "2.0";
      identifier = { name = "cabal-helper"; version = "0.8.2.0"; };
    ...
    components = {
      "library" = {
        ...
        build-tools = [
          (hsPkgs.buildPackages.cabal-helper or (pkgs.buildPackages.cabal-helper or ((hsPkgs.pkgs-errors).buildToolDepError "cabal-helper")))
          ];
        buildable = true;
        };
      exes = {
