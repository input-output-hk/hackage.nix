{ system
  ...
  , ... }:
  {
    ...
    package = {
      specVersion = "1.6";
      identifier = { name = "darcs"; version = "2.2.0"; };
    ...
    components = {
      "library" = {
        ...
        build-tools = (pkgs.lib).optionals (!flags.curl) ((pkgs.lib).optional (flags.libwww) (hsPkgs.buildPackages.libwww-config or (pkgs.buildPackages.libwww-config or (errorHandler.buildToolDepError "libwww-config"))));
        buildable = true;
        };
      exes = {
        "darcs" = {
