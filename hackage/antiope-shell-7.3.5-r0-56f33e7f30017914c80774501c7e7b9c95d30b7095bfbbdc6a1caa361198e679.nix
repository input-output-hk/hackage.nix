...
in { system, compiler, flags, pkgs, hsPkgs, pkgconfPkgs, ... }:
  {
    ...
    package = {
      specVersion = "2.4";
      identifier = { name = "antiope-shell"; version = "7.3.5"; };
      license = "MIT";
    ...
    components = {
      "library" = {
        depends = [
          ...
          (hsPkgs."antiope-messages" or (buildDepError "antiope-messages"))
      ...
      tests = {
        "antiope-shell-test" = {
          depends = [
            ...
            (hsPkgs."amazonka-s3" or (buildDepError "amazonka-s3"))
            (hsPkgs."antiope-core" or (buildDepError "antiope-core"))
            (hsPkgs."antiope-shell" or (buildDepError "antiope-shell"))
            (hsPkgs."attoparsec" or (buildDepError "attoparsec"))
            (hsPkgs."bytestring" or (buildDepError "bytestring"))
