{ system
  ...
  , ... }:
  {
    ...
    package = {
      specVersion = "2.0";
      identifier = { name = "gi-keybinder"; version = "0.3.2"; };
      ...
      url = "";
      synopsis = "Libkeybinder bindings";
      description = "Bindings for Libkeybinder (library for registering global keyboard shortcuts to be used by GTK-based applications under the X Window System), autogenerated by haskell-gi.";
      buildType = "Custom";
      setup-depends = [
    ...
    components = {
      "library" = {
        ...
        pkgconfig = [
          (pkgconfPkgs."keybinder-3.0" or (errorHandler.pkgConfDepError "keybinder-3.0"))
        ];
        buildable = true;
      };
    };
