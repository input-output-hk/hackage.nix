      ...
      "library" = {
        depends = (([
          ...
          then [
            ...
            (hsPkgs."text" or ((hsPkgs.pkgs-errors).buildDepError "text"))
            ])) ++ (pkgs.lib).optional (compiler.isGhc && (compiler.version).lt "7.7") (hsPkgs."tagged" or ((hsPkgs.pkgs-errors).buildDepError "tagged"))) ++ (if compiler.isGhc && (compiler.version).lt "7.9"
          then [
          ...
          else (pkgs.lib).optional (flags.integer-gmp2) (hsPkgs."integer-gmp" or ((hsPkgs.pkgs-errors).buildDepError "integer-gmp")));
        buildable = true;
        };
      tests = {
        "text-show-properties" = {
          depends = (([
            ...
            ] ++ (pkgs.lib).optional (compiler.isGhc && (compiler.version).ge "7.2" && (compiler.isGhc && (compiler.version).lt "7.6")) (hsPkgs."ghc-prim" or ((hsPkgs.pkgs-errors).buildDepError "ghc-prim"))) ++ (pkgs.lib).optional (compiler.isGhc && (compiler.version).lt "7.7") (hsPkgs."tagged" or ((hsPkgs.pkgs-errors).buildDepError "tagged"))) ++ (pkgs.lib).optionals (compiler.isGhc && (compiler.version).lt "7.9") ([
            (hsPkgs."nats" or ((hsPkgs.pkgs-errors).buildDepError "nats"))
            (hsPkgs."void" or ((hsPkgs.pkgs-errors).buildDepError "void"))
            ] ++ (if flags.transformers-four
            then [
