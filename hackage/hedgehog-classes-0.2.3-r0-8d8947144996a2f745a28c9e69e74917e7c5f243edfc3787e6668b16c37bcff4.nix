    ...
    components = {
      "library" = {
        depends = (([
          ...
          ] ++ (pkgs.lib).optional (flags.aeson) (hsPkgs."aeson" or ((hsPkgs.pkgs-errors).buildDepError "aeson"))) ++ (pkgs.lib).optional (flags.semirings) (hsPkgs."semirings" or ((hsPkgs.pkgs-errors).buildDepError "semirings"))) ++ (pkgs.lib).optional (flags.comonad) (hsPkgs."comonad" or ((hsPkgs.pkgs-errors).buildDepError "comonad"));
        buildable = true;
        };
      tests = {
        "spec" = {
