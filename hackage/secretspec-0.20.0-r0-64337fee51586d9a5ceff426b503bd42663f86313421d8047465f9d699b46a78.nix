{ system
  ...
  , ... }:
  {
    ...
    package = {
      specVersion = "2.4";
      identifier = { name = "secretspec"; version = "0.20.0"; };
      license = "Apache-2.0";
      copyright = "";
    ...
    components = {
      "library" = {
        ...
        libs = pkgs.lib.optional (!flags.use-pkg-config) (pkgs."secretspec" or (errorHandler.sysDepError "secretspec"));
        ...
        pkgconfig = pkgs.lib.optional (flags.use-pkg-config) (pkgconfPkgs."libsecretspec" or (errorHandler.pkgConfDepError "libsecretspec"));
        buildable = true;
      };
      exes = {
