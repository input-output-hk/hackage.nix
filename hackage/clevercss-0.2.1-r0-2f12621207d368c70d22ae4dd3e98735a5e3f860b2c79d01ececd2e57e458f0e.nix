{ system, compiler, flags, pkgs, hsPkgs, pkgconfPkgs, ... }:
  {
    flags = { splitbase = true; parsec2 = true; };
    package = {
      specVersion = "1.2";
      identifier = { name = "clevercss"; version = "0.2.1"; };
    ...
    components = {
      "library" = {
        depends = (if flags.splitbase
          then [ (hsPkgs.base) (hsPkgs.containers) (hsPkgs.mtl) ]
          else [ (hsPkgs.base) (hsPkgs.mtl) ]) ++ [ (hsPkgs.parsec) ];
        };
