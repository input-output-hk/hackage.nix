{ system, compiler, flags, pkgs, hsPkgs, pkgconfPkgs, ... }:
  {
    ...
    package = {
      specVersion = "1.8";
      identifier = { name = "naturalcomp"; version = "0.0.2"; };
    ...
    components = {
      "library" = {
        depends = ([
          ...
          ] ++ (pkgs.lib).optional (flags.filepath) (hsPkgs."system-filepath" or ((hsPkgs.pkgs-errors).buildDepError "system-filepath"))) ++ (pkgs.lib).optional (flags.unicode-collation) (hsPkgs."rfc5051" or ((hsPkgs.pkgs-errors).buildDepError "rfc5051"));
        buildable = true;
        };
      };
    }