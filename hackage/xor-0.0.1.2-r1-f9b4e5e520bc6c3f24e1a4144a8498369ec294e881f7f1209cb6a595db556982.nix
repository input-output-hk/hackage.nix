{ system
  ...
  , ... }:
  {
    ...
    package = {
      specVersion = "2.2";
      identifier = { name = "xor"; version = "0.0.1.2"; };
    ...
    components = {
      "library" = {
        ...
        ] ++ pkgs.lib.optional (!(compiler.isGhc && compiler.version.ge "8.0")) (hsPkgs."bytestring" or (errorHandler.buildDepError "bytestring"));
        buildable = true;
      };
      tests = {
        "test" = {
