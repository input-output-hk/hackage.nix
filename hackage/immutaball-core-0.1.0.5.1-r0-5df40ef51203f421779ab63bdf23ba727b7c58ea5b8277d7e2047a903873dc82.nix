{ system
  ...
  , ... }:
  {
    flags = { add-default-compiler-flags = true; internal-wires = false; };
    package = {
      specVersion = "3.0";
      identifier = { name = "immutaball-core"; version = "0.1.0.5.1"; };
      license = "0BSD";
    ...
    components = {
      "library" = {
        ...
        ] ++ pkgs.lib.optional (!flags.internal-wires) (hsPkgs."wires" or (errorHandler.buildDepError "wires"));
        buildable = true;
      };
      exes = {
        "immutaball" = {
