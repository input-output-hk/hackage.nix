{ system
  ...
  , ... }:
  {
    ...
    package = {
      specVersion = "2.2";
      identifier = { name = "amazonka-chime-sdk-meetings"; version = "2.0"; };
      license = "MPL-2.0";
    ...
    components = {
      ...
      tests = {
        "amazonka-chime-sdk-meetings-test" = {
          depends = [
            (hsPkgs."amazonka-chime-sdk-meetings" or (errorHandler.buildDepError "amazonka-chime-sdk-meetings"))
            (hsPkgs."amazonka-core" or (errorHandler.buildDepError "amazonka-core"))
