{ system, compiler, flags, pkgs, hsPkgs, pkgconfPkgs, ... }:
  {
    ...
    package = {
      specVersion = "1.18";
      identifier = { name = "record-dot-preprocessor"; version = "0.2.1"; };
      ...
      tests = {
        "record-dot-preprocessor-test" = {
          depends = [
            ...
            ] ++ (pkgs.lib).optional (compiler.isGhc && (compiler.version).ge "8.6") (hsPkgs."record-dot-preprocessor" or ((hsPkgs.pkgs-errors).buildDepError "record-dot-preprocessor"));
          buildable = true;
          };
        };
      };
