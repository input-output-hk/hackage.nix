{ system
  ...
  , ... }:
  {
    ...
    package = {
      specVersion = "2.2";
      identifier = { name = "streamly"; version = "0.8.2"; };
    ...
    components = {
      "library" = {
        ...
        ] ++ (if flags.use-unliftio
          then [
            (hsPkgs."unliftio-core" or (errorHandler.buildDepError "unliftio-core"))
          ]
          else [
            (hsPkgs."monad-control" or (errorHandler.buildDepError "monad-control"))
          ])) ++ pkgs.lib.optionals (!flags.streamly-core) ([
        ...
        frameworks = pkgs.lib.optionals (!flags.streamly-core) (pkgs.lib.optional (system.isOsx) (pkgs."Cocoa" or (errorHandler.sysDepError "Cocoa")));
        buildable = true;
      };
    };
  }