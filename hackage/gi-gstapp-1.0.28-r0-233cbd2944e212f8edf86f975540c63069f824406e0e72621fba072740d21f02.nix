{ system
  ...
  , ... }:
  {
    ...
    package = {
      specVersion = "2.0";
      identifier = { name = "gi-gstapp"; version = "1.0.28"; };
      ...
      url = "";
      synopsis = "GStreamerApp bindings";
      description = "Bindings for GStreamerApp, autogenerated by haskell-gi.";
      buildType = "Custom";
      setup-depends = [
        ...
        (hsPkgs.buildPackages.gi-gstbase or (pkgs.buildPackages.gi-gstbase or (errorHandler.setupDepError "gi-gstbase")))
    ...
    components = {
      "library" = {
        ...
        pkgconfig = [
          (pkgconfPkgs."gstreamer-app-1.0" or (errorHandler.pkgConfDepError "gstreamer-app-1.0"))
        ];
        buildable = true;
      };
    };
