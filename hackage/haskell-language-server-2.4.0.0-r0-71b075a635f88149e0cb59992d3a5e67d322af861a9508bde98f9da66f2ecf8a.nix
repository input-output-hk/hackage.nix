{ system
  ...
  , ... }:
  {
    ...
    package = {
      specVersion = "3.0";
      identifier = { name = "haskell-language-server"; version = "2.4.0.0"; };
      license = "Apache-2.0";
