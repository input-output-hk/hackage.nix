  ...
  , ... }:
  {
    ...
    components = {
      "library" = {
        ...
        libs = (pkgs.lib).optionals (flags.usenativeffi-1-0 || flags.usenativeffi-1-1) (((pkgs.lib).optional (system.isWindows) (pkgs."vulkan-1" or (errorHandler.sysDepError "vulkan-1")) ++ (pkgs.lib).optional (system.isOsx) (pkgs."vulkan" or (errorHandler.sysDepError "vulkan"))) ++ (pkgs.lib).optional (!system.isWindows && !system.isOsx) (pkgs."vulkan" or (errorHandler.sysDepError "vulkan")));
        build-tools = [
