    ...
    components = {
      "library" = {
        depends = ((([
          ...
          ] ++ (pkgs.lib).optional (compiler.isGhc && (compiler.version).ge "8.6") (hsPkgs."deferred-folds" or ((hsPkgs.pkgs-errors).buildDepError "deferred-folds"))) ++ (if system.isWindows
          then [
          ...
          ]) ++ (pkgs.lib).optional (!flags.stack) (hsPkgs."deferred-folds" or ((hsPkgs.pkgs-errors).buildDepError "deferred-folds"));
        buildable = true;
        };
      exes = {
        "tutd" = {
