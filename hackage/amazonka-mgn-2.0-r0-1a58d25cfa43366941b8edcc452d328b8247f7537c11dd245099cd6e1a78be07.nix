{ system
  ...
  , ... }:
  {
    ...
    package = {
      specVersion = "2.2";
      identifier = { name = "amazonka-mgn"; version = "2.0"; };
      license = "MPL-2.0";
    ...
    components = {
      ...
      tests = {
        "amazonka-mgn-test" = {
          depends = [
            (hsPkgs."amazonka-core" or (errorHandler.buildDepError "amazonka-core"))
            (hsPkgs."amazonka-mgn" or (errorHandler.buildDepError "amazonka-mgn"))
