{ system
  ...
  , ... }:
  {
    flags = { superdirt = false; };
    package = {
      specVersion = "3.0";
      identifier = { name = "zwirn"; version = "0.2.3.1"; };
      ...
      sublibs = {
        ...
        "zwirn-doux" = {
          depends = [
            ...
            (hsPkgs."zwirn".components.sublibs.zwirn-lang or (errorHandler.buildDepError "zwirn:zwirn-lang"))
            (hsPkgs."tidal-link" or (errorHandler.buildDepError "tidal-link"))
            (hsPkgs."haskell-doux" or (errorHandler.buildDepError "haskell-doux"))
      ...
      exes = {
        "zwirnzi" = {
          depends = [
            ...
            then [
              (hsPkgs."zwirn".components.sublibs.zwirn-stream or (errorHandler.buildDepError "zwirn:zwirn-stream"))
              (hsPkgs."yaml" or (errorHandler.buildDepError "yaml"))
            ]
            else [
              (hsPkgs."zwirn".components.sublibs.zwirn-doux or (errorHandler.buildDepError "zwirn:zwirn-doux"))
              (hsPkgs."yaml" or (errorHandler.buildDepError "yaml"))
            ]);
          buildable = true;
        };
        "zwirnmill" = {
          depends = [
            ...
            (hsPkgs."tinyfiledialogs" or (errorHandler.buildDepError "tinyfiledialogs"))
