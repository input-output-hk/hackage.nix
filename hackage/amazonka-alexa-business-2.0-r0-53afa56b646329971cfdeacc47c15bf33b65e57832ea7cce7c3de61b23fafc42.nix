{ system
  ...
  , ... }:
  {
    ...
    package = {
      specVersion = "2.2";
      identifier = { name = "amazonka-alexa-business"; version = "2.0"; };
      license = "MPL-2.0";
    ...
    components = {
      ...
      tests = {
        "amazonka-alexa-business-test" = {
          depends = [
            (hsPkgs."amazonka-alexa-business" or (errorHandler.buildDepError "amazonka-alexa-business"))
            (hsPkgs."amazonka-core" or (errorHandler.buildDepError "amazonka-core"))
