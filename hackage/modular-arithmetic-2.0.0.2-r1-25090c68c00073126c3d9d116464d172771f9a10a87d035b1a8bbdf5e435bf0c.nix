{ system
  ...
  , ... }:
  {
    ...
    package = {
      specVersion = "2.2";
      identifier = { name = "modular-arithmetic"; version = "2.0.0.2"; };
    ...
    components = {
      "library" = {
        ...
        ] ++ pkgs.lib.optional (compiler.isGhc && compiler.version.lt "9.2.1") (hsPkgs."typelits-witnesses" or (errorHandler.buildDepError "typelits-witnesses"));
        buildable = true;
      };
      tests = {
        "examples" = {
