    ...
    components = {
      exes = {
        "git-annex" = {
          ...
          ]) ++ pkgs.lib.optional (flags.webdav) (hsPkgs."DAV" or (errorHandler.buildDepError "DAV"))) ++ pkgs.lib.optionals (flags.assistant) (if system.isLinux && flags.inotify
            then [
