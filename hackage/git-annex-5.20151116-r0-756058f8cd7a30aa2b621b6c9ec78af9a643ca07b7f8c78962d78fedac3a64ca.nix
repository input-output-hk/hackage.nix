      ...
      exes = {
        "git-annex" = {
          depends = ((((((((((((((((((((([
            ...
            ]) ++ (pkgs.lib).optional (flags.webdav) (hsPkgs."DAV" or ((hsPkgs.pkgs-errors).buildDepError "DAV"))) ++ (pkgs.lib).optionals (flags.assistant) (if system.isLinux && flags.inotify
            then [
            ...
            ]) ++ (pkgs.lib).optional (flags.concurrentoutput) (hsPkgs."concurrent-output" or ((hsPkgs.pkgs-errors).buildDepError "concurrent-output"))) ++ (pkgs.lib).optional (flags.ekg) (hsPkgs."ekg" or ((hsPkgs.pkgs-errors).buildDepError "ekg"));
          buildable = true;
          };
        };
      };
