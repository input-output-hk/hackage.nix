{ system
  ...
  , ... }:
  {
    ...
    package = {
      specVersion = "2.4";
      identifier = { name = "mmzk-typeid"; version = "0.7.1.2"; };
      license = "MIT";
      copyright = "";
      maintainer = "MMZK1526";
      author = "MMZK1526";
