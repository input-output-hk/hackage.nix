      ...
      exes = {
        "git-annex" = {
          depends = (((((((((((((((([
            ...
            (hsPkgs.unix-compat)
            (hsPkgs.async)
            ] ++ (pkgs.lib).optional (!system.isWindows) (hsPkgs.unix)) ++ (pkgs.lib).optionals (flags.testsuite) [
            (hsPkgs.tasty)
            (hsPkgs.tasty-hunit)
            ...
            then [ (hsPkgs.hinotify) ]
              ...
              then [ (hsPkgs.hfsevents) ]
                ...
                else (pkgs.lib).optionals (!system.isSolaris && !system.isLinux) ((pkgs.lib).optional (flags.android) (hsPkgs.hinotify)))) ++ (pkgs.lib).optional (system.isLinux && flags.dbus) (hsPkgs.dbus)) ++ (pkgs.lib).optional (flags.android) (hsPkgs.data-endian)) ++ (pkgs.lib).optionals (flags.webapp && !system.isWindows) [
            (hsPkgs.yesod)
