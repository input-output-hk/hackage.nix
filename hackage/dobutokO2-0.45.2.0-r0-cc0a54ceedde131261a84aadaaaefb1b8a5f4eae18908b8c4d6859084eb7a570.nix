{ system
  ...
  , ... }:
  {
    ...
    package = {
      specVersion = "1.10";
      identifier = { name = "dobutokO2"; version = "0.45.2.0"; };
      license = "MIT";
      ...
      description = "It can also generate a timbre for the notes. Uses SoX and AFTOVolio inside. For generation of the timbres uses additive synthesis.";
      buildType = "Simple";
    };
    components = {
      "library" = {
