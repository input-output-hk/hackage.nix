{ system, compiler, flags, pkgs, hsPkgs, pkgconfPkgs, ... }:
  {
    ...
    package = {
      specVersion = "1.18";
      identifier = { name = "rhine"; version = "0.1.1.0"; };
    ...
    components = {
      ...
      exes = {
        "test" = { depends = [ (hsPkgs.base) (hsPkgs.rhine) ]; };
        "HelloWorld" = { depends = [ (hsPkgs.base) (hsPkgs.rhine) ]; };
        "Demonstration" = { depends = [ (hsPkgs.base) (hsPkgs.rhine) ]; };
        };
      };
    }