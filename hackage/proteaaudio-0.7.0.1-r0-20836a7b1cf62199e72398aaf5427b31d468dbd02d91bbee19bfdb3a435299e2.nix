{ system, compiler, flags, pkgs, hsPkgs, pkgconfPkgs, ... }:
  {
    ...
    package = {
      specVersion = "1.10";
      identifier = { name = "proteaaudio"; version = "0.7.0.1"; };
    ...
    components = {
      "library" = {
        ...
        libs = ((pkgs.lib).optionals (system.isWindows) [
          ...
          (pkgs."pulse-simple" or ((hsPkgs.pkgs-errors).sysDepError "pulse-simple"))
          (pkgs."pulse" or ((hsPkgs.pkgs-errors).sysDepError "pulse"))
