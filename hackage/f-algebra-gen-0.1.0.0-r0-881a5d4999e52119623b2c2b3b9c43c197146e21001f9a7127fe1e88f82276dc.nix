{ system
  ...
  , ... }:
  {
    ...
    package = {
      specVersion = "1.10";
      identifier = { name = "f-algebra-gen"; version = "0.1.0.0"; };
      license = "MIT";
      copyright = "";
