    ...
    components = {
      "library" = {
        depends = (((((([
          ...
          ] ++ (pkgs.lib).optional (compiler.isGhc && (compiler.version).eq "7.8.4") (hsPkgs."haddock-api" or (errorHandler.buildDepError "haddock-api"))) ++ (pkgs.lib).optional (compiler.isGhc && (compiler.version).eq "7.8.3") (hsPkgs."haddock" or (errorHandler.buildDepError "haddock"))) ++ (pkgs.lib).optional (compiler.isGhc && false) (hsPkgs."haddock" or (errorHandler.buildDepError "haddock"))) ++ (pkgs.lib).optional (compiler.isGhc && false) (hsPkgs."haddock" or (errorHandler.buildDepError "haddock"))) ++ (pkgs.lib).optional (compiler.isGhc && false) (hsPkgs."haddock" or (errorHandler.buildDepError "haddock"))) ++ (pkgs.lib).optional (compiler.isGhc && (compiler.version).ge "7.8.4") (hsPkgs."haddock-api" or (errorHandler.buildDepError "haddock-api"))) ++ (pkgs.lib).optional (compiler.isGhc && (compiler.version).lt "7.2") (hsPkgs."haddock" or (errorHandler.buildDepError "haddock"));
        buildable = true;
        };
      exes = {
        "haskell-docs" = {
