{ system
  ...
  , ... }:
  {
    ...
    package = {
      specVersion = "3.4";
      identifier = { name = "haskell-language-server"; version = "2.14.0.0"; };
      license = "Apache-2.0";
