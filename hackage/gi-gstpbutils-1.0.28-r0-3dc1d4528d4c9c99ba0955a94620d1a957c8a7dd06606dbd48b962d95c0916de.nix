{ system
  ...
  , ... }:
  {
    ...
    package = {
      specVersion = "2.0";
      identifier = { name = "gi-gstpbutils"; version = "1.0.28"; };
      ...
      setup-depends = [
        ...
        (hsPkgs.pkgsBuildBuild.gi-gstaudio or (pkgs.pkgsBuildBuild.gi-gstaudio or (errorHandler.setupDepError "gi-gstaudio")))
        (hsPkgs.pkgsBuildBuild.gi-gstvideo or (pkgs.pkgsBuildBuild.gi-gstvideo or (errorHandler.setupDepError "gi-gstvideo")))
        (hsPkgs.pkgsBuildBuild.gi-gsttag or (pkgs.pkgsBuildBuild.gi-gsttag or (errorHandler.setupDepError "gi-gsttag")))
