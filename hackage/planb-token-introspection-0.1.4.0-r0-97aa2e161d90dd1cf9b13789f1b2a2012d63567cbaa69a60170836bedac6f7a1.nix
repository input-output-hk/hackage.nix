{ system
  ...
  , ... }:
  {
    ...
    package = {
      specVersion = "1.10";
      identifier = { name = "planb-token-introspection"; version = "0.1.4.0"; };
      license = "BSD-3-Clause";
      copyright = "(c) 2018, 2019 Moritz Clasmeier";
    ...
    components = {
      ...
      tests = {
        "access-token-provider-test" = {
          depends = [
            (hsPkgs."base" or (errorHandler.buildDepError "base"))
            (hsPkgs."planb-token-introspection" or (errorHandler.buildDepError "planb-token-introspection"))
            (hsPkgs."aeson" or (errorHandler.buildDepError "aeson"))
            (hsPkgs."text" or (errorHandler.buildDepError "text"))
