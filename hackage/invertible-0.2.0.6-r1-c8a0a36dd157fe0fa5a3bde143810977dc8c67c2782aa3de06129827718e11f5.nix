{ system
  ...
  , ... }:
  {
    ...
    package = {
      specVersion = "1.10";
      identifier = { name = "invertible"; version = "0.2.0.6"; };
    ...
    components = {
      "library" = {
        ...
        ] ++ pkgs.lib.optional (flags.arrows) (hsPkgs."arrows" or (errorHandler.buildDepError "arrows"))) ++ pkgs.lib.optional (flags.invariant) (hsPkgs."invariant" or (errorHandler.buildDepError "invariant"))) ++ pkgs.lib.optional (flags.lens) (hsPkgs."lens" or (errorHandler.buildDepError "lens"))) ++ pkgs.lib.optional (flags.partial-isomorphisms) (hsPkgs."partial-isomorphisms" or (errorHandler.buildDepError "partial-isomorphisms"))) ++ pkgs.lib.optional (flags.piso) (hsPkgs."Piso" or (errorHandler.buildDepError "Piso"))) ++ pkgs.lib.optional (flags.semigroupoids) (hsPkgs."semigroupoids" or (errorHandler.buildDepError "semigroupoids"))) ++ pkgs.lib.optional (flags.typecompose) (hsPkgs."TypeCompose" or (errorHandler.buildDepError "TypeCompose"));
        buildable = true;
      };
      tests = {
        "tests" = {
