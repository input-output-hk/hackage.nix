    ...
    components = {
      exes = {
        "git-annex" = {
          ...
          ] ++ pkgs.lib.optional (flags.s3) (hsPkgs."hS3" or (errorHandler.buildDepError "hS3"))) ++ pkgs.lib.optional (flags.assistant && !system.isWindows && !system.isSolaris) (hsPkgs."stm" or (errorHandler.buildDepError "stm"))) ++ pkgs.lib.optional (system.isLinux && flags.inotify) (hsPkgs."hinotify" or (errorHandler.buildDepError "hinotify"))) ++ pkgs.lib.optional (system.isLinux && flags.dbus) (hsPkgs."dbus" or (errorHandler.buildDepError "dbus"))) ++ pkgs.lib.optionals (flags.webapp && flags.assistant) [
