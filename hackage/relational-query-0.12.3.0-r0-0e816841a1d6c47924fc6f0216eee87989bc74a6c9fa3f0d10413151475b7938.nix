{ system
  ...
  , ... }:
  {
    ...
    package = {
      specVersion = "1.10";
      identifier = { name = "relational-query"; version = "0.12.3.0"; };
    ...
    components = {
      "library" = {
        ...
        ] ++ pkgs.lib.optional (compiler.isGhc && (compiler.version.ge "7.4" && compiler.version.lt "7.5")) (hsPkgs."ghc-prim" or (errorHandler.buildDepError "ghc-prim"))) ++ pkgs.lib.optional (compiler.isGhc && (compiler.version.ge "7.4" && compiler.version.lt "7.5") || compiler.isGhc && (compiler.version.ge "7.6" && compiler.version.lt "7.7")) (hsPkgs."bytestring-short" or (errorHandler.buildDepError "bytestring-short"));
        buildable = true;
      };
      tests = {
        "sqls" = {
