      ...
      tests = {
        "hup-spec" = {
          depends = ([
            ...
            ] ++ (pkgs.lib).optional (compiler.isGhc && (compiler.version).lt "8.4.4") (hsPkgs."simple-templates" or (buildDepError "simple-templates"))) ++ (pkgs.lib).optionals (flags.enablewebtests) [
