{ system, compiler, flags, pkgs, hsPkgs, pkgconfPkgs, ... }:
  {
    ...
    package = {
      specVersion = "1.10";
      identifier = { name = "inspection-testing"; version = "0.1.1.1"; };
      license = "MIT";
    ...
    components = {
      ...
      tests = {
        "NS_NP" = { depends = [ (hsPkgs.inspection-testing) (hsPkgs.base) ]; };
        "simple" = { depends = [ (hsPkgs.inspection-testing) (hsPkgs.base) ]; };
        "fusion" = { depends = [ (hsPkgs.inspection-testing) (hsPkgs.base) ]; };
        "text" = {
