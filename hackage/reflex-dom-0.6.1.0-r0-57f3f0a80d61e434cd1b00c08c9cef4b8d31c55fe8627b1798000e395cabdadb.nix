{ system
  ...
  , ... }:
  {
    ...
    package = {
      specVersion = "1.24";
      identifier = { name = "reflex-dom"; version = "0.6.1.0"; };
    ...
    components = {
      "library" = {
        ...
        build-tools = (pkgs.lib).optional (system.isAndroid) (hsPkgs.buildPackages.hsc2hs or (pkgs.buildPackages.hsc2hs or (errorHandler.buildToolDepError "hsc2hs")));
        buildable = true;
        };
      exes = {
        "sortableList" = {
