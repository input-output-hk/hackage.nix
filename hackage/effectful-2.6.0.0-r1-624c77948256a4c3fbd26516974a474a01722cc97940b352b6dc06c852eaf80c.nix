{ system
  ...
  , ... }:
  {
    ...
    package = {
      specVersion = "3.0";
      identifier = { name = "effectful"; version = "2.6.0.0"; };
    ...
    components = {
      ...
      benchmarks = {
        "bench" = {
          ...
          ] ++ pkgs.lib.optional (compiler.isGhc && compiler.version.lt "9.9") (hsPkgs."cleff" or (errorHandler.buildDepError "cleff"))) ++ pkgs.lib.optional (compiler.isGhc && compiler.version.lt "9.9") (hsPkgs."freer-simple" or (errorHandler.buildDepError "freer-simple"))) ++ pkgs.lib.optional (compiler.isGhc && compiler.version.lt "9.13") (hsPkgs."fused-effects" or (errorHandler.buildDepError "fused-effects"))) ++ pkgs.lib.optional (compiler.isGhc && compiler.version.lt "9.13") (hsPkgs."polysemy" or (errorHandler.buildDepError "polysemy")));
          buildable = true;
        };
      };
    };
