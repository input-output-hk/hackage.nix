{ system
  ...
  , ... }:
  {
    ...
    package = {
      specVersion = "2.4";
      identifier = { name = "pty-mcp-server"; version = "0.2.0.0"; };
      license = "Apache-2.0";
        ...
        "pty-mcp-server" = {
          depends = if system.isWindows
            then [
              ...
              (hsPkgs."pms-infra-agent-process" or (errorHandler.buildDepError "pms-infra-agent-process"))
              (hsPkgs."pms-infra-agent-socket" or (errorHandler.buildDepError "pms-infra-agent-socket"))
              (hsPkgs."pms-infra-agent-serial" or (errorHandler.buildDepError "pms-infra-agent-serial"))
