{ system, compiler, flags, pkgs, hsPkgs, pkgconfPkgs, ... }:
  {
    ...
    package = {
      specVersion = "1.8";
      identifier = { name = "zeromq4-haskell"; version = "0.3"; };
      license = "MIT";
    ...
    components = {
      "library" = {
        ...
        libs = (pkgs.lib).optional (system.isFreebsd) (pkgs."pthread" or ((hsPkgs.pkgs-errors).sysDepError "pthread"));
        pkgconfig = [
          (pkgconfPkgs."libzmq" or ((hsPkgs.pkgs-errors).pkgConfDepError "libzmq"))
          ];
        buildable = true;
        };
      tests = {
