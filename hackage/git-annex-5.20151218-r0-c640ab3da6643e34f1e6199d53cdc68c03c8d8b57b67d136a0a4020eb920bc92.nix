      ...
      exes = {
        "git-annex" = {
          depends = ((((((((((((((((((((([
            ...
            ]) ++ (pkgs.lib).optional (flags.webdav) (hsPkgs."DAV" or (buildDepError "DAV"))) ++ (pkgs.lib).optionals (flags.assistant) (if system.isLinux && flags.inotify
