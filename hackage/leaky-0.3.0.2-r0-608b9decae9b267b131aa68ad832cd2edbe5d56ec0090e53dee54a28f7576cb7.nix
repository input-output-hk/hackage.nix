      ...
      exes = {
        "leaky" = {
          depends = (([
            ...
            ] ++ (pkgs.lib).optional (flags.use_cpphs) (hsPkgs."cpphs" or (buildDepError "cpphs"))) ++ (pkgs.lib).optional (flags.cowboy) (hsPkgs."cpphs" or (buildDepError "cpphs"))) ++ (pkgs.lib).optional (flags.omnitypic) (hsPkgs."ghc-prim" or (buildDepError "ghc-prim"));
          build-tools = [
