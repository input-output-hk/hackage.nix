      ...
      "library" = {
        depends = (([
          ...
          then [
            ...
            ])) ++ (pkgs.lib).optional (flags.mtl) (hsPkgs."mtl" or ((hsPkgs.pkgs-errors).buildDepError "mtl"))) ++ (pkgs.lib).optional (flags.transformers) (hsPkgs."transformers" or ((hsPkgs.pkgs-errors).buildDepError "transformers"));
        buildable = true;
        };
      exes = {
        "MonadLoc" = {
