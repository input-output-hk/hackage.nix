{ system, compiler, flags, pkgs, hsPkgs, pkgconfPkgs, ... }:
  {
    ...
    package = {
      specVersion = "1.8";
      identifier = { name = "git-annex"; version = "4.20130521"; };
      ...
      exes = {
        "git-annex" = {
          depends = (((((((((((([
            ...
            ]) ++ (pkgs.lib).optional (flags.android) (hsPkgs."data-endian" or ((hsPkgs.pkgs-errors).buildDepError "data-endian"))) ++ (if system.isLinux && flags.inotify
            then [
            ...
            ]) ++ (pkgs.lib).optional (flags.dns) (hsPkgs."dns" or ((hsPkgs.pkgs-errors).buildDepError "dns"));
          buildable = true;
          };
        };
      };
