{ system
  ...
  , ... }:
  {
    ...
    package = {
      specVersion = "1.10";
      identifier = { name = "bytestring"; version = "0.11.1.0"; };
      ...
      tests = {
        ...
        "test-builder" = {
          depends = [
            ...
            (hsPkgs."tasty-quickcheck" or (errorHandler.buildDepError "tasty-quickcheck"))
            ] ++ (pkgs.lib).optional (compiler.isGhc && (compiler.version).lt "8.4") (hsPkgs."ghc-byteorder" or (errorHandler.buildDepError "ghc-byteorder"));
          buildable = true;
          };
        };
      benchmarks = {
