{ system, compiler, flags, pkgs, hsPkgs, pkgconfPkgs, ... }:
  {
    flags = { gtk3 = true; jsffi = true; webkit = false; };
    package = {
      specVersion = "1.10";
      identifier = { name = "jsaddle"; version = "0.2.1.0"; };
      license = "MIT";
      copyright = "";
    ...
    components = {
      "library" = {
        depends = ([
          ...
          ] ++ (pkgs.lib).optional (compiler.isGhcjs && true && flags.jsffi) (hsPkgs."ghcjs-base" or ((hsPkgs.pkgs-errors).buildDepError "ghcjs-base"))) ++ (pkgs.lib).optionals (!(compiler.isGhcjs && true) || flags.webkit) (if flags.gtk3
          then [
      ...
      tests = {
        "test-tool" = {
          depends = ([
            ...
            ] ++ (pkgs.lib).optional (compiler.isGhcjs && true && flags.jsffi) (hsPkgs."ghcjs-base" or ((hsPkgs.pkgs-errors).buildDepError "ghcjs-base"))) ++ (pkgs.lib).optionals (!(compiler.isGhcjs && true) || flags.webkit) ([
