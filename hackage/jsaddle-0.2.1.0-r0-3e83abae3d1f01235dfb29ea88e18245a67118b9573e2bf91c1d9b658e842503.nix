    ...
    components = {
      "library" = {
        depends = ([
          ...
          ] ++ (pkgs.lib).optional (compiler.isGhcjs && true && flags.jsffi) (hsPkgs."ghcjs-base" or (errorHandler.buildDepError "ghcjs-base"))) ++ (pkgs.lib).optionals (!(compiler.isGhcjs && true) || flags.webkit) (if flags.gtk3
          then [
      ...
      tests = {
        "test-tool" = {
          depends = ([
            ...
            ] ++ (pkgs.lib).optional (compiler.isGhcjs && true && flags.jsffi) (hsPkgs."ghcjs-base" or (errorHandler.buildDepError "ghcjs-base"))) ++ (pkgs.lib).optionals (!(compiler.isGhcjs && true) || flags.webkit) ([
