{ system, compiler, flags, pkgs, hsPkgs, pkgconfPkgs, ... }:
  {
    ...
    package = {
      specVersion = "1.2";
      identifier = { name = "temporal-music-notation"; version = "0.1.2"; };
    ...
    components = {
      "library" = {
        depends = [
          ...
          (hsPkgs."type-level-natural-number-decimal" or ((hsPkgs.pkgs-errors).buildDepError "type-level-natural-number-decimal"))
          ];
        buildable = true;
        };
      };
