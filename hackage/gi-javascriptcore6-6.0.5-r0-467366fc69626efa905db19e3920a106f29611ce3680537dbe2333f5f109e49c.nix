{ system
  ...
  , ... }:
  {
    ...
    package = {
      specVersion = "2.0";
      identifier = { name = "gi-javascriptcore6"; version = "6.0.5"; };
      ...
      description = "Bindings for JavaScriptCore 6.x, autogenerated by haskell-gi.";
      buildType = "Custom";
      setup-depends = [
    ...
    components = {
      "library" = {
        ...
        pkgconfig = [
          (pkgconfPkgs."javascriptcoregtk-6.0" or (errorHandler.pkgConfDepError "javascriptcoregtk-6.0"))
        ];
        buildable = true;
      };
    };
