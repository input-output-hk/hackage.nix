{ system
  ...
  , ... }:
  {
    ...
    package = {
      specVersion = "2.0";
      identifier = { name = "base64"; version = "0.4.2"; };
      ...
      description = "RFC 4648-compliant Base64 with an eye towards performance and modernity (support for RFC 7049 idioms for Base64url).";
      buildType = "Simple";
    };
    components = {
      "library" = {
