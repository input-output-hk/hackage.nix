{ system, compiler, flags, pkgs, hsPkgs, pkgconfPkgs, ... }:
  {
    ...
    package = {
      specVersion = "1.8";
      identifier = { name = "git-annex"; version = "5.20141231"; };
        ...
        "git-annex" = {
          depends = ((((((((((((((((((([
            ...
            then [
              ...
              ])) ++ (pkgs.lib).optional (flags.cryptohash) (hsPkgs."cryptohash" or ((hsPkgs.pkgs-errors).buildDepError "cryptohash"))) ++ (pkgs.lib).optionals (flags.s3) [
