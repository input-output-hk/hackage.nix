{ system
  ...
  , ... }:
  {
    ...
    package = {
      specVersion = "2.2";
      identifier = { name = "amazonka-backup-gateway"; version = "2.0"; };
      license = "MPL-2.0";
    ...
    components = {
      ...
      tests = {
        "amazonka-backup-gateway-test" = {
          depends = [
            (hsPkgs."amazonka-backup-gateway" or (errorHandler.buildDepError "amazonka-backup-gateway"))
            (hsPkgs."amazonka-core" or (errorHandler.buildDepError "amazonka-core"))
