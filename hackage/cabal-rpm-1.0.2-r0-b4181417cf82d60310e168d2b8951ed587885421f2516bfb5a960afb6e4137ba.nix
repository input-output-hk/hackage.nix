        ...
        "cabal-rpm" = {
          depends = (([
            ...
            then [
              ...
              (hsPkgs."time" or (errorHandler.buildDepError "time"))
              ])) ++ (pkgs.lib).optional (compiler.isGhc && (compiler.version).lt "8.0") (hsPkgs."semigroups" or (errorHandler.buildDepError "semigroups"))) ++ (pkgs.lib).optionals (compiler.isGhc && (compiler.version).ge "8.0" && flags.https) [
