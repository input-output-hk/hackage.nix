      ...
      "library" = {
        depends = [
          ...
          then [
            ...
            else (pkgs.lib).optional (!system.isHalvm) (hsPkgs."unix" or ((hsPkgs.pkgs-errors).buildDepError "unix")));
        libs = (pkgs.lib).optionals (!(compiler.isGhcjs && true)) ((pkgs.lib).optional (system.isWindows) (pkgs."advapi32" or ((hsPkgs.pkgs-errors).sysDepError "advapi32")));
        buildable = true;
        };
      };
    }