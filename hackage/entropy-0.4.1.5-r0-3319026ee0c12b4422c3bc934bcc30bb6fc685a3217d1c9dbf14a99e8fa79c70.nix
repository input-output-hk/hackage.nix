      ...
      "library" = {
        depends = [
          ...
          then [
            ...
            else (pkgs.lib).optional (!system.isHalvm) (hsPkgs."unix" or (buildDepError "unix")));
        libs = (pkgs.lib).optionals (!(compiler.isGhcjs && true)) ((pkgs.lib).optional (system.isWindows) (pkgs."advapi32" or (sysDepError "advapi32")));
        buildable = true;
        };
      };
    }