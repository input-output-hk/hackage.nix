{ system
  ...
  , ... }:
  {
    flags = { examples = false; gles3 = false; gl2 = false; };
    package = {
      specVersion = "1.10";
      identifier = { name = "nanovg"; version = "0.6.0.0"; };
      license = "ISC";
    ...
    components = {
      "library" = {
        ...
        pkgconfig = pkgs.lib.optional (!system.isOsx) (pkgconfPkgs."glew" or (errorHandler.pkgConfDepError "glew"));
        build-tools = [
