{ system
  ...
  , ... }:
  {
    ...
    package = {
      specVersion = "2.4";
      identifier = { name = "sizes"; version = "2.4.4"; };
    ...
    components = {
      ...
      tests = {
        "sizes-test" = {
          ...
          build-tools = [
            (hsPkgs.pkgsBuildBuild.sizes.components.exes.sizes or (pkgs.pkgsBuildBuild.sizes or (errorHandler.buildToolDepError "sizes:sizes")))
          ];
          buildable = true;
        };
      };
