  ...
  , ... }:
  {
    ...
    components = {
      "library" = {
        ...
        ] ++ pkgs.lib.optional (!system.isOsx) (hsPkgs."clock" or (errorHandler.buildDepError "clock"))) ++ pkgs.lib.optional (system.isOsx) (hsPkgs."time" or (errorHandler.buildDepError "time"));
        libs = [
