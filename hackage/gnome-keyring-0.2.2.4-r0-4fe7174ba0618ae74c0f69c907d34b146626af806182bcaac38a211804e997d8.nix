...
in { system, compiler, flags, pkgs, hsPkgs, pkgconfPkgs, ... }:
  {
    ...
    package = {
      specVersion = "1.6";
      identifier = { name = "gnome-keyring"; version = "0.2.2.4"; };
    ...
    components = {
      "library" = {
        ...
        libs = [ (pkgs."gnome-keyring" or (sysDepError "gnome-keyring")) ];
        pkgconfig = [
          (pkgconfPkgs."gnome-keyring-1" or (pkgConfDepError "gnome-keyring-1"))
          ];
        build-tools = [
