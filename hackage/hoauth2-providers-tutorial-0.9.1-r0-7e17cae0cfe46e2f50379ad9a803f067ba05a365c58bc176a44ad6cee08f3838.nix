{ system
  ...
  , ... }:
  {
    ...
    package = {
      specVersion = "2.4";
      identifier = { name = "hoauth2-providers-tutorial"; version = "0.9.1"; };
      license = "MIT";
      copyright = "";
      ...
      homepage = "";
      url = "";
      synopsis = "Tutorial for the hoauth2-providers module";
      description = "A tutorial that demonstrates how to use the hoauth2-providers package\nfor OAuth2 Authorization Code flow.";
      buildType = "Simple";
    };
    components = {
      "library" = {
