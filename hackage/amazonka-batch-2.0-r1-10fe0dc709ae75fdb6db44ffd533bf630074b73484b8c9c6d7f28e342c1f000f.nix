{ system
  ...
  , ... }:
  {
    ...
    package = {
      specVersion = "2.2";
      identifier = { name = "amazonka-batch"; version = "2.0"; };
      license = "MPL-2.0";
    ...
    components = {
      ...
      tests = {
        "amazonka-batch-test" = {
          depends = [
            (hsPkgs."amazonka-batch" or (errorHandler.buildDepError "amazonka-batch"))
            (hsPkgs."amazonka-core" or (errorHandler.buildDepError "amazonka-core"))
