...
in { system, compiler, flags, pkgs, hsPkgs, pkgconfPkgs, ... }:
  {
    ...
    package = {
      specVersion = "1.8";
      identifier = { name = "gtk2hs-buildtools"; version = "0.13.0.4"; };
      ...
      exes = {
        ...
        "gtk2hsC2hs" = {
          depends = [
            ...
            ] ++ (pkgs.lib).optional (compiler.isGhc && (compiler.version).ge "7.7") (hsPkgs."hashtables" or (buildDepError "hashtables"));
          build-tools = [
