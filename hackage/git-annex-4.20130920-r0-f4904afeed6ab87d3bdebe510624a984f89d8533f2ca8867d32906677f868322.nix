        ...
        "git-annex" = {
          depends = (((((((((((((([
            ...
            then [ (hsPkgs.hinotify) ]
              ...
              else (pkgs.lib).optionals (!system.isWindows && !system.isSolaris && !system.isLinux) ((pkgs.lib).optional (flags.android) (hsPkgs.hinotify)))) ++ (pkgs.lib).optional (system.isLinux && flags.dbus) (hsPkgs.dbus)) ++ (pkgs.lib).optionals (flags.webapp) [
            (hsPkgs.yesod)
