        ...
        "git-annex" = {
          depends = (((((((((((((([
            ...
            then [ (hsPkgs."hinotify" or (buildDepError "hinotify")) ]
              ...
              else (pkgs.lib).optionals (!system.isWindows && !system.isSolaris && !system.isLinux) ((pkgs.lib).optional (flags.android) (hsPkgs."hinotify" or (buildDepError "hinotify"))))) ++ (pkgs.lib).optional (system.isLinux && flags.dbus) (hsPkgs."dbus" or (buildDepError "dbus"))) ++ (pkgs.lib).optionals (flags.webapp) [
