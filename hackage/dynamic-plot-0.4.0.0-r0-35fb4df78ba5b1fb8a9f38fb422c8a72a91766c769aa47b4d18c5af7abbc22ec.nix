{ system, compiler, flags, pkgs, hsPkgs, pkgconfPkgs, ... }:
  {
    ...
    package = {
      specVersion = "1.18";
      identifier = { name = "dynamic-plot"; version = "0.4.0.0"; };
    ...
    components = {
      "library" = {
        depends = [
          ...
          (hsPkgs."manifold-random" or ((hsPkgs.pkgs-errors).buildDepError "manifold-random"))
          (hsPkgs."colour-space" or ((hsPkgs.pkgs-errors).buildDepError "colour-space"))
