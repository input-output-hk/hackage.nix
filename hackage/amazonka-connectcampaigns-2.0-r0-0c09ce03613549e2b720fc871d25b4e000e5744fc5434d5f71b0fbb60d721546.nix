{ system
  ...
  , ... }:
  {
    ...
    package = {
      specVersion = "2.2";
      identifier = { name = "amazonka-connectcampaigns"; version = "2.0"; };
      license = "MPL-2.0";
    ...
    components = {
      ...
      tests = {
        "amazonka-connectcampaigns-test" = {
          depends = [
            (hsPkgs."amazonka-connectcampaigns" or (errorHandler.buildDepError "amazonka-connectcampaigns"))
            (hsPkgs."amazonka-core" or (errorHandler.buildDepError "amazonka-core"))
