      ...
      exes = {
        "hdevtools" = {
          depends = (((([
            ...
            ] ++ (pkgs.lib).optional (compiler.isGhc && false) (hsPkgs."Cabal" or ((hsPkgs.pkgs-errors).buildDepError "Cabal"))) ++ (pkgs.lib).optional (compiler.isGhc && (compiler.version).ge "7.7") (hsPkgs."Cabal" or ((hsPkgs.pkgs-errors).buildDepError "Cabal"))) ++ (pkgs.lib).optionals (compiler.isGhc && ((compiler.version).ge "7.9" && (compiler.version).lt "8.0")) [
            ...
            ]) ++ (pkgs.lib).optional (compiler.isGhc && (compiler.version).ge "8.2") (hsPkgs."ghc-boot" or ((hsPkgs.pkgs-errors).buildDepError "ghc-boot"));
          buildable = true;
          };
        };
      };
