{ system, compiler, flags, pkgs, hsPkgs, pkgconfPkgs, ... }:
  {
    ...
    components = {
      ...
      tests = {
        "hspec" = {
          depends = [ (hsPkgs.base) (hsPkgs.hspec) (hsPkgs.curlhs) ];
          };
        };
      };
    }