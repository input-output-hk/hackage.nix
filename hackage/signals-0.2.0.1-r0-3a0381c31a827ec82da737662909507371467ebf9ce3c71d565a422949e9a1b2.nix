{ system, compiler, flags, pkgs, hsPkgs, pkgconfPkgs, ... }:
  {
    ...
    package = {
      specVersion = "1.10";
      identifier = { name = "signals"; version = "0.2.0.1"; };
    ...
    components = {
      "library" = {
        depends = [
          ...
          (hsPkgs."imperative-edsl-vhdl" or ((hsPkgs.pkgs-errors).buildDepError "imperative-edsl-vhdl"))
          (hsPkgs."observable-sharing" or ((hsPkgs.pkgs-errors).buildDepError "observable-sharing"))
