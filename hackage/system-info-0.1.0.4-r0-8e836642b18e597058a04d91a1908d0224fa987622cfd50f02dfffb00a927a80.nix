{ system, compiler, flags, pkgs, hsPkgs, pkgconfPkgs, ... }:
  {
    ...
    package = {
      specVersion = "1.18";
      identifier = { name = "system-info"; version = "0.1.0.4"; };
      license = "MIT";
    ...
    components = {
      "library" = {
        depends = (pkgs.lib).optional (system.isLinux || system.isFreebsd) (hsPkgs."base" or ((hsPkgs.pkgs-errors).buildDepError "base")) ++ (pkgs.lib).optionals (system.isWindows) [
