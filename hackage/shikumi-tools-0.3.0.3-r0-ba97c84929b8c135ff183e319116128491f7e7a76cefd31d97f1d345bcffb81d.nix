{ system
  ...
  , ... }:
  {
    ...
    package = {
      specVersion = "3.4";
      identifier = { name = "shikumi-tools"; version = "0.3.0.3"; };
      ...
      tests = {
        "shikumi-tools-test" = {
          depends = [
            ...
            (hsPkgs."lens" or (errorHandler.buildDepError "lens"))
            (hsPkgs."shikumi" or (errorHandler.buildDepError "shikumi"))
            (hsPkgs."shikumi-tools" or (errorHandler.buildDepError "shikumi-tools"))
