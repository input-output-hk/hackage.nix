{ system, compiler, flags, pkgs, hsPkgs, pkgconfPkgs, ... }:
  {
    ...
    components = {
      exes = {
        ...
        "yesod-ajax" = { depends = [ (hsPkgs.yesod-static) ]; };
        "yesod-file-echo" = { depends = [ (hsPkgs.text) ]; };
        "yesod-pretty-yaml" = {
          depends = [
        ...
        "yesod-i18n" = {};
        "yesod-session" = {};
        "yesod-widgets" = { depends = [ (hsPkgs.yesod-form) ]; };
        ...
        "yesod-hamlet-synopsis" = { depends = [ (hsPkgs.hamlet) ]; };
