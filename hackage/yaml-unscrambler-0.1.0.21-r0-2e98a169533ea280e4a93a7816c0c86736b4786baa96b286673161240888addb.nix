{ system
  ...
  , ... }:
  {
    ...
    package = {
      specVersion = "3.0";
      identifier = { name = "yaml-unscrambler"; version = "0.1.0.21"; };
      license = "MIT";
      ...
      description = "Very flexible declarative YAML parsing toolkit with extensive error detalization capabilities and expected schema generation.";
      buildType = "Simple";
    };
    components = {
      "library" = {
