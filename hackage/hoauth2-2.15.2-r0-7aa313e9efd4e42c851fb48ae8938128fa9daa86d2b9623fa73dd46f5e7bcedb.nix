{ system
  ...
  , ... }:
  {
    ...
    package = {
      specVersion = "2.4";
      identifier = { name = "hoauth2"; version = "2.15.2"; };
      license = "MIT";
      ...
      description = "This package provides Haskell bindings for the OAuth2 Authorization Framework and Bearer Token Usage.";
      buildType = "Simple";
    };
    components = {
      "library" = {
