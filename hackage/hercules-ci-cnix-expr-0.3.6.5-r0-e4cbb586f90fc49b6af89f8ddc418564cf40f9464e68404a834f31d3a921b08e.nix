{ system
  ...
  , ... }:
  {
    ...
    package = {
      specVersion = "2.4";
      identifier = { name = "hercules-ci-cnix-expr"; version = "0.3.6.5"; };
      license = "Apache-2.0";
    ...
    components = {
      "library" = {
        ...
        ] ++ pkgs.lib.optional (flags.nix-2_8) (pkgconfPkgs."nix-cmd" or (errorHandler.pkgConfDepError "nix-cmd"))) ++ pkgs.lib.optional (flags.nix-2_24) (pkgconfPkgs."nix-flake" or (errorHandler.pkgConfDepError "nix-flake"));
        buildable = true;
      };
      tests = {
