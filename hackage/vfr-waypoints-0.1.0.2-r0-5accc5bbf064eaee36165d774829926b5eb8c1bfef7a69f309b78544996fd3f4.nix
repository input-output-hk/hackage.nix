{ system, compiler, flags, pkgs, hsPkgs, pkgconfPkgs, ... }:
  {
    ...
    package = {
      specVersion = "1.10";
      identifier = { name = "vfr-waypoints"; version = "0.1.0.2"; };
    ...
    components = {
      "library" = {
        depends = [
          ...
          (hsPkgs."geodetic-types" or ((hsPkgs.pkgs-errors).buildDepError "geodetic-types"))
      ...
      exes = {
        "vfr-waypoints" = {
          depends = [
            ...
            (hsPkgs."vfr-waypoints" or ((hsPkgs.pkgs-errors).buildDepError "vfr-waypoints"))
            ];
          buildable = true;
          };
        };
