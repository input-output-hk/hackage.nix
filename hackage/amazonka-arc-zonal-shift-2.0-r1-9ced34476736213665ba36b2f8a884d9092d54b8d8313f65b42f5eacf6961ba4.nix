{ system
  ...
  , ... }:
  {
    ...
    package = {
      specVersion = "2.2";
      identifier = { name = "amazonka-arc-zonal-shift"; version = "2.0"; };
      license = "MPL-2.0";
    ...
    components = {
      ...
      tests = {
        "amazonka-arc-zonal-shift-test" = {
          depends = [
            (hsPkgs."amazonka-arc-zonal-shift" or (errorHandler.buildDepError "amazonka-arc-zonal-shift"))
            (hsPkgs."amazonka-core" or (errorHandler.buildDepError "amazonka-core"))
