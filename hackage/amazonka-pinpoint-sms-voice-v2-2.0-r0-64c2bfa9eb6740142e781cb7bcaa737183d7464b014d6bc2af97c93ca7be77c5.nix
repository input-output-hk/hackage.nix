{ system
  ...
  , ... }:
  {
    ...
    components = {
      ...
      tests = {
        "amazonka-pinpoint-sms-voice-v2-test" = {
          depends = [
            (hsPkgs."amazonka-core" or (errorHandler.buildDepError "amazonka-core"))
            (hsPkgs."amazonka-pinpoint-sms-voice-v2" or (errorHandler.buildDepError "amazonka-pinpoint-sms-voice-v2"))
