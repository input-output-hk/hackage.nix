...
in { system, compiler, flags, pkgs, hsPkgs, pkgconfPkgs, ... }:
  {
    ...
    package = {
      specVersion = "1.12";
      identifier = { name = "genvalidity-mergeful"; version = "0.0.0.0"; };
      license = "MIT";
    ...
    components = {
      "library" = {
        depends = [
          ...
          (hsPkgs."mergeful" or (buildDepError "mergeful"))
          ];
        };
      tests = {
        "mergeful-test" = {
          depends = [
            ...
            (hsPkgs."genvalidity-mergeful" or (buildDepError "genvalidity-mergeful"))
