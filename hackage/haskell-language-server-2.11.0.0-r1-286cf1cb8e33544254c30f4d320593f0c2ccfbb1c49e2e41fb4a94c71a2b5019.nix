{ system
  ...
  , ... }:
  {
    ...
    package = {
      specVersion = "3.4";
      identifier = { name = "haskell-language-server"; version = "2.11.0.0"; };
      license = "Apache-2.0";
    ...
    components = {
      ...
      sublibs = {
        ...
        "hls-hlint-plugin" = {
          ...
          buildable = if !flags.hlint || compiler.isGhc && compiler.version.ge "9.10" && (compiler.isGhc && compiler.version.lt "9.11") && !flags.ignore-plugins-ghc-bounds
            then false
            else true;
        };
        "hls-stan-plugin" = {
