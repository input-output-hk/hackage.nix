      ...
      tests = {
        "unit-tests" = {
          depends = ([
            ...
            ] ++ (pkgs.lib).optional (compiler.isGhc && (compiler.version).lt "7.8") (hsPkgs."tagged" or (buildDepError "tagged"))) ++ (pkgs.lib).optional (compiler.isGhc && (compiler.version).ge "7.10") (hsPkgs."quickcheck-instances" or (buildDepError "quickcheck-instances"));
          buildable = true;
          };
        };
      benchmarks = {
