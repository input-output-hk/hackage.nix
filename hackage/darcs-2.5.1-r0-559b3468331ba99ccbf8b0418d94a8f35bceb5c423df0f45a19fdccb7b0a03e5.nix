    ...
    components = {
      ...
      exes = {
        "witnesses" = {
          ...
          build-tools = (pkgs.lib).optional (!(!flags.type-witnesses)) (hsPkgs.buildPackages.ghc or (pkgs.buildPackages.ghc or (errorHandler.buildToolDepError "ghc")));
        ...
        "unit" = {
          ...
          build-tools = (pkgs.lib).optional (!(!flags.test)) (hsPkgs.buildPackages.ghc or (pkgs.buildPackages.ghc or (errorHandler.buildToolDepError "ghc")));
