{ system
  ...
  , ... }:
  {
    ...
    package = {
      specVersion = "1.8";
      identifier = { name = "darcs"; version = "2.5.1"; };
    ...
    components = {
      ...
      exes = {
        "witnesses" = {
          ...
          build-tools = pkgs.lib.optional (!!flags.type-witnesses) (hsPkgs.pkgsBuildBuild.ghc.components.exes.ghc or (pkgs.pkgsBuildBuild.ghc or (errorHandler.buildToolDepError "ghc:ghc")));
        ...
        "unit" = {
          ...
          build-tools = pkgs.lib.optional (!!flags.test) (hsPkgs.pkgsBuildBuild.ghc.components.exes.ghc or (pkgs.pkgsBuildBuild.ghc or (errorHandler.buildToolDepError "ghc:ghc")));
