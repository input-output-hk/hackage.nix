...
in { system, compiler, flags, pkgs, hsPkgs, pkgconfPkgs, ... }:
  {
    ...
    components = {
      "library" = {
        ...
        libs = (pkgs.lib).optional (system.isWindows) (pkgs."groonga" or (sysDepError "groonga"));
        pkgconfig = (pkgs.lib).optional (!system.isWindows) (pkgconfPkgs."groonga" or (pkgConfDepError "groonga"));
        build-tools = [
