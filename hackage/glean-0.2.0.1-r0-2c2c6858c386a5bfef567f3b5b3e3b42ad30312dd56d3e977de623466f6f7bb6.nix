{ system
  ...
  , ... }:
  {
    ...
    package = {
      specVersion = "3.6";
      identifier = { name = "glean"; version = "0.2.0.1"; };
    ...
    components = {
      sublibs = {
        "stubs" = {
          depends = ([
            ...
            ])) ++ pkgs.lib.optionals (!flags.fbthrift) [
        ...
        "rocksdb" = {
          depends = [
            ...
            (hsPkgs."haxl" or (errorHandler.buildDepError "haxl"))
            (hsPkgs."hinotify" or (errorHandler.buildDepError "hinotify"))
            (hsPkgs."glean".components.sublibs.storage or (errorHandler.buildDepError "glean:storage"))
            (hsPkgs."glean".components.sublibs.rts or (errorHandler.buildDepError "glean:rts"))
          ] ++ (if flags.use-folly-clib
            then [
              (hsPkgs."fb-util" or (errorHandler.buildDepError "fb-util"))
        ...
        "lmdb" = {
          depends = [
            ...
            (hsPkgs."glean".components.sublibs.storage or (errorHandler.buildDepError "glean:storage"))
            (hsPkgs."glean".components.sublibs.rts or (errorHandler.buildDepError "glean:rts"))
            (hsPkgs."lmdb-clib" or (errorHandler.buildDepError "lmdb-clib"))
          ] ++ (if flags.use-folly-clib
            then [
              (hsPkgs."fb-util" or (errorHandler.buildDepError "fb-util"))
              (hsPkgs."folly-clib" or (errorHandler.buildDepError "folly-clib"))
        ...
        "core" = {
          depends = [
            ...
            (hsPkgs."haxl" or (errorHandler.buildDepError "haxl"))
            (hsPkgs."hinotify" or (errorHandler.buildDepError "hinotify"))
            (hsPkgs."glean".components.sublibs.angle or (errorHandler.buildDepError "glean:angle"))
        ...
        "db" = {
          depends = [
            ...
            (hsPkgs."glean".components.sublibs.angle or (errorHandler.buildDepError "glean:angle"))
            (hsPkgs."glean".components.sublibs.backend-api or (errorHandler.buildDepError "glean:backend-api"))
            (hsPkgs."glean".components.sublibs.bytecode or (errorHandler.buildDepError "glean:bytecode"))
            (hsPkgs."glean".components.sublibs.config or (errorHandler.buildDepError "glean:config"))
            (hsPkgs."glean".components.sublibs.core or (errorHandler.buildDepError "glean:core"))
            (hsPkgs."glean".components.sublibs.defaultconfigs or (errorHandler.buildDepError "glean:defaultconfigs"))
            ...
            (hsPkgs."glean".components.sublibs.lmdb or (errorHandler.buildDepError "glean:lmdb"))
          ];
          buildable = true;
        };
        "backend-api" = {
          depends = [
            ...
            (hsPkgs."hinotify" or (errorHandler.buildDepError "hinotify"))
            (hsPkgs."glean".components.sublibs.if-glean-hs or (errorHandler.buildDepError "glean:if-glean-hs"))
            (hsPkgs."glean".components.sublibs.typed or (errorHandler.buildDepError "glean:typed"))
            (hsPkgs."glean".components.sublibs.util or (errorHandler.buildDepError "glean:util"))
          ];
          buildable = true;
        };
        ...
        "client-hs" = {
          depends = [
            ...
            (hsPkgs."glean".components.sublibs.typed or (errorHandler.buildDepError "glean:typed"))
            (hsPkgs."glean".components.sublibs.util or (errorHandler.buildDepError "glean:util"))
            (hsPkgs."glean".components.sublibs.write or (errorHandler.buildDepError "glean:write"))
          ];
          buildable = true;
        };
        "client-hs-local" = {
          depends = [
            ...
            (hsPkgs."hinotify" or (errorHandler.buildDepError "hinotify"))
            (hsPkgs."glean".components.sublibs.if-glean-hs or (errorHandler.buildDepError "glean:if-glean-hs"))
            (hsPkgs."glean".components.sublibs.backend-local or (errorHandler.buildDepError "glean:backend-local"))
            (hsPkgs."glean".components.sublibs.core or (errorHandler.buildDepError "glean:core"))
      ...
      tests = {
        ...
        "glean-snapshot-haskell" = {
          ...
          build-tools = [
            (hsPkgs.pkgsBuildBuild.glean.components.exes.hie-indexer or (pkgs.pkgsBuildBuild.hie-indexer or (errorHandler.buildToolDepError "glean:hie-indexer")))
            (hsPkgs.pkgsBuildBuild.glean.components.exes.glean or (pkgs.pkgsBuildBuild.glean or (errorHandler.buildToolDepError "glean:glean")))
          ];
          buildable = if compiler.isGhc && compiler.version.ge "9.2"
            then true
            else false;
        };
        "glean-snapshot-codemarkup-haskell" = {
          depends = [
            (hsPkgs."fb-util" or (errorHandler.buildDepError "fb-util"))
            (hsPkgs."thrift-lib" or (errorHandler.buildDepError "thrift-lib"))
            (hsPkgs."HUnit" or (errorHandler.buildDepError "HUnit"))
        ...
        "glean-snapshot-rust-lsif" = {
          ...
          buildable = if !flags.rust-tests then false else true;
        };
        "glean-snapshot-rust-scip" = {
          depends = [
            (hsPkgs."fb-util" or (errorHandler.buildDepError "fb-util"))
            (hsPkgs."thrift-lib" or (errorHandler.buildDepError "thrift-lib"))
            (hsPkgs."HUnit" or (errorHandler.buildDepError "HUnit"))
        ...
        "glean-snapshot-python-scip" = {
          ...
          buildable = if !flags.python-tests then false else true;
        };
        "glean-snapshot-dotnet-scip" = {
          depends = [
            (hsPkgs."fb-util" or (errorHandler.buildDepError "fb-util"))
            (hsPkgs."thrift-lib" or (errorHandler.buildDepError "thrift-lib"))
            (hsPkgs."HUnit" or (errorHandler.buildDepError "HUnit"))
          ...
          buildable = if !flags.dotnet-tests then false else true;
        };
        "glean-snapshot-typescript" = {
          depends = [
            (hsPkgs."fb-util" or (errorHandler.buildDepError "fb-util"))
            (hsPkgs."thrift-lib" or (errorHandler.buildDepError "thrift-lib"))
            (hsPkgs."HUnit" or (errorHandler.buildDepError "HUnit"))
          ...
          buildable = if !flags.typescript-tests then false else true;
        };
        "glean-snapshot-go" = {
          depends = [
            (hsPkgs."fb-util" or (errorHandler.buildDepError "fb-util"))
          ...
          buildable = if !flags.go-tests then false else true;
        };
        "glean-snapshot-java-lsif" = {
          depends = [
            (hsPkgs."fb-util" or (errorHandler.buildDepError "fb-util"))
            (hsPkgs."thrift-lib" or (errorHandler.buildDepError "thrift-lib"))
            (hsPkgs."HUnit" or (errorHandler.buildDepError "HUnit"))
          ...
          buildable = if !flags.java-lsif-tests then false else true;
        };
        "glean-snapshot-lsif" = {
          depends = [
            (hsPkgs."fb-util" or (errorHandler.buildDepError "fb-util"))
        ...
        "glass-regression-buck" = {
          depends = [
            (hsPkgs."HUnit" or (errorHandler.buildDepError "HUnit"))
            (hsPkgs."glean".components.sublibs.client-hs-local or (errorHandler.buildDepError "glean:client-hs-local"))
            (hsPkgs."glean".components.sublibs.glass-lib or (errorHandler.buildDepError "glean:glass-lib"))
            (hsPkgs."glean".components.sublibs.glass-regression or (errorHandler.buildDepError "glean:glass-regression"))
            (hsPkgs."glean".components.sublibs.if-glass-hs or (errorHandler.buildDepError "glean:if-glass-hs"))
            (hsPkgs."glean".components.sublibs.regression-test-lib or (errorHandler.buildDepError "glean:regression-test-lib"))
            (hsPkgs."fb-util" or (errorHandler.buildDepError "fb-util"))
            (hsPkgs."thrift-lib" or (errorHandler.buildDepError "thrift-lib"))
