{ system
  ...
  , ... }:
  {
    ...
    components = {
      ...
      tests = {
        "amazonka-applicationcostprofiler-test" = {
          depends = [
            (hsPkgs."amazonka-applicationcostprofiler" or (errorHandler.buildDepError "amazonka-applicationcostprofiler"))
            (hsPkgs."amazonka-core" or (errorHandler.buildDepError "amazonka-core"))
