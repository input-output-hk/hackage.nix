...
in { system, compiler, flags, pkgs, hsPkgs, pkgconfPkgs, ... }:
  {
    ...
    package = {
      specVersion = "1.10";
      identifier = { name = "witherable"; version = "0.3.5"; };
    ...
    components = {
      "library" = {
        depends = [
          ...
          (hsPkgs."witherable-class" or (buildDepError "witherable-class"))
          ] ++ (pkgs.lib).optional (compiler.isGhc && (compiler.version).lt "7.9") (hsPkgs."void" or (buildDepError "void"));
        buildable = true;
        };
      };
    }