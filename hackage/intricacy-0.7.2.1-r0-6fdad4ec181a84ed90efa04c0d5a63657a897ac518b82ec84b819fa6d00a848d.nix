{ system
  ...
  , ... }:
  {
    ...
    package = {
      specVersion = "1.10";
      identifier = { name = "intricacy"; version = "0.7.2.1"; };
      ...
      exes = {
        "intricacy" = {
          ...
          libs = (pkgs.lib).optionals (!(!flags.game)) ((pkgs.lib).optionals (flags.sdl) ((pkgs.lib).optionals (system.isWindows) ([
            ...
            ] ++ (pkgs.lib).optional (flags.sound) (pkgs."SDL_mixer" or (errorHandler.sysDepError "SDL_mixer")))) ++ (pkgs.lib).optional (flags.curses) (pkgs."tinfow" or (errorHandler.sysDepError "tinfow")));
