{ system, compiler, flags, pkgs, hsPkgs, pkgconfPkgs, ... }:
  {
    ...
    package = {
      specVersion = "1.10";
      identifier = { name = "sitepipe"; version = "0.2.0.0"; };
    ...
    components = {
      "library" = {
        depends = [
          ...
          ] ++ (pkgs.lib).optional (compiler.isGhc && (compiler.version).ge "8.2") (hsPkgs."pandoc" or ((hsPkgs.pkgs-errors).buildDepError "pandoc"));
        buildable = true;
        };
      };
    }