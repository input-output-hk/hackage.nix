{ system, compiler, flags, pkgs, hsPkgs, pkgconfPkgs, ... }:
  {
    flags = { test = false; blaze_html_0_5 = false; ghc7 = true; };
    package = {
      specVersion = "1.8";
      identifier = { name = "yesod-core"; version = "1.0.1.1"; };
      license = "MIT";
      copyright = "";
    ...
    components = {
      "library" = {
        depends = (([
          ...
          ]) ++ (pkgs.lib).optional (flags.test) (hsPkgs."wai-test" or ((hsPkgs.pkgs-errors).buildDepError "wai-test"))) ++ (if flags.blaze_html_0_5
          then [
