{ system
  ...
  , ... }:
  {
    ...
    package = {
      specVersion = "2.2";
      identifier = { name = "hyperbole"; version = "0.7.0"; };
    ...
    components = {
      "library" = {
        ...
        build-tools = [
          (hsPkgs.pkgsBuildBuild.hyperbole.components.exes.docgen or (pkgs.pkgsBuildBuild.docgen or (errorHandler.buildToolDepError "hyperbole:docgen")))
        ];
        buildable = true;
      };
      exes = {
