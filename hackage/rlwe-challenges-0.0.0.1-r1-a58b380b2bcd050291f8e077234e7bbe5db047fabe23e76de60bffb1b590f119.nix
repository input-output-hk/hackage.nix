{ system
  ...
  , ... }:
  {
    ...
    package = {
      ...
      description = "Contains a library for reading serialized challenges (generated with <https://hackage.haskell.org/package/hprotoc hprotoc>) and an executable used to generate, suppress, and verify RLWE/RLWR challenges.";
      buildType = "Simple";
    };
    components = {
      "library" = {
