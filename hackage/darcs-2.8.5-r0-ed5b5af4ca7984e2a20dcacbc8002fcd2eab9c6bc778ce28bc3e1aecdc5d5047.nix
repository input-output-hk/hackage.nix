    ...
    components = {
      "library" = {
        depends = (pkgs.lib).optionals (!(!flags.library)) ((((((([
          ...
          ]) ++ (pkgs.lib).optional (compiler.isGhc && (compiler.version).lt "7.0") (hsPkgs."haskeline" or ((hsPkgs.pkgs-errors).buildDepError "haskeline"))) ++ (pkgs.lib).optional (!system.isWindows) (hsPkgs."unix" or ((hsPkgs.pkgs-errors).buildDepError "unix"))) ++ (pkgs.lib).optionals (flags.http) ([
      ...
      exes = {
        ...
        "darcs-test" = {
          depends = (pkgs.lib).optionals (!(!flags.test)) ((((((([
            ...
            (hsPkgs."base" or ((hsPkgs.pkgs-errors).buildDepError "base"))
            ]) ++ (pkgs.lib).optional (!system.isWindows) (hsPkgs."unix" or ((hsPkgs.pkgs-errors).buildDepError "unix"))) ++ (pkgs.lib).optional (compiler.isGhc && (compiler.version).lt "7.0") (hsPkgs."haskeline" or ((hsPkgs.pkgs-errors).buildDepError "haskeline"))) ++ (pkgs.lib).optional (flags.mmap && !system.isWindows) (hsPkgs."mmap" or ((hsPkgs.pkgs-errors).buildDepError "mmap"))) ++ (pkgs.lib).optional (flags.terminfo && !system.isWindows) (hsPkgs."terminfo" or ((hsPkgs.pkgs-errors).buildDepError "terminfo"))) ++ (pkgs.lib).optionals (flags.http) ([
            (hsPkgs."HTTP" or ((hsPkgs.pkgs-errors).buildDepError "HTTP"))
            ] ++ (if flags.network-uri
            then [
              (hsPkgs."network" or ((hsPkgs.pkgs-errors).buildDepError "network"))
