{ system, compiler, flags, pkgs, hsPkgs, pkgconfPkgs, ... }:
  {
    ...
    package = {
      specVersion = "1.24";
      identifier = { name = "clang-pure"; version = "0.2.0.5"; };
      license = "Apache-2.0";
      ...
      setup-depends = [
        ...
        (hsPkgs.buildPackages.inline-c or (pkgs.buildPackages.inline-c or ((hsPkgs.pkgs-errors).buildToolDepError "inline-c")))
        ];
      };
    components = {
      "library" = {
