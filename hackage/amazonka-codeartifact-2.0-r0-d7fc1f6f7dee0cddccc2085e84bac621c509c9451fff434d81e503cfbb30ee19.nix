{ system
  ...
  , ... }:
  {
    ...
    package = {
      specVersion = "2.2";
      identifier = { name = "amazonka-codeartifact"; version = "2.0"; };
      license = "MPL-2.0";
    ...
    components = {
      ...
      tests = {
        "amazonka-codeartifact-test" = {
          depends = [
            (hsPkgs."amazonka-codeartifact" or (errorHandler.buildDepError "amazonka-codeartifact"))
            (hsPkgs."amazonka-core" or (errorHandler.buildDepError "amazonka-core"))
