{ system
  ...
  , ... }:
  {
    ...
    package = {
      specVersion = "3.0";
      identifier = { name = "natskell"; version = "1.0.0.1"; };
      license = "MIT";
      copyright = "";
    ...
    components = {
      "library" = {
        depends = [
          ...
          (hsPkgs."natskell".components.sublibs.jetstream-internal or (errorHandler.buildDepError "natskell:jetstream-internal"))
