{ system
  ...
  , ... }:
  {
    ...
    package = {
      specVersion = "2.0";
      identifier = { name = "gi-nm"; version = "1.0.1"; };
      ...
      url = "";
      synopsis = "NM bindings";
      description = "Bindings for NM (NetworkManager library), autogenerated by haskell-gi.";
      buildType = "Custom";
      setup-depends = [
    ...
    components = {
      "library" = {
        ...
        pkgconfig = [
          (pkgconfPkgs."libnm" or (errorHandler.pkgConfDepError "libnm"))
        ];
        buildable = true;
      };
    };
