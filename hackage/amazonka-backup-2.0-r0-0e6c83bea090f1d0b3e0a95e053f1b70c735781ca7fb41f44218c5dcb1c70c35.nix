{ system
  ...
  , ... }:
  {
    ...
    package = {
      specVersion = "2.2";
      identifier = { name = "amazonka-backup"; version = "2.0"; };
      license = "MPL-2.0";
    ...
    components = {
      ...
      tests = {
        "amazonka-backup-test" = {
          depends = [
            (hsPkgs."amazonka-backup" or (errorHandler.buildDepError "amazonka-backup"))
            (hsPkgs."amazonka-core" or (errorHandler.buildDepError "amazonka-core"))
