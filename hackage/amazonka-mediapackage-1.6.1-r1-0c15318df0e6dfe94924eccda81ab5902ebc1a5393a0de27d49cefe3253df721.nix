{ system
  ...
  , ... }:
  {
    ...
    package = {
      specVersion = "1.10";
      identifier = { name = "amazonka-mediapackage"; version = "1.6.1"; };
      license = "MPL-2.0";
    ...
    components = {
      ...
      tests = {
        "amazonka-mediapackage-test" = {
          depends = [
            (hsPkgs."amazonka-core" or (errorHandler.buildDepError "amazonka-core"))
            (hsPkgs."amazonka-test" or (errorHandler.buildDepError "amazonka-test"))
            (hsPkgs."amazonka-mediapackage" or (errorHandler.buildDepError "amazonka-mediapackage"))
            (hsPkgs."base" or (errorHandler.buildDepError "base"))
