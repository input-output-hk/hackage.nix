    ...
    components = {
      "library" = {
        depends = (([
          ...
          else (pkgs.lib).optional (!system.isWindows) (hsPkgs."unix" or ((hsPkgs.pkgs-errors).buildDepError "unix")))) ++ (if flags.split-these
          then [
      ...
      tests = {
        ...
        "hydration" = {
          depends = [
            ...
            (hsPkgs."aeson" or ((hsPkgs.pkgs-errors).buildDepError "aeson"))
            (hsPkgs."bytestring" or ((hsPkgs.pkgs-errors).buildDepError "bytestring"))
            (hsPkgs."chrome-test-utils" or ((hsPkgs.pkgs-errors).buildDepError "chrome-test-utils"))
            (hsPkgs."constraints" or ((hsPkgs.pkgs-errors).buildDepError "constraints"))
