      ...
      exes = {
        "idris" = {
          depends = ((([
            ...
            ] ++ (pkgs.lib).optional (system.isLinux) (hsPkgs.unix)) ++ (pkgs.lib).optional (system.isOsx) (hsPkgs.unix)) ++ (pkgs.lib).optional (system.isWindows) (hsPkgs.Win32)) ++ (pkgs.lib).optional (flags.llvm) (hsPkgs.llvm-general);
          };
        };
      };
    }