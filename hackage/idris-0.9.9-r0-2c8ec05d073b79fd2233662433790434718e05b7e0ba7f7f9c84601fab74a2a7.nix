    ...
    components = {
      exes = {
        "idris" = {
          ...
          ] ++ pkgs.lib.optional (system.isLinux) (hsPkgs."unix" or (errorHandler.buildDepError "unix"))) ++ pkgs.lib.optional (system.isOsx) (hsPkgs."unix" or (errorHandler.buildDepError "unix"))) ++ pkgs.lib.optional (system.isWindows) (hsPkgs."Win32" or (errorHandler.buildDepError "Win32"))) ++ pkgs.lib.optional (flags.llvm) (hsPkgs."llvm-general" or (errorHandler.buildDepError "llvm-general"));
          buildable = true;
        };
      };
    };
