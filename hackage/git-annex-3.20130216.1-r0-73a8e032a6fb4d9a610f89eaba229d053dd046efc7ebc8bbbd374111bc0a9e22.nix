{ system, compiler, flags, pkgs, hsPkgs, pkgconfPkgs, ... }:
  {
    ...
    package = {
      specVersion = "1.8";
      identifier = { name = "git-annex"; version = "3.20130216.1"; };
      ...
      exes = {
        "git-annex" = {
          depends = ((((((((([
            ...
            ]) ++ (pkgs.lib).optional (flags.assistant) (hsPkgs."async" or ((hsPkgs.pkgs-errors).buildDepError "async"))) ++ (pkgs.lib).optional (flags.assistant && !system.isWindows && !system.isSolaris) (hsPkgs."stm" or ((hsPkgs.pkgs-errors).buildDepError "stm"))) ++ (if system.isLinux && flags.inotify
            then [
