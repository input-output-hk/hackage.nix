{ system, compiler, flags, pkgs, hsPkgs, pkgconfPkgs, ... }:
  {
    ...
    package = {
      specVersion = "1.6";
      identifier = { name = "llvm-ffi"; version = "3.3.0"; };
    ...
    components = {
      "library" = {
        ...
        pkgconfig = if flags.specificpkgconfig
          then [
            (pkgconfPkgs."llvm-3.3" or ((hsPkgs.pkgs-errors).pkgConfDepError "llvm-3.3"))
            ]
          else [
