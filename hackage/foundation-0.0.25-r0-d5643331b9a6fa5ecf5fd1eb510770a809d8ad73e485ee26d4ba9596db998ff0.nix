{ system, compiler, flags, pkgs, hsPkgs, pkgconfPkgs, ... }:
  {
    ...
    components = {
      "library" = {
        ...
        libs = (pkgs.lib).optionals (!(compiler.isGhc && (compiler.version).lt "8.0" || compiler.isGhcjs && true)) ((pkgs.lib).optionals (system.isWindows) ((pkgs.lib).optional (system.isI386) (pkgs."gcc" or ((hsPkgs.pkgs-errors).sysDepError "gcc"))));
