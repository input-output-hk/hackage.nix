      ...
      "library" = {
        depends = (((([
          ...
          then [ (hsPkgs."network" or (buildDepError "network")) ]
            ...
            ])) ++ (pkgs.lib).optional (flags.template_haskell && !system.isArm) (hsPkgs."template-haskell" or (buildDepError "template-haskell"))) ++ (pkgs.lib).optional (!system.isWindows) (hsPkgs."unix" or (buildDepError "unix"))) ++ (pkgs.lib).optionals (flags.base4) [
          (hsPkgs."base" or (buildDepError "base"))
