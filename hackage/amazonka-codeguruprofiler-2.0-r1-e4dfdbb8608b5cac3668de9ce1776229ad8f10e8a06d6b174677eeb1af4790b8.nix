{ system
  ...
  , ... }:
  {
    ...
    package = {
      specVersion = "2.2";
      identifier = { name = "amazonka-codeguruprofiler"; version = "2.0"; };
      license = "MPL-2.0";
    ...
    components = {
      ...
      tests = {
        "amazonka-codeguruprofiler-test" = {
          depends = [
            (hsPkgs."amazonka-codeguruprofiler" or (errorHandler.buildDepError "amazonka-codeguruprofiler"))
            (hsPkgs."amazonka-core" or (errorHandler.buildDepError "amazonka-core"))
