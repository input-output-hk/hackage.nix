{ system, compiler, flags, pkgs, hsPkgs, pkgconfPkgs, ... }:
  {
    ...
    package = {
      specVersion = "1.6";
      identifier = { name = "darcs"; version = "2.1.2.1"; };
    ...
    components = {
      exes = {
        "darcs" = {
          ...
          pkgconfig = (pkgs.lib).optionals (flags.curl) ((pkgs.lib).optional (flags.curl-pipelining) (pkgconfPkgs."libcurl" or ((hsPkgs.pkgs-errors).pkgConfDepError "libcurl")));
