{ system
  ...
  , ... }:
  {
    ...
    package = {
      specVersion = "1.10";
      identifier = { name = "aeson-combinators"; version = "0.1.2.2"; };
    ...
    components = {
      "library" = {
        depends = [
          ...
          (hsPkgs."scientific" or (errorHandler.buildDepError "scientific"))
        ] ++ pkgs.lib.optional (compiler.isGhc && compiler.version.ge "9.2.0") (hsPkgs."attoparsec-aeson" or (errorHandler.buildDepError "attoparsec-aeson"));
        buildable = true;
      };
      tests = {
        "spec" = {
