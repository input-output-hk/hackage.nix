    ...
    components = {
      "library" = {
        depends = [
          ...
          (hsPkgs."th-reify-compat" or ((hsPkgs.pkgs-errors).buildDepError "th-reify-compat"))
          ...
          ] ++ (pkgs.lib).optional (flags.ghc74-generic) (hsPkgs."ghc-prim" or ((hsPkgs.pkgs-errors).buildDepError "ghc-prim"));
        buildable = true;
        };
      tests = {
        "sqls" = {
