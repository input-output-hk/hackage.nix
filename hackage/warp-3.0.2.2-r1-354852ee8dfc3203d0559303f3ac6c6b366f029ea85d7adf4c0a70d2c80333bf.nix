  ...
  , ... }:
  {
    ...
    components = {
      "library" = {
        ...
        ] ++ pkgs.lib.optional (compiler.isGhc && compiler.version.ge "7.8") (hsPkgs."atomic-primops" or (errorHandler.buildDepError "atomic-primops"))) ++ (if flags.network-bytestring
          then [
      ...
      tests = {
        ...
        "spec" = {
          ...
          ] ++ pkgs.lib.optional (compiler.isGhc && compiler.version.ge "7.8") (hsPkgs."atomic-primops" or (errorHandler.buildDepError "atomic-primops"))) ++ pkgs.lib.optionals ((system.isLinux || system.isFreebsd || system.isOsx) && flags.allow-sendfilefd) [
            (hsPkgs."unix" or (errorHandler.buildDepError "unix"))
