{ system
  ...
  , ... }:
  {
    ...
    package = {
      specVersion = "2.0";
      identifier = { name = "gi-json"; version = "1.0.6"; };
      ...
      url = "";
      synopsis = "JSON GObject bindings";
      description = "Low-level bindings for json-glib, autogenerated by haskell-gi.";
      buildType = "Custom";
      setup-depends = [
    ...
    components = {
      "library" = {
        ...
        pkgconfig = [
          (pkgconfPkgs."json-glib-1.0" or (errorHandler.pkgConfDepError "json-glib-1.0"))
        ];
        buildable = true;
      };
    };
