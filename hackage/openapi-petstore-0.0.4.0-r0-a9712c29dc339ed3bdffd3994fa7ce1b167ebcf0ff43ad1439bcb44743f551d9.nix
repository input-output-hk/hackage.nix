...
in { system, compiler, flags, pkgs, hsPkgs, pkgconfPkgs, ... }:
  {
    ...
    package = {
      specVersion = "1.10";
      identifier = { name = "openapi-petstore"; version = "0.0.4.0"; };
      license = "MIT";
    ...
    components = {
      "library" = {
        depends = [
          ...
          then [ (hsPkgs."katip" or (buildDepError "katip")) ]
          else [ (hsPkgs."monad-logger" or (buildDepError "monad-logger")) ]);
        };
      tests = {
        "tests" = {
          depends = [
            (hsPkgs."openapi-petstore" or (buildDepError "openapi-petstore"))
