{ system
  ...
  , ... }:
  {
    ...
    package = {
      specVersion = "2.2";
      identifier = { name = "amazonka-amp"; version = "2.0"; };
      license = "MPL-2.0";
    ...
    components = {
      ...
      tests = {
        "amazonka-amp-test" = {
          depends = [
            (hsPkgs."amazonka-amp" or (errorHandler.buildDepError "amazonka-amp"))
            (hsPkgs."amazonka-core" or (errorHandler.buildDepError "amazonka-core"))
