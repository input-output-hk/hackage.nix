{ system
  ...
  , ... }:
  {
    flags = { deprecated-pager-hints = true; wireplumber = true; };
    package = {
      specVersion = "3.4";
      identifier = { name = "taffybar"; version = "7.2.5"; };
    ...
    components = {
      "library" = {
        depends = ([
          ...
          (hsPkgs."dbus-menu" or (errorHandler.buildDepError "dbus-menu"))
          ...
          (hsPkgs."gi-gtk-layer-shell" or (errorHandler.buildDepError "gi-gtk-layer-shell"))
          ...
          (hsPkgs."gtk-scaling-image" or (errorHandler.buildDepError "gtk-scaling-image"))
        ...
        ] ++ pkgs.lib.optional (flags.deprecated-pager-hints) (hsPkgs."xmonad" or (errorHandler.buildDepError "xmonad"))) ++ pkgs.lib.optional (flags.wireplumber) (hsPkgs."gi-wireplumber" or (errorHandler.buildDepError "gi-wireplumber"));
        pkgconfig = [
          (pkgconfPkgs."gtk+-3.0" or (errorHandler.pkgConfDepError "gtk+-3.0"))
        ] ++ pkgs.lib.optional (system.isLinux) (pkgconfPkgs."libudev" or (errorHandler.pkgConfDepError "libudev"));
        buildable = true;
      };
      sublibs = {
        "testlib" = {
      ...
      tests = {
        "unit" = {
          depends = [
            ...
            (hsPkgs."status-notifier-item" or (errorHandler.buildDepError "status-notifier-item"))
            (hsPkgs."taffybar" or (errorHandler.buildDepError "taffybar"))
            (hsPkgs."taffybar".components.sublibs.testlib or (errorHandler.buildDepError "taffybar:testlib"))
            (hsPkgs."typed-process" or (errorHandler.buildDepError "typed-process"))
            (hsPkgs."unix" or (errorHandler.buildDepError "unix"))
            (hsPkgs."unliftio" or (errorHandler.buildDepError "unliftio"))
            (hsPkgs."transformers" or (errorHandler.buildDepError "transformers"))
          ...
          build-tools = [
            (hsPkgs.pkgsBuildBuild.hspec-discover.components.exes.hspec-discover or (pkgs.pkgsBuildBuild.hspec-discover or (errorHandler.buildToolDepError "hspec-discover:hspec-discover")))
            (hsPkgs.pkgsBuildBuild.taffybar.components.exes.taffybar-test-wm or (pkgs.pkgsBuildBuild.taffybar-test-wm or (errorHandler.buildToolDepError "taffybar:taffybar-test-wm")))
            (hsPkgs.pkgsBuildBuild.taffybar.components.exes.taffybar-appearance-snap or (pkgs.pkgsBuildBuild.taffybar-appearance-snap or (errorHandler.buildToolDepError "taffybar:taffybar-appearance-snap")))
          ];
          buildable = true;
        };
      };
