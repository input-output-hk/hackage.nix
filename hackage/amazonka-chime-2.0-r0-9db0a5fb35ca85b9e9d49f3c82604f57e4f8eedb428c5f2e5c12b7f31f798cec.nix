{ system
  ...
  , ... }:
  {
    ...
    package = {
      specVersion = "2.2";
      identifier = { name = "amazonka-chime"; version = "2.0"; };
      license = "MPL-2.0";
    ...
    components = {
      ...
      tests = {
        "amazonka-chime-test" = {
          depends = [
            (hsPkgs."amazonka-chime" or (errorHandler.buildDepError "amazonka-chime"))
            (hsPkgs."amazonka-core" or (errorHandler.buildDepError "amazonka-core"))
