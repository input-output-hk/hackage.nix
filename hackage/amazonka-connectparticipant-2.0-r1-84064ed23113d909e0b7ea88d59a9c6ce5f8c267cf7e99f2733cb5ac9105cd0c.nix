{ system
  ...
  , ... }:
  {
    ...
    package = {
      specVersion = "2.2";
      identifier = { name = "amazonka-connectparticipant"; version = "2.0"; };
      license = "MPL-2.0";
    ...
    components = {
      ...
      tests = {
        "amazonka-connectparticipant-test" = {
          depends = [
            (hsPkgs."amazonka-connectparticipant" or (errorHandler.buildDepError "amazonka-connectparticipant"))
            (hsPkgs."amazonka-core" or (errorHandler.buildDepError "amazonka-core"))
