      ...
      tests = {
        "test" = {
          depends = [
            ...
            ] ++ (pkgs.lib).optional (flags.store || !(compiler.isGhcjs && true)) (hsPkgs."store" or (buildDepError "store"));
          buildable = true;
          };
        };
      };
