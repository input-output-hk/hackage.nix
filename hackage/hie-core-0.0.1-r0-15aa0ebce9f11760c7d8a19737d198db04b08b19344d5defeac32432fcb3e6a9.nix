    ...
    components = {
      ...
      exes = {
        "hie-core" = {
          depends = [
            ...
            (hsPkgs."hie-core" or (errorHandler.buildDepError "hie-core"))
      ...
      tests = {
        "hie-core-tests" = {
          ...
          build-tools = [
            (hsPkgs.buildPackages.hie-core or (pkgs.buildPackages.hie-core or (errorHandler.buildToolDepError "hie-core")))
            ];
          buildable = true;
          };
        };
