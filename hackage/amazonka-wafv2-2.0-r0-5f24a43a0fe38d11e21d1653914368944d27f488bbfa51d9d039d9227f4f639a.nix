{ system
  ...
  , ... }:
  {
    ...
    package = {
      specVersion = "2.2";
      identifier = { name = "amazonka-wafv2"; version = "2.0"; };
      license = "MPL-2.0";
      ...
      tests = {
        "amazonka-wafv2-test" = {
          depends = [
            ...
            (hsPkgs."amazonka-wafv2" or (errorHandler.buildDepError "amazonka-wafv2"))
            (hsPkgs."base" or (errorHandler.buildDepError "base"))
