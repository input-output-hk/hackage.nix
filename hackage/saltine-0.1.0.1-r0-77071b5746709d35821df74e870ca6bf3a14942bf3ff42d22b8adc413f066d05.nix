{ system, compiler, flags, pkgs, hsPkgs, pkgconfPkgs, ... }:
  {
    ...
    components = {
      "library" = {
        ...
        libs = (pkgs.lib).optional (system.isWindows) (pkgs."sodium" or ((hsPkgs.pkgs-errors).sysDepError "sodium"));
        pkgconfig = (pkgs.lib).optional (!system.isWindows) (pkgconfPkgs."libsodium" or ((hsPkgs.pkgs-errors).pkgConfDepError "libsodium"));
        buildable = true;
        };
      tests = {
        "tests" = {
