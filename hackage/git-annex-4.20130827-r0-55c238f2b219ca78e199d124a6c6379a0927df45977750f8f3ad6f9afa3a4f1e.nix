{ system, compiler, flags, pkgs, hsPkgs, pkgconfPkgs, ... }:
  {
    ...
    package = {
      specVersion = "1.8";
      identifier = { name = "git-annex"; version = "4.20130827"; };
      ...
      exes = {
        "git-annex" = {
          depends = ((((((((((((([
            ...
            ]) ++ (pkgs.lib).optional (flags.android) (hsPkgs."data-endian" or ((hsPkgs.pkgs-errors).buildDepError "data-endian"))) ++ (pkgs.lib).optionals (flags.assistant) (if system.isLinux && flags.inotify
            then [
              (hsPkgs."hinotify" or ((hsPkgs.pkgs-errors).buildDepError "hinotify"))
              ]
            else (pkgs.lib).optional (system.isOsx) (hsPkgs."hfsevents" or ((hsPkgs.pkgs-errors).buildDepError "hfsevents")))) ++ (pkgs.lib).optional (system.isLinux && flags.dbus) (hsPkgs."dbus" or ((hsPkgs.pkgs-errors).buildDepError "dbus"))) ++ (pkgs.lib).optionals (flags.webapp) [
            ...
            ]) ++ (pkgs.lib).optional (flags.dns) (hsPkgs."dns" or ((hsPkgs.pkgs-errors).buildDepError "dns"))) ++ (pkgs.lib).optional (flags.feed) (hsPkgs."feed" or ((hsPkgs.pkgs-errors).buildDepError "feed"));
          buildable = true;
          };
        };
      };
