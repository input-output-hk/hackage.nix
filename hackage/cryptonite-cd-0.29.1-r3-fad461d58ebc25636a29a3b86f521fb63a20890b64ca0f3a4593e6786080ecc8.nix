{ system
  ...
  , ... }:
  {
    ...
    package = {
      specVersion = "1.18";
      identifier = { name = "cryptonite-cd"; version = "0.29.1"; };
    ...
    components = {
      "library" = {
        depends = ((([
          ...
          (hsPkgs."memory-cd" or (errorHandler.buildDepError "memory-cd"))
          (hsPkgs."basement-cd" or (errorHandler.buildDepError "basement-cd"))
      ...
      tests = {
        "test-cryptonite" = {
          depends = [
            ...
            (hsPkgs."cryptonite-cd" or (errorHandler.buildDepError "cryptonite-cd"))
          ];
          buildable = true;
        };
      };
