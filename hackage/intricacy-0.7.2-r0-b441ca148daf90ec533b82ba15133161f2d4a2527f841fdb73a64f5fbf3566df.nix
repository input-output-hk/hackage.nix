{ system, compiler, flags, pkgs, hsPkgs, pkgconfPkgs, ... }:
  {
    ...
    package = {
      specVersion = "1.10";
      identifier = { name = "intricacy"; version = "0.7.2"; };
      ...
      exes = {
        "intricacy" = {
          depends = (pkgs.lib).optionals (flags.game) (((([
            ...
            ] ++ (pkgs.lib).optional (!(compiler.isGhc && (compiler.version).ge "8.0")) (hsPkgs."semigroups" or ((hsPkgs.pkgs-errors).buildDepError "semigroups"))) ++ (pkgs.lib).optionals (flags.sdl) (([
            ...
            ]) ++ (pkgs.lib).optional (system.isOsx) (hsPkgs."network-fancy" or ((hsPkgs.pkgs-errors).buildDepError "network-fancy")))) ++ (pkgs.lib).optional (flags.curses) (hsPkgs."hscurses" or ((hsPkgs.pkgs-errors).buildDepError "hscurses"))) ++ (pkgs.lib).optionals (!flags.sdl) ((pkgs.lib).optional (!flags.curses) (hsPkgs."Unsatisfiable" or ((hsPkgs.pkgs-errors).buildDepError "Unsatisfiable"))));
