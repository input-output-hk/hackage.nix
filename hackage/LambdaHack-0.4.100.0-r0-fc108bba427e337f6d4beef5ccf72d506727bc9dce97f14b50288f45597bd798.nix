{ system, compiler, flags, pkgs, hsPkgs, pkgconfPkgs, ... }:
  {
    ...
    package = {
      specVersion = "1.10";
      identifier = { name = "LambdaHack"; version = "0.4.100.0"; };
    ...
    components = {
      "library" = {
        ...
        pkgconfig = (pkgs.lib).optionals (!flags.curses) ((pkgs.lib).optional (!flags.vty) (pkgconfPkgs."gtk+-2.0" or ((hsPkgs.pkgs-errors).pkgConfDepError "gtk+-2.0")));
        buildable = true;
        };
      exes = {
        "LambdaHack" = {
