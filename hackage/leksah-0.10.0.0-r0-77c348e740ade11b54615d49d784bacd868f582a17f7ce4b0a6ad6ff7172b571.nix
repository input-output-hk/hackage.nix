        ...
        "leksah" = {
          depends = ((((if system.isWindows
            then [ (hsPkgs."Win32" or (buildDepError "Win32")) ]
              ...
              (hsPkgs."unix" or (buildDepError "unix"))
              ]) ++ (pkgs.lib).optional (system.isOsx) (hsPkgs."ige-mac-integration" or (buildDepError "ige-mac-integration"))) ++ (pkgs.lib).optional (compiler.isGhc && (compiler.version).lt "6.12.3" && flags.yi) (hsPkgs."yi" or (buildDepError "yi"))) ++ (pkgs.lib).optional (compiler.isGhc && (compiler.version).lt "6.12.3" && flags.yi && flags.dyre) (hsPkgs."dyre" or (buildDepError "dyre"))) ++ (if compiler.isGhc && (compiler.version).lt "6.12.3"
            then [
              (hsPkgs."Cabal" or (buildDepError "Cabal"))
              (hsPkgs."base" or (buildDepError "base"))
              (hsPkgs."binary" or (buildDepError "binary"))
