{ system
  ...
  , ... }:
  {
    ...
    package = {
      specVersion = "1.10";
      identifier = { name = "keyring"; version = "0.1.0.5"; };
      license = "MIT";
    ...
    components = {
      "library" = {
        ...
        build-tools = (pkgs.lib).optional (system.isOsx) (hsPkgs.buildPackages.hsc2hs or (pkgs.buildPackages.hsc2hs or (errorHandler.buildToolDepError "hsc2hs")));
        buildable = true;
        };
      exes = {
        "keyring-example" = {
