{ system
  ...
  , ... }:
  {
    flags = {
      ...
      enablebetaextensions = false;
      useplatformandroidkhr = false;
      useplatformdirectfbext = false;
      useplatformfuchsia = false;
      useplatformggp = false;
      useplatformiosmvk = false;
      useplatformmacosmvk = false;
      useplatformmetalext = false;
      ...
      usenativeffi-1-2 = false;
    };
    package = {
      specVersion = "1.22";
      identifier = { name = "vulkan-api"; version = "1.4.0.0"; };
