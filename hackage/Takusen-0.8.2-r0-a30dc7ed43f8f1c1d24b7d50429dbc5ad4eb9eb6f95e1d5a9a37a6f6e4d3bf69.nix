  ...
  , ... }:
  {
    ...
    components = {
      "library" = {
        ...
        build-tools = ((pkgs.lib.optional (flags.odbc) (hsPkgs.buildPackages.odbcconf.components.exes.odbcconf or (pkgs.buildPackages.odbcconf or (errorHandler.buildToolDepError "odbcconf:odbcconf"))) ++ pkgs.lib.optional (flags.oracle) (hsPkgs.buildPackages.sqlplus.components.exes.sqlplus or (pkgs.buildPackages.sqlplus or (errorHandler.buildToolDepError "sqlplus:sqlplus")))) ++ pkgs.lib.optional (flags.postgres) (hsPkgs.buildPackages.pg_config.components.exes.pg_config or (pkgs.buildPackages.pg_config or (errorHandler.buildToolDepError "pg_config:pg_config")))) ++ pkgs.lib.optional (flags.sqlite) (hsPkgs.buildPackages.sqlite3.components.exes.sqlite3 or (pkgs.buildPackages.sqlite3 or (errorHandler.buildToolDepError "sqlite3:sqlite3")));
        buildable = true;
      };
    };
  }