  ...
  , ... }:
  {
    ...
    components = {
      "library" = {
        ...
        build-tools = ((pkgs.lib.optional (flags.odbc) (hsPkgs.pkgsBuildBuild.odbcconf.components.exes.odbcconf or (pkgs.pkgsBuildBuild.odbcconf or (errorHandler.buildToolDepError "odbcconf:odbcconf"))) ++ pkgs.lib.optional (flags.oracle) (hsPkgs.pkgsBuildBuild.sqlplus.components.exes.sqlplus or (pkgs.pkgsBuildBuild.sqlplus or (errorHandler.buildToolDepError "sqlplus:sqlplus")))) ++ pkgs.lib.optional (flags.postgres) (hsPkgs.pkgsBuildBuild.pg_config.components.exes.pg_config or (pkgs.pkgsBuildBuild.pg_config or (errorHandler.buildToolDepError "pg_config:pg_config")))) ++ pkgs.lib.optional (flags.sqlite) (hsPkgs.pkgsBuildBuild.sqlite3.components.exes.sqlite3 or (pkgs.pkgsBuildBuild.sqlite3 or (errorHandler.buildToolDepError "sqlite3:sqlite3")));
        buildable = true;
      };
    };
  }