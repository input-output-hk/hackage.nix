{ system
  ...
  , ... }:
  {
    ...
    components = {
      ...
      tests = {
        "amazonka-resourcegroupstagging-test" = {
          depends = [
            (hsPkgs."amazonka-core" or (errorHandler.buildDepError "amazonka-core"))
            (hsPkgs."amazonka-resourcegroupstagging" or (errorHandler.buildDepError "amazonka-resourcegroupstagging"))
