    ...
    components = {
      ...
      exes = {
        "nano-bench" = {
          depends = ([
            (hsPkgs."mtl" or ((hsPkgs.pkgs-errors).buildDepError "mtl"))
            ] ++ (pkgs.lib).optional (flags.fusion-plugin && !(compiler.isGhcjs && true) && !(compiler.isGhc && (compiler.version).lt "8.6")) (hsPkgs."fusion-plugin" or ((hsPkgs.pkgs-errors).buildDepError "fusion-plugin"))) ++ (pkgs.lib).optionals (flags.dev) [
      ...
      benchmarks = {
        "linear" = {
          depends = (([
            ...
            (hsPkgs."random" or ((hsPkgs.pkgs-errors).buildDepError "random"))
            (hsPkgs."gauge" or ((hsPkgs.pkgs-errors).buildDepError "gauge"))
            ] ++ (pkgs.lib).optional (flags.fusion-plugin && !(compiler.isGhcjs && true) && !(compiler.isGhc && (compiler.version).lt "8.6")) (hsPkgs."fusion-plugin" or ((hsPkgs.pkgs-errors).buildDepError "fusion-plugin"))) ++ (pkgs.lib).optional (compiler.isGhc && (compiler.version).lt "8.0") (hsPkgs."transformers" or ((hsPkgs.pkgs-errors).buildDepError "transformers"))) ++ (pkgs.lib).optionals (flags.inspection) [
            (hsPkgs."template-haskell" or ((hsPkgs.pkgs-errors).buildDepError "template-haskell"))
            (hsPkgs."inspection-testing" or ((hsPkgs.pkgs-errors).buildDepError "inspection-testing"))
            ];
          buildable = true;
        ...
        "fileio" = {
          depends = ([
            ...
            (hsPkgs."deepseq" or ((hsPkgs.pkgs-errors).buildDepError "deepseq"))
            ] ++ (pkgs.lib).optional (flags.fusion-plugin && !(compiler.isGhcjs && true) && !(compiler.isGhc && (compiler.version).lt "8.6")) (hsPkgs."fusion-plugin" or ((hsPkgs.pkgs-errors).buildDepError "fusion-plugin"))) ++ (pkgs.lib).optionals (flags.inspection) [
            (hsPkgs."template-haskell" or ((hsPkgs.pkgs-errors).buildDepError "template-haskell"))
            (hsPkgs."inspection-testing" or ((hsPkgs.pkgs-errors).buildDepError "inspection-testing"))
            ];
          buildable = true;
