{ system
  ...
  , ... }:
  {
    ...
    package = {
      specVersion = "2.2";
      identifier = { name = "amazonka-transcribe"; version = "2.0"; };
      license = "MPL-2.0";
      ...
      tests = {
        "amazonka-transcribe-test" = {
          depends = [
            ...
            (hsPkgs."amazonka-transcribe" or (errorHandler.buildDepError "amazonka-transcribe"))
            (hsPkgs."base" or (errorHandler.buildDepError "base"))
