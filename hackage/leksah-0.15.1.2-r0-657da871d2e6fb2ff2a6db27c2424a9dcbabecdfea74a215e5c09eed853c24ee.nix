...
in { system, compiler, flags, pkgs, hsPkgs, pkgconfPkgs, ... }:
  {
    ...
    package = {
      specVersion = "1.18";
      identifier = { name = "leksah"; version = "0.15.1.2"; };
      ...
      "library" = {
        depends = (((((([
          ...
          then [ (hsPkgs."Win32" or (buildDepError "Win32")) ]
            ...
            ])) ++ (pkgs.lib).optional (system.isOsx) (hsPkgs."gtk3-mac-integration" or (buildDepError "gtk3-mac-integration"))) ++ (pkgs.lib).optionals (flags.yi) [
          (hsPkgs."yi" or (buildDepError "yi"))
          (hsPkgs."yi-language" or (buildDepError "yi-language"))
          (hsPkgs."yi-rope" or (buildDepError "yi-rope"))
          ]) ++ (pkgs.lib).optional (flags.yi && flags.dyre) (hsPkgs."dyre" or (buildDepError "dyre"))) ++ (pkgs.lib).optionals (flags.loc && system.isLinux) [
