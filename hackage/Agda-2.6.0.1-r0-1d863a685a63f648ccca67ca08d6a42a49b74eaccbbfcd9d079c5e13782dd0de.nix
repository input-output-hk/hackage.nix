    ...
    components = {
      "library" = {
        depends = (((((((([
          ...
          (hsPkgs.text)
          ]) ++ (pkgs.lib).optional (compiler.isGhc && (compiler.version).ge "8.0" && (compiler.isGhc && (compiler.version).lt "8.4")) (hsPkgs.transformers)) ++ (pkgs.lib).optionals (compiler.isGhc && (compiler.version).lt "8.0") [
          (hsPkgs.transformers)
          (hsPkgs.filemanip)
          ]) ++ [
          (hsPkgs.zlib)
