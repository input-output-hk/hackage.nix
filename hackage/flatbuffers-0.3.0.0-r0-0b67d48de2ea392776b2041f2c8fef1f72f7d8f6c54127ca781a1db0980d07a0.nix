{ system
  ...
  , ... }:
  {
    ...
    package = {
      specVersion = "1.18";
      identifier = { name = "flatbuffers"; version = "0.3.0.0"; };
      ...
      tests = {
        "test" = {
          depends = [
            ...
            (hsPkgs."directory" or (errorHandler.buildDepError "directory"))
            (hsPkgs."filepath" or (errorHandler.buildDepError "filepath"))
            (hsPkgs."flatbuffers" or (errorHandler.buildDepError "flatbuffers"))
            ...
            (hsPkgs."text" or (errorHandler.buildDepError "text"))
            (hsPkgs."text-manipulate" or (errorHandler.buildDepError "text-manipulate"))
            (hsPkgs."th-pprint" or (errorHandler.buildDepError "th-pprint"))
