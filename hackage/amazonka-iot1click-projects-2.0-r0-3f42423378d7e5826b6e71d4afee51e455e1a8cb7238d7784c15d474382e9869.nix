{ system
  ...
  , ... }:
  {
    ...
    package = {
      specVersion = "2.2";
      identifier = { name = "amazonka-iot1click-projects"; version = "2.0"; };
      license = "MPL-2.0";
    ...
    components = {
      ...
      tests = {
        "amazonka-iot1click-projects-test" = {
          depends = [
            (hsPkgs."amazonka-core" or (errorHandler.buildDepError "amazonka-core"))
            (hsPkgs."amazonka-iot1click-projects" or (errorHandler.buildDepError "amazonka-iot1click-projects"))
