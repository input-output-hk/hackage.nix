{ system, compiler, flags, pkgs, hsPkgs, pkgconfPkgs, ... }:
  {
    ...
    package = {
      specVersion = "1.10";
      identifier = { name = "lzma-clib"; version = "5.2.2"; };
    ...
    components = {
      "library" = {
        depends = (pkgs.lib).optional (!system.isWindows) (hsPkgs."only-buildable-on-windows" or ((hsPkgs.pkgs-errors).buildDepError "only-buildable-on-windows"));
