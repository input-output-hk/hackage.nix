{ system, compiler, flags, pkgs, hsPkgs, pkgconfPkgs, ... }:
  {
    ...
    package = {
      specVersion = "1.6";
      identifier = { name = "cpsa"; version = "3.6.0"; };
    ...
    components = {
      exes = {
        ...
        "cpsagraph" = { depends = [ (hsPkgs.base) (hsPkgs.containers) ]; };
        "cpsashapes" = { depends = [ (hsPkgs.base) (hsPkgs.containers) ]; };
        "cpsaannotations" = {
          depends = [ (hsPkgs.base) (hsPkgs.containers) ];
          };
        "cpsadiff" = { depends = [ (hsPkgs.base) (hsPkgs.containers) ]; };
        "cpsasas" = { depends = [ (hsPkgs.base) (hsPkgs.containers) ]; };
        "cpsapp" = { depends = [ (hsPkgs.base) (hsPkgs.containers) ]; };
        "cpsajson" = { depends = [ (hsPkgs.base) (hsPkgs.containers) ]; };
        "cpsadebase" = { depends = [ (hsPkgs.base) (hsPkgs.containers) ]; };
        "cpsamatch" = { depends = [ (hsPkgs.base) (hsPkgs.containers) ]; };
        };
      };
    }