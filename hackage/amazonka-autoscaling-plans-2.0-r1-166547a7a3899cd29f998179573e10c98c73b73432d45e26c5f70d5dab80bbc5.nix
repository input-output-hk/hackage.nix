{ system
  ...
  , ... }:
  {
    ...
    package = {
      specVersion = "2.2";
      identifier = { name = "amazonka-autoscaling-plans"; version = "2.0"; };
      license = "MPL-2.0";
    ...
    components = {
      ...
      tests = {
        "amazonka-autoscaling-plans-test" = {
          depends = [
            (hsPkgs."amazonka-autoscaling-plans" or (errorHandler.buildDepError "amazonka-autoscaling-plans"))
            (hsPkgs."amazonka-core" or (errorHandler.buildDepError "amazonka-core"))
