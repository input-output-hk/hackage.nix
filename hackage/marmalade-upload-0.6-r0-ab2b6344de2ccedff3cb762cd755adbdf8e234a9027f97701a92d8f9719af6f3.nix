{ system, compiler, flags, pkgs, hsPkgs, pkgconfPkgs, ... }:
  {
    ...
    components = {
      "library" = {
        ...
        libs = (pkgs.lib).optional (flags.libmagic) (pkgs."magic" or ((hsPkgs.pkgs-errors).sysDepError "magic"));
        build-tools = (pkgs.lib).optional (flags.libmagic) (hsPkgs.buildPackages.hsc2hs or (pkgs.buildPackages.hsc2hs or ((hsPkgs.pkgs-errors).buildToolDepError "hsc2hs")));
        buildable = true;
        };
      exes = {
        "marmalade-upload" = {
