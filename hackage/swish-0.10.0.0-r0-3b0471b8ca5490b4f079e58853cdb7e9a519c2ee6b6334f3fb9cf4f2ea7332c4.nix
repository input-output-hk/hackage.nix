{ system, compiler, flags, pkgs, hsPkgs, pkgconfPkgs, ... }:
  {
    ...
    package = {
      specVersion = "1.9.2";
      identifier = { name = "swish"; version = "0.10.0.0"; };
      ...
      "library" = {
        depends = ([
          ...
          then [
            ...
            ])) ++ (pkgs.lib).optional (compiler.isGhc && (compiler.version).lt "8.0.0") (hsPkgs."semigroups" or ((hsPkgs.pkgs-errors).buildDepError "semigroups"));
        buildable = true;
        };
      exes = {
        "Swish" = {
