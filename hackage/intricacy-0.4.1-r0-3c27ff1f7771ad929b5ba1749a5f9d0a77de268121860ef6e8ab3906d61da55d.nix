{ system
  ...
  , ... }:
  {
    ...
    package = {
      specVersion = "1.8";
      identifier = { name = "intricacy"; version = "0.4.1"; };
    ...
    components = {
      exes = {
        "intricacy" = {
          ...
          ])) ++ pkgs.lib.optional (flags.curses) (hsPkgs."hscurses" or (errorHandler.buildDepError "hscurses"))) ++ pkgs.lib.optionals (!flags.sdl) (pkgs.lib.optional (!flags.curses) (hsPkgs."Unsatisfiable" or (errorHandler.buildDepError "Unsatisfiable")));
