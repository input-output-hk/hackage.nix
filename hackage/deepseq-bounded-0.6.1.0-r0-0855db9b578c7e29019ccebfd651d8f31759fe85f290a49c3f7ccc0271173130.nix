{ system
  ...
  , ... }:
  {
    ...
    package = {
      specVersion = "1.18";
      identifier = { name = "deepseq-bounded"; version = "0.6.1.0"; };
    ...
    components = {
      "library" = {
        depends = ((((((([
          ...
          (hsPkgs."deepseq" or (errorHandler.buildDepError "deepseq"))
        ] ++ pkgs.lib.optional (!flags.haskell98_fragment) (hsPkgs."deepseq-generics" or (errorHandler.buildDepError "deepseq-generics")))) ++ pkgs.lib.optionals (!flags.haskell98_fragment) (pkgs.lib.optional (flags.use_sop) (hsPkgs."generics-sop" or (errorHandler.buildDepError "generics-sop")))) ++ pkgs.lib.optionals (flags.new_improved_pattern_grammar) (pkgs.lib.optionals (!flags.haskell98_fragment) (pkgs.lib.optionals (flags.use_attoparsec) [
        ...
        build-tools = pkgs.lib.optional (flags.use_cpphs) (hsPkgs.pkgsBuildBuild.cpphs.components.exes.cpphs or (pkgs.pkgsBuildBuild.cpphs or (errorHandler.buildToolDepError "cpphs:cpphs")));
        buildable = true;
      };
      tests = {
