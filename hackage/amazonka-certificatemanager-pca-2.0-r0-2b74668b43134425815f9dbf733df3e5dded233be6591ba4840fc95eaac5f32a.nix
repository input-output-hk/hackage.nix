    ...
    components = {
      ...
      tests = {
        "amazonka-certificatemanager-pca-test" = {
          depends = [
            (hsPkgs."amazonka-certificatemanager-pca" or (errorHandler.buildDepError "amazonka-certificatemanager-pca"))
            (hsPkgs."amazonka-core" or (errorHandler.buildDepError "amazonka-core"))
