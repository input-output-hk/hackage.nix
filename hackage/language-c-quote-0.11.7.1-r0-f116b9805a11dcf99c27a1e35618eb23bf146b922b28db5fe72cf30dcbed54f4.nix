{ system, compiler, flags, pkgs, hsPkgs, pkgconfPkgs, ... }:
  {
    ...
    package = {
      specVersion = "1.10";
      identifier = { name = "language-c-quote"; version = "0.11.7.1"; };
    ...
    components = {
      "library" = {
        depends = [
          ...
          then (pkgs.lib).optional (compiler.isGhc && (compiler.version).lt "7.8") (hsPkgs."safe" or ((hsPkgs.pkgs-errors).buildDepError "safe")) ++ [
