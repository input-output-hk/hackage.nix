{ system
  ...
  , ... }:
  {
    ...
    package = {
      specVersion = "2.4";
      identifier = { name = "explainable-predicates"; version = "0.1.1.0"; };
    ...
    components = {
      "library" = {
        ...
        ] ++ pkgs.lib.optional (flags.regex) (hsPkgs."regex-tdfa" or (errorHandler.buildDepError "regex-tdfa"))) ++ pkgs.lib.optional (flags.containers) (hsPkgs."mono-traversable" or (errorHandler.buildDepError "mono-traversable"))) ++ pkgs.lib.optional (flags.quickcheck) (hsPkgs."QuickCheck" or (errorHandler.buildDepError "QuickCheck"));
        buildable = true;
      };
      tests = {
        "tests" = {
