{ system
  ...
  , ... }:
  {
    ...
    package = {
      specVersion = "2.2";
      identifier = { name = "amazonka-appconfig"; version = "2.0"; };
      license = "MPL-2.0";
    ...
    components = {
      ...
      tests = {
        "amazonka-appconfig-test" = {
          depends = [
            (hsPkgs."amazonka-appconfig" or (errorHandler.buildDepError "amazonka-appconfig"))
            (hsPkgs."amazonka-core" or (errorHandler.buildDepError "amazonka-core"))
