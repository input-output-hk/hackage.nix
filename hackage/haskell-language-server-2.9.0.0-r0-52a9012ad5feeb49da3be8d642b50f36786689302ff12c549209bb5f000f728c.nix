{ system
  ...
  , ... }:
  {
    ...
    package = {
      specVersion = "3.4";
      identifier = { name = "haskell-language-server"; version = "2.9.0.0"; };
      license = "Apache-2.0";
    ...
    components = {
      ...
      sublibs = {
        ...
        "hls-hlint-plugin" = {
          ...
          buildable = if !(flags.hlint && (compiler.isGhc && compiler.version.lt "9.10"))
            then false
            else true;
        };
        "hls-stan-plugin" = {
      ...
      benchmarks = {
        "benchmark" = {
          ...
          build-tools = [
            (hsPkgs.buildPackages.haskell-language-server.components.exes.ghcide-bench or (pkgs.buildPackages.ghcide-bench or (errorHandler.buildToolDepError "haskell-language-server:ghcide-bench")))
