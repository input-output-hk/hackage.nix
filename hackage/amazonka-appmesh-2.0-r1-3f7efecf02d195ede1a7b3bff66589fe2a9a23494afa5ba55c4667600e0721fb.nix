{ system
  ...
  , ... }:
  {
    ...
    package = {
      specVersion = "2.2";
      identifier = { name = "amazonka-appmesh"; version = "2.0"; };
      license = "MPL-2.0";
    ...
    components = {
      ...
      tests = {
        "amazonka-appmesh-test" = {
          depends = [
            (hsPkgs."amazonka-appmesh" or (errorHandler.buildDepError "amazonka-appmesh"))
            (hsPkgs."amazonka-core" or (errorHandler.buildDepError "amazonka-core"))
