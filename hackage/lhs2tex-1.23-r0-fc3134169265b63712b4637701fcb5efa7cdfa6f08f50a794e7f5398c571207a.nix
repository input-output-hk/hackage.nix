{ system, compiler, flags, pkgs, hsPkgs, pkgconfPkgs, ... }:
  {
    ...
    package = {
      specVersion = "1.10";
      identifier = { name = "lhs2tex"; version = "1.23"; };
      ...
      setup-depends = [
        ...
        (hsPkgs.buildPackages.regex-compat or (pkgs.buildPackages.regex-compat or ((hsPkgs.pkgs-errors).buildToolDepError "regex-compat")))
        ];
      };
    components = {
      exes = {
