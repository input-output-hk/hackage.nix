      ...
      "library" = {
        depends = ((((if flags.splitbase
          then [
            ...
            (hsPkgs."base" or (buildDepError "base"))
            ]) ++ (pkgs.lib).optional (system.isLinux) (hsPkgs."unix" or (buildDepError "unix"))) ++ (pkgs.lib).optional (system.isFreebsd) (hsPkgs."unix" or (buildDepError "unix"))) ++ (pkgs.lib).optional (system.isOpenbsd || system.isNetbsd) (hsPkgs."unix" or (buildDepError "unix"))) ++ (pkgs.lib).optional (system.isSolaris) (hsPkgs."unix" or (buildDepError "unix"));
