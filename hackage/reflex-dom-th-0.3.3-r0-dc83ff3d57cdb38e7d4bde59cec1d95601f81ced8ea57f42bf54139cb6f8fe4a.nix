{ system
  ...
  , ... }:
  {
    ...
    package = {
      specVersion = "2.4";
      identifier = { name = "reflex-dom-th"; version = "0.3.3"; };
    ...
    components = {
      "library" = {
        depends = [
          ...
          (hsPkgs."megaparsec" or (errorHandler.buildDepError "megaparsec"))
          (hsPkgs."gettext-th" or (errorHandler.buildDepError "gettext-th"))
      ...
      tests = {
        "test-reflex-dom-th" = {
          depends = [
            ...
            (hsPkgs."reflex-dom-th" or (errorHandler.buildDepError "reflex-dom-th"))
