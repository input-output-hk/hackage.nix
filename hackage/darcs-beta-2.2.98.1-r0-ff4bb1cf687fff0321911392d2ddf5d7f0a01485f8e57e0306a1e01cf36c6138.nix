{ system
  ...
  , ... }:
  {
    ...
    package = {
      specVersion = "1.6";
      identifier = { name = "darcs-beta"; version = "2.2.98.1"; };
        ...
        "unit" = {
          depends = ((((((pkgs.lib).optionals (!(!flags.test)) [
            ...
            then [
              ...
              (hsPkgs."base" or (errorHandler.buildDepError "base"))
              ])) ++ (pkgs.lib).optional (flags.mmap && !system.isWindows) (hsPkgs."mmap" or (errorHandler.buildDepError "mmap"))) ++ (pkgs.lib).optional (flags.bytestring) (hsPkgs."bytestring" or (errorHandler.buildDepError "bytestring"))) ++ (pkgs.lib).optional (flags.zlib) (hsPkgs."zlib" or (errorHandler.buildDepError "zlib"))) ++ (pkgs.lib).optional (flags.terminfo && !system.isWindows) (hsPkgs."terminfo" or (errorHandler.buildDepError "terminfo"));
