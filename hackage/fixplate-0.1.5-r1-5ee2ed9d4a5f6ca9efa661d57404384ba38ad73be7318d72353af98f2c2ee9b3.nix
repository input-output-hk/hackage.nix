    ...
    components = {
      "library" = {
        depends = ([
          ...
          ] ++ (pkgs.lib).optional (flags.withutils) (hsPkgs."containers" or (buildDepError "containers"))) ++ (pkgs.lib).optional (flags.withquickcheck) (hsPkgs."QuickCheck" or (buildDepError "QuickCheck"));
        buildable = true;
        };
      };
    }