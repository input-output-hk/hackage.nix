{ system
  ...
  , ... }:
  {
    flags = { dev = false; library-only = false; usebuildinfo = false; };
    package = {
      specVersion = "2.2";
      identifier = { name = "espial"; version = "0.0.38"; };
    ...
    components = {
      "library" = {
        ...
        ] ++ pkgs.lib.optional (!system.isWindows) (hsPkgs."unix" or (errorHandler.buildDepError "unix"))) ++ pkgs.lib.optionals (flags.dev || flags.library-only) [
