    ...
    components = {
      "library" = {
        ...
        build-tools = (pkgs.lib).optionals (flags.embed_data_files) ([
          (hsPkgs.buildPackages.hsb2hs or (pkgs.buildPackages.hsb2hs or ((hsPkgs.pkgs-errors).buildToolDepError "hsb2hs")))
          ] ++ (pkgs.lib).optional (system.isOsx) (hsPkgs.buildPackages.cpphs or (pkgs.buildPackages.cpphs or ((hsPkgs.pkgs-errors).buildToolDepError "cpphs"))));
        buildable = true;
        };
      exes = {
        "pandoc-citeproc" = {
