    ...
    components = {
      "library" = {
        depends = [
          ...
          (hsPkgs."casr-logbook-meta" or (buildDepError "casr-logbook-meta"))
          (hsPkgs."casr-logbook-meta-html" or (buildDepError "casr-logbook-meta-html"))
          (hsPkgs."casr-logbook-reports" or (buildDepError "casr-logbook-reports"))
          (hsPkgs."casr-logbook-reports-meta" or (buildDepError "casr-logbook-reports-meta"))
          (hsPkgs."casr-logbook-reports-html" or (buildDepError "casr-logbook-reports-html"))
