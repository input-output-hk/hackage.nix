{ system
  ...
  , ... }:
  {
    flags = {
      ...
      amazonka = true;
      blockfrost = true;
      testcontainers-localstack = true;
    };
    package = {
      specVersion = "3.4";
      identifier = { name = "effectful-zoo"; version = "0.0.6.0"; };
    ...
    components = {
      sublibs = {
        ...
        "amazonka" = {
          ...
          buildable = if !flags.amazonka then false else true;
        };
        "blockfrost" = {
          depends = [
            (hsPkgs."base" or (errorHandler.buildDepError "base"))
          ...
          buildable = if !flags.blockfrost then false else true;
        };
        "rds-data" = {
          depends = [
            (hsPkgs."base" or (errorHandler.buildDepError "base"))
        ...
        "rds-data-test" = {
          ...
          buildable = (if !flags.amazonka
            then false
            else true) && (if !flags.testcontainers-localstack
            then false
            else true);
        };
        "hedgehog" = {
