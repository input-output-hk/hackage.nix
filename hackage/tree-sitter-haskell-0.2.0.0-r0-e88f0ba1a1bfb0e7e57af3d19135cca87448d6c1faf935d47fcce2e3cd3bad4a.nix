    ...
    components = {
      "library" = {
        depends = [
          ...
          (hsPkgs."tree-sitter-haskell-internal" or ((hsPkgs.pkgs-errors).buildDepError "tree-sitter-haskell-internal"))
          ];
        buildable = true;
        };
      sublibs = {
      ...
      exes = {
        "demo" = {
          depends = [
            (hsPkgs."base" or ((hsPkgs.pkgs-errors).buildDepError "base"))
            (hsPkgs."tree-sitter" or ((hsPkgs.pkgs-errors).buildDepError "tree-sitter"))
            (hsPkgs."tree-sitter-haskell" or ((hsPkgs.pkgs-errors).buildDepError "tree-sitter-haskell"))
            ];
