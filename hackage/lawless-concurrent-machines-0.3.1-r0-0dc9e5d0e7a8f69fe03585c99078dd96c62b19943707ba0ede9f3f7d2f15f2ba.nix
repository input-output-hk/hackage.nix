{ system, compiler, flags, pkgs, hsPkgs, pkgconfPkgs, ... }:
  {
    ...
    package = {
      specVersion = "1.10";
      identifier = { name = "lawless-concurrent-machines"; version = "0.3.1"; };
    ...
    components = {
      ...
      tests = {
        "tests" = {
          depends = [
            (hsPkgs."base" or ((hsPkgs.pkgs-errors).buildDepError "base"))
            (hsPkgs."lawless-concurrent-machines" or ((hsPkgs.pkgs-errors).buildDepError "lawless-concurrent-machines"))
            (hsPkgs."machines" or ((hsPkgs.pkgs-errors).buildDepError "machines"))
