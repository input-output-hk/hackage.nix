{ system
  ...
  , ... }:
  {
    ...
    components = {
      ...
      tests = {
        "amazonka-license-manager-user-subscriptions-test" = {
          depends = [
            (hsPkgs."amazonka-core" or (errorHandler.buildDepError "amazonka-core"))
            (hsPkgs."amazonka-license-manager-user-subscriptions" or (errorHandler.buildDepError "amazonka-license-manager-user-subscriptions"))
