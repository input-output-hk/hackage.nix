{ system, compiler, flags, pkgs, hsPkgs, pkgconfPkgs, ... }:
  {
    ...
    package = {
      specVersion = "1.4";
      identifier = { name = "bindings-gts"; version = "0.0.2"; };
    ...
    components = {
      "library" = {
        ...
        pkgconfig = [
          ...
          (pkgconfPkgs."gmodule-2.0" or ((hsPkgs.pkgs-errors).pkgConfDepError "gmodule-2.0"))
          (pkgconfPkgs."gts" or ((hsPkgs.pkgs-errors).pkgConfDepError "gts"))
          ];
        buildable = true;
        };
      };
