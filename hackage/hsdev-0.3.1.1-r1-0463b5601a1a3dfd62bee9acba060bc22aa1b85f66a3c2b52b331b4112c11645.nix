...
in { system, compiler, flags, pkgs, hsPkgs, pkgconfPkgs, ... }:
  {
    ...
    package = {
      specVersion = "1.8";
      identifier = { name = "hsdev"; version = "0.3.1.1"; };
    ...
    components = {
      "library" = {
        depends = (((([
          ...
          ] ++ (pkgs.lib).optional (flags.docs) (hsPkgs."haddock-api" or (buildDepError "haddock-api")))) ++ (pkgs.lib).optionals (compiler.isGhc && (compiler.version).ge "8.0" && (compiler.isGhc && (compiler.version).lt "8.2")) ([
          (hsPkgs."ghc" or (buildDepError "ghc"))
          (hsPkgs."ghc-boot" or (buildDepError "ghc-boot"))
          (hsPkgs."directory" or (buildDepError "directory"))
          ] ++ (pkgs.lib).optional (flags.docs) (hsPkgs."haddock-api" or (buildDepError "haddock-api")))) ++ (pkgs.lib).optionals (compiler.isGhc && (compiler.version).lt "8.0") ([
          (hsPkgs."ghc" or (buildDepError "ghc"))
          (hsPkgs."bin-package-db" or (buildDepError "bin-package-db"))
          (hsPkgs."directory" or (buildDepError "directory"))
          ] ++ (pkgs.lib).optional (flags.docs) (hsPkgs."haddock-api" or (buildDepError "haddock-api")))) ++ (pkgs.lib).optional (flags.docs) (hsPkgs."hdocs" or (buildDepError "hdocs"));
        buildable = true;
        };
      exes = {
        "hsdev" = {
