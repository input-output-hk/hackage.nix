{ system, compiler, flags, pkgs, hsPkgs, pkgconfPkgs, ... }:
  {
    ...
    package = {
      specVersion = "1.10";
      identifier = { name = "pathwalk"; version = "0.3.0.0"; };
      license = "MIT";
      copyright = "";
    ...
    components = {
      ...
      tests = {
        "basic" = { depends = [ (hsPkgs.base) (hsPkgs.pathwalk) ]; };
        "stoprecursing" = { depends = [ (hsPkgs.base) (hsPkgs.pathwalk) ]; };
        "lazy" = { depends = [ (hsPkgs.base) (hsPkgs.pathwalk) ]; };
        };
      };
    }