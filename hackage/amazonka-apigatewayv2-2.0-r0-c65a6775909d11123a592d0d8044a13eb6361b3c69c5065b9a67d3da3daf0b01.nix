{ system
  ...
  , ... }:
  {
    ...
    package = {
      specVersion = "2.2";
      identifier = { name = "amazonka-apigatewayv2"; version = "2.0"; };
      license = "MPL-2.0";
    ...
    components = {
      ...
      tests = {
        "amazonka-apigatewayv2-test" = {
          depends = [
            (hsPkgs."amazonka-apigatewayv2" or (errorHandler.buildDepError "amazonka-apigatewayv2"))
            (hsPkgs."amazonka-core" or (errorHandler.buildDepError "amazonka-core"))
