{ system
  ...
  , ... }:
  {
    ...
    package = {
      specVersion = "2.2";
      identifier = { name = "amazonka-auditmanager"; version = "2.0"; };
      license = "MPL-2.0";
    ...
    components = {
      ...
      tests = {
        "amazonka-auditmanager-test" = {
          depends = [
            (hsPkgs."amazonka-auditmanager" or (errorHandler.buildDepError "amazonka-auditmanager"))
            (hsPkgs."amazonka-core" or (errorHandler.buildDepError "amazonka-core"))
