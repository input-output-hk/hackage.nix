      ...
      exes = {
        "hdevtools" = {
          depends = (([
            ...
            ] ++ (pkgs.lib).optional (compiler.isGhc && false) (hsPkgs."Cabal" or ((hsPkgs.pkgs-errors).buildDepError "Cabal"))) ++ (pkgs.lib).optional (compiler.isGhc && (compiler.version).ge "7.7") (hsPkgs."Cabal" or ((hsPkgs.pkgs-errors).buildDepError "Cabal"))) ++ (pkgs.lib).optional (compiler.isGhc && (compiler.version).ge "7.9") (hsPkgs."Cabal" or ((hsPkgs.pkgs-errors).buildDepError "Cabal"));
          buildable = true;
          };
        };
      };
