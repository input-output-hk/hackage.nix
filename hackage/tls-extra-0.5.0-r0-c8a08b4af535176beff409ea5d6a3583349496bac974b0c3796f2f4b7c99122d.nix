    ...
    components = {
      "library" = {
        depends = [
          ...
          ] ++ (pkgs.lib).optional (system.isLinux && flags.fastaes && (system.isI386 || system.isX86_64)) (hsPkgs."cipher-aes" or (errorHandler.buildDepError "cipher-aes"));
        buildable = true;
        };
      exes = {
        "Tests" = {
          depends = (pkgs.lib).optionals (flags.test) [
            ...
            ] ++ (pkgs.lib).optional (system.isLinux && flags.fastaes) (hsPkgs."cipher-aes" or (errorHandler.buildDepError "cipher-aes"));
