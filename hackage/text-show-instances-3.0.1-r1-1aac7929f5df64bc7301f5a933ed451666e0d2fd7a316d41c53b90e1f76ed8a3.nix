{ system, compiler, flags, pkgs, hsPkgs, pkgconfPkgs, ... }:
  {
    ...
    package = {
      specVersion = "1.10";
      identifier = { name = "text-show-instances"; version = "3.0.1"; };
      ...
      tests = {
        "spec" = {
          depends = ([
            ...
            (hsPkgs."vector" or ((hsPkgs.pkgs-errors).buildDepError "vector"))
            (hsPkgs."xhtml" or ((hsPkgs.pkgs-errors).buildDepError "xhtml"))
            ] ++ (pkgs.lib).optional (!flags.developer) (hsPkgs."text-show-instances" or ((hsPkgs.pkgs-errors).buildDepError "text-show-instances"))) ++ (if system.isWindows
            then [
              (hsPkgs."Win32" or ((hsPkgs.pkgs-errors).buildDepError "Win32"))
              ]
            else [
