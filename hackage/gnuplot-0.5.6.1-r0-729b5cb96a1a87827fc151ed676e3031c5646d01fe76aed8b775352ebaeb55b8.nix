{ system, compiler, flags, pkgs, hsPkgs, pkgconfPkgs, ... }:
  {
    ...
    package = {
      specVersion = "1.8";
      identifier = { name = "gnuplot"; version = "0.5.6.1"; };
    ...
    components = {
      "library" = {
        depends = [
          ...
          ] ++ (pkgs.lib).optionals (!flags.executepipe) ((pkgs.lib).optional (flags.executeshell) (hsPkgs."shell-utility" or ((hsPkgs.pkgs-errors).buildDepError "shell-utility")));
        buildable = true;
        };
      exes = {
        "gnuplot-demo" = {
