...
in { system, compiler, flags, pkgs, hsPkgs, pkgconfPkgs, ... }:
  {
    ...
    package = {
      specVersion = "2.2";
      identifier = { name = "arbor-monad-metric-datadog"; version = "1.1.0"; };
      license = "MIT";
    ...
    components = {
      "library" = {
        depends = [
          ...
          (hsPkgs."arbor-monad-metric" or (buildDepError "arbor-monad-metric"))
      ...
      tests = {
        "arbor-monad-metric-datadog-test" = {
          depends = [
            ...
            (hsPkgs."arbor-datadog" or (buildDepError "arbor-datadog"))
            (hsPkgs."arbor-monad-metric" or (buildDepError "arbor-monad-metric"))
            (hsPkgs."arbor-monad-metric-datadog" or (buildDepError "arbor-monad-metric-datadog"))
            (hsPkgs."bytestring" or (buildDepError "bytestring"))
            (hsPkgs."containers" or (buildDepError "containers"))
