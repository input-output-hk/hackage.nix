{ system
  ...
  , ... }:
  {
    ...
    package = {
      specVersion = "1.12";
      identifier = { name = "posit"; version = "2022.2.0.1"; };
    ...
    components = {
      "library" = {
        ...
        ] ++ pkgs.lib.optional (!flags.do-liquid) (hsPkgs."base" or (errorHandler.buildDepError "base"))) ++ pkgs.lib.optional (!flags.do-no-storable-random) (hsPkgs."random" or (errorHandler.buildDepError "random"));
        buildable = true;
      };
      tests = {
        "posit-test" = {
