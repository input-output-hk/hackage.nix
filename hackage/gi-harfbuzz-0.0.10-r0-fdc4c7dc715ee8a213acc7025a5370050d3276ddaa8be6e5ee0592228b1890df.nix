{ system
  ...
  , ... }:
  {
    ...
    package = {
      specVersion = "2.0";
      identifier = { name = "gi-harfbuzz"; version = "0.0.10"; };
      ...
      setup-depends = [
        ...
        (hsPkgs.pkgsBuildBuild.gi-freetype2 or (pkgs.pkgsBuildBuild.gi-freetype2 or (errorHandler.setupDepError "gi-freetype2")))
      ];
    };
    components = {
      "library" = {
        depends = [
          ...
          (hsPkgs."gi-freetype2" or (errorHandler.buildDepError "gi-freetype2"))
