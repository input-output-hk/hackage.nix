{ system
  ...
  , ... }:
  {
    ...
    package = {
      specVersion = "2.4";
      identifier = { name = "pms-infra-agent-socket"; version = "0.0.2.0"; };
      license = "Apache-2.0";
      ...
      tests = {
        "pms-infra-agent-socket-test" = {
          depends = [
            ...
            (hsPkgs."network" or (errorHandler.buildDepError "network"))
            (hsPkgs."pms-domain-model" or (errorHandler.buildDepError "pms-domain-model"))
            (hsPkgs."pms-infra-agent-socket" or (errorHandler.buildDepError "pms-infra-agent-socket"))
          ];
          build-tools = [
