      ...
      "library" = {
        depends = (([
          ...
          then [
            ...
            ])) ++ (pkgs.lib).optional (flags.cereal) (hsPkgs."cereal" or ((hsPkgs.pkgs-errors).buildDepError "cereal"))) ++ (pkgs.lib).optional (flags.cryptoapi) (hsPkgs."crypto-api" or ((hsPkgs.pkgs-errors).buildDepError "crypto-api"));
        buildable = true;
        };
      benchmarks = {
        "bench-cprng-aes" = {
