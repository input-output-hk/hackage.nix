{ system
  ...
  , ... }:
  {
    ...
    components = {
      ...
      tests = {
        "amazonka-license-manager-linux-subscriptions-test" = {
          depends = [
            (hsPkgs."amazonka-core" or (errorHandler.buildDepError "amazonka-core"))
            (hsPkgs."amazonka-license-manager-linux-subscriptions" or (errorHandler.buildDepError "amazonka-license-manager-linux-subscriptions"))
