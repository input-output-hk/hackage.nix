    ...
    components = {
      "library" = {
        depends = ([
          ...
          ] ++ (pkgs.lib).optional (flags.barbies) (hsPkgs."barbies" or ((hsPkgs.pkgs-errors).buildDepError "barbies"))) ++ (pkgs.lib).optional (flags.cassava) (hsPkgs."cassava" or ((hsPkgs.pkgs-errors).buildDepError "cassava"));
        buildable = true;
        };
      tests = {
        "bits" = {
