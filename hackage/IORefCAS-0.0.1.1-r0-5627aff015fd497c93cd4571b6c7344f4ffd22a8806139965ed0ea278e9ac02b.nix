{ system, compiler, flags, pkgs, hsPkgs, pkgconfPkgs, ... }:
  {
    ...
    package = {
      specVersion = "1.8";
      identifier = { name = "IORefCAS"; version = "0.0.1.1"; };
    ...
    components = {
      "library" = {
        depends = [ (hsPkgs.base) (hsPkgs.ghc-prim) (hsPkgs.bits-atomic) ];
        };
      tests = {
        "test-IORefCAS" = {
          depends = [ (hsPkgs.QuickCheck) (hsPkgs.HUnit) (hsPkgs.bits-atomic) ];
          };
        };
      };
    }