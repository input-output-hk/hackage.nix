{ system, compiler, flags, pkgs, hsPkgs, pkgconfPkgs, ... }:
  {
    ...
    package = {
      specVersion = "1.2";
      identifier = { name = "HXQ"; version = "0.11.0"; };
    ...
    components = {
      "library" = {
        depends = ([
          ...
          ] ++ (pkgs.lib).optional (!system.isWindows) (hsPkgs."readline" or ((hsPkgs.pkgs-errors).buildDepError "readline"))) ++ (if flags.mysql
          then [
      ...
      exes = {
        "xquery" = {
          depends = (pkgs.lib).optional (!system.isWindows) (hsPkgs."readline" or ((hsPkgs.pkgs-errors).buildDepError "readline")) ++ (if flags.mysql
            then [
              (hsPkgs."HDBC" or ((hsPkgs.pkgs-errors).buildDepError "HDBC"))
              (hsPkgs."HDBC-odbc" or ((hsPkgs.pkgs-errors).buildDepError "HDBC-odbc"))
              ]
