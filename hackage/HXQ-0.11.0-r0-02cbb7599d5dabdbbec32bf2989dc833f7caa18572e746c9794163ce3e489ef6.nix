    ...
    components = {
      "library" = {
        depends = ([
          ...
          ] ++ (pkgs.lib).optional (!system.isWindows) (hsPkgs."readline" or (buildDepError "readline"))) ++ (if flags.mysql
          then [
      ...
      exes = {
        "xquery" = {
          depends = (pkgs.lib).optional (!system.isWindows) (hsPkgs."readline" or (buildDepError "readline")) ++ (if flags.mysql
            then [
              (hsPkgs."HDBC" or (buildDepError "HDBC"))
              (hsPkgs."HDBC-odbc" or (buildDepError "HDBC-odbc"))
              ]
