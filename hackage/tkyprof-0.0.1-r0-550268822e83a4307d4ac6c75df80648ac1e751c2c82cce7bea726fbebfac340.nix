      ...
      exes = {
        "tkyprof" = {
          depends = [
            ...
            ] ++ (pkgs.lib).optionals (flags.production) ((pkgs.lib).optional (!flags.web) (hsPkgs."wai-handler-webkit" or ((hsPkgs.pkgs-errors).buildDepError "wai-handler-webkit")));
          pkgconfig = (pkgs.lib).optionals (flags.production) ((pkgs.lib).optional (!flags.web) (pkgconfPkgs."QtWebKit" or ((hsPkgs.pkgs-errors).pkgConfDepError "QtWebKit")));
