{ system
  ...
  , ... }:
  {
    flags = {
      ...
      version-with-git-hash = false;
    };
    package = {
      specVersion = "2.4";
      identifier = { name = "Agda"; version = "2.8.0.2"; };
      license = "MIT";
      copyright = "(c) 2005-2026 The Agda Team.";
    ...
    components = {
      "library" = {
        ...
        ] ++ pkgs.lib.optional (flags.enable-cluster-counting) (hsPkgs."text-icu" or (errorHandler.buildDepError "text-icu"))) ++ pkgs.lib.optional (flags.version-with-git-hash) (hsPkgs."gitrev" or (errorHandler.buildDepError "gitrev"))) ++ pkgs.lib.optional (system.isWindows) (hsPkgs."Win32" or (errorHandler.buildDepError "Win32"))) ++ pkgs.lib.optional (compiler.isGhc && compiler.version.lt "9.2") (hsPkgs."th-lift-instances" or (errorHandler.buildDepError "th-lift-instances"));
        build-tools = [
      ...
      exes = {
        ...
        "agda-mode" = {
          depends = ([
            ...
            (hsPkgs."process" or (errorHandler.buildDepError "process"))
            (hsPkgs."template-haskell" or (errorHandler.buildDepError "template-haskell"))
          ] ++ pkgs.lib.optional (compiler.isGhc && compiler.version.lt "9.2") (hsPkgs."th-lift-instances" or (errorHandler.buildDepError "th-lift-instances"))) ++ pkgs.lib.optional (flags.version-with-git-hash) (hsPkgs."gitrev" or (errorHandler.buildDepError "gitrev"));
          buildable = true;
        };
      };
    };
