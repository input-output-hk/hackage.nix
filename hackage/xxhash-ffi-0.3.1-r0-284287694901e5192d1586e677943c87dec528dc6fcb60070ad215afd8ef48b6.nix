{ system
  ...
  , ... }:
  {
    ...
    package = {
      specVersion = "2.2";
      identifier = { name = "xxhash-ffi"; version = "0.3.1"; };
    ...
    components = {
      "library" = {
        ...
        pkgconfig = pkgs.lib.optional (flags.pkg-config && (compiler.isGhc && compiler.version.ge "8.10")) (pkgconfPkgs."libxxhash" or (errorHandler.pkgConfDepError "libxxhash"));
        buildable = true;
      };
      tests = {
        "xxhash-ffi-test" = {
