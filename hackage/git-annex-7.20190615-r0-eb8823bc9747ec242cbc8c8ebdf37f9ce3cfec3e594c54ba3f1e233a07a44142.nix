{ system, compiler, flags, pkgs, hsPkgs, pkgconfPkgs, ... }:
  {
    ...
    package = {
      specVersion = "1.8";
      identifier = { name = "git-annex"; version = "7.20190615"; };
      ...
      exes = {
        "git-annex" = {
          depends = (((((((((([
            ...
            ]) ++ (pkgs.lib).optional (flags.torrentparser) (hsPkgs."torrent" or ((hsPkgs.pkgs-errors).buildDepError "torrent"))) ++ (pkgs.lib).optionals (flags.magicmime) ((pkgs.lib).optional (!system.isWindows) (hsPkgs."magic" or ((hsPkgs.pkgs-errors).buildDepError "magic")))) ++ (pkgs.lib).optionals (flags.benchmark) [
