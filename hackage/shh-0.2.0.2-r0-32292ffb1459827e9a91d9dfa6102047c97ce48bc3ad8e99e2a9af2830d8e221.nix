{ system
  ...
  , ... }:
  {
    ...
    package = {
      specVersion = "1.10";
      identifier = { name = "shh"; version = "0.2.0.2"; };
      ...
      exes = {
        "shh-example" = {
          ...
          build-tools = [
            ...
            (hsPkgs.pkgsBuildBuild.vault.components.exes.vault or (pkgs.pkgsBuildBuild.vault or (errorHandler.buildToolDepError "vault:vault")))
