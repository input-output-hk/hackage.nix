{ system, compiler, flags, pkgs, hsPkgs, pkgconfPkgs, ... }:
  {
    ...
    components = {
      "library" = {
        ...
        libs = (pkgs.lib).optionals (flags.use-system-library) ((pkgs.lib).optional (!flags.pkg-config) (pkgs."argon2" or ((hsPkgs.pkgs-errors).sysDepError "argon2")));
        pkgconfig = (pkgs.lib).optionals (flags.use-system-library) ((pkgs.lib).optional (flags.pkg-config) (pkgconfPkgs."libargon2" or ((hsPkgs.pkgs-errors).pkgConfDepError "libargon2")));
        buildable = true;
        };
      tests = {
        "tests" = {
