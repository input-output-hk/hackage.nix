    ...
    components = {
      "library" = {
        depends = ([
          ...
          ] ++ (pkgs.lib).optional (compiler.isGhc && false) (hsPkgs."base" or ((hsPkgs.pkgs-errors).buildDepError "base"))) ++ (pkgs.lib).optional (compiler.isGhc && false) (hsPkgs."base" or ((hsPkgs.pkgs-errors).buildDepError "base"));
        libs = [
          (pkgs."dttools" or ((hsPkgs.pkgs-errors).sysDepError "dttools"))
          ];
        build-tools = [
