    ...
    components = {
      "library" = {
        depends = [
          ...
          (hsPkgs."ffi" or ((hsPkgs.pkgs-errors).buildDepError "ffi"))
          (hsPkgs."greencard" or ((hsPkgs.pkgs-errors).buildDepError "greencard"))
          ];
        build-tools = [
          (hsPkgs.buildPackages.greencard or (pkgs.buildPackages.greencard or ((hsPkgs.pkgs-errors).buildToolDepError "greencard")))
          ];
        buildable = true;
        };
      };
