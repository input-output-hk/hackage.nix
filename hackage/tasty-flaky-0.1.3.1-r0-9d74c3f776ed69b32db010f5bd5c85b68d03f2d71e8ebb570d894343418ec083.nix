{ system
  ...
  , ... }:
  {
    ...
    package = {
      specVersion = "3.4";
      identifier = { name = "tasty-flaky"; version = "0.1.3.1"; };
      ...
      description = "This package allows to retry Tasty-based tests that are expected to fail intermittently -- also known as flaky tests.";
      buildType = "Simple";
    };
    components = {
      "library" = {
