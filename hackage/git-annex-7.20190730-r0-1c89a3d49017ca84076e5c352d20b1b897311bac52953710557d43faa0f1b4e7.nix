{ system, compiler, flags, pkgs, hsPkgs, pkgconfPkgs, ... }:
  {
    ...
    package = {
      specVersion = "1.8";
      identifier = { name = "git-annex"; version = "7.20190730"; };
      ...
      exes = {
        "git-annex" = {
          depends = (((((((((([
            ...
            (hsPkgs.network-info)
            ]) ++ (pkgs.lib).optional (flags.torrentparser) (hsPkgs.torrent)) ++ (pkgs.lib).optionals (flags.magicmime) ((pkgs.lib).optional (!system.isWindows) (hsPkgs.magic))) ++ (pkgs.lib).optional (flags.benchmark) (hsPkgs.criterion);
          };
        };
      };
    }