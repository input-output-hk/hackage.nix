{ system
  ...
  , ... }:
  {
    ...
    package = {
      specVersion = "3.4";
      identifier = { name = "haskell-language-server"; version = "2.13.0.0"; };
      license = "Apache-2.0";
    ...
    components = {
      ...
      sublibs = {
        ...
        "hls-retrie-plugin" = {
          ...
          buildable = if !(flags.retrie && (compiler.isGhc && compiler.version.lt "9.10" || flags.ignore-plugins-ghc-bounds))
            then false
            else true;
        };
        "hls-hlint-plugin" = {
        ...
        "hls-splice-plugin" = {
          ...
          buildable = if !(flags.splice && (compiler.isGhc && compiler.version.lt "9.10" || flags.ignore-plugins-ghc-bounds))
            then false
            else true;
        };
        ...
        "hls-floskell-plugin" = {
          ...
          buildable = if !(flags.floskell && (compiler.isGhc && compiler.version.lt "9.10" || flags.ignore-plugins-ghc-bounds))
            then false
            else true;
        };
        "hls-fourmolu-plugin" = {
          ...
          buildable = if !flags.fourmolu || compiler.isGhc && compiler.version.ge "9.14"
            then false
            else true;
        };
        "hls-ormolu-plugin" = {
          ...
          buildable = if !flags.ormolu || compiler.isGhc && compiler.version.ge "9.14"
            then false
            else true;
        };
