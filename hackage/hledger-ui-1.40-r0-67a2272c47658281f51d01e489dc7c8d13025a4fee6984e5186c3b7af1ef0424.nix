{ system
  ...
  , ... }:
  {
    flags = { ghcdebug = false; threaded = true; };
    package = {
      specVersion = "1.12";
      identifier = { name = "hledger-ui"; version = "1.40"; };
    ...
    components = {
      "library" = {
        ...
        ] ++ pkgs.lib.optional (flags.ghcdebug) (hsPkgs."ghc-debug-stub" or (errorHandler.buildDepError "ghc-debug-stub"))) ++ (if system.isWindows
          then [
