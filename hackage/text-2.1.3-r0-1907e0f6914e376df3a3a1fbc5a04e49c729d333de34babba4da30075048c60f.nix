{ system
  ...
  , ... }:
  {
    ...
    package = {
      specVersion = "2.2";
      identifier = { name = "text"; version = "2.1.3"; };
    ...
    components = {
      ...
      tests = {
        "tests" = {
          ...
          ] ++ pkgs.lib.optional (compiler.isGhc && compiler.version.lt "9.4") (hsPkgs."data-array-byte" or (errorHandler.buildDepError "data-array-byte"))) ++ pkgs.lib.optional (compiler.isGhc && (compiler.version.ge "8.2.1" && compiler.version.lt "8.6" || compiler.version.ge "8.6.2" && compiler.version.lt "9.2" || compiler.version.ge "9.2.2")) (hsPkgs."tasty-inspection-testing" or (errorHandler.buildDepError "tasty-inspection-testing"))) ++ pkgs.lib.optional (system.isOpenbsd) (hsPkgs."splitmix" or (errorHandler.buildDepError "splitmix"));
          buildable = true;
        };
      };
      benchmarks = {
