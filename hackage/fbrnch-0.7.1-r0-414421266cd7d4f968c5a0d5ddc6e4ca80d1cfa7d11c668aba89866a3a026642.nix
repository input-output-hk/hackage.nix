{ system
  ...
  , ... }:
  {
    ...
    package = {
      specVersion = "2.0";
      identifier = { name = "fbrnch"; version = "0.7.1"; };
      ...
      sublibs = {
        ...
        "fedora-dists-internal" = {
          depends = [
            ...
            (hsPkgs."pdc-internal" or (errorHandler.buildDepError "pdc-internal"))
            (hsPkgs."text" or (errorHandler.buildDepError "text"))
            (hsPkgs."time" or (errorHandler.buildDepError "time"))
            ];
          buildable = true;
      ...
      exes = {
        "fbrnch" = {
          depends = [
            ...
            (hsPkgs."base" or (errorHandler.buildDepError "base"))
            (hsPkgs."bodhi-internal" or (errorHandler.buildDepError "bodhi-internal"))
            ...
            (hsPkgs."copr-internal" or (errorHandler.buildDepError "copr-internal"))
            (hsPkgs."directory" or (errorHandler.buildDepError "directory"))
            (hsPkgs."email-validate" or (errorHandler.buildDepError "email-validate"))
            (hsPkgs."extra" or (errorHandler.buildDepError "extra"))
            (hsPkgs."fedora-dists-internal" or (errorHandler.buildDepError "fedora-dists-internal"))
            (hsPkgs."filepath" or (errorHandler.buildDepError "filepath"))
            (hsPkgs."http-conduit" or (errorHandler.buildDepError "http-conduit"))
            (hsPkgs."http-directory" or (errorHandler.buildDepError "http-directory"))
            (hsPkgs."http-query" or (errorHandler.buildDepError "http-query"))
            (hsPkgs."koji-internal" or (errorHandler.buildDepError "koji-internal"))
            (hsPkgs."network-uri" or (errorHandler.buildDepError "network-uri"))
            (hsPkgs."optparse-applicative" or (errorHandler.buildDepError "optparse-applicative"))
            (hsPkgs."pagure-internal" or (errorHandler.buildDepError "pagure-internal"))
