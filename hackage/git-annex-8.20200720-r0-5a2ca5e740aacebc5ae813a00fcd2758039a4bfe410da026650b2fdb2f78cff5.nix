{ system
  ...
  , ... }:
  {
    ...
    package = {
      specVersion = "1.10";
      identifier = { name = "git-annex"; version = "8.20200720"; };
        ...
        "git-annex" = {
          depends = (((((((((((([
            ...
            then [
              ...
              (hsPkgs."network" or (errorHandler.buildDepError "network"))
              (hsPkgs."network" or (errorHandler.buildDepError "network"))
            ])) ++ pkgs.lib.optional (flags.gitlfs) (hsPkgs."git-lfs" or (errorHandler.buildDepError "git-lfs"))) ++ pkgs.lib.optional (flags.httpclientrestricted) (hsPkgs."http-client-restricted" or (errorHandler.buildDepError "http-client-restricted"))) ++ pkgs.lib.optional (flags.s3) (hsPkgs."aws" or (errorHandler.buildDepError "aws"))) ++ pkgs.lib.optional (flags.webdav) (hsPkgs."DAV" or (errorHandler.buildDepError "DAV"))) ++ pkgs.lib.optionals (flags.assistant && !system.isSolaris && !system.isHurd) ([
