{ system, compiler, flags, pkgs, hsPkgs, pkgconfPkgs, ... }:
  {
    ...
    package = {
      specVersion = "1.10";
      identifier = { name = "text-show"; version = "3.2.2"; };
    ...
    components = {
      "library" = {
        depends = [
          ...
          ] ++ (pkgs.lib).optional (compiler.isGhc && (compiler.version).ge "8.0") (hsPkgs."ghc-boot" or ((hsPkgs.pkgs-errors).buildDepError "ghc-boot"));
        buildable = true;
        };
      tests = {
        "spec" = {
          depends = ([
            ...
            (hsPkgs."transformers-compat" or ((hsPkgs.pkgs-errors).buildDepError "transformers-compat"))
            (hsPkgs."void" or ((hsPkgs.pkgs-errors).buildDepError "void"))
            ] ++ (pkgs.lib).optional (compiler.isGhc && (compiler.version).ge "8.0") (hsPkgs."ghc-boot" or ((hsPkgs.pkgs-errors).buildDepError "ghc-boot"))) ++ (pkgs.lib).optional (!flags.developer) (hsPkgs."text-show" or ((hsPkgs.pkgs-errors).buildDepError "text-show"));
          buildable = true;
          };
        };
      benchmarks = {
        "bench" = {
          depends = [
            ...
            (hsPkgs."transformers-compat" or ((hsPkgs.pkgs-errors).buildDepError "transformers-compat"))
            (hsPkgs."void" or ((hsPkgs.pkgs-errors).buildDepError "void"))
            ] ++ (pkgs.lib).optional (!flags.developer) (hsPkgs."text-show" or ((hsPkgs.pkgs-errors).buildDepError "text-show"));
