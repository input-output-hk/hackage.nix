{ system, compiler, flags, pkgs, hsPkgs, pkgconfPkgs, ... }:
  {
    ...
    package = {
      specVersion = "1.8";
      identifier = { name = "git-annex"; version = "6.20160229"; };
      ...
      exes = {
        "git-annex" = {
          depends = ((((((((((((((((([
            ...
            (hsPkgs.gnutls)
            (hsPkgs.xml-types)
            ])) ++ (pkgs.lib).optional (flags.torrentparser) (hsPkgs.torrent)) ++ (pkgs.lib).optionals (flags.magicmime) ((pkgs.lib).optional (!system.isWindows) (hsPkgs.magic))) ++ (pkgs.lib).optional (flags.concurrentoutput) (hsPkgs.concurrent-output)) ++ (pkgs.lib).optional (flags.ekg) (hsPkgs.ekg)) ++ (pkgs.lib).optionals (flags.benchmark) [
            (hsPkgs.criterion)
            (hsPkgs.deepseq)
            ];
          };
