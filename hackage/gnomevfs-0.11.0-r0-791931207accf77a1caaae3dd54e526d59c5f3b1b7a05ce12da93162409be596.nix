{ system, compiler, flags, pkgs, hsPkgs, pkgconfPkgs, ... }:
  {
    ...
    components = {
      "library" = {
        ...
        pkgconfig = [
          (pkgconfPkgs."gnome-vfs-2.0" or ((hsPkgs.pkgs-errors).pkgConfDepError "gnome-vfs-2.0"))
          (pkgconfPkgs."gnome-vfs-module-2.0" or ((hsPkgs.pkgs-errors).pkgConfDepError "gnome-vfs-module-2.0"))
          ];
        build-tools = [
