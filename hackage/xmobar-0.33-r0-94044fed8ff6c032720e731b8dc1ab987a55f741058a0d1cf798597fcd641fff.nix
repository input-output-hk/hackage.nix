{ system, compiler, flags, pkgs, hsPkgs, pkgconfPkgs, ... }:
  {
    ...
    package = {
      specVersion = "1.8";
      identifier = { name = "xmobar"; version = "0.33"; };
    ...
    components = {
      "library" = {
        depends = ((((((((((((([
          ...
          ]) ++ (pkgs.lib).optional (flags.with_utf8 || flags.all_extensions) (hsPkgs."utf8-string" or ((hsPkgs.pkgs-errors).buildDepError "utf8-string"))) ++ (pkgs.lib).optional (flags.with_inotify || flags.all_extensions) (hsPkgs."hinotify" or ((hsPkgs.pkgs-errors).buildDepError "hinotify"))) ++ (pkgs.lib).optional (flags.with_iwlib) (hsPkgs."iwlib" or ((hsPkgs.pkgs-errors).buildDepError "iwlib"))) ++ (pkgs.lib).optionals (!flags.with_iwlib && (flags.with_nl80211 || flags.all_extensions)) [
          (hsPkgs."netlink" or ((hsPkgs.pkgs-errors).buildDepError "netlink"))
          (hsPkgs."cereal" or ((hsPkgs.pkgs-errors).buildDepError "cereal"))
          ]) ++ (pkgs.lib).optional (flags.with_mpd || flags.all_extensions) (hsPkgs."libmpd" or ((hsPkgs.pkgs-errors).buildDepError "libmpd"))) ++ (pkgs.lib).optionals (flags.with_alsa || flags.all_extensions) [
          ...
          (hsPkgs."http-conduit" or ((hsPkgs.pkgs-errors).buildDepError "http-conduit"))
          (hsPkgs."http-types" or ((hsPkgs.pkgs-errors).buildDepError "http-types"))
          ]) ++ (pkgs.lib).optional (system.isFreebsd) (hsPkgs."bsd-sysctl" or ((hsPkgs.pkgs-errors).buildDepError "bsd-sysctl"));
        libs = ([
          (pkgs."Xrandr" or ((hsPkgs.pkgs-errors).sysDepError "Xrandr"))
          (pkgs."Xrender" or ((hsPkgs.pkgs-errors).sysDepError "Xrender"))
          ] ++ (pkgs.lib).optional (flags.with_iwlib) (pkgs."iw" or ((hsPkgs.pkgs-errors).sysDepError "iw"))) ++ (pkgs.lib).optional (flags.with_xpm || flags.all_extensions) (pkgs."Xpm" or ((hsPkgs.pkgs-errors).sysDepError "Xpm"));
        buildable = true;
        };
      exes = {
        "xmobar" = {
