    ...
    components = {
      "library" = {
        depends = ((((((((((((([
          ...
          ]) ++ (pkgs.lib).optional (flags.with_utf8 || flags.all_extensions) (hsPkgs."utf8-string" or (buildDepError "utf8-string"))) ++ (pkgs.lib).optional (flags.with_inotify || flags.all_extensions) (hsPkgs."hinotify" or (buildDepError "hinotify"))) ++ (pkgs.lib).optional (flags.with_iwlib) (hsPkgs."iwlib" or (buildDepError "iwlib"))) ++ (pkgs.lib).optionals (!flags.with_iwlib && (flags.with_nl80211 || flags.all_extensions)) [
          (hsPkgs."netlink" or (buildDepError "netlink"))
          (hsPkgs."cereal" or (buildDepError "cereal"))
          ]) ++ (pkgs.lib).optional (flags.with_mpd || flags.all_extensions) (hsPkgs."libmpd" or (buildDepError "libmpd"))) ++ (pkgs.lib).optionals (flags.with_alsa || flags.all_extensions) [
          ...
          (hsPkgs."http-conduit" or (buildDepError "http-conduit"))
          (hsPkgs."http-types" or (buildDepError "http-types"))
          ]) ++ (pkgs.lib).optional (system.isFreebsd) (hsPkgs."bsd-sysctl" or (buildDepError "bsd-sysctl"));
        libs = ([
          (pkgs."Xrandr" or (sysDepError "Xrandr"))
          (pkgs."Xrender" or (sysDepError "Xrender"))
          ] ++ (pkgs.lib).optional (flags.with_iwlib) (pkgs."iw" or (sysDepError "iw"))) ++ (pkgs.lib).optional (flags.with_xpm || flags.all_extensions) (pkgs."Xpm" or (sysDepError "Xpm"));
        buildable = true;
        };
      exes = {
        "xmobar" = {
