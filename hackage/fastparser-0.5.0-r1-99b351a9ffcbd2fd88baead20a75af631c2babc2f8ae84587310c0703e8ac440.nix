{ system
  ...
  , ... }:
  {
    ...
    package = {
      specVersion = "1.10";
      identifier = { name = "fastparser"; version = "0.5.0"; };
      ...
      description = "This package is deprecated as new, fast, parser combinators libraries that are well maintained exist :)";
      buildType = "Simple";
      };
    components = {
      "library" = {
