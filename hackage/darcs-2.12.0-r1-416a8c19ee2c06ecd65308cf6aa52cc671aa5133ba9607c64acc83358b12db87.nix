      ...
      "library" = {
        depends = ((((([
          ...
          then [
            ...
            (hsPkgs."network" or (buildDepError "network"))
            ]))) ++ (pkgs.lib).optional (!flags.curl && !flags.http) (hsPkgs."base" or (buildDepError "base"))) ++ (pkgs.lib).optional (flags.terminfo && !system.isWindows) (hsPkgs."terminfo" or (buildDepError "terminfo"));
