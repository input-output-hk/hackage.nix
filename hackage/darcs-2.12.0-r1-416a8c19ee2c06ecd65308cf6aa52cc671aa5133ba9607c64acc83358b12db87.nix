      ...
      "library" = {
        depends = ((((([
          ...
          then [
            ...
            (hsPkgs."network" or ((hsPkgs.pkgs-errors).buildDepError "network"))
            ]))) ++ (pkgs.lib).optional (!flags.curl && !flags.http) (hsPkgs."base" or ((hsPkgs.pkgs-errors).buildDepError "base"))) ++ (pkgs.lib).optional (flags.terminfo && !system.isWindows) (hsPkgs."terminfo" or ((hsPkgs.pkgs-errors).buildDepError "terminfo"));
