{ system
  ...
  , ... }:
  {
    ...
    package = {
      specVersion = "2.2";
      identifier = { name = "amazonka-accessanalyzer"; version = "2.0"; };
      license = "MPL-2.0";
    ...
    components = {
      ...
      tests = {
        "amazonka-accessanalyzer-test" = {
          depends = [
            (hsPkgs."amazonka-accessanalyzer" or (errorHandler.buildDepError "amazonka-accessanalyzer"))
            (hsPkgs."amazonka-core" or (errorHandler.buildDepError "amazonka-core"))
