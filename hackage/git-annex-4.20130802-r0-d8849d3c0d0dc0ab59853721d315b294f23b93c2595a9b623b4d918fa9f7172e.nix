      ...
      exes = {
        "git-annex" = {
          depends = ((((((((((((([
            ...
            (hsPkgs.async)
            (hsPkgs.stm)
            ]) ++ (pkgs.lib).optional (flags.android) (hsPkgs.data-endian)) ++ (pkgs.lib).optionals (flags.assistant) (if system.isLinux && flags.inotify
            ...
            (hsPkgs.gnutls)
            (hsPkgs.xml-types)
            ]) ++ (pkgs.lib).optional (flags.dns) (hsPkgs.dns)) ++ (pkgs.lib).optional (flags.feed) (hsPkgs.feed);
          };
        };
      };
    }