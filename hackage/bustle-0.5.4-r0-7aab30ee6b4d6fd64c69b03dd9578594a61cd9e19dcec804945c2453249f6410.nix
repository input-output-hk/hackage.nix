{ system, compiler, flags, pkgs, hsPkgs, pkgconfPkgs, ... }:
  {
    ...
    package = {
      specVersion = "1.18";
      identifier = { name = "bustle"; version = "0.5.4"; };
      ...
      exes = {
        "bustle" = {
          depends = [
            ...
            ] ++ (pkgs.lib).optional (flags.withgtk2hsbuildtools) (hsPkgs."gtk2hs-buildtools" or ((hsPkgs.pkgs-errors).buildDepError "gtk2hs-buildtools"));
          pkgconfig = [
