{ system
  ...
  , ... }:
  {
    ...
    package = {
      specVersion = "1.6";
      identifier = { name = "random-source"; version = "0.3.0.4"; };
    ...
    components = {
      "library" = {
        ...
        ] ++ pkgs.lib.optional (compiler.isGhc && compiler.version.ge "6.10") (hsPkgs."mwc-random" or (errorHandler.buildDepError "mwc-random"))) ++ (if flags.mtl2
          then [
