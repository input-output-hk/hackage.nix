{ system
  ...
  , ... }:
  {
    ...
    package = {
      specVersion = "2.2";
      identifier = { name = "amazonka-chime-sdk-identity"; version = "2.0"; };
      license = "MPL-2.0";
    ...
    components = {
      ...
      tests = {
        "amazonka-chime-sdk-identity-test" = {
          depends = [
            (hsPkgs."amazonka-chime-sdk-identity" or (errorHandler.buildDepError "amazonka-chime-sdk-identity"))
            (hsPkgs."amazonka-core" or (errorHandler.buildDepError "amazonka-core"))
