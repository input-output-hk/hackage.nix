{ system, compiler, flags, pkgs, hsPkgs, pkgconfPkgs, ... }:
  {
    ...
    package = {
      specVersion = "1.10";
      identifier = { name = "mintty"; version = "0.1"; };
    ...
    components = {
      "library" = {
        ...
        libs = (pkgs.lib).optionals (system.isWindows) ((pkgs.lib).optional (!flags.win32-2-5) (pkgs."ntdll" or ((hsPkgs.pkgs-errors).sysDepError "ntdll")));
        build-tools = (pkgs.lib).optionals (system.isWindows) ((pkgs.lib).optional (!flags.win32-2-5) (hsPkgs.buildPackages.hsc2hs or (pkgs.buildPackages.hsc2hs or ((hsPkgs.pkgs-errors).buildToolDepError "hsc2hs"))));
        buildable = true;
        };
      };
    }