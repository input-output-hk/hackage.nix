{ system
  ...
  , ... }:
  {
    ...
    package = {
      specVersion = "2.2";
      identifier = { name = "amazonka-compute-optimizer"; version = "2.0"; };
      license = "MPL-2.0";
    ...
    components = {
      ...
      tests = {
        "amazonka-compute-optimizer-test" = {
          depends = [
            (hsPkgs."amazonka-compute-optimizer" or (errorHandler.buildDepError "amazonka-compute-optimizer"))
            (hsPkgs."amazonka-core" or (errorHandler.buildDepError "amazonka-core"))
