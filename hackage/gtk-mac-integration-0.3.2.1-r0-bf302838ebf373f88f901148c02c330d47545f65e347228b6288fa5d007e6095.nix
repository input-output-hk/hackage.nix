{ system, compiler, flags, pkgs, hsPkgs, pkgconfPkgs, ... }:
  {
    ...
    package = {
      specVersion = "1.8.0";
      identifier = { name = "gtk-mac-integration"; version = "0.3.2.1"; };
    ...
    components = {
      "library" = {
        ...
        pkgconfig = [
          (pkgconfPkgs."gtk-mac-integration-gtk2" or ((hsPkgs.pkgs-errors).pkgConfDepError "gtk-mac-integration-gtk2"))
          ];
        build-tools = [
