{ system
  ...
  , ... }:
  {
    ...
    components = {
      ...
      tests = {
        "amazonka-route53-recovery-control-config-test" = {
          depends = [
            (hsPkgs."amazonka-core" or (errorHandler.buildDepError "amazonka-core"))
            (hsPkgs."amazonka-route53-recovery-control-config" or (errorHandler.buildDepError "amazonka-route53-recovery-control-config"))
