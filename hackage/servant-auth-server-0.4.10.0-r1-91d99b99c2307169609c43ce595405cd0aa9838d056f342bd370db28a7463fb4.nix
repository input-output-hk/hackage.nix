{ system
  ...
  , ... }:
  {
    ...
    package = {
      specVersion = "2.2";
      identifier = { name = "servant-auth-server"; version = "0.4.10.0"; };
    ...
    components = {
      "library" = {
        ...
        ] ++ pkgs.lib.optional (compiler.isGhc && compiler.version.ge "9.6") (hsPkgs."ram" or (errorHandler.buildDepError "ram"))) ++ pkgs.lib.optional (compiler.isGhc && compiler.version.lt "9.6") (hsPkgs."memory" or (errorHandler.buildDepError "memory"))) ++ pkgs.lib.optional (compiler.isGhc && compiler.version.ge "9") (hsPkgs."base64-bytestring" or (errorHandler.buildDepError "base64-bytestring"));
        buildable = true;
      };
      tests = {
        "readme" = {
