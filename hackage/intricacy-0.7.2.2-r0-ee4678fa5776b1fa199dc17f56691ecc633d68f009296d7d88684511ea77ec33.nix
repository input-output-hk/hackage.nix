{ system
  ...
  , ... }:
  {
    ...
    package = {
      specVersion = "1.10";
      identifier = { name = "intricacy"; version = "0.7.2.2"; };
      ...
      exes = {
        "intricacy" = {
          ...
          libs = (pkgs.lib).optionals (!(!flags.game)) ((pkgs.lib).optionals (flags.sdl) ((pkgs.lib).optionals (system.isWindows) ([
            ...
            ] ++ (pkgs.lib).optional (flags.sound) (pkgs."SDL_mixer" or (errorHandler.sysDepError "SDL_mixer")))) ++ (pkgs.lib).optionals (flags.curses) ((pkgs.lib).optional (flags.tinfo) (pkgs."tinfo" or (errorHandler.sysDepError "tinfo")) ++ (pkgs.lib).optional (flags.tinfow) (pkgs."tinfow" or (errorHandler.sysDepError "tinfow"))));
