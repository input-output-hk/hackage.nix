{ system
  ...
  , ... }:
  {
    ...
    package = {
      specVersion = "3.0";
      identifier = { name = "opc-xml-da-client"; version = "0.1"; };
      license = "MIT";
    ...
    components = {
      "library" = {
        depends = [
          ...
          (hsPkgs."opc-xml-da-client".components.sublibs.opc-xml-da-client-protocol or (errorHandler.buildDepError "opc-xml-da-client:opc-xml-da-client-protocol"))
