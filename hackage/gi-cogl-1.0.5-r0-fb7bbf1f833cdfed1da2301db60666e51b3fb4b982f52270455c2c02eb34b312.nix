{ system
  ...
  , ... }:
  {
    ...
    package = {
      specVersion = "2.0";
      identifier = { name = "gi-cogl"; version = "1.0.5"; };
      ...
      url = "";
      synopsis = "COGL GObject bindings";
      description = "Low-level bindings for cogl, autogenerated by haskell-gi.";
      buildType = "Custom";
      setup-depends = [
    ...
    components = {
      "library" = {
        ...
        pkgconfig = [
          (pkgconfPkgs."cogl-1.0" or (errorHandler.pkgConfDepError "cogl-1.0"))
          ];
        buildable = true;
        };
      };
