{ system
  ...
  , ... }:
  {
    ...
    package = {
      specVersion = "1.12";
      identifier = { name = "servant-queryparam-server"; version = "0.4.0"; };
      ...
      homepage = "";
      url = "";
      synopsis = "Server support for [servant-queryparam-core](https://hackage.haskell.org/package/servant-queryparam-core).";
      description = "";
      buildType = "Simple";
    };
    components = {
