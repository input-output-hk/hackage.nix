{ system
  ...
  , ... }:
  {
    flags = { echo-server = false; };
    package = {
      specVersion = "3.0";
      identifier = { name = "restman"; version = "0.7.6.0"; };
    ...
    components = {
      ...
      exes = {
        ...
        "restman-echo" = {
          ...
          buildable = if !flags.echo-server then false else true;
        };
      };
      tests = {
        "restman-test" = {
