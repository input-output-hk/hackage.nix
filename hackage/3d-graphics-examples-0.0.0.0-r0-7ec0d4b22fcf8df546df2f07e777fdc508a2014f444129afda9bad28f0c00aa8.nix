{ system, compiler, flags, pkgs, hsPkgs, pkgconfPkgs, ... }:
  {
    ...
    package = {
      specVersion = "1.8";
      identifier = { name = "3d-graphics-examples"; version = "0.0.0.0"; };
      ...
      url = "http://hackage.haskell.org/packages/archive/3d-graphics-examples/0.0.0.0/3d-graphics-examples-0.0.0.0.tar.gz";
    ...
    components = {
      exes = {
        "l-systems" = {
          depends = [ (hsPkgs.base) (hsPkgs.GLUT) (hsPkgs.OpenGL) ];
          };
        "mountains" = {
          depends = [
            (hsPkgs.base)
