{ system
  ...
  , ... }:
  {
    ...
    package = {
      specVersion = "2.2";
      identifier = { name = "amazonka-controltower"; version = "2.0"; };
      license = "MPL-2.0";
    ...
    components = {
      ...
      tests = {
        "amazonka-controltower-test" = {
          depends = [
            (hsPkgs."amazonka-controltower" or (errorHandler.buildDepError "amazonka-controltower"))
            (hsPkgs."amazonka-core" or (errorHandler.buildDepError "amazonka-core"))
