{ system, compiler, flags, pkgs, hsPkgs, pkgconfPkgs, ... }:
  {
    ...
    package = {
      specVersion = "1.24";
      identifier = { name = "gstreamer"; version = "0.12.8"; };
    ...
    components = {
      "library" = {
        ...
        pkgconfig = [
          (pkgconfPkgs."gstreamer-0.10" or ((hsPkgs.pkgs-errors).pkgConfDepError "gstreamer-0.10"))
          (pkgconfPkgs."gstreamer-audio-0.10" or ((hsPkgs.pkgs-errors).pkgConfDepError "gstreamer-audio-0.10"))
          (pkgconfPkgs."gstreamer-base-0.10" or ((hsPkgs.pkgs-errors).pkgConfDepError "gstreamer-base-0.10"))
          (pkgconfPkgs."gstreamer-controller-0.10" or ((hsPkgs.pkgs-errors).pkgConfDepError "gstreamer-controller-0.10"))
          (pkgconfPkgs."gstreamer-dataprotocol-0.10" or ((hsPkgs.pkgs-errors).pkgConfDepError "gstreamer-dataprotocol-0.10"))
          (pkgconfPkgs."gstreamer-net-0.10" or ((hsPkgs.pkgs-errors).pkgConfDepError "gstreamer-net-0.10"))
          (pkgconfPkgs."gstreamer-plugins-base-0.10" or ((hsPkgs.pkgs-errors).pkgConfDepError "gstreamer-plugins-base-0.10"))
          ];
        build-tools = [
