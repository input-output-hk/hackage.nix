{ system
  ...
  , ... }:
  {
    ...
    package = {
      specVersion = "2.0";
      identifier = { name = "bzlib"; version = "0.5.3.0"; };
    ...
    components = {
      "library" = {
        ...
        ] ++ pkgs.lib.optional (system.isWindows) (hsPkgs."base" or (errorHandler.buildDepError "base"))) ++ pkgs.lib.optional (!!(system.isWindows || compiler.isGhcjs && true || system.isGhcjs || system.isWasm32)) (hsPkgs."bzip2-clib" or (errorHandler.buildDepError "bzip2-clib"));
