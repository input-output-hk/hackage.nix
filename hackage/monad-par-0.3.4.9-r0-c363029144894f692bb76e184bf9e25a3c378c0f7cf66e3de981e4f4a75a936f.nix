    ...
    components = {
      "library" = {
        depends = ([
          ...
          ] ++ (pkgs.lib).optional (flags.chaselev) (hsPkgs."chaselev-deque" or (buildDepError "chaselev-deque"))) ++ (pkgs.lib).optional (flags.newgeneric) (hsPkgs."par-classes" or (buildDepError "par-classes"));
        buildable = true;
        };
      tests = {
        "test-monad-par" = {
