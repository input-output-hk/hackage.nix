    ...
    components = {
      "library" = {
        depends = ((([
          ...
          (hsPkgs.utf8-string)
          ] ++ (pkgs.lib).optionals (!flags.portable) ((pkgs.lib).optional (!system.isWindows) (hsPkgs.unix))) ++ (pkgs.lib).optional (!system.isWindows) (hsPkgs.unix)) ++ (pkgs.lib).optionals (flags.cloud) [
          (hsPkgs.network)
          (hsPkgs.network-uri)
