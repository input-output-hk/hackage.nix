{ system
  ...
  , ... }:
  {
    ...
    package = {
      specVersion = "1.6";
      identifier = { name = "GLUtil"; version = "0.9.2"; };
    ...
    components = {
      "library" = {
        ...
        build-tools = pkgs.lib.optional (!(compiler.isGhc && compiler.version.ge "7.10.1" && !system.isWindows)) (hsPkgs.pkgsBuildBuild.cpphs.components.exes.cpphs or (pkgs.pkgsBuildBuild.cpphs or (errorHandler.buildToolDepError "cpphs:cpphs")));
        buildable = true;
      };
    };
  }