    ...
    components = {
      "library" = {
        depends = (([
          ...
          ] ++ (pkgs.lib).optional (compiler.isGhc && (compiler.version).ge "8.6.1") (hsPkgs."base" or (buildDepError "base"))) ++ (pkgs.lib).optionals (compiler.isGhc && (compiler.version).lt "8.0.1") [
