{ system, compiler, flags, pkgs, hsPkgs, pkgconfPkgs, ... }:
  {
    ...
    package = {
      specVersion = "1.8";
      identifier = { name = "git-annex"; version = "4.20130323"; };
      ...
      exes = {
        "git-annex" = {
          depends = ((((((((([
            ...
            ] ++ (pkgs.lib).optional (flags.testsuite) (hsPkgs."HUnit" or ((hsPkgs.pkgs-errors).buildDepError "HUnit"))) ++ (pkgs.lib).optional (flags.s3) (hsPkgs."hS3" or ((hsPkgs.pkgs-errors).buildDepError "hS3"))) ++ (pkgs.lib).optionals (flags.webdav) [
            ...
            ]) ++ (if system.isLinux && flags.inotify
            then [
