      ...
      exes = {
        "git-annex" = {
          depends = ((((((((([
            ...
            ] ++ (pkgs.lib).optional (flags.testsuite) (hsPkgs."HUnit" or (errorHandler.buildDepError "HUnit"))) ++ (pkgs.lib).optional (flags.s3) (hsPkgs."hS3" or (errorHandler.buildDepError "hS3"))) ++ (pkgs.lib).optionals (flags.webdav) [
