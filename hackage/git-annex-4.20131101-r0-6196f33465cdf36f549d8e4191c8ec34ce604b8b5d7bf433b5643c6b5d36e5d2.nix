      ...
      exes = {
        "git-annex" = {
          depends = ((((((((((((((([
            ...
            ] ++ (pkgs.lib).optional (!system.isWindows) (hsPkgs."unix" or (errorHandler.buildDepError "unix"))) ++ (pkgs.lib).optional (flags.testsuite) (hsPkgs."HUnit" or (errorHandler.buildDepError "HUnit"))) ++ (pkgs.lib).optional (flags.tdfa) (hsPkgs."regex-tdfa" or (errorHandler.buildDepError "regex-tdfa"))) ++ (pkgs.lib).optional (flags.cryptohash) (hsPkgs."cryptohash" or (errorHandler.buildDepError "cryptohash"))) ++ (pkgs.lib).optional (flags.s3) (hsPkgs."hS3" or (errorHandler.buildDepError "hS3"))) ++ (pkgs.lib).optionals (flags.webdav) [
            (hsPkgs."DAV" or (errorHandler.buildDepError "DAV"))
            (hsPkgs."http-conduit" or (errorHandler.buildDepError "http-conduit"))
            (hsPkgs."xml-conduit" or (errorHandler.buildDepError "xml-conduit"))
            (hsPkgs."http-types" or (errorHandler.buildDepError "http-types"))
            ]) ++ (pkgs.lib).optional (flags.assistant && !system.isWindows && !system.isSolaris) (hsPkgs."stm" or (errorHandler.buildDepError "stm"))) ++ (pkgs.lib).optional (flags.android) (hsPkgs."data-endian" or (errorHandler.buildDepError "data-endian"))) ++ (pkgs.lib).optionals (flags.assistant) (if system.isLinux && flags.inotify
            then [
              ...
              else (pkgs.lib).optionals (!system.isWindows && !system.isSolaris && !system.isLinux) ((pkgs.lib).optional (flags.android) (hsPkgs."hinotify" or (errorHandler.buildDepError "hinotify"))))) ++ (pkgs.lib).optional (system.isLinux && flags.dbus) (hsPkgs."dbus" or (errorHandler.buildDepError "dbus"))) ++ (pkgs.lib).optionals (flags.webapp && !system.isWindows) [
