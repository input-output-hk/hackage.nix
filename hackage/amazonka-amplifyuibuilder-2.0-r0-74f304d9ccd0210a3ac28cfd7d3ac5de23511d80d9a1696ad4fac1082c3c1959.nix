{ system
  ...
  , ... }:
  {
    ...
    package = {
      specVersion = "2.2";
      identifier = { name = "amazonka-amplifyuibuilder"; version = "2.0"; };
      license = "MPL-2.0";
    ...
    components = {
      ...
      tests = {
        "amazonka-amplifyuibuilder-test" = {
          depends = [
            (hsPkgs."amazonka-amplifyuibuilder" or (errorHandler.buildDepError "amazonka-amplifyuibuilder"))
            (hsPkgs."amazonka-core" or (errorHandler.buildDepError "amazonka-core"))
