{ system, compiler, flags, pkgs, hsPkgs, pkgconfPkgs, ... }:
  {
    ...
    package = {
      specVersion = "1.10";
      identifier = { name = "al"; version = "0.1.4"; };
    ...
    components = {
      "library" = {
        ...
        libs = (pkgs.lib).optional (system.isWindows) (pkgs."OpenAL32" or ((hsPkgs.pkgs-errors).sysDepError "OpenAL32"));
        frameworks = (pkgs.lib).optionals (!system.isWindows) ((pkgs.lib).optional (system.isOsx) (pkgs."OpenAL" or ((hsPkgs.pkgs-errors).sysDepError "OpenAL")));
        pkgconfig = (pkgs.lib).optionals (!system.isWindows) ((pkgs.lib).optional (!system.isOsx) (pkgconfPkgs."openal" or ((hsPkgs.pkgs-errors).pkgConfDepError "openal")));
        build-tools = [
