{ system
  ...
  , ... }:
  {
    ...
    package = {
      specVersion = "2.2";
      identifier = { name = "hspec-discover-discover"; version = "1.0.0.0"; };
      ...
      tests = {
        "hspec-discover-discover-test" = {
          ...
          build-tools = [
            ...
            (hsPkgs.pkgsBuildBuild.hspec-discover-discover.components.exes.hspec-discover-discover or (pkgs.pkgsBuildBuild.hspec-discover-discover or (errorHandler.buildToolDepError "hspec-discover-discover:hspec-discover-discover")))
          ];
          buildable = true;
        };
      };
