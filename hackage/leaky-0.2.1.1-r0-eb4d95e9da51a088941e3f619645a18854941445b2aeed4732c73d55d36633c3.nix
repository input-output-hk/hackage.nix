{ system, compiler, flags, pkgs, hsPkgs, pkgconfPkgs, ... }:
  {
    ...
    package = {
      specVersion = "1.18";
      identifier = { name = "leaky"; version = "0.2.1.1"; };
      ...
      exes = {
        "leaky" = {
          depends = ([
            ...
            ] ++ (pkgs.lib).optional (flags.use_cpphs) (hsPkgs."cpphs" or ((hsPkgs.pkgs-errors).buildDepError "cpphs"))) ++ (pkgs.lib).optional (flags.omnitypic) (hsPkgs."ghc-prim" or ((hsPkgs.pkgs-errors).buildDepError "ghc-prim"));
          build-tools = (pkgs.lib).optional (flags.use_cpphs) (hsPkgs.buildPackages.cpphs or (pkgs.buildPackages.cpphs or ((hsPkgs.pkgs-errors).buildToolDepError "cpphs")));
          buildable = true;
          };
        };
      };
