{ system, compiler, flags, pkgs, hsPkgs, pkgconfPkgs, ... }:
  {
    ...
    package = {
      specVersion = "1.10";
      identifier = { name = "helics"; version = "0.5.1"; };
      license = "MIT";
    ...
    components = {
      "library" = {
        ...
        libs = (pkgs.lib).optionals (!(flags.dummy && !system.isLinux)) [
          (pkgs."newrelic-collector-client" or ((hsPkgs.pkgs-errors).sysDepError "newrelic-collector-client"))
          (pkgs."newrelic-transaction" or ((hsPkgs.pkgs-errors).sysDepError "newrelic-transaction"))
          (pkgs."newrelic-common" or ((hsPkgs.pkgs-errors).sysDepError "newrelic-common"))
          ];
        build-tools = (pkgs.lib).optional (!(flags.dummy && !system.isLinux)) (hsPkgs.buildPackages.hsc2hs or (pkgs.buildPackages.hsc2hs or ((hsPkgs.pkgs-errors).buildToolDepError "hsc2hs")));
        buildable = true;
        };
      exes = {
        "helics-example" = {
