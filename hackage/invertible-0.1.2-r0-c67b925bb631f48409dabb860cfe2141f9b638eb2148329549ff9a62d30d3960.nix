...
, ... }:
  {
    ...
    components = {
      "library" = {
        ...
        ] ++ pkgs.lib.optional (flags.arrows) (hsPkgs.arrows)) ++ pkgs.lib.optional (flags.hlist) (hsPkgs.HList)) ++ pkgs.lib.optional (flags.invariant) (hsPkgs.invariant)) ++ pkgs.lib.optional (flags.lens) (hsPkgs.lens)) ++ pkgs.lib.optional (flags.partial-isomorphisms) (hsPkgs.partial-isomorphisms)) ++ pkgs.lib.optional (flags.piso) (hsPkgs.Piso)) ++ pkgs.lib.optional (flags.semigroupoids) (hsPkgs.semigroupoids)) ++ pkgs.lib.optional (flags.typecompose) (hsPkgs.TypeCompose);
      };
      tests = {
        "tests" = {
          depends  = [
