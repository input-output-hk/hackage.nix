{ system
  ...
  , ... }:
  {
    ...
    package = {
      specVersion = "2.2";
      identifier = { name = "amazonka-appintegrations"; version = "2.0"; };
      license = "MPL-2.0";
    ...
    components = {
      ...
      tests = {
        "amazonka-appintegrations-test" = {
          depends = [
            (hsPkgs."amazonka-appintegrations" or (errorHandler.buildDepError "amazonka-appintegrations"))
            (hsPkgs."amazonka-core" or (errorHandler.buildDepError "amazonka-core"))
