{ system, compiler, flags, pkgs, hsPkgs, pkgconfPkgs, ... }:
  {
    ...
    package = {
      specVersion = "2.0";
      identifier = { name = "ghc"; version = "8.4.3"; };
    ...
    components = {
      "library" = {
        depends = (([
          ...
          ] ++ (pkgs.lib).optional (!(system.isLinux && system.isX86_64 && (compiler.isGhc && (compiler.version).eq "8.4.3"))) (hsPkgs."base" or ((hsPkgs.pkgs-errors).buildDepError "base"))) ++ (pkgs.lib).optional (!flags.buildable) (hsPkgs."base" or ((hsPkgs.pkgs-errors).buildDepError "base"))) ++ (if system.isWindows
          then [
