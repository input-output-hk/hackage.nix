{ system
  ...
  , ... }:
  {
    ...
    components = {
      ...
      tests = {
        "amazonka-marketplace-entitlement-test" = {
          depends = [
            (hsPkgs."amazonka-core" or (errorHandler.buildDepError "amazonka-core"))
            (hsPkgs."amazonka-marketplace-entitlement" or (errorHandler.buildDepError "amazonka-marketplace-entitlement"))
