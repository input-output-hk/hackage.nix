{ system
  ...
  , ... }:
  {
    ...
    package = {
      specVersion = "1.12";
      identifier = { name = "vary"; version = "0.1.1.3"; };
      license = "MIT";
