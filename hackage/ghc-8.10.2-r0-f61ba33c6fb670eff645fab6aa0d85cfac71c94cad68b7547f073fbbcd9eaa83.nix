    ...
    components = {
      "library" = {
        depends = ((((([
          ...
          ] ++ (pkgs.lib).optional (!(system.isLinux && system.isX86_64 && (compiler.isGhc && (compiler.version).eq "8.10.2"))) (hsPkgs."base" or (errorHandler.buildDepError "base"))) ++ (pkgs.lib).optional (!flags.buildable) (hsPkgs."base" or (errorHandler.buildDepError "base"))) ++ (if system.isWindows
