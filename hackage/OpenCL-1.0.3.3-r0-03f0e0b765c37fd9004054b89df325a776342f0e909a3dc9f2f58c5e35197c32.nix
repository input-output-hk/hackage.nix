...
in { system, compiler, flags, pkgs, hsPkgs, pkgconfPkgs, ... }:
  {
    ...
    components = {
      "library" = {
        ...
        libs = (pkgs.lib).optional (system.isLinux) (pkgs."OpenCL" or (sysDepError "OpenCL")) ++ (pkgs.lib).optional (system.isWindows) (pkgs."OpenCL" or (sysDepError "OpenCL"));
        frameworks = (pkgs.lib).optional (system.isLinux) (pkgs."OpenCL" or (sysDepError "OpenCL")) ++ (pkgs.lib).optional (system.isOsx) (pkgs."OpenCL" or (sysDepError "OpenCL"));
        build-tools = [
