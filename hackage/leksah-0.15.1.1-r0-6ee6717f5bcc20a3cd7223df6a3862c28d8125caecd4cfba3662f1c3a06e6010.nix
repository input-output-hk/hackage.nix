{ system, compiler, flags, pkgs, hsPkgs, pkgconfPkgs, ... }:
  {
    ...
    package = {
      specVersion = "1.18";
      identifier = { name = "leksah"; version = "0.15.1.1"; };
      ...
      "library" = {
        depends = (((((([
          ...
          then [
            ...
            ])) ++ (pkgs.lib).optional (system.isOsx) (hsPkgs."gtk3-mac-integration" or ((hsPkgs.pkgs-errors).buildDepError "gtk3-mac-integration"))) ++ (pkgs.lib).optionals (flags.yi) [
          ...
          ]) ++ (pkgs.lib).optional (flags.yi && flags.dyre) (hsPkgs."dyre" or ((hsPkgs.pkgs-errors).buildDepError "dyre"))) ++ (pkgs.lib).optionals (flags.loc && system.isLinux) [
