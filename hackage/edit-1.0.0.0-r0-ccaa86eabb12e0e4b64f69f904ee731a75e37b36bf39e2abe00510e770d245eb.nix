    ...
    components = {
      "library" = {
        depends = (([
          ...
          ] ++ (pkgs.lib).optional (!flags.no_arbitrary) (hsPkgs."QuickCheck" or (buildDepError "QuickCheck"))) ++ (pkgs.lib).optional (!flags.no_comonad) (hsPkgs."comonad" or (buildDepError "comonad"))) ++ (pkgs.lib).optionals (flags.tutorial) [
