{ system, compiler, flags, pkgs, hsPkgs, pkgconfPkgs, ... }:
  {
    ...
    package = {
      specVersion = "1.24";
      identifier = { name = "darcs"; version = "2.14.1"; };
      ...
      tests = {
        "darcs-test" = {
          depends = ([
            ...
            (hsPkgs."zip-archive" or ((hsPkgs.pkgs-errors).buildDepError "zip-archive"))
            ] ++ (pkgs.lib).optional (system.isWindows) (hsPkgs."Win32" or ((hsPkgs.pkgs-errors).buildDepError "Win32"))) ++ (pkgs.lib).optional (system.isWindows) (hsPkgs."shelly" or ((hsPkgs.pkgs-errors).buildDepError "shelly"));
          buildable = true;
          };
        };
      };
