{ system
  ...
  , ... }:
  {
    ...
    package = {
      specVersion = "3.0";
      identifier = { name = "seihou-cli"; version = "0.8.0.0"; };
    ...
    components = {
      ...
      tests = {
        "seihou-cli-test" = {
          ...
          build-tools = [
            (hsPkgs.pkgsBuildBuild.seihou-cli.components.exes.seihou or (pkgs.pkgsBuildBuild.seihou or (errorHandler.buildToolDepError "seihou-cli:seihou")))
          ];
          buildable = true;
        };
      };
