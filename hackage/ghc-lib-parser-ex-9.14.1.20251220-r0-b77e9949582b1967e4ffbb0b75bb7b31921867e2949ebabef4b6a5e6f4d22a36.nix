{ system
  ...
  , ... }:
  {
    ...
    package = {
      specVersion = "3.4";
      identifier = { name = "ghc-lib-parser-ex"; version = "9.14.1.20251220"; };
    ...
    components = {
      "library" = {
        ...
        ] ++ (if flags.auto && (compiler.isGhc && compiler.version.ge "9.14.0") && (compiler.isGhc && compiler.version.lt "9.15.0")
          then [
