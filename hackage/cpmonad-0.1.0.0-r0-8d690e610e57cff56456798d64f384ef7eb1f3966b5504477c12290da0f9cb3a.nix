{ system
  ...
  , ... }:
  {
    ...
    package = {
      specVersion = "3.0";
      identifier = { name = "cpmonad"; version = "0.1.0.0"; };
      license = "MIT";
      copyright = "";
      ...
      tests = {
        "test" = {
          depends = [
            ...
            (hsPkgs."vector" or (errorHandler.buildDepError "vector"))
            (hsPkgs."vector-algorithms" or (errorHandler.buildDepError "vector-algorithms"))
            (hsPkgs."cpmonad" or (errorHandler.buildDepError "cpmonad"))
