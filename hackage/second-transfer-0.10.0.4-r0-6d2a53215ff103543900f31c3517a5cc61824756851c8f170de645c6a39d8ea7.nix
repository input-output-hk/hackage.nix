{ system, compiler, flags, pkgs, hsPkgs, pkgconfPkgs, ... }:
  {
    ...
    package = {
      specVersion = "1.10";
      identifier = { name = "second-transfer"; version = "0.10.0.4"; };
    ...
    components = {
      "library" = {
        ...
        libs = ((pkgs.lib).optionals (system.isOsx) ((pkgs.lib).optional (flags.enable-botan) (pkgs."second_transfer__enable_tls" or ((hsPkgs.pkgs-errors).sysDepError "second_transfer__enable_tls"))) ++ (pkgs.lib).optional (system.isLinux) (pkgs."stdc++" or ((hsPkgs.pkgs-errors).sysDepError "stdc++"))) ++ (pkgs.lib).optionals (flags.enable-botan) ((pkgs.lib).optional (system.isLinux) (pkgs."botan-1.11" or ((hsPkgs.pkgs-errors).sysDepError "botan-1.11")));
        build-tools = [
