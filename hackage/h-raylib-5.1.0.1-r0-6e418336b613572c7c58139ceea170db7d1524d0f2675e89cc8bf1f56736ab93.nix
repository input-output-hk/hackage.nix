{ system
  ...
  , ... }:
  {
    ...
    package = {
      specVersion = "2.4";
      identifier = { name = "h-raylib"; version = "5.1.0.1"; };
      license = "Apache-2.0";
      copyright = "";
      maintainer = "Anut";
      author = "Anut";
    ...
    components = {
      "library" = {
        ...
        pkgconfig = pkgs.lib.optionals (!(flags.platform-windows || flags.detect-platform && system.isWindows)) (pkgs.lib.optionals (!(flags.platform-linux || flags.detect-platform && system.isLinux)) (pkgs.lib.optionals (!(flags.platform-mac || flags.detect-platform && system.isOsx)) (pkgs.lib.optionals (!(flags.platform-bsd || flags.detect-platform && (system.isFreebsd || system.isNetbsd || system.isOpenbsd))) (pkgs.lib.optional (flags.platform-nixos) (pkgconfPkgs."raylib" or (errorHandler.pkgConfDepError "raylib"))))));
        buildable = true;
      };
      exes = {
        "basic-window" = {
