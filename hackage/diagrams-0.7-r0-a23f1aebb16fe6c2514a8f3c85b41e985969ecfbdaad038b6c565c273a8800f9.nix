  ...
  , ... }:
  {
    ...
    components = {
      "library" = {
        ...
        ] ++ pkgs.lib.optional (flags.cairo) (hsPkgs."diagrams-cairo" or (errorHandler.buildDepError "diagrams-cairo"))) ++ pkgs.lib.optional (flags.svg) (hsPkgs."diagrams-svg" or (errorHandler.buildDepError "diagrams-svg"))) ++ pkgs.lib.optional (flags.ps) (hsPkgs."diagrams-postscript" or (errorHandler.buildDepError "diagrams-postscript"));
        buildable = true;
      };
    };
  }