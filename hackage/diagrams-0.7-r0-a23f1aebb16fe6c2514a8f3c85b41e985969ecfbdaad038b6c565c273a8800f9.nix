    ...
    components = {
      "library" = {
        depends = (([
          ...
          ] ++ (pkgs.lib).optional (flags.cairo) (hsPkgs.diagrams-cairo)) ++ (pkgs.lib).optional (flags.svg) (hsPkgs.diagrams-svg)) ++ (pkgs.lib).optional (flags.ps) (hsPkgs.diagrams-postscript);
        };
      };
    }