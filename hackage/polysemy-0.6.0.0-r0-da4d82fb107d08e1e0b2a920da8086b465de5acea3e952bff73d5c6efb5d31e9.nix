    ...
    components = {
      "library" = {
        depends = (([
          ...
          ] ++ (pkgs.lib).optional (compiler.isGhc && (compiler.version).ge "8.6") (hsPkgs."loopbreaker" or ((hsPkgs.pkgs-errors).buildDepError "loopbreaker"))) ++ (pkgs.lib).optional (flags.dump-core) (hsPkgs."dump-core" or ((hsPkgs.pkgs-errors).buildDepError "dump-core"))) ++ (pkgs.lib).optional (compiler.isGhc && (compiler.version).lt "8.2.2") (hsPkgs."unsupported-ghc-version" or ((hsPkgs.pkgs-errors).buildDepError "unsupported-ghc-version"));
        buildable = true;
        };
      tests = {
        "polysemy-test" = {
          depends = [
            ...
            (hsPkgs."type-errors" or ((hsPkgs.pkgs-errors).buildDepError "type-errors"))
            (hsPkgs."unagi-chan" or ((hsPkgs.pkgs-errors).buildDepError "unagi-chan"))
            ] ++ (pkgs.lib).optional (compiler.isGhc && (compiler.version).ge "8.6") (hsPkgs."loopbreaker" or ((hsPkgs.pkgs-errors).buildDepError "loopbreaker"));
          build-tools = [
