{ system
  ...
  , ... }:
  {
    ...
    package = {
      specVersion = "1.10";
      identifier = { name = "git-annex"; version = "8.20200908"; };
      ...
      setup-depends = [
        ...
        (hsPkgs.buildPackages.filepath-bytestring or (pkgs.buildPackages.filepath-bytestring or (errorHandler.buildToolDepError "filepath-bytestring")))
        (hsPkgs.buildPackages.process or (pkgs.buildPackages.process or (errorHandler.buildToolDepError "process")))
        (hsPkgs.buildPackages.async or (pkgs.buildPackages.async or (errorHandler.buildToolDepError "async")))
        (hsPkgs.buildPackages.utf8-string or (pkgs.buildPackages.utf8-string or (errorHandler.buildToolDepError "utf8-string")))
      ...
      exes = {
        "git-annex" = {
          depends = (((((((((([
            ...
            ]) ++ (pkgs.lib).optional (flags.torrentparser) (hsPkgs."torrent" or (errorHandler.buildDepError "torrent"))) ++ (pkgs.lib).optionals (flags.magicmime) ((pkgs.lib).optional (!system.isWindows) (hsPkgs."magic" or (errorHandler.buildDepError "magic")))) ++ (pkgs.lib).optional (flags.benchmark) (hsPkgs."criterion" or (errorHandler.buildDepError "criterion"));
          buildable = true;
          };
        };
      };
