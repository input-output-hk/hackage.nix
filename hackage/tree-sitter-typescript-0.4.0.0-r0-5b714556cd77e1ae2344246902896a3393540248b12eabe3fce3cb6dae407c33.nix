{ system
  ...
  , ... }:
  {
    ...
    package = {
      specVersion = "2.4";
      identifier = { name = "tree-sitter-typescript"; version = "0.4.0.0"; };
    ...
    components = {
      "library" = {
        depends = [
          ...
          (hsPkgs."tree-sitter-typescript-internal" or (errorHandler.buildDepError "tree-sitter-typescript-internal"))
          ];
        buildable = true;
        };
      sublibs = {
      ...
      tests = {
        "test" = {
          depends = [
            (hsPkgs."base" or (errorHandler.buildDepError "base"))
            (hsPkgs."tree-sitter" or (errorHandler.buildDepError "tree-sitter"))
            (hsPkgs."tree-sitter-typescript" or (errorHandler.buildDepError "tree-sitter-typescript"))
