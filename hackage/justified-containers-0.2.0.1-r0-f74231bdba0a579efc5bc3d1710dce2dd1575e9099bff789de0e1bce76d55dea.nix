{ system
  ...
  , ... }:
  {
    ...
    package = {
      specVersion = "1.10";
      identifier = { name = "justified-containers"; version = "0.2.0.1"; };
    ...
    components = {
      "library" = {
        depends = [
          ...
          (hsPkgs."roles" or (errorHandler.buildDepError "roles"))
          ];
        buildable = true;
        };
      tests = {
        "justified-containers-spec" = {
          depends = [
            ...
            (hsPkgs."justified-containers" or (errorHandler.buildDepError "justified-containers"))
            (hsPkgs."containers" or (errorHandler.buildDepError "containers"))
