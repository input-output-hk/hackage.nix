{ system
  ...
  , ... }:
  {
    ...
    package = {
      specVersion = "2.2";
      identifier = { name = "amazonka-braket"; version = "2.0"; };
      license = "MPL-2.0";
    ...
    components = {
      ...
      tests = {
        "amazonka-braket-test" = {
          depends = [
            (hsPkgs."amazonka-braket" or (errorHandler.buildDepError "amazonka-braket"))
            (hsPkgs."amazonka-core" or (errorHandler.buildDepError "amazonka-core"))
