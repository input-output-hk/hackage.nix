...
in { system, compiler, flags, pkgs, hsPkgs, pkgconfPkgs, ... }:
  {
    ...
    package = {
      specVersion = "1.10";
      identifier = { name = "opengl-spacenavigator"; version = "0.1.5.5"; };
      license = "MIT";
      copyright = "(c) 2015 Brian W Bush";
      maintainer = "Brian W Bush <consult@brianwbush.info>";
      author = "Brian W Bush <consult@brianwbush.info>";
      homepage = "https://bitbucket.org/functionally/opengl-spacenavigator";
      url = "https://bitbucket.org/functionally/opengl-spacenavigator/downloads/opengl-spacenavigator-0.1.5.5.tar.gz";
