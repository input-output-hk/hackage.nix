      ...
      exes = {
        "git-annex" = {
          depends = ((((((((((((((((([
            ...
            ])) ++ (pkgs.lib).optional (flags.torrentparser) (hsPkgs."torrent" or (errorHandler.buildDepError "torrent"))) ++ (pkgs.lib).optional (flags.magicmime) (hsPkgs."magic" or (errorHandler.buildDepError "magic"))) ++ (pkgs.lib).optional (flags.concurrentoutput) (hsPkgs."concurrent-output" or (errorHandler.buildDepError "concurrent-output"))) ++ (pkgs.lib).optional (flags.ekg) (hsPkgs."ekg" or (errorHandler.buildDepError "ekg"))) ++ (pkgs.lib).optionals (flags.benchmark) [
