      ...
      exes = {
        "git-annex" = {
          depends = ((((((((((((((((([
            ...
            (hsPkgs.gnutls)
            (hsPkgs.xml-types)
            ])) ++ (pkgs.lib).optional (flags.torrentparser) (hsPkgs.torrent)) ++ (pkgs.lib).optional (flags.magicmime) (hsPkgs.magic)) ++ (pkgs.lib).optional (flags.concurrentoutput) (hsPkgs.concurrent-output)) ++ (pkgs.lib).optional (flags.ekg) (hsPkgs.ekg)) ++ (pkgs.lib).optionals (flags.benchmark) [
            (hsPkgs.criterion)
            (hsPkgs.deepseq)
            ];
          };
