{ system
  ...
  , ... }:
  {
    ...
    package = {
      specVersion = "2.2";
      identifier = { name = "amazonka-comprehendmedical"; version = "2.0"; };
      license = "MPL-2.0";
    ...
    components = {
      ...
      tests = {
        "amazonka-comprehendmedical-test" = {
          depends = [
            (hsPkgs."amazonka-comprehendmedical" or (errorHandler.buildDepError "amazonka-comprehendmedical"))
            (hsPkgs."amazonka-core" or (errorHandler.buildDepError "amazonka-core"))
