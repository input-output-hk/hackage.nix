{ system
  ...
  , ... }:
  {
    ...
    package = {
      specVersion = "2.0";
      identifier = { name = "atelier-monitoring"; version = "0.1.0.0"; };
      license = "MIT";
      copyright = "";
      ...
      description = "Moitoring, metrics, and tracing effects and utilities for Effectful-based\napplications —  part of the atelier toolkit.";
      buildType = "Simple";
    };
    components = {
      "library" = {
      ...
      tests = {
        "atelier-monitoring-test" = {
          depends = [
            (hsPkgs."aeson" or (errorHandler.buildDepError "aeson"))
            (hsPkgs."atelier-monitoring" or (errorHandler.buildDepError "atelier-monitoring"))
            (hsPkgs."atelier-prelude" or (errorHandler.buildDepError "atelier-prelude"))
            (hsPkgs."base" or (errorHandler.buildDepError "base"))
            (hsPkgs."bytestring" or (errorHandler.buildDepError "bytestring"))
            (hsPkgs."containers" or (errorHandler.buildDepError "containers"))
