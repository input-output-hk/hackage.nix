{ system
  ...
  , ... }:
  {
    flags = {
      ...
      disable-build-tool-depends = false;
    };
    package = {
      specVersion = "3.0";
      identifier = { name = "arrayfire"; version = "0.9.0.0"; };
    ...
    components = {
      "library" = {
        ...
        build-tools = pkgs.lib.optional (!flags.disable-build-tool-depends) (hsPkgs.pkgsBuildBuild.hsc2hs.components.exes.hsc2hs or (pkgs.pkgsBuildBuild.hsc2hs or (errorHandler.buildToolDepError "hsc2hs:hsc2hs")));
        buildable = true;
      };
      exes = {
        "main" = {
      ...
      tests = {
        "test" = {
          ...
          build-tools = pkgs.lib.optional (!flags.disable-build-tool-depends) (hsPkgs.pkgsBuildBuild.hspec-discover.components.exes.hspec-discover or (pkgs.pkgsBuildBuild.hspec-discover or (errorHandler.buildToolDepError "hspec-discover:hspec-discover")));
          buildable = true;
        };
        "doctests" = {
          depends = [
