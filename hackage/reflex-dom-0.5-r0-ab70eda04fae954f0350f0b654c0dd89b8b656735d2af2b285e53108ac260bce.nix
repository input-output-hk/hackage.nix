  ...
  , ... }:
  {
    ...
    components = {
      "library" = {
        ...
        build-tools = pkgs.lib.optional (flags.android) (hsPkgs.pkgsBuildBuild.hsc2hs.components.exes.hsc2hs or (pkgs.pkgsBuildBuild.hsc2hs or (errorHandler.buildToolDepError "hsc2hs:hsc2hs")));
        buildable = true;
      };
      exes = {
        "sortableList" = {
