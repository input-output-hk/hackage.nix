{ system
  ...
  , ... }:
  {
    ...
    package = {
      specVersion = "2.0";
      identifier = { name = "gi-gtk"; version = "4.0.10"; };
      ...
      setup-depends = [
        ...
        (hsPkgs.pkgsBuildBuild.gi-graphene or (pkgs.pkgsBuildBuild.gi-graphene or (errorHandler.setupDepError "gi-graphene")))
        (hsPkgs.pkgsBuildBuild.gi-gsk or (pkgs.pkgsBuildBuild.gi-gsk or (errorHandler.setupDepError "gi-gsk")))
