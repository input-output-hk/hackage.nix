{ system, compiler, flags, pkgs, hsPkgs, pkgconfPkgs, ... }:
  {
    ...
    package = {
      specVersion = "1.6";
      identifier = { name = "network-info"; version = "0.2.0.4"; };
    ...
    components = {
      "library" = {
        ...
        libs = (pkgs.lib).optional (system.isWindows) (pkgs."iphlpapi" or ((hsPkgs.pkgs-errors).sysDepError "iphlpapi")) ++ (pkgs.lib).optionals (system.isSolaris) [
