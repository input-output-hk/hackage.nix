{ system
  ...
  , ... }:
  {
    ...
    package = {
      specVersion = "3.0";
      identifier = { name = "brick-calendar"; version = "0.2.0.0"; };
      license = "MIT";
      copyright = "";
