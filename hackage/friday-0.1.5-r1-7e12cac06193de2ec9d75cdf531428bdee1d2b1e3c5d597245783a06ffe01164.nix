{ system, compiler, flags, pkgs, hsPkgs, pkgconfPkgs, ... }:
  {
    ...
    components = {
      ...
      exes = {
        "delayed" = { depends = [ (hsPkgs.base) (hsPkgs.friday) ]; };
        "canny" = { depends = [ (hsPkgs.base) (hsPkgs.friday) ]; };
        "gaussian_blur" = { depends = [ (hsPkgs.base) (hsPkgs.friday) ]; };
        "histogram" = { depends = [ (hsPkgs.base) (hsPkgs.friday) ]; };
        "resize_image" = { depends = [ (hsPkgs.base) (hsPkgs.friday) ]; };
        "threshold" = { depends = [ (hsPkgs.base) (hsPkgs.friday) ]; };
        };
      tests = {
        "test" = {
          depends = [
      ...
      benchmarks = {
        "benchmark" = {
          depends = [ (hsPkgs.base) (hsPkgs.criterion) (hsPkgs.friday) ];
          };
        };
      };
    }