{ system
  ...
  , ... }:
  {
    ...
    package = {
      ...
      description = "Please see the example in the documentation at <https://vegowotenks.de/projects/Infinitree/> or in the readme at <https://git.jossco.de/VegOwOtenks/Infinitree#readme>";
      buildType = "Simple";
    };
    components = {
      "library" = {
