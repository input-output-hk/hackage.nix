      ...
      exes = {
        "xmobar" = {
          depends = ((([
            ...
            ]) ++ (pkgs.lib).optional (flags.with_utf8 && (compiler.isGhc && (compiler.version).lt "6.12.1")) (hsPkgs."utf8-string" or (buildDepError "utf8-string"))) ++ (pkgs.lib).optional (flags.with_inotify) (hsPkgs."hinotify" or (buildDepError "hinotify"));
          buildable = true;
          };
        };
      };
