{ system, compiler, flags, pkgs, hsPkgs, pkgconfPkgs, ... }:
  {
    ...
    package = {
      specVersion = "2.2";
      identifier = { name = "hedgehog-classes"; version = "0.2.4"; };
    ...
    components = {
      "library" = {
        depends = ((([
          ...
          ] ++ (pkgs.lib).optional (flags.aeson) (hsPkgs."aeson" or ((hsPkgs.pkgs-errors).buildDepError "aeson"))) ++ (pkgs.lib).optional (flags.semirings) (hsPkgs."semirings" or ((hsPkgs.pkgs-errors).buildDepError "semirings"))) ++ (pkgs.lib).optional (flags.comonad) (hsPkgs."comonad" or ((hsPkgs.pkgs-errors).buildDepError "comonad"))) ++ (pkgs.lib).optional (flags.primitive) (hsPkgs."primitive" or ((hsPkgs.pkgs-errors).buildDepError "primitive"));
        buildable = true;
        };
      tests = {
        "spec" = {
