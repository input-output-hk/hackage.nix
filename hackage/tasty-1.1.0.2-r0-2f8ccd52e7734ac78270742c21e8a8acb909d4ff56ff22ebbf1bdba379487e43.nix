{ system
  ...
  , ... }:
  {
    ...
    package = {
      specVersion = "1.10";
      identifier = { name = "tasty"; version = "1.1.0.2"; };
      license = "MIT";
      copyright = "";
      ...
      "library" = {
        depends = (([
          ...
          then [ (hsPkgs."clock" or (errorHandler.buildDepError "clock")) ]
            ...
            ])) ++ (pkgs.lib).optional (compiler.isGhc && (compiler.version).lt "7.6") (hsPkgs."ghc-prim" or (errorHandler.buildDepError "ghc-prim"))) ++ (pkgs.lib).optionals (!system.isWindows) [
