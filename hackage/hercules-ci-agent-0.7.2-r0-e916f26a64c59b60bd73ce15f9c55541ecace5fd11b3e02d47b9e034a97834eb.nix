{ system
  ...
  , ... }:
  {
    ...
    package = {
      specVersion = "2.4";
      identifier = { name = "hercules-ci-agent"; version = "0.7.2"; };
      license = "Apache-2.0";
      ...
      sublibs = {
        ...
        "cnix" = {
          depends = [
            ...
            (hsPkgs."hercules-ci-agent".components.sublibs.internal-ffi or (errorHandler.buildDepError "hercules-ci-agent:internal-ffi"))
            (hsPkgs."bytestring" or (errorHandler.buildDepError "bytestring"))
      ...
      exes = {
        "hercules-ci-agent" = {
          depends = [
            ...
            (hsPkgs."hercules-ci-agent".components.sublibs.cnix or (errorHandler.buildDepError "hercules-ci-agent:cnix"))
            (hsPkgs."conduit" or (errorHandler.buildDepError "conduit"))
