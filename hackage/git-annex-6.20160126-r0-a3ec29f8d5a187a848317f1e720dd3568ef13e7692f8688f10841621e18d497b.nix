      ...
      exes = {
        "git-annex" = {
          depends = (((((((((((((((([
            ...
            ]) ++ (pkgs.lib).optional (flags.webdav) (hsPkgs."DAV" or (buildDepError "DAV"))) ++ (pkgs.lib).optional (flags.assistant && !system.isSolaris) (hsPkgs."dns" or (buildDepError "dns"))) ++ (pkgs.lib).optionals (flags.assistant) (if system.isLinux
            then [ (hsPkgs."hinotify" or (buildDepError "hinotify")) ]
              ...
              then [ (hsPkgs."hfsevents" or (buildDepError "hfsevents")) ]
                ...
                else (pkgs.lib).optionals (!system.isSolaris && !system.isLinux) ((pkgs.lib).optional (flags.android) (hsPkgs."hinotify" or (buildDepError "hinotify"))))) ++ (pkgs.lib).optionals (system.isLinux) [
            ...
            ]) ++ (pkgs.lib).optional (flags.torrentparser) (hsPkgs."torrent" or (buildDepError "torrent"))) ++ (pkgs.lib).optional (flags.concurrentoutput) (hsPkgs."concurrent-output" or (buildDepError "concurrent-output"))) ++ (pkgs.lib).optional (flags.ekg) (hsPkgs."ekg" or (buildDepError "ekg"))) ++ (pkgs.lib).optionals (flags.benchmark) [
