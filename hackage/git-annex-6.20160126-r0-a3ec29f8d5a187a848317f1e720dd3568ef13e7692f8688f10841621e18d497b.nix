{ system
  ...
  , ... }:
  {
    ...
    package = {
      specVersion = "1.8";
      identifier = { name = "git-annex"; version = "6.20160126"; };
    ...
    components = {
      exes = {
        "git-annex" = {
          ...
          ]) ++ pkgs.lib.optional (flags.webdav) (hsPkgs."DAV" or (errorHandler.buildDepError "DAV"))) ++ pkgs.lib.optional (flags.assistant && !system.isSolaris) (hsPkgs."dns" or (errorHandler.buildDepError "dns"))) ++ pkgs.lib.optionals (flags.assistant) (if system.isLinux
            then [
              ...
              then [
                ...
                else pkgs.lib.optionals (!system.isSolaris && !system.isLinux) (pkgs.lib.optional (flags.android) (hsPkgs."hinotify" or (errorHandler.buildDepError "hinotify"))))) ++ pkgs.lib.optionals (system.isLinux) [
          ...
          ]) ++ pkgs.lib.optional (flags.torrentparser) (hsPkgs."torrent" or (errorHandler.buildDepError "torrent"))) ++ pkgs.lib.optional (flags.concurrentoutput) (hsPkgs."concurrent-output" or (errorHandler.buildDepError "concurrent-output"))) ++ pkgs.lib.optional (flags.ekg) (hsPkgs."ekg" or (errorHandler.buildDepError "ekg"))) ++ pkgs.lib.optionals (flags.benchmark) [
