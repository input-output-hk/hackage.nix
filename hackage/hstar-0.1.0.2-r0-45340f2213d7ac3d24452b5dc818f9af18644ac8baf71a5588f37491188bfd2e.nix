      ...
      exes = {
        "hstar" = {
          depends = ((([
            ...
            ] ++ (pkgs.lib).optional (flags.with-brotli) (hsPkgs."brotli" or (buildDepError "brotli"))) ++ (pkgs.lib).optional (flags.pure) (hsPkgs."archive-tar" or (buildDepError "archive-tar"))) ++ (pkgs.lib).optional (flags.tar-bytestring) (hsPkgs."archive-tar-bytestring" or (buildDepError "archive-tar-bytestring"))) ++ (pkgs.lib).optional (!flags.pure && !flags.tar-bytestring) (hsPkgs."archive-libarchive" or (buildDepError "archive-libarchive"));
          build-tools = [
