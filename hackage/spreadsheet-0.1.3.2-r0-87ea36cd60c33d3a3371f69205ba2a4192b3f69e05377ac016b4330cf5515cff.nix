{ system, compiler, flags, pkgs, hsPkgs, pkgconfPkgs, ... }:
  {
    ...
    package = {
      specVersion = "1.6";
      identifier = { name = "spreadsheet"; version = "0.1.3.2"; };
    ...
    components = {
      ...
      exes = {
        "csvreplace" = {
          depends = (pkgs.lib).optional (flags.buildexamples) (hsPkgs."bytestring" or ((hsPkgs.pkgs-errors).buildDepError "bytestring"));
