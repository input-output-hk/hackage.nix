{ system
  ...
  , ... }:
  {
    ...
    package = {
      specVersion = "1.8";
      identifier = { name = "warp"; version = "1.3.7.3"; };
      license = "MIT";
      copyright = "";
      ...
      "library" = {
        depends = (([
          ...
          then [
            ...
            (hsPkgs."network" or (errorHandler.buildDepError "network"))
          ])) ++ pkgs.lib.optional (system.isLinux || system.isFreebsd || system.isOsx) (hsPkgs."hashable" or (errorHandler.buildDepError "hashable"))) ++ pkgs.lib.optional (!system.isWindows) (hsPkgs."unix" or (errorHandler.buildDepError "unix"));
        buildable = true;
      };
      tests = {
        "spec" = {
