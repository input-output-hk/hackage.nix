      ...
      "library" = {
        depends = (([
          ...
          then [
            ...
            (hsPkgs."network" or (buildDepError "network"))
            ])) ++ (pkgs.lib).optional (system.isLinux || system.isFreebsd || system.isOsx) (hsPkgs."hashable" or (buildDepError "hashable"))) ++ (pkgs.lib).optional (!system.isWindows) (hsPkgs."unix" or (buildDepError "unix"));
        };
      tests = {
        "spec" = {
          depends = [
