{ system
  ...
  , ... }:
  {
    ...
    package = {
      specVersion = "2.2";
      identifier = { name = "amazonka-appflow"; version = "2.0"; };
      license = "MPL-2.0";
    ...
    components = {
      ...
      tests = {
        "amazonka-appflow-test" = {
          depends = [
            (hsPkgs."amazonka-appflow" or (errorHandler.buildDepError "amazonka-appflow"))
            (hsPkgs."amazonka-core" or (errorHandler.buildDepError "amazonka-core"))
