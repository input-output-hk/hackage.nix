{ system, compiler, flags, pkgs, hsPkgs, pkgconfPkgs, ... }:
  {
    ...
    package = {
      specVersion = "1.10";
      identifier = { name = "ghc-mod"; version = "3.1.4"; };
    ...
    components = {
      "library" = {
        depends = [
          ...
          ] ++ (pkgs.lib).optional (compiler.isGhc && (compiler.version).lt "7.7") (hsPkgs."convertible" or ((hsPkgs.pkgs-errors).buildDepError "convertible"));
        buildable = true;
        };
      exes = {
        "ghc-mod" = {
      ...
      tests = {
        ...
        "spec" = {
          depends = ([
            ...
            ] ++ (pkgs.lib).optional (compiler.isGhc && (compiler.version).lt "7.7") (hsPkgs."convertible" or ((hsPkgs.pkgs-errors).buildDepError "convertible"))) ++ (pkgs.lib).optional (compiler.isGhc && (compiler.version).lt "7.6.0") (hsPkgs."executable-path" or ((hsPkgs.pkgs-errors).buildDepError "executable-path"));
          buildable = true;
          };
        };
      };
