{ system
  ...
  , ... }:
  {
    ...
    package = {
      ...
      description = "The hackage package has been superseded by the github repository which builds with Bazel. Please see https://github.com/tweag/inline-java/tree/master/jvm#readme.";
      buildType = "Simple";
      };
    components = {
      "library" = {
