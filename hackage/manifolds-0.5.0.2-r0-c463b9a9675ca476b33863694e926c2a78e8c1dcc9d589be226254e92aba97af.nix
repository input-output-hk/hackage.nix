...
in { system, compiler, flags, pkgs, hsPkgs, pkgconfPkgs, ... }:
  {
    ...
    package = {
      specVersion = "1.18";
      identifier = { name = "manifolds"; version = "0.5.0.2"; };
    ...
    components = {
      "library" = {
        depends = [
          ...
          (hsPkgs."spatial-rotations" or (buildDepError "spatial-rotations"))
          ...
          (hsPkgs."number-show" or (buildDepError "number-show"))
          ...
          (hsPkgs."pragmatic-show" or (buildDepError "pragmatic-show"))
