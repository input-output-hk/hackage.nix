{ system
  ...
  , ... }:
  {
    ...
    package = {
      specVersion = "2.2";
      identifier = { name = "snap-core"; version = "1.0.5.1"; };
    ...
    components = {
      "library" = {
        depends = ((([
          ...
          ]) ++ (pkgs.lib).optional (!(compiler.isGhc && (compiler.version).ge "7.6")) (hsPkgs."unix-compat" or (errorHandler.buildDepError "unix-compat"));
        buildable = true;
        };
      tests = {
        "testsuite" = {
