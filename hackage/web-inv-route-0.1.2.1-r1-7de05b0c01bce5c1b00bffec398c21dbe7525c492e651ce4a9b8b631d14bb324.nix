{ system, compiler, flags, pkgs, hsPkgs, pkgconfPkgs, ... }:
  {
    ...
    package = {
      specVersion = "1.20";
      identifier = { name = "web-inv-route"; version = "0.1.2.1"; };
    ...
    components = {
      "library" = {
        depends = ((([
          ...
          ] ++ (pkgs.lib).optional (flags.uri) (hsPkgs."network-uri" or ((hsPkgs.pkgs-errors).buildDepError "network-uri"))) ++ (pkgs.lib).optional (flags.wai) (hsPkgs."wai" or ((hsPkgs.pkgs-errors).buildDepError "wai"))) ++ (pkgs.lib).optional (flags.snap) (hsPkgs."snap-core" or ((hsPkgs.pkgs-errors).buildDepError "snap-core"))) ++ (pkgs.lib).optional (flags.happstack) (hsPkgs."happstack-server" or ((hsPkgs.pkgs-errors).buildDepError "happstack-server"));
        buildable = true;
        };
      tests = {
        "tests" = {
