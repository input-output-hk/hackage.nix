{ system
  ...
  , ... }:
  {
    flags = { curl = false; html-entities = true; };
    package = {
      specVersion = "1.18";
      identifier = { name = "cabal-rpm"; version = "2.3.2"; };
      license = "GPL-3.0-only";
      copyright = "2007-2008 Bryan O'Sullivan <bos@serpentine.com>,\n2012-2026 Jens Petersen <juhpetersen@gmail.com>";
      ...
      exes = {
        "cabal-rpm" = {
          depends = (([
            ...
            ])) ++ pkgs.lib.optional (flags.html-entities) (hsPkgs."html-entities" or (errorHandler.buildDepError "html-entities"));
          buildable = true;
        };
      };
    };
