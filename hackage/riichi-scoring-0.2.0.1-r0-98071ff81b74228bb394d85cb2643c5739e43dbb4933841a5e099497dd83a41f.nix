{ system
  ...
  , ... }:
  {
    ...
    package = {
      specVersion = "2.2";
      identifier = { name = "riichi-scoring"; version = "0.2.0.1"; };
      ...
      exes = {
        "riichi" = {
          depends = [
            ...
            (hsPkgs."containers" or (errorHandler.buildDepError "containers"))
            (hsPkgs."mtl" or (errorHandler.buildDepError "mtl"))
            (hsPkgs."riichi-scoring".components.sublibs.riichi-lib or (errorHandler.buildDepError "riichi-scoring:riichi-lib"))
          ];
          buildable = true;
        };
      };
