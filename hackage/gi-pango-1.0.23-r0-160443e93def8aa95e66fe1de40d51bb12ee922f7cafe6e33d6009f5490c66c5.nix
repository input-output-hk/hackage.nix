{ system
  ...
  , ... }:
  {
    ...
    package = {
      specVersion = "1.24";
      identifier = { name = "gi-pango"; version = "1.0.23"; };
      ...
      setup-depends = [
        ...
        (hsPkgs.buildPackages.gi-harfbuzz or (pkgs.buildPackages.gi-harfbuzz or (errorHandler.buildToolDepError "gi-harfbuzz")))
        ];
      };
    components = {
      "library" = {
