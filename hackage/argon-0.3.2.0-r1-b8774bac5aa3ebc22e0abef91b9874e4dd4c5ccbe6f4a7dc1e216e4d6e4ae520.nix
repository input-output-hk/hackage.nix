{ system, compiler, flags, pkgs, hsPkgs, pkgconfPkgs, ... }:
  {
    ...
    package = {
      specVersion = "1.10";
      identifier = { name = "argon"; version = "0.3.2.0"; };
      license = "ISC";
      ...
      exes = {
        "argon" = {
          depends = [
            ...
            ] ++ (pkgs.lib).optional (compiler.isGhc && (compiler.version).lt "7.10") (hsPkgs."pathwalk" or ((hsPkgs.pkgs-errors).buildDepError "pathwalk"));
          buildable = if compiler.isGhc && (compiler.version).lt "7.8"
            then false
            else true;
          };
