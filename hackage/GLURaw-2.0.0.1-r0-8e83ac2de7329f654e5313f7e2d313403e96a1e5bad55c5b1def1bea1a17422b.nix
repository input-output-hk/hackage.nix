{ system, compiler, flags, pkgs, hsPkgs, pkgconfPkgs, ... }:
  {
    ...
    package = {
      specVersion = "1.10";
      identifier = { name = "GLURaw"; version = "2.0.0.1"; };
    ...
    components = {
      "library" = {
        ...
        libs = if system.isWindows && flags.usenativewindowslibraries
          ...
          else (pkgs.lib).optionals (!system.isOsx) ((pkgs.lib).optional (!system.isIos) (pkgs."GLU" or ((hsPkgs.pkgs-errors).sysDepError "GLU")));
