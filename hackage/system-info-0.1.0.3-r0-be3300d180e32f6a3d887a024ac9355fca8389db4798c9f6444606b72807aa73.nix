{ system
  ...
  , ... }:
  {
    ...
    package = {
      specVersion = "1.18";
      identifier = { name = "system-info"; version = "0.1.0.3"; };
      license = "MIT";
    ...
    components = {
      "library" = {
        depends = (pkgs.lib).optional (system.isLinux) (hsPkgs."base" or (errorHandler.buildDepError "base")) ++ (pkgs.lib).optionals (system.isWindows) [
