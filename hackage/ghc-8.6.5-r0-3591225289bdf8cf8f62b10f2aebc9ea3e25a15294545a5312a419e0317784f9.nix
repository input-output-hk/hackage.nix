    ...
    components = {
      "library" = {
        depends = (([
          ...
          ] ++ (pkgs.lib).optional (!(system.isLinux && system.isX86_64 && (compiler.isGhc && (compiler.version).eq "8.6.5"))) (hsPkgs."base" or ((hsPkgs.pkgs-errors).buildDepError "base"))) ++ (pkgs.lib).optional (!flags.buildable) (hsPkgs."base" or ((hsPkgs.pkgs-errors).buildDepError "base"))) ++ (if system.isWindows
          then [
