{ system
  ...
  , ... }:
  {
    ...
    package = {
      specVersion = "3.4";
      identifier = { name = "haskell-bee-stm"; version = "0.1.0.0"; };
      ...
      url = "";
      synopsis = "STM broker implementation for haskell-bee";
      ...
      tests = {
        "stm-test-unit" = {
          depends = [
            ...
            (hsPkgs."unix-time" or (errorHandler.buildDepError "unix-time"))
            (hsPkgs."haskell-bee" or (errorHandler.buildDepError "haskell-bee"))
            (hsPkgs."haskell-bee-stm" or (errorHandler.buildDepError "haskell-bee-stm"))
          ];
          buildable = true;
        };
        "stm-test-integration" = {
          depends = [
            (hsPkgs."base" or (errorHandler.buildDepError "base"))
            (hsPkgs."aeson" or (errorHandler.buildDepError "aeson"))
            (hsPkgs."containers" or (errorHandler.buildDepError "containers"))
