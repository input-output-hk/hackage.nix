{ system
  ...
  , ... }:
  {
    flags = { interop-tests = false; };
    package = {
      specVersion = "1.12";
      identifier = { name = "sd-jwt"; version = "0.1.0.1"; };
      ...
      exes = {
        "sd-jwt-example" = {
          depends = [
            ...
            (hsPkgs."mtl" or (errorHandler.buildDepError "mtl"))
            (hsPkgs."scientific" or (errorHandler.buildDepError "scientific"))
            (hsPkgs."sd-jwt" or (errorHandler.buildDepError "sd-jwt"))
            (hsPkgs."text" or (errorHandler.buildDepError "text"))
            (hsPkgs."time" or (errorHandler.buildDepError "time"))
            (hsPkgs."vector" or (errorHandler.buildDepError "vector"))
          ];
        ...
        "sd-jwt-interop-test" = {
          depends = [
            ...
            (hsPkgs."time" or (errorHandler.buildDepError "time"))
            (hsPkgs."vector" or (errorHandler.buildDepError "vector"))
          ] ++ pkgs.lib.optionals (flags.interop-tests) [
          ...
          buildable = if flags.interop-tests then true else false;
        };
      };
      tests = {
        "sd-jwt-test" = {
