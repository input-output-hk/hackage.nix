{ system
  ...
  , ... }:
  {
    ...
    package = {
      specVersion = "1.24";
      identifier = { name = "hash-string"; version = "0.1.0.0"; };
      license = "Apache-2.0";
      ...
      homepage = "";
      url = "";
      synopsis = "binary strings supporting constant-time base16 and comparisons";
      description = "binary string types supporting constant-time base16 encoding and decoding, as\nwell as constant time lexicographic comparisons. Note that the time required\ndoes depend linearly on length, but is otherwise data-independent.";
      buildType = "Simple";
    };
    components = {
      "library" = {
