{ system
  ...
  , ... }:
  {
    ...
    package = {
      specVersion = "2.0";
      identifier = { name = "gi-dazzle"; version = "1.0.1"; };
      ...
      url = "";
      synopsis = "libdazzle bindings";
      description = "Bindings for libdazzle, autogenerated by haskell-gi.";
      buildType = "Custom";
      setup-depends = [
    ...
    components = {
      "library" = {
        ...
        pkgconfig = [
          (pkgconfPkgs."libdazzle-1.0" or (errorHandler.pkgConfDepError "libdazzle-1.0"))
        ];
        buildable = true;
      };
    };
