{ system, compiler, flags, pkgs, hsPkgs, pkgconfPkgs, ... }:
  {
    ...
    package = {
      specVersion = "1.10";
      identifier = { name = "taglib-api"; version = "0.1.1.3"; };
    ...
    components = {
      "library" = {
        ...
        libs = (pkgs.lib).optional (!flags.usepkgconfig) (pkgs."tag_c" or ((hsPkgs.pkgs-errors).sysDepError "tag_c"));
        pkgconfig = (pkgs.lib).optional (flags.usepkgconfig) (pkgconfPkgs."taglib_c" or ((hsPkgs.pkgs-errors).pkgConfDepError "taglib_c"));
        buildable = true;
        };
      };
    }