  ...
  , ... }:
  {
    ...
    components = {
      "library" = {
        ...
        ]) ++ pkgs.lib.optional (flags.full) (hsPkgs."svgcairo" or (errorHandler.buildDepError "svgcairo"))) ++ pkgs.lib.optional (flags.sdl) (hsPkgs."SDL" or (errorHandler.buildDepError "SDL"));
        buildable = true;
      };
    };
  }