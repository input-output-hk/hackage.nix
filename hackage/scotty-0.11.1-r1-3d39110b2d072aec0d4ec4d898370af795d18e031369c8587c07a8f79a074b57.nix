    ...
    components = {
      ...
      tests = {
        "spec" = {
          ...
          ] ++ pkgs.lib.optional (flags.hpc-coveralls) (hsPkgs.pkgsBuildBuild.hpc-coveralls.components.exes.hpc-coveralls or (pkgs.pkgsBuildBuild.hpc-coveralls or (errorHandler.buildToolDepError "hpc-coveralls:hpc-coveralls")));
          buildable = true;
        };
      };
    };
