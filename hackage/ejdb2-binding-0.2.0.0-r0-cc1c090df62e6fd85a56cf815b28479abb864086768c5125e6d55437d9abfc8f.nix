...
in { system, compiler, flags, pkgs, hsPkgs, pkgconfPkgs, ... }:
  {
    ...
    package = {
      specVersion = "2.4";
      identifier = { name = "ejdb2-binding"; version = "0.2.0.0"; };
      license = "MIT";
    ...
    components = {
      "library" = {
        ...
        libs = [ (pkgs."ejdb2" or (sysDepError "ejdb2")) ];
        pkgconfig = [
          (pkgconfPkgs."libejdb2" or (pkgConfDepError "libejdb2"))
          ];
        build-tools = [
      ...
      tests = {
        "ejdb2haskell-test" = {
          depends = [
            ...
            (hsPkgs."ejdb2-binding" or (buildDepError "ejdb2-binding"))
            ];
          buildable = true;
          };
        };
