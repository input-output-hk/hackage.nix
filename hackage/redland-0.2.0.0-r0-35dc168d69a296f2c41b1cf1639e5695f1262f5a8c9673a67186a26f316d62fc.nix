{ system, compiler, flags, pkgs, hsPkgs, pkgconfPkgs, ... }:
  {
    ...
    package = {
      specVersion = "1.10";
      identifier = { name = "redland"; version = "0.2.0.0"; };
    ...
    components = {
      "library" = {
        ...
        pkgconfig = [
          (pkgconfPkgs."raptor2" or ((hsPkgs.pkgs-errors).pkgConfDepError "raptor2"))
          (pkgconfPkgs."redland" or ((hsPkgs.pkgs-errors).pkgConfDepError "redland"))
          ];
        build-tools = [
