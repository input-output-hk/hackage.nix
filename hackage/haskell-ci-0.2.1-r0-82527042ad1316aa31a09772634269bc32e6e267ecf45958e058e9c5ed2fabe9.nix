      ...
      sublibs = {
        "haskell-ci-internal" = {
          depends = [
            ...
            ] ++ (pkgs.lib).optional (flags.shellcheck && (compiler.isGhc && ((compiler.version).ge "7.10" && (compiler.version).lt "8.7"))) (hsPkgs."ShellCheck" or ((hsPkgs.pkgs-errors).buildDepError "ShellCheck"));
          buildable = true;
          };
        };
      exes = {
