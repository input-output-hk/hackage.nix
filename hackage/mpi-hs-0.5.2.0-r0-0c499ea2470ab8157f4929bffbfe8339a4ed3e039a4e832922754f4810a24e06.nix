{ system, compiler, flags, pkgs, hsPkgs, pkgconfPkgs, ... }:
  {
    ...
    package = {
      specVersion = "1.12";
      identifier = { name = "mpi-hs"; version = "0.5.2.0"; };
      license = "Apache-2.0";
      copyright = "";
    ...
    components = {
      "library" = {
        ...
        libs = ((((pkgs.lib).optional (flags.openmpi-debian) (pkgs."mpi" or ((hsPkgs.pkgs-errors).sysDepError "mpi")) ++ (pkgs.lib).optional (flags.openmpi-macports) (pkgs."mpi" or ((hsPkgs.pkgs-errors).sysDepError "mpi"))) ++ (pkgs.lib).optional (flags.openmpi-ubuntu) (pkgs."mpi" or ((hsPkgs.pkgs-errors).sysDepError "mpi"))) ++ (pkgs.lib).optional (flags.mpich-macports) (pkgs."mpi" or ((hsPkgs.pkgs-errors).sysDepError "mpi"))) ++ (pkgs.lib).optional (flags.mpich-ubuntu) (pkgs."mpich" or ((hsPkgs.pkgs-errors).sysDepError "mpich"));
        build-tools = [
