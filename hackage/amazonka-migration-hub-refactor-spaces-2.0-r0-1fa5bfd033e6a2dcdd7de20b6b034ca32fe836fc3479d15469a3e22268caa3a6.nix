{ system
  ...
  , ... }:
  {
    ...
    components = {
      ...
      tests = {
        "amazonka-migration-hub-refactor-spaces-test" = {
          depends = [
            (hsPkgs."amazonka-core" or (errorHandler.buildDepError "amazonka-core"))
            (hsPkgs."amazonka-migration-hub-refactor-spaces" or (errorHandler.buildDepError "amazonka-migration-hub-refactor-spaces"))
