{ system
  ...
  , ... }:
  {
    ...
    package = {
      specVersion = "3.0";
      identifier = { name = "hackport"; version = "0.9.1.0"; };
      ...
      tests = {
        ...
        "doctests-v2" = {
          depends = [
            (hsPkgs."base" or (errorHandler.buildDepError "base"))
            (hsPkgs."process" or (errorHandler.buildDepError "process"))
          ] ++ pkgs.lib.optional (!flags.build-tool-depends) (hsPkgs."directory" or (errorHandler.buildDepError "directory"));
          build-tools = pkgs.lib.optional (flags.build-tool-depends) (hsPkgs.pkgsBuildBuild.doctest.components.exes.doctest or (pkgs.pkgsBuildBuild.doctest or (errorHandler.buildToolDepError "doctest:doctest")));
        ...
        "spec" = {
          ...
          build-tools = pkgs.lib.optional (flags.build-tool-depends) (hsPkgs.pkgsBuildBuild.hspec-discover.components.exes.hspec-discover or (pkgs.pkgsBuildBuild.hspec-discover or (errorHandler.buildToolDepError "hspec-discover:hspec-discover")));
          buildable = true;
        };
      };
    };
