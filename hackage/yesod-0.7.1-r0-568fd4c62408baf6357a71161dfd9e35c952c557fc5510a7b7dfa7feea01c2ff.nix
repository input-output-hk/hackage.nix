{ system, compiler, flags, pkgs, hsPkgs, pkgconfPkgs, ... }:
  {
    flags = { ghc7 = true; production = false; };
    package = {
      specVersion = "1.6";
      identifier = { name = "yesod"; version = "0.7.1"; };
    ...
    components = {
      "library" = {
        depends = ([
          ...
          ] ++ (pkgs.lib).optional (!flags.production) (hsPkgs."wai-handler-devel" or ((hsPkgs.pkgs-errors).buildDepError "wai-handler-devel"))) ++ [
