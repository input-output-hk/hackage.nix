{ system, compiler, flags, pkgs, hsPkgs, pkgconfPkgs, ... }:
  {
    ...
    package = {
      specVersion = "2.4";
      identifier = { name = "taskwarrior"; version = "0.1.2.0"; };
      ...
      description = "Types and aeson instances for the https://taskwarrior.org task import/export feature";
      buildType = "Simple";
      };
    components = {
      "library" = {
      ...
      tests = {
        "test-taskwarrior" = {
          depends = [
            ...
            (hsPkgs."taskwarrior" or ((hsPkgs.pkgs-errors).buildDepError "taskwarrior"))
            (hsPkgs."text" or ((hsPkgs.pkgs-errors).buildDepError "text"))
            (hsPkgs."time" or ((hsPkgs.pkgs-errors).buildDepError "time"))
            (hsPkgs."unordered-containers" or ((hsPkgs.pkgs-errors).buildDepError "unordered-containers"))
            (hsPkgs."uuid" or ((hsPkgs.pkgs-errors).buildDepError "uuid"))
