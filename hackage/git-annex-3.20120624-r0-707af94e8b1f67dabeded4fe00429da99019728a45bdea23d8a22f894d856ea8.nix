{ system, compiler, flags, pkgs, hsPkgs, pkgconfPkgs, ... }:
  {
    flags = { s3 = true; inotify = true; };
    package = {
      specVersion = "1.8";
      identifier = { name = "git-annex"; version = "3.20120624"; };
      ...
      exes = {
        "git-annex" = {
          depends = ([
            ...
            ] ++ (pkgs.lib).optional (flags.s3) (hsPkgs."hS3" or ((hsPkgs.pkgs-errors).buildDepError "hS3"))) ++ (pkgs.lib).optional (flags.inotify) (hsPkgs."hinotify" or ((hsPkgs.pkgs-errors).buildDepError "hinotify"));
          buildable = true;
          };
        };
      tests = {
