{ system
  ...
  , ... }:
  {
    ...
    package = {
      specVersion = "1.12";
      identifier = { name = "mig-server"; version = "0.1.0.0"; };
    ...
    components = {
      "library" = {
        depends = [
          ...
          (hsPkgs."mig-extra" or (errorHandler.buildDepError "mig-extra"))
          (hsPkgs."mig-swagger-ui" or (errorHandler.buildDepError "mig-swagger-ui"))
          (hsPkgs."mig-wai" or (errorHandler.buildDepError "mig-wai"))
