{ system
  ...
  , ... }:
  {
    ...
    package = {
      specVersion = "2.2";
      identifier = { name = "wled-json"; version = "0.1.0.4"; };
    ...
    components = {
      ...
      exes = {
        "wled-json-demo" = {
          ...
          ] ++ pkgs.lib.optional (compiler.isGhc && compiler.version.gt "9.12") (hsPkgs."semialign" or (errorHandler.buildDepError "semialign"));
          buildable = true;
        };
        "wled-json-simple" = {
          depends = [
