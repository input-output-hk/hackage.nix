{ system
  ...
  , ... }:
  {
    ...
    package = {
      specVersion = "2.2";
      identifier = { name = "amazonka-chime-sdk-voice"; version = "2.0"; };
      license = "MPL-2.0";
    ...
    components = {
      ...
      tests = {
        "amazonka-chime-sdk-voice-test" = {
          depends = [
            (hsPkgs."amazonka-chime-sdk-voice" or (errorHandler.buildDepError "amazonka-chime-sdk-voice"))
            (hsPkgs."amazonka-core" or (errorHandler.buildDepError "amazonka-core"))
