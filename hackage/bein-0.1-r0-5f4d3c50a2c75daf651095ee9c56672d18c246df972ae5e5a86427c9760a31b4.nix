    ...
    components = {
      exes = {
        "beinctl" = {
          ...
          libs = [
            (pkgs."pgport" or (errorHandler.sysDepError "pgport"))
            (pkgs."xslt" or (errorHandler.sysDepError "xslt"))
            (pkgs."xml2" or (errorHandler.sysDepError "xml2"))
            (pkgs."pam" or (errorHandler.sysDepError "pam"))
            ...
            (pkgs."crypt" or (errorHandler.sysDepError "crypt"))
