{ system, compiler, flags, pkgs, hsPkgs, pkgconfPkgs, ... }:
  {
    ...
    package = {
      specVersion = "1.6";
      identifier = { name = "xmobar"; version = "0.14"; };
    ...
    components = {
      exes = {
        "xmobar" = {
          ...
          libs = (pkgs.lib).optional true (pkgs."Xrandr" or ((hsPkgs.pkgs-errors).sysDepError "Xrandr")) ++ (pkgs.lib).optional (flags.with_iwlib || flags.all_extensions) (pkgs."iw" or ((hsPkgs.pkgs-errors).sysDepError "iw"));
          buildable = true;
          };
        };
      };
