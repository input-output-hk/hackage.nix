      ...
      tests = {
        ...
        "parser-tests" = {
          depends = ([
            ...
            (hsPkgs."Diff" or (buildDepError "Diff"))
            (hsPkgs."Cabal" or (buildDepError "Cabal"))
            ] ++ (pkgs.lib).optional (!(compiler.isGhc && (compiler.version).ge "8.0")) (hsPkgs."semigroups" or (buildDepError "semigroups"))) ++ (pkgs.lib).optional (compiler.isGhc && (compiler.version).ge "7.8") (hsPkgs."tree-diff" or (buildDepError "tree-diff"));
          buildable = true;
          };
        "check-tests" = {
          depends = [
