{ system, compiler, flags, pkgs, hsPkgs, pkgconfPkgs, ... }:
  {
    ...
    package = {
      specVersion = "1.12";
      identifier = { name = "cobot-io"; version = "0.1.2.10"; };
    ...
    components = {
      "library" = {
        depends = [
          ...
          (hsPkgs."hyraxAbif" or ((hsPkgs.pkgs-errors).buildDepError "hyraxAbif"))
      ...
      tests = {
        "cobot-io-test" = {
          depends = [
            ...
            (hsPkgs."binary" or ((hsPkgs.pkgs-errors).buildDepError "binary"))
            (hsPkgs."bytestring" or ((hsPkgs.pkgs-errors).buildDepError "bytestring"))
            (hsPkgs."cobot-io" or ((hsPkgs.pkgs-errors).buildDepError "cobot-io"))
            (hsPkgs."containers" or ((hsPkgs.pkgs-errors).buildDepError "containers"))
            (hsPkgs."data-msgpack" or ((hsPkgs.pkgs-errors).buildDepError "data-msgpack"))
            (hsPkgs."deepseq" or ((hsPkgs.pkgs-errors).buildDepError "deepseq"))
