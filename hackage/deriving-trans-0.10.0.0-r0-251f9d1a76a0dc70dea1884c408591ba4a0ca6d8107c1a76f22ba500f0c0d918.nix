{ system
  ...
  , ... }:
  {
    ...
    package = {
      specVersion = "3.0";
      identifier = { name = "deriving-trans"; version = "0.10.0.0"; };
    ...
    components = {
      "library" = {
        ...
        ] ++ pkgs.lib.optional (flags.exceptions) (hsPkgs."exceptions" or (errorHandler.buildDepError "exceptions"))) ++ pkgs.lib.optional (flags.logict) (hsPkgs."logict" or (errorHandler.buildDepError "logict"))) ++ pkgs.lib.optional (flags.monad-logger) (hsPkgs."monad-logger" or (errorHandler.buildDepError "monad-logger"))) ++ pkgs.lib.optional (flags.mtl) (hsPkgs."mtl" or (errorHandler.buildDepError "mtl"))) ++ pkgs.lib.optional (flags.primitive) (hsPkgs."primitive" or (errorHandler.buildDepError "primitive"))) ++ pkgs.lib.optional (flags.random) (hsPkgs."random" or (errorHandler.buildDepError "random"))) ++ pkgs.lib.optional (flags.resourcet) (hsPkgs."resourcet" or (errorHandler.buildDepError "resourcet"))) ++ pkgs.lib.optional (flags.unliftio) (hsPkgs."unliftio-core" or (errorHandler.buildDepError "unliftio-core"));
        buildable = true;
      };
    };
  }