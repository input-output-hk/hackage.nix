{ system, compiler, flags, pkgs, hsPkgs, pkgconfPkgs, ... }:
  {
    flags = { two = true; three = false; mtl = true; };
    package = {
      specVersion = "1.8";
      identifier = { name = "transformers-compat"; version = "0.5.1.2"; };
        ...
        depends = ([
          ...
          then [
            ...
            then [
              ...
              (hsPkgs."transformers" or ((hsPkgs.pkgs-errors).buildDepError "transformers"))
              ])) ++ (pkgs.lib).optional (!(!flags.mtl)) (hsPkgs."ghc-prim" or ((hsPkgs.pkgs-errors).buildDepError "ghc-prim"));
        buildable = true;
        };
      };
    }