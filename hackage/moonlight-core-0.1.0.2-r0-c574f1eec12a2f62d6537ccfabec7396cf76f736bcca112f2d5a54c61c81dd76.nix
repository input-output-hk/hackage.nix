{ system
  ...
  , ... }:
  {
    ...
    package = {
      specVersion = "3.0";
      identifier = { name = "moonlight-core"; version = "0.1.0.2"; };
      license = "MIT";
    ...
    components = {
      "library" = {
        depends = [
          ...
          (hsPkgs."moonlight-core".components.sublibs.egraph-program or (errorHandler.buildDepError "moonlight-core:egraph-program"))
          ...
          (hsPkgs."moonlight-core".components.sublibs.syntax or (errorHandler.buildDepError "moonlight-core:syntax"))
