{ system
  ...
  , ... }:
  {
    ...
    package = {
      specVersion = "1.8";
      identifier = { name = "lens"; version = "4.15.2"; };
    ...
    components = {
      "library" = {
        ...
        ] ++ pkgs.lib.optional (compiler.isGhc && compiler.version.lt "8.0") (hsPkgs."generic-deriving" or (errorHandler.buildDepError "generic-deriving"));
        buildable = true;
      };
      tests = {
        "templates" = {
