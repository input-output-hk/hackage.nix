    ...
    components = {
      "library" = {
        depends = [
          ...
          (hsPkgs."stackage-cabal" or ((hsPkgs.pkgs-errors).buildDepError "stackage-cabal"))
          (hsPkgs."stackage-sandbox" or ((hsPkgs.pkgs-errors).buildDepError "stackage-sandbox"))
          (hsPkgs."stackage-setup" or ((hsPkgs.pkgs-errors).buildDepError "stackage-setup"))
          ];
        buildable = true;
        };
      };
