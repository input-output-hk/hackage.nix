{ system
  ...
  , ... }:
  {
    ...
    package = {
      specVersion = "3.4";
      identifier = { name = "sqlc-hs"; version = "0.2.0.0"; };
      license = "Apache-2.0";
      copyright = "";
      ...
      description = "A Haskell code generator plugin for sqlc, allowing you to generate idiomatic Haskell types and functions directly from your SQL queries.\nIt leverages postgresql-simple, mysql-simple, and sqlite-simple, generating a thin layer on top of these well-known libraries.";
      buildType = "Simple";
    };
    components = {
      "library" = {
