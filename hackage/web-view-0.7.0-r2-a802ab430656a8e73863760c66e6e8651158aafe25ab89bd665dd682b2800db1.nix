{ system
  ...
  , ... }:
  {
    ...
    package = {
      specVersion = "2.2";
      identifier = { name = "web-view"; version = "0.7.0"; };
      ...
      description = "Type-safe HTML and CSS with intuitive layouts and composable styles. Inspired by Tailwindcss and Elm-UI";
      buildType = "Simple";
    };
    components = {
      "library" = {
