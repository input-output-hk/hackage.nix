    ...
    components = {
      exes = {
        "threadscope" = {
          ...
          ] ++ pkgs.lib.optional (system.isOsx) (hsPkgs."gtk-mac-integration" or (errorHandler.buildDepError "gtk-mac-integration"))) ++ pkgs.lib.optional (!system.isWindows) (hsPkgs."unix" or (errorHandler.buildDepError "unix"));
          buildable = true;
        };
      };
    };
