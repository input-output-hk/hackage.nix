{ system, compiler, flags, pkgs, hsPkgs, pkgconfPkgs, ... }:
  {
    ...
    package = {
      specVersion = "1.6";
      identifier = { name = "threadscope"; version = "0.2.11.1"; };
      ...
      exes = {
        "threadscope" = {
          depends = ([
            ...
            ] ++ (pkgs.lib).optional (system.isOsx) (hsPkgs."gtk-mac-integration" or ((hsPkgs.pkgs-errors).buildDepError "gtk-mac-integration"))) ++ (pkgs.lib).optional (!system.isWindows) (hsPkgs."unix" or ((hsPkgs.pkgs-errors).buildDepError "unix"));
          buildable = true;
          };
        };
      };
