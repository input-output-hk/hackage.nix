      ...
      exes = {
        "isdefinite-unsigned-th" = {
          depends = [
            ...
            (hsPkgs."hasktorch-types-th" or ((hsPkgs.pkgs-errors).buildDepError "hasktorch-types-th"))
            (hsPkgs."hasktorch-partial-unsigned" or ((hsPkgs.pkgs-errors).buildDepError "hasktorch-partial-unsigned"))
            ];
          buildable = true;
          };
        ...
        "isdefinite-signed-th" = {
          depends = [
            ...
            (hsPkgs."hasktorch-ffi-th" or ((hsPkgs.pkgs-errors).buildDepError "hasktorch-ffi-th"))
            (hsPkgs."hasktorch-types-th" or ((hsPkgs.pkgs-errors).buildDepError "hasktorch-types-th"))
            (hsPkgs."hasktorch-partial-signed" or ((hsPkgs.pkgs-errors).buildDepError "hasktorch-partial-signed"))
            ];
          buildable = true;
          };
        ...
        "isdefinite-floating-th" = {
          depends = [
            ...
            (hsPkgs."hasktorch-ffi-th" or ((hsPkgs.pkgs-errors).buildDepError "hasktorch-ffi-th"))
            (hsPkgs."hasktorch-types-th" or ((hsPkgs.pkgs-errors).buildDepError "hasktorch-types-th"))
            (hsPkgs."hasktorch-partial-floating" or ((hsPkgs.pkgs-errors).buildDepError "hasktorch-partial-floating"))
            ];
          buildable = true;
          };
