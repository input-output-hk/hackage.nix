{ system
  ...
  , ... }:
  {
    flags = { more-tests = false; old-text-tests = false; };
    package = {
      specVersion = "1.10";
      identifier = { name = "inspection-testing"; version = "0.4.4.0"; };
      license = "MIT";
    ...
    components = {
      ...
      tests = {
        ...
        "text" = {
          depends = pkgs.lib.optionals (flags.old-text-tests) [
            (hsPkgs."inspection-testing" or (errorHandler.buildDepError "inspection-testing"))
            (hsPkgs."base" or (errorHandler.buildDepError "base"))
            (hsPkgs."text" or (errorHandler.buildDepError "text"))
            (hsPkgs."bytestring" or (errorHandler.buildDepError "bytestring"))
          ];
          buildable = if flags.old-text-tests then true else false;
        };
      };
    };
  }