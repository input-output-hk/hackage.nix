{ system, compiler, flags, pkgs, hsPkgs, pkgconfPkgs, ... }:
  {
    ...
    package = {
      specVersion = "1.2";
      identifier = { name = "hake"; version = "0.4"; };
      license = "LicenseRef-GPL";
      copyright = "";
      maintainer = "Yoshikuni Jujo <PAF01143@nifty.ne.jp>";
      author = "Yoshikuni Jujo";
      homepage = "http://homepage3.nifty.com/salamander/second/projects/hake/index.xhtml";
      url = "http://homepage3.nifty.com/salamander/second/portage/distfiles/hake-0.4.tar.gz";
    ...
    components = {
      "library" = {
        depends = [ (hsPkgs.base) (hsPkgs.old-time) (hsPkgs.mtl) ];
        };
      exes = {
        "hake" = {
          depends = [ (hsPkgs.directory) (hsPkgs.process) (hsPkgs.yjtools) ];
          };
        };
      };
    }