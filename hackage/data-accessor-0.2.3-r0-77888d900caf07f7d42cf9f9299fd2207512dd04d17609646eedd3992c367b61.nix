{ system, compiler, flags, pkgs, hsPkgs, pkgconfPkgs, ... }:
  {
    flags = { monadfail = true; category = true; splitbase = true; };
    package = {
      specVersion = "1.6";
      identifier = { name = "data-accessor"; version = "0.2.3"; };
      ...
      "library" = {
        depends = [
          ...
          then [
            ...
            (hsPkgs."base" or ((hsPkgs.pkgs-errors).buildDepError "base"))
            ] ++ (pkgs.lib).optional (compiler.isJhc && true) (hsPkgs."containers" or ((hsPkgs.pkgs-errors).buildDepError "containers")));
        buildable = true;
        };
      };
    }