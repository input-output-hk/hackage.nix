{ system
  ...
  , ... }:
  {
    ...
    package = {
      specVersion = "1.22";
      identifier = { name = "hs-opentelemetry-api"; version = "1.0.0.0"; };
      ...
      url = "";
      synopsis = "OpenTelemetry API for libraries to instrument code or build wrappers.";
