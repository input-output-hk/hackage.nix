{ system
  ...
  , ... }:
  {
    ...
    package = {
      specVersion = "2.4";
      identifier = { name = "fractionizer"; version = "0.12.0.0"; };
      license = "MIT";
      ...
      homepage = "";
      url = "";
      synopsis = "Allows to approximate the fractional numbers in the range [0.005, 1] with sum of 2, 3, 4 or 5 unit fractions of special types.";
