{ system
  ...
  , ... }:
  {
    ...
    package = {
      specVersion = "1.12";
      identifier = { name = "persistent-mtl"; version = "0.5.0.1"; };
    ...
    components = {
      "library" = {
        ...
        buildable = if compiler.isGhc && compiler.version.ge "9.2.0" && (compiler.isGhc && compiler.version.lt "9.3") || compiler.isGhc && compiler.version.ge "9.4.0" && (compiler.isGhc && compiler.version.lt "9.4.3")
          then false
          else true;
      };
      tests = {
