{ system
  ...
  , ... }:
  {
    ...
    package = {
      specVersion = "3.0";
      identifier = { name = "hasql"; version = "2.0.0.0"; };
      license = "MIT";
    ...
    components = {
      "library" = {
        depends = [
          (hsPkgs."hasql".components.sublibs.codecs or (errorHandler.buildDepError "hasql:codecs"))
          (hsPkgs."hasql".components.sublibs.comms or (errorHandler.buildDepError "hasql:comms"))
          (hsPkgs."hasql".components.sublibs.engine or (errorHandler.buildDepError "hasql:engine"))
