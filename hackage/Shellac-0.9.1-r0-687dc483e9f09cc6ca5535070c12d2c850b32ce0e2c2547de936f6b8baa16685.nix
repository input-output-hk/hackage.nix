  ...
  , ... }:
  {
    ...
    components = {
      "library" = {
        ...
        ] ++ pkgs.lib.optionals (!system.isWindows) (pkgs.lib.optional (compiler.isGhc && compiler.version.ge "6.8") (hsPkgs."unix" or (errorHandler.buildDepError "unix")))) ++ pkgs.lib.optional (compiler.isGhc && compiler.version.ge "6.8") (hsPkgs."directory" or (errorHandler.buildDepError "directory"));
        buildable = true;
      };
    };
  }