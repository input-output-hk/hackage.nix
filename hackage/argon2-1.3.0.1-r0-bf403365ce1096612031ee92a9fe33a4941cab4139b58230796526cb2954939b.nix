  ...
  , ... }:
  {
    ...
    components = {
      "library" = {
        ...
        libs = (pkgs.lib).optionals (flags.use-system-library) ((pkgs.lib).optional (!flags.pkg-config) (pkgs."argon2" or (errorHandler.sysDepError "argon2")));
        pkgconfig = (pkgs.lib).optionals (flags.use-system-library) ((pkgs.lib).optional (flags.pkg-config) (pkgconfPkgs."libargon2" or (errorHandler.pkgConfDepError "libargon2")));
        buildable = true;
        };
      tests = {
        "tests" = {
