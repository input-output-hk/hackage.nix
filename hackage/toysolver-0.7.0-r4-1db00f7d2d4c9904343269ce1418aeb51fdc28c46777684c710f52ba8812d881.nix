{ system
  ...
  , ... }:
  {
    ...
    package = {
      specVersion = "2.0";
      identifier = { name = "toysolver"; version = "0.7.0"; };
    ...
    components = {
      "library" = {
        depends = (([
          ...
          ] ++ (pkgs.lib).optional (flags.withzlib) (hsPkgs."zlib" or (errorHandler.buildDepError "zlib"))) ++ (pkgs.lib).optional (flags.opencl) (hsPkgs."OpenCL" or (errorHandler.buildDepError "OpenCL"))) ++ (pkgs.lib).optional (compiler.isGhc && true) (hsPkgs."ghc-prim" or (errorHandler.buildDepError "ghc-prim"));
        buildable = true;
        };
      foreignlibs = {
        "toysat-ipasir" = {
