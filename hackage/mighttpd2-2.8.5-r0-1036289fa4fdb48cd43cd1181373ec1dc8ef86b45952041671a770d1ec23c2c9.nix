...
in { system, compiler, flags, pkgs, hsPkgs, pkgconfPkgs, ... }:
  {
    ...
    package = {
      specVersion = "1.8";
      identifier = { name = "mighttpd2"; version = "2.8.5"; };
      ...
      exes = {
        "mighty" = {
          depends = ([
            ...
            ] ++ (pkgs.lib).optional (flags.rev-proxy) (hsPkgs."http-conduit" or (buildDepError "http-conduit"))) ++ (pkgs.lib).optionals (flags.tls) [
