{ system
  ...
  , ... }:
  {
    ...
    components = {
      ...
      tests = {
        "amazonka-codestar-notifications-test" = {
          depends = [
            (hsPkgs."amazonka-codestar-notifications" or (errorHandler.buildDepError "amazonka-codestar-notifications"))
            (hsPkgs."amazonka-core" or (errorHandler.buildDepError "amazonka-core"))
