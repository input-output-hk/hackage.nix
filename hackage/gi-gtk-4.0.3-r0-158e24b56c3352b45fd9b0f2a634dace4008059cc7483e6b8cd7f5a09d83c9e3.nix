  ...
  , ... }:
  {
    ...
    package = {
      ...
      setup-depends = [
        ...
        (hsPkgs.buildPackages.gi-graphene or (pkgs.buildPackages.gi-graphene or (errorHandler.setupDepError "gi-graphene")))
        (hsPkgs.buildPackages.gi-gsk or (pkgs.buildPackages.gi-gsk or (errorHandler.setupDepError "gi-gsk")))
