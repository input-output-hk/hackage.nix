{ system
  ...
  , ... }:
  {
    ...
    package = {
      specVersion = "2.2";
      identifier = { name = "amazonka-cloudformation"; version = "2.0"; };
      license = "MPL-2.0";
