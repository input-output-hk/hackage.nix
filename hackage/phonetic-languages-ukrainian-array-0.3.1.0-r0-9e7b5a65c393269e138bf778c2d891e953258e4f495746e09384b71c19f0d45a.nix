{ system
  ...
  , ... }:
  {
    ...
    package = {
      ...
      description = "Applies needed minimal grammar connections so that the text afterwards can be processed by dobutokO-poetry or phonetic languages approach related programs. Uses arrays instead of vectors.";
      buildType = "Simple";
    };
    components = {
      "library" = {
