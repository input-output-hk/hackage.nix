{ system, compiler, flags, pkgs, hsPkgs, pkgconfPkgs, ... }:
  {
    ...
    package = {
      specVersion = "1.2";
      identifier = { name = "clustertools"; version = "0.1.2"; };
    ...
    components = {
      exes = {
        ...
        "ace2fasta" = { depends = [ (hsPkgs.bio) ]; };
        "ace2clusters" = { depends = [ (hsPkgs.bio) ]; };
        "clusterlibs" = {
          depends = [ (hsPkgs.regex-compat) (hsPkgs.QuickCheck) ];
          };
        "xcerpt" = { depends = [ (hsPkgs.haskell98) ]; };
        };
      };
    }