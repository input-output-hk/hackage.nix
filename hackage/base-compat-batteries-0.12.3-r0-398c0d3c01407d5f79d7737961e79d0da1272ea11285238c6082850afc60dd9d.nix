{ system
  ...
  , ... }:
  {
    ...
    package = {
      specVersion = "1.10";
      identifier = { name = "base-compat-batteries"; version = "0.12.3"; };
      license = "MIT";
    ...
    components = {
      "library" = {
        ...
        ]) ++ pkgs.lib.optional (!(compiler.isGhc && compiler.version.ge "8.6")) (hsPkgs."contravariant" or (errorHandler.buildDepError "contravariant"))) ++ pkgs.lib.optionals (!(compiler.isGhc && compiler.version.ge "9.0")) ([
          (hsPkgs."OneTuple" or (errorHandler.buildDepError "OneTuple"))
        ] ++ pkgs.lib.optional (!(compiler.isGhc && compiler.version.ge "7.8")) (hsPkgs."OneTuple" or (errorHandler.buildDepError "OneTuple")));
        buildable = true;
      };
      tests = {
        "spec" = {
