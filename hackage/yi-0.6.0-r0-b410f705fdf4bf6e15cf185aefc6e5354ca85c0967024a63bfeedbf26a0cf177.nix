      ...
      exes = {
        "yi" = {
          depends = ((((((([
            ...
            ] ++ (pkgs.lib).optional (!system.isWindows) (hsPkgs."unix" or (buildDepError "unix"))) ++ (pkgs.lib).optional (flags.vty) (hsPkgs."vty" or (buildDepError "vty"))) ++ (pkgs.lib).optionals (flags.gtk) [
            (hsPkgs."gtk" or (buildDepError "gtk"))
            (hsPkgs."glib" or (buildDepError "glib"))
            ]) ++ (pkgs.lib).optional (flags.pango) (hsPkgs."gtk" or (buildDepError "gtk"))) ++ (pkgs.lib).optionals (flags.cocoa) [
            ...
            ]) ++ (pkgs.lib).optional (flags.ghcinterpreter) (hsPkgs."hint" or (buildDepError "hint"))) ++ (pkgs.lib).optionals (flags.ghcapi) [
