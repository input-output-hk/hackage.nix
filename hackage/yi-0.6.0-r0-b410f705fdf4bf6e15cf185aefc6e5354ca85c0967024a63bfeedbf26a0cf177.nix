      ...
      exes = {
        "yi" = {
          depends = ((((((([
            ...
            ] ++ (pkgs.lib).optional (!system.isWindows) (hsPkgs."unix" or ((hsPkgs.pkgs-errors).buildDepError "unix"))) ++ (pkgs.lib).optional (flags.vty) (hsPkgs."vty" or ((hsPkgs.pkgs-errors).buildDepError "vty"))) ++ (pkgs.lib).optionals (flags.gtk) [
            (hsPkgs."gtk" or ((hsPkgs.pkgs-errors).buildDepError "gtk"))
            (hsPkgs."glib" or ((hsPkgs.pkgs-errors).buildDepError "glib"))
            ]) ++ (pkgs.lib).optional (flags.pango) (hsPkgs."gtk" or ((hsPkgs.pkgs-errors).buildDepError "gtk"))) ++ (pkgs.lib).optionals (flags.cocoa) [
            ...
            ]) ++ (pkgs.lib).optional (flags.ghcinterpreter) (hsPkgs."hint" or ((hsPkgs.pkgs-errors).buildDepError "hint"))) ++ (pkgs.lib).optionals (flags.ghcapi) [
