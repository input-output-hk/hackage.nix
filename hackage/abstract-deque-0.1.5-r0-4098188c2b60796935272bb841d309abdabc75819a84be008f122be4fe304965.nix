{ system, compiler, flags, pkgs, hsPkgs, pkgconfPkgs, ... }:
  {
    ...
    package = {
      specVersion = "1.8";
      identifier = { name = "abstract-deque"; version = "0.1.5"; };
    ...
    components = {
      "library" = {
        depends = [
          ...
          ] ++ (pkgs.lib).optional (compiler.isGhc && (compiler.version).ge "7.2") (hsPkgs."IORefCAS" or ((hsPkgs.pkgs-errors).buildDepError "IORefCAS"));
        buildable = true;
        };
      tests = {
        "test-abstract-deque" = {
