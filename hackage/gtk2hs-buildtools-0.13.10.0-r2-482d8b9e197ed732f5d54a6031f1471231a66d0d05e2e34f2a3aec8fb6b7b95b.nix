{ system
  ...
  , ... }:
  {
    ...
    package = {
      specVersion = "3.0";
      identifier = { name = "gtk2hs-buildtools"; version = "0.13.10.0"; };
    ...
    components = {
      "library" = {
        ...
        ] ++ pkgs.lib.optional (!(compiler.isGhc && compiler.version.ge "8.0")) (hsPkgs."fail" or (errorHandler.buildDepError "fail"))) ++ pkgs.lib.optional (compiler.isGhc && compiler.version.ge "7.7") (hsPkgs."hashtables" or (errorHandler.buildDepError "hashtables"));
        build-tools = [
