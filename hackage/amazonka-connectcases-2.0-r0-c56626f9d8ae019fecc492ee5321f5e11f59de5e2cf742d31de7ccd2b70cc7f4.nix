{ system
  ...
  , ... }:
  {
    ...
    package = {
      specVersion = "2.2";
      identifier = { name = "amazonka-connectcases"; version = "2.0"; };
      license = "MPL-2.0";
    ...
    components = {
      ...
      tests = {
        "amazonka-connectcases-test" = {
          depends = [
            (hsPkgs."amazonka-connectcases" or (errorHandler.buildDepError "amazonka-connectcases"))
            (hsPkgs."amazonka-core" or (errorHandler.buildDepError "amazonka-core"))
