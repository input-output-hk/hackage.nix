{ system
  ...
  , ... }:
  {
    flags = { no-hgeometry = false; };
    package = {
      specVersion = "2.0";
      identifier = { name = "reanimate"; version = "1.1.3.2"; };
    ...
    components = {
      "library" = {
        ...
        ] ++ pkgs.lib.optional (!system.isWindows) (hsPkgs."unix" or (errorHandler.buildDepError "unix"))) ++ pkgs.lib.optionals (!flags.no-hgeometry) [
