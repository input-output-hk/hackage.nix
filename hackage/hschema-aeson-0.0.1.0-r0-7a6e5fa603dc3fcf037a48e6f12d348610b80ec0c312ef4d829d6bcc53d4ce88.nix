{ system
  ...
  , ... }:
  {
    ...
    package = {
      specVersion = "1.12";
      identifier = { name = "hschema-aeson"; version = "0.0.1.0"; };
    ...
    components = {
      "library" = {
        depends = [
          ...
          (hsPkgs."hschema-prettyprinter" or (errorHandler.buildDepError "hschema-prettyprinter"))
          (hsPkgs."hschema-quickcheck" or (errorHandler.buildDepError "hschema-quickcheck"))
      ...
      tests = {
        "hschema-test" = {
          depends = [
            ...
            (hsPkgs."free" or (errorHandler.buildDepError "free"))
            (hsPkgs."hschema" or (errorHandler.buildDepError "hschema"))
            (hsPkgs."hschema-aeson" or (errorHandler.buildDepError "hschema-aeson"))
            (hsPkgs."hschema-prettyprinter" or (errorHandler.buildDepError "hschema-prettyprinter"))
            (hsPkgs."hschema-quickcheck" or (errorHandler.buildDepError "hschema-quickcheck"))
