    ...
    components = {
      "library" = {
        ...
        libs = if flags.mpich14
          then [
            (pkgs."mpich" or ((hsPkgs.pkgs-errors).sysDepError "mpich"))
            (pkgs."opa" or ((hsPkgs.pkgs-errors).sysDepError "opa"))
            (pkgs."mpl" or ((hsPkgs.pkgs-errors).sysDepError "mpl"))
            ]
          else [
            (pkgs."mpi" or ((hsPkgs.pkgs-errors).sysDepError "mpi"))
            (pkgs."open-rte" or ((hsPkgs.pkgs-errors).sysDepError "open-rte"))
            (pkgs."open-pal" or ((hsPkgs.pkgs-errors).sysDepError "open-pal"))
            ];
        build-tools = [
