    ...
    components = {
      "library" = {
        ...
        libs = if flags.mpich14
          then [
            (pkgs."mpich" or (sysDepError "mpich"))
            (pkgs."opa" or (sysDepError "opa"))
            (pkgs."mpl" or (sysDepError "mpl"))
            ]
          else [
            (pkgs."mpi" or (sysDepError "mpi"))
            (pkgs."open-rte" or (sysDepError "open-rte"))
            (pkgs."open-pal" or (sysDepError "open-pal"))
            ];
        build-tools = [
