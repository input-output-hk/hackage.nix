{ system
  ...
  , ... }:
  {
    ...
    package = {
      specVersion = "2.4";
      identifier = { name = "network-packet-linux"; version = "0.1.0.0"; };
    ...
    components = {
      "library" = {
        depends = [
          ...
          (hsPkgs."vendored-network" or (errorHandler.buildDepError "vendored-network"))
        ];
        build-tools = [
      ...
      tests = {
        ...
        "socketspec" = {
          depends = [
            ...
            (hsPkgs."network" or (errorHandler.buildDepError "network"))
            (hsPkgs."vendored-network-test" or (errorHandler.buildDepError "vendored-network-test"))
            (hsPkgs."network-packet-linux" or (errorHandler.buildDepError "network-packet-linux"))
          ];
          build-tools = [
