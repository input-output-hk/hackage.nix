{ system
  ...
  , ... }:
  {
    ...
    package = {
      specVersion = "2.4";
      identifier = { name = "ghcide"; version = "1.4.0.3"; };
      license = "Apache-2.0";
    ...
    components = {
      ...
      benchmarks = {
        "benchHist" = {
          ...
          build-tools = [
            (hsPkgs.pkgsBuildBuild.ghcide.components.exes.ghcide-bench or (pkgs.pkgsBuildBuild.ghcide-bench or (errorHandler.buildToolDepError "ghcide:ghcide-bench")))
