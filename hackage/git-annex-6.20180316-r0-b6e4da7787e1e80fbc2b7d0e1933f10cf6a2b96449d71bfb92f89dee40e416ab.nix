{ system, compiler, flags, pkgs, hsPkgs, pkgconfPkgs, ... }:
  {
    ...
    package = {
      specVersion = "1.8";
      identifier = { name = "git-annex"; version = "6.20180316"; };
      ...
      exes = {
        "git-annex" = {
          depends = ((((((((((((([
            ...
            ]) ++ (pkgs.lib).optional (flags.webdav) (hsPkgs."DAV" or ((hsPkgs.pkgs-errors).buildDepError "DAV"))) ++ (pkgs.lib).optionals (flags.assistant && !system.isSolaris && !system.isHurd) [
            ...
            ]) ++ (pkgs.lib).optional (flags.torrentparser) (hsPkgs."torrent" or ((hsPkgs.pkgs-errors).buildDepError "torrent"))) ++ (pkgs.lib).optionals (flags.magicmime) ((pkgs.lib).optional (!system.isWindows) (hsPkgs."magic" or ((hsPkgs.pkgs-errors).buildDepError "magic")))) ++ (pkgs.lib).optional (flags.concurrentoutput) (hsPkgs."concurrent-output" or ((hsPkgs.pkgs-errors).buildDepError "concurrent-output"))) ++ (pkgs.lib).optionals (flags.benchmark) [
