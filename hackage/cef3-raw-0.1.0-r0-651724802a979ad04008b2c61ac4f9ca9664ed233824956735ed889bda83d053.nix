...
in { system, compiler, flags, pkgs, hsPkgs, pkgconfPkgs, ... }:
  {
    ...
    components = {
      "library" = {
        ...
        libs = (pkgs.lib).optional (system.isLinux) (pkgs."cef" or (sysDepError "cef")) ++ (pkgs.lib).optional (system.isWindows) (pkgs."libcef" or (sysDepError "libcef"));
        pkgconfig = (pkgs.lib).optional (system.isLinux) (pkgconfPkgs."gtk+-2.0" or (pkgConfDepError "gtk+-2.0"));
        build-tools = [
