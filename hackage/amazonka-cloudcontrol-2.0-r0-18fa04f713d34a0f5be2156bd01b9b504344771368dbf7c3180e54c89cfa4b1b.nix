{ system
  ...
  , ... }:
  {
    ...
    package = {
      specVersion = "2.2";
      identifier = { name = "amazonka-cloudcontrol"; version = "2.0"; };
      license = "MPL-2.0";
    ...
    components = {
      ...
      tests = {
        "amazonka-cloudcontrol-test" = {
          depends = [
            (hsPkgs."amazonka-cloudcontrol" or (errorHandler.buildDepError "amazonka-cloudcontrol"))
            (hsPkgs."amazonka-core" or (errorHandler.buildDepError "amazonka-core"))
