{ system, compiler, flags, pkgs, hsPkgs, pkgconfPkgs, ... }:
  {
    ...
    package = {
      specVersion = "1.18";
      identifier = { name = "ats-format"; version = "0.1.1.0"; };
      ...
      setup-depends = [
        ...
        (hsPkgs.buildPackages.composition-prelude or (pkgs.buildPackages.composition-prelude or ((hsPkgs.pkgs-errors).buildToolDepError "composition-prelude")))
