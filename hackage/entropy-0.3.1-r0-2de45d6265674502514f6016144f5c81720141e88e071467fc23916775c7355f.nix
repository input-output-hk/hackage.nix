{ system, compiler, flags, pkgs, hsPkgs, pkgconfPkgs, ... }:
  {
    ...
    package = {
      specVersion = "1.10";
      identifier = { name = "entropy"; version = "0.3.1"; };
    ...
    components = {
      "library" = {
        depends = [
          ...
          ] ++ (pkgs.lib).optionals (!system.isWindows) ((pkgs.lib).optional (!flags.halvm) (hsPkgs."unix" or ((hsPkgs.pkgs-errors).buildDepError "unix")));
