{ system
  ...
  , ... }:
  {
    flags = { mapoperad = false; polybag = false; useoldmap = false; };
    package = {
      specVersion = "1.2";
      identifier = { name = "Operads"; version = "0.7"; };
      license = "BSD-3-Clause";
      copyright = "© 2009 Mikael Vejdemo Johansson";
      maintainer = "mik@stanford.edu";
      author = "Mikael Vejdemo Johansson";
      homepage = "http://math.stanford.edu/~mik/operads";
      url = "http://hackage.haskell.org/packages/archive/Operads/0.4/Operads-0.4.tar.gz";
