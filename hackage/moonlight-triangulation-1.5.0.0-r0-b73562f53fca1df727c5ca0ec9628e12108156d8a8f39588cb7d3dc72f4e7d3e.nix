{ system
  ...
  , ... }:
  {
    ...
    package = {
      specVersion = "3.4";
      identifier = { name = "moonlight-triangulation"; version = "1.5.0.0"; };
      license = "MIT";
    ...
    components = {
      "library" = {
        depends = [
          ...
          (hsPkgs."moonlight-triangulation".components.sublibs.storage-internal or (errorHandler.buildDepError "moonlight-triangulation:storage-internal"))
        ];
        buildable = true;
      };
      sublibs = {
