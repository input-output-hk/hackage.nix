{ system, compiler, flags, pkgs, hsPkgs, pkgconfPkgs, ... }:
  {
    ...
    package = {
      specVersion = "1.10";
      identifier = { name = "wigner-ville-accelerate"; version = "0.1.0.1"; };
    ...
    components = {
      "library" = {
        depends = [ (hsPkgs.base) (hsPkgs.accelerate) (hsPkgs.accelerate-fft) ];
        };
      tests = {
        "wigner-test" = { depends = [ (hsPkgs.base) (hsPkgs.wigner) ]; };
        };
      };
    }