    ...
    components = {
      "library" = {
        depends = (((((((([
          ...
          (hsPkgs."data-default-instances-new-base" or (errorHandler.buildDepError "data-default-instances-new-base"))
          ] ++ (pkgs.lib).optional (compiler.isGhc && (compiler.version).lt "7.6") (hsPkgs."ghc-prim" or (errorHandler.buildDepError "ghc-prim"))) ++ (pkgs.lib).optional (flags.with-bytestring) (hsPkgs."data-default-instances-bytestring" or (errorHandler.buildDepError "data-default-instances-bytestring"))) ++ (pkgs.lib).optional (flags.with-case-insensitive) (hsPkgs."data-default-instances-case-insensitive" or (errorHandler.buildDepError "data-default-instances-case-insensitive"))) ++ (pkgs.lib).optional (flags.with-containers) (hsPkgs."data-default-instances-containers" or (errorHandler.buildDepError "data-default-instances-containers"))) ++ (pkgs.lib).optional (flags.with-dlist) (hsPkgs."data-default-instances-dlist" or (errorHandler.buildDepError "data-default-instances-dlist"))) ++ (pkgs.lib).optional (flags.with-text) (hsPkgs."data-default-instances-text" or (errorHandler.buildDepError "data-default-instances-text"))) ++ (pkgs.lib).optional (flags.with-old-locale) (hsPkgs."data-default-instances-old-locale" or (errorHandler.buildDepError "data-default-instances-old-locale"))) ++ (pkgs.lib).optional (flags.with-unordered-containers) (hsPkgs."data-default-instances-unordered-containers" or (errorHandler.buildDepError "data-default-instances-unordered-containers"))) ++ (pkgs.lib).optional (flags.with-vector) (hsPkgs."data-default-instances-vector" or (errorHandler.buildDepError "data-default-instances-vector"));
        buildable = true;
        };
      };
    }