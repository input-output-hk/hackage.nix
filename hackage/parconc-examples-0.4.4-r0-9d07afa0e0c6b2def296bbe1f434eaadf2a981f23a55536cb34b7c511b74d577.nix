    ...
    components = {
      exes = {
        ...
        "fwaccel" = {
          depends = [
            (hsPkgs."base" or ((hsPkgs.pkgs-errors).buildDepError "base"))
            ] ++ (pkgs.lib).optional (flags.accelerate) (hsPkgs."accelerate" or ((hsPkgs.pkgs-errors).buildDepError "accelerate"));
          buildable = if flags.accelerate then true else false;
          };
        "fwaccel-gpu" = {
          depends = ([
            (hsPkgs."base" or ((hsPkgs.pkgs-errors).buildDepError "base"))
            ] ++ (pkgs.lib).optional (flags.accelerate) (hsPkgs."accelerate" or ((hsPkgs.pkgs-errors).buildDepError "accelerate"))) ++ (pkgs.lib).optional (flags.cuda) (hsPkgs."accelerate-cuda" or ((hsPkgs.pkgs-errors).buildDepError "accelerate-cuda"));
        ...
        "ping" = {
          depends = (([
            ...
            then [
              ...
              (hsPkgs."network" or ((hsPkgs.pkgs-errors).buildDepError "network"))
              ])) ++ (pkgs.lib).optional (compiler.isGhc && (compiler.version).le "7.6") (hsPkgs."ghc-prim" or ((hsPkgs.pkgs-errors).buildDepError "ghc-prim"))) ++ (pkgs.lib).optionals (flags.distributed) [
