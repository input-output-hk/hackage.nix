      ...
      exes = {
        "git-annex" = {
          depends = ((((((((((((((((((((([
            ...
            ]) ++ (pkgs.lib).optional (flags.webdav) (hsPkgs."DAV" or ((hsPkgs.pkgs-errors).buildDepError "DAV"))) ++ (pkgs.lib).optionals (flags.assistant) (if system.isLinux
            then [
              ...
              then [
                ...
                else (pkgs.lib).optionals (!system.isSolaris && !system.isLinux) ((pkgs.lib).optional (flags.android) (hsPkgs."hinotify" or ((hsPkgs.pkgs-errors).buildDepError "hinotify"))))) ++ (pkgs.lib).optionals (system.isLinux) [
