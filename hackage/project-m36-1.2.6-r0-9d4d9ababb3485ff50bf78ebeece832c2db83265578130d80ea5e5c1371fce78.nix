{ system
  ...
  , ... }:
  {
    ...
    package = {
      specVersion = "3.0";
      identifier = { name = "project-m36"; version = "1.2.6"; };
      license = "MIT";
      copyright = "";
      ...
      exes = {
        "tutd" = {
          depends = [
            ...
            (hsPkgs."ghc-paths" or (errorHandler.buildDepError "ghc-paths"))
            (hsPkgs."project-m36" or (errorHandler.buildDepError "project-m36"))
            (hsPkgs."project-m36".components.sublibs.project-m36-tutoriald or (errorHandler.buildDepError "project-m36:project-m36-tutoriald"))
            (hsPkgs."containers" or (errorHandler.buildDepError "containers"))
            (hsPkgs."unordered-containers" or (errorHandler.buildDepError "unordered-containers"))
            (hsPkgs."hashable" or (errorHandler.buildDepError "hashable"))
            (hsPkgs."transformers" or (errorHandler.buildDepError "transformers"))
        ...
        "sqlegacy" = {
          depends = [
            ...
            (hsPkgs."project-m36" or (errorHandler.buildDepError "project-m36"))
            (hsPkgs."project-m36".components.sublibs.project-m36-tutoriald or (errorHandler.buildDepError "project-m36:project-m36-tutoriald"))
            (hsPkgs."project-m36".components.sublibs.project-m36-sqlegacy or (errorHandler.buildDepError "project-m36:project-m36-sqlegacy"))
            (hsPkgs."containers" or (errorHandler.buildDepError "containers"))
            (hsPkgs."unordered-containers" or (errorHandler.buildDepError "unordered-containers"))
            (hsPkgs."hashable" or (errorHandler.buildDepError "hashable"))
            (hsPkgs."transformers" or (errorHandler.buildDepError "transformers"))
