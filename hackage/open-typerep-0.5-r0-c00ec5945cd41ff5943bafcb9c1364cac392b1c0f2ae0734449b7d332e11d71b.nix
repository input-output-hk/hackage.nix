{ system, compiler, flags, pkgs, hsPkgs, pkgconfPkgs, ... }:
  {
    ...
    package = {
      specVersion = "1.10";
      identifier = { name = "open-typerep"; version = "0.5"; };
    ...
    components = {
      "library" = {
        depends = [
          ...
          ] ++ (pkgs.lib).optional (compiler.isGhc && (compiler.version).lt "7.10") (hsPkgs."base-orphans" or ((hsPkgs.pkgs-errors).buildDepError "base-orphans"));
        buildable = true;
        };
      tests = {
        "examples" = {
