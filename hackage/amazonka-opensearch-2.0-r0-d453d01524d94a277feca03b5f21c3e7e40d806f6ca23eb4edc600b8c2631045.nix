{ system
  ...
  , ... }:
  {
    ...
    package = {
      specVersion = "2.2";
      identifier = { name = "amazonka-opensearch"; version = "2.0"; };
      license = "MPL-2.0";
    ...
    components = {
      ...
      tests = {
        "amazonka-opensearch-test" = {
          depends = [
            (hsPkgs."amazonka-core" or (errorHandler.buildDepError "amazonka-core"))
            (hsPkgs."amazonka-opensearch" or (errorHandler.buildDepError "amazonka-opensearch"))
