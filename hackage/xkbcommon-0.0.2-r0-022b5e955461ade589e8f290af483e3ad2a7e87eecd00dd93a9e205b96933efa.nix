{ system, compiler, flags, pkgs, hsPkgs, pkgconfPkgs, ... }:
  {
    ...
    components = {
      ...
      tests = {
        "context" = { depends = [ (hsPkgs.base) (hsPkgs.xkbcommon) ]; };
        "filecomp" = { depends = [ (hsPkgs.base) (hsPkgs.xkbcommon) ]; };
        "keyseq" = { depends = [ (hsPkgs.base) (hsPkgs.xkbcommon) ]; };
        "keysym" = { depends = [ (hsPkgs.base) (hsPkgs.xkbcommon) ]; };
        "rulescomp" = {
          depends = [ (hsPkgs.base) (hsPkgs.xkbcommon) (hsPkgs.unix) ];
          };
        "state" = { depends = [ (hsPkgs.base) (hsPkgs.xkbcommon) ]; };
        "stringcomp" = { depends = [ (hsPkgs.base) (hsPkgs.xkbcommon) ]; };
        };
      benchmarks = {
        "bench-key-proc" = {
          depends = [
