{ system
  ...
  , ... }:
  {
    ...
    package = {
      specVersion = "2.2";
      identifier = { name = "amazonka-apprunner"; version = "2.0"; };
      license = "MPL-2.0";
    ...
    components = {
      ...
      tests = {
        "amazonka-apprunner-test" = {
          depends = [
            (hsPkgs."amazonka-apprunner" or (errorHandler.buildDepError "amazonka-apprunner"))
            (hsPkgs."amazonka-core" or (errorHandler.buildDepError "amazonka-core"))
