{ system, compiler, flags, pkgs, hsPkgs, pkgconfPkgs, ... }:
  {
    flags = { with-brotli = true; with-snappy = true; };
    package = {
      specVersion = "1.18";
      identifier = { name = "sak"; version = "0.1.2.4"; };
      ...
      exes = {
        "sak" = {
          depends = ([
            ...
            ] ++ (pkgs.lib).optional (flags.with-snappy) (hsPkgs."snappy-lazy" or ((hsPkgs.pkgs-errors).buildDepError "snappy-lazy"))) ++ (pkgs.lib).optional (flags.with-brotli) (hsPkgs."brotli" or ((hsPkgs.pkgs-errors).buildDepError "brotli"));
          build-tools = [
