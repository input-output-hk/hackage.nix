      ...
      exes = {
        "sak" = {
          depends = ([
            ...
            ] ++ (pkgs.lib).optional (flags.with-snappy) (hsPkgs."snappy-lazy" or (buildDepError "snappy-lazy"))) ++ (pkgs.lib).optional (flags.with-brotli) (hsPkgs."brotli" or (buildDepError "brotli"));
          build-tools = [
