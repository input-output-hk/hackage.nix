{ system
  ...
  , ... }:
  {
    ...
    components = {
      ...
      tests = {
        "amazonka-migrationhuborchestrator-test" = {
          depends = [
            (hsPkgs."amazonka-core" or (errorHandler.buildDepError "amazonka-core"))
            (hsPkgs."amazonka-migrationhuborchestrator" or (errorHandler.buildDepError "amazonka-migrationhuborchestrator"))
