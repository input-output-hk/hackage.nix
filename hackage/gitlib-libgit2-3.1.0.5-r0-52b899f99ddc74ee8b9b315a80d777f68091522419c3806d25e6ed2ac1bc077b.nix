{ system, compiler, flags, pkgs, hsPkgs, pkgconfPkgs, ... }:
  {
    ...
    package = {
      specVersion = "1.10";
      identifier = { name = "gitlib-libgit2"; version = "3.1.0.5"; };
      license = "MIT";
      copyright = "";
    ...
    components = {
      "library" = {
        depends = [
          ...
          ] ++ (pkgs.lib).optional (compiler.isGhc && (compiler.version).lt "7.10") (hsPkgs."missing-foreign" or ((hsPkgs.pkgs-errors).buildDepError "missing-foreign"));
        buildable = true;
        };
      tests = {
        "smoke" = {
