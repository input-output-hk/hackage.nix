{ system, compiler, flags, pkgs, hsPkgs, pkgconfPkgs, ... }:
  {
    ...
    package = {
      specVersion = "1.6";
      identifier = { name = "data-reify"; version = "0.1"; };
    ...
    components = {
      ...
      exes = {
        "data-reify-test1" = { depends = [ (hsPkgs.base) ]; };
        "data-reify-test2" = { depends = [ (hsPkgs.base) ]; };
        "data-reify-test3" = { depends = [ (hsPkgs.base) ]; };
        "data-reify-test4" = { depends = [ (hsPkgs.base) ]; };
        };
      };
    }