{ system
  ...
  , ... }:
  {
    ...
    package = {
      specVersion = "1.12";
      identifier = { name = "git-annex"; version = "10.20220724"; };
      ...
      exes = {
        "git-annex" = {
          depends = ((((((([
            ...
            ])) ++ pkgs.lib.optional (flags.gitlfs) (hsPkgs."git-lfs" or (errorHandler.buildDepError "git-lfs"))) ++ pkgs.lib.optionals (flags.assistant && !system.isSolaris && !system.isHurd) (([
            ...
            then [
              ...
              else pkgs.lib.optional (system.isWindows) (hsPkgs."Win32-notify" or (errorHandler.buildDepError "Win32-notify")))) ++ pkgs.lib.optionals (flags.webapp) [
          ...
          ])) ++ pkgs.lib.optionals (flags.dbus) (pkgs.lib.optionals (system.isLinux) [
