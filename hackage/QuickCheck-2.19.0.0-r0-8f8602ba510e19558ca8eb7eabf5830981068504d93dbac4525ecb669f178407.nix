{ system
  ...
  , ... }:
  {
    ...
    package = {
      specVersion = "1.10";
      identifier = { name = "QuickCheck"; version = "2.19.0.0"; };
    ...
    components = {
      "library" = {
        depends = (((((([
          ...
          (hsPkgs."random" or (errorHandler.buildDepError "random"))
          (hsPkgs."containers" or (errorHandler.buildDepError "containers"))
        ]) ++ pkgs.lib.optional (compiler.isGhc && compiler.version.lt "9.4") (hsPkgs."data-array-byte" or (errorHandler.buildDepError "data-array-byte"))) ++ pkgs.lib.optional (compiler.isGhc && compiler.version.lt "9.2") (hsPkgs."OneTuple" or (errorHandler.buildDepError "OneTuple"));
        buildable = true;
      };
      tests = {
        "test-quickcheck" = {
