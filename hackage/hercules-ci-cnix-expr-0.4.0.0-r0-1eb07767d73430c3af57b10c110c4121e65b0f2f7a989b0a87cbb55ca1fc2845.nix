{ system
  ...
  , ... }:
  {
    ...
    package = {
      specVersion = "2.4";
      identifier = { name = "hercules-ci-cnix-expr"; version = "0.4.0.0"; };
      license = "Apache-2.0";
    ...
    components = {
      "library" = {
        ...
        ] ++ pkgs.lib.optional (flags.nix-2_24) (pkgconfPkgs."nix-flake" or (errorHandler.pkgConfDepError "nix-flake"));
        buildable = true;
      };
      tests = {
        "hercules-ci-cnix-expr-unit-tests" = {
          depends = [
            (hsPkgs."aeson" or (errorHandler.buildDepError "aeson"))
            (hsPkgs."base" or (errorHandler.buildDepError "base"))
            (hsPkgs."bytestring" or (errorHandler.buildDepError "bytestring"))
          ...
          libs = pkgs.lib.optional (flags.nix-2_24 && !flags.nix-2_25) (pkgs."nixfetchers" or (errorHandler.sysDepError "nixfetchers"));
          build-tools = [
