    ...
    components = {
      "library" = {
        depends = [
          ...
          (hsPkgs."guarded-allocation" or ((hsPkgs.pkgs-errors).buildDepError "guarded-allocation"))
      ...
      tests = {
        "lapack-test" = {
          depends = [
            ...
            (hsPkgs."quickcheck-transformer" or ((hsPkgs.pkgs-errors).buildDepError "quickcheck-transformer"))
