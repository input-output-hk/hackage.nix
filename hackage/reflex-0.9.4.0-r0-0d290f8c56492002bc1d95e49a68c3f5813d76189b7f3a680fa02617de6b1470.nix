{ system
  ...
  , ... }:
  {
    ...
    package = {
      specVersion = "1.22";
      identifier = { name = "reflex"; version = "0.9.4.0"; };
      ...
      "library" = {
        depends = (([
          ...
          then [
            ...
            (hsPkgs."these" or (errorHandler.buildDepError "these"))
            (hsPkgs."monoidal-containers" or (errorHandler.buildDepError "monoidal-containers"))
          ])) ++ pkgs.lib.optional (flags.debug-trace-events) (hsPkgs."bytestring" or (errorHandler.buildDepError "bytestring"))) ++ pkgs.lib.optional (compiler.isGhcjs && true) (hsPkgs."ghcjs-base" or (errorHandler.buildDepError "ghcjs-base"));
        buildable = true;
      };
      tests = {
        "semantics" = {
        ...
        "hlint" = {
          ...
          buildable = (if compiler.isGhc && compiler.version.ge "9.6"
            then false
            else true) && (if compiler.isGhcjs && true || system.isJavaScript
            then false
            else true);
        };
        "EventWriterT" = {
