{ system
  ...
  , ... }:
  {
    flags = {
      ...
      haskell-scripting = true;
    };
    package = {
      specVersion = "2.2";
      identifier = { name = "project-m36"; version = "1.2.5"; };
      license = "MIT";
      copyright = "";
    ...
    components = {
      "library" = {
        ...
        ]) ++ pkgs.lib.optional (compiler.isGhc && compiler.version.ge "8.6") (hsPkgs."deferred-folds" or (errorHandler.buildDepError "deferred-folds"))) ++ pkgs.lib.optional (compiler.isGhc && compiler.version.ge "9") (hsPkgs."ghc-bignum" or (errorHandler.buildDepError "ghc-bignum"))) ++ pkgs.lib.optional (!(compiler.isGhc && compiler.version.ge "9")) (hsPkgs."integer-gmp" or (errorHandler.buildDepError "integer-gmp"))) ++ (if system.isWindows
          then [ (hsPkgs."Win32" or (errorHandler.buildDepError "Win32")) ]
          else [
            (hsPkgs."unix" or (errorHandler.buildDepError "unix"))
          ])) ++ pkgs.lib.optional (system.isLinux) (hsPkgs."linux-xattr" or (errorHandler.buildDepError "linux-xattr"))) ++ pkgs.lib.optional (!flags.stack) (hsPkgs."deferred-folds" or (errorHandler.buildDepError "deferred-folds"));
        buildable = true;
      };
      exes = {
        "tutd" = {
