...
in { system, compiler, flags, pkgs, hsPkgs, pkgconfPkgs, ... }:
  {
    ...
    package = {
      specVersion = "1.2";
      identifier = { name = "bullet"; version = "0.2.4"; };
    ...
    components = {
      "library" = {
        ...
        libs = if system.isLinux
          then [ (pkgs."stdc++" or (sysDepError "stdc++")) ]
          else [
            (pkgs."BulletSoftBody" or (sysDepError "BulletSoftBody"))
        ...
        pkgconfig = (pkgs.lib).optional (system.isLinux) (pkgconfPkgs."bullet" or (pkgConfDepError "bullet"));
        build-tools = [
