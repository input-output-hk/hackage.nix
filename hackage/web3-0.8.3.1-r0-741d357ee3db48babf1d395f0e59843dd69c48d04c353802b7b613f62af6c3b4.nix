{ system, compiler, flags, pkgs, hsPkgs, pkgconfPkgs, ... }:
  {
    ...
    package = {
      specVersion = "1.12";
      identifier = { name = "web3"; version = "0.8.3.1"; };
    ...
    components = {
      "library" = {
        depends = [
          ...
          ] ++ (pkgs.lib).optional (flags.compiler) (hsPkgs."containers" or ((hsPkgs.pkgs-errors).buildDepError "containers"));
        libs = (pkgs.lib).optional (flags.compiler) (pkgs."solidity" or ((hsPkgs.pkgs-errors).sysDepError "solidity"));
        buildable = true;
        };
      tests = {
        "live" = {
