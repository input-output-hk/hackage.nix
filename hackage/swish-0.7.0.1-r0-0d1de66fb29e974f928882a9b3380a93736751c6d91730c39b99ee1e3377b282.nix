  ...
  , ... }:
  {
    ...
    components = {
      "library" = {
        ...
        ] ++ pkgs.lib.optional (compiler.isGhc && compiler.version.lt "7.4.0") (hsPkgs."intern" or (errorHandler.buildDepError "intern"))) ++ pkgs.lib.optional (compiler.isGhc && compiler.version.ge "7.4.0") (hsPkgs."intern" or (errorHandler.buildDepError "intern"));
        buildable = true;
      };
      exes = {
        "Swish" = {
