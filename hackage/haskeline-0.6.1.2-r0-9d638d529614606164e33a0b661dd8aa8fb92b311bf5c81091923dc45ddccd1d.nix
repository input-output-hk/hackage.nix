{ system, compiler, flags, pkgs, hsPkgs, pkgconfPkgs, ... }:
  {
    ...
    package = {
      specVersion = "1.6";
      identifier = { name = "haskeline"; version = "0.6.1.2"; };
    ...
    components = {
      "library" = {
        ...
        libs = (pkgs.lib).optionals (!system.isWindows) ((pkgs.lib).optional (system.isOsx || system.isFreebsd || flags.libiconv) (pkgs."iconv" or ((hsPkgs.pkgs-errors).sysDepError "iconv")));
        buildable = true;
        };
      };
    }