      ...
      exes = {
        "cabal" = {
          depends = (((([
            ...
            ] ++ (pkgs.lib).optional (!(compiler.isGhc && (compiler.version).ge "8.0")) (hsPkgs."fail" or ((hsPkgs.pkgs-errors).buildDepError "fail"))) ++ (pkgs.lib).optionals (flags.native-dns) (if system.isWindows
            then [
