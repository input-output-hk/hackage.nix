{ system, compiler, flags, pkgs, hsPkgs, pkgconfPkgs, ... }:
  {
    ...
    package = {
      specVersion = "1.10";
      identifier = { name = "direct-sqlite"; version = "2.3.5"; };
    ...
    components = {
      "library" = {
        depends = [
          ...
          ] ++ (pkgs.lib).optionals (flags.systemlib) ((pkgs.lib).optional (flags.fulltextsearch) (hsPkgs."base" or ((hsPkgs.pkgs-errors).buildDepError "base")));
