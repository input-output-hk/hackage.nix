{ system, compiler, flags, pkgs, hsPkgs, pkgconfPkgs, ... }:
  {
    flags = { bytestring-builder = true; };
    package = {
      specVersion = "1.10";
      identifier = { name = "scientific"; version = "0.3.2.1"; };
    ...
    components = {
      "library" = {
        depends = [
          ...
          ] ++ (pkgs.lib).optional (flags.bytestring-builder) (hsPkgs."bytestring" or ((hsPkgs.pkgs-errors).buildDepError "bytestring"));
        buildable = true;
        };
      tests = {
        "test-scientific" = {
