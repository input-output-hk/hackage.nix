{ system
  ...
  , ... }:
  {
    flags = { dev = false; cluster = false; };
    package = {
      specVersion = "3.0";
      identifier = { name = "hedis"; version = "0.16.1"; };
      license = "BSD-3-Clause";
      copyright = "Copyright (c) 2011 Falko Peters";
      maintainer = "Kostiantyn Rybnikov <k-bx@k-bx.com>, Alexander Vershilov <alexander.vershilov@gmail.com>";
    ...
    components = {
      ...
      tests = {
        ...
        "hedis-test-cluster" = {
          ...
          buildable = if !flags.cluster then false else true;
        };
        "hedis-test-hooks" = {
          depends = [
            (hsPkgs."base" or (errorHandler.buildDepError "base"))
