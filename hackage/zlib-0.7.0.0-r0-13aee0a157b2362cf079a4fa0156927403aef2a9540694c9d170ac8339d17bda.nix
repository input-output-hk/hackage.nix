{ system
  ...
  , ... }:
  {
    ...
    package = {
      specVersion = "1.10";
      identifier = { name = "zlib"; version = "0.7.0.0"; };
    ...
    components = {
      "library" = {
        ...
        libs = pkgs.lib.optionals (!(flags.bundled-c-zlib || compiler.isGhcjs && true || system.isGhcjs || system.isWasm32)) (pkgs.lib.optional (!flags.pkg-config) (pkgs."z" or (errorHandler.sysDepError "z")));
        pkgconfig = pkgs.lib.optionals (!(flags.bundled-c-zlib || compiler.isGhcjs && true || system.isGhcjs || system.isWasm32)) (pkgs.lib.optional (flags.pkg-config) (pkgconfPkgs."zlib" or (errorHandler.pkgConfDepError "zlib")));
        build-tools = [
