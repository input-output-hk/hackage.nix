  ...
  , ... }:
  {
    ...
    components = {
      "library" = {
        ...
        ] ++ pkgs.lib.optional (flags.testsuite) (hsPkgs."deepseq" or (errorHandler.buildDepError "deepseq"))) ++ pkgs.lib.optional (!(flags.portable || system.isWindows)) (hsPkgs."bytestring-mmap" or (errorHandler.buildDepError "bytestring-mmap"));
        buildable = true;
      };
      exes = {
        "snap" = {
          depends = [
            ...
            (hsPkgs."unix-compat" or (errorHandler.buildDepError "unix-compat"))
            (hsPkgs."zlib" or (errorHandler.buildDepError "zlib"))
          ] ++ pkgs.lib.optional (flags.testsuite) (hsPkgs."deepseq" or (errorHandler.buildDepError "deepseq"));
          buildable = true;
        };
      };
    };
