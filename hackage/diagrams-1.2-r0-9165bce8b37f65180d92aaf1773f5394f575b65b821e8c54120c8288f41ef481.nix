...
, ... }:
  {
    ...
    components = {
      "library" = {
        ...
        ] ++ pkgs.lib.optional (flags.cairo) (hsPkgs.diagrams-cairo)) ++ pkgs.lib.optional (flags.gtk) (hsPkgs.diagrams-gtk)) ++ pkgs.lib.optional (flags.svg) (hsPkgs.diagrams-svg)) ++ pkgs.lib.optional (flags.ps) (hsPkgs.diagrams-postscript)) ++ pkgs.lib.optional (flags.rasterific) (hsPkgs.diagrams-rasterific);
      };
    };
  }