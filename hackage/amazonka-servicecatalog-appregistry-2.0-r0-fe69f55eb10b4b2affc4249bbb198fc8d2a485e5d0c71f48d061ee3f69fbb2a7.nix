{ system
  ...
  , ... }:
  {
    ...
    components = {
      ...
      tests = {
        "amazonka-servicecatalog-appregistry-test" = {
          depends = [
            (hsPkgs."amazonka-core" or (errorHandler.buildDepError "amazonka-core"))
            (hsPkgs."amazonka-servicecatalog-appregistry" or (errorHandler.buildDepError "amazonka-servicecatalog-appregistry"))
