  ...
  , ... }:
  {
    ...
    components = {
      "library" = {
        ...
        build-tools = (pkgs.lib).optional (flags.embed_data_files) (hsPkgs.buildPackages.hsb2hs or (pkgs.buildPackages.hsb2hs or (errorHandler.buildToolDepError "hsb2hs")));
        buildable = true;
        };
      exes = {
        "pandoc-citeproc" = {
