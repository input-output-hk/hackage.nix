{ system, compiler, flags, pkgs, hsPkgs, pkgconfPkgs, ... }:
  {
    ...
    package = {
      specVersion = "1.10";
      identifier = { name = "hopenpgp-tools"; version = "0.23.1"; };
      ...
      exes = {
        "hot" = {
          depends = [
            ...
            (hsPkgs."prettyprinter-convert-ansi-wl-pprint" or ((hsPkgs.pkgs-errors).buildDepError "prettyprinter-convert-ansi-wl-pprint"))
