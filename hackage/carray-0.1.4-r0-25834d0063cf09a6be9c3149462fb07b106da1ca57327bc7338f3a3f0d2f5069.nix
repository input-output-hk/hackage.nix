{ system, compiler, flags, pkgs, hsPkgs, pkgconfPkgs, ... }:
  {
    ...
    package = {
      specVersion = "1.2";
      identifier = { name = "carray"; version = "0.1.4"; };
    ...
    components = {
      "library" = {
        depends = (([ (hsPkgs.ix-shapable) ] ++ (if flags.bytestringinbase
          ...
          then [ (hsPkgs.base) (hsPkgs.array) (hsPkgs.binary) ]
          else [ (hsPkgs.base) (hsPkgs.binary) ])) ++ (if flags.base4
