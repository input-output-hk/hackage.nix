    ...
    in {
      ...
      components = {
        invertible = {
          ...
          ] ++ pkgs.lib.optional _flags.arrows hsPkgs.arrows) ++ pkgs.lib.optional _flags.hlist hsPkgs.HList) ++ pkgs.lib.optional _flags.invariant hsPkgs.invariant) ++ pkgs.lib.optional _flags.lens hsPkgs.lens) ++ [
