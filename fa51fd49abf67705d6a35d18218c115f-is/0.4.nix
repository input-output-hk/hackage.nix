    ...
    in {
      ...
      components = {
        is = {
          depends  = (([
            hsPkgs.base
          ] ++ pkgs.lib.optional compiler.isGhc hsPkgs.template-haskell) ++ pkgs.lib.optional compiler.isGhc hsPkgs.template-haskell) ++ pkgs.lib.optional compiler.isGhc hsPkgs.template-haskell;
        };
        tests = {
          test = {
            depends  = [
