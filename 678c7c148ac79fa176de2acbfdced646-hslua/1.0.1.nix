  ...
  in {
    ...
    components = {
      "hslua" = {
        ...
        libs = pkgs.lib.optionals (_flags.system-lua || _flags.pkg-config) (pkgs.lib.optional (!_flags.pkg-config) (pkgs."lua"));
        pkgconfig = pkgs.lib.optionals (_flags.system-lua || _flags.pkg-config) (pkgs.lib.optional (_flags.pkg-config) (pkgconfPkgs.lua5.3));
      };
      tests = {
        "test-hslua" = {
          depends  = [
