  ...
  in {
    ...
    components = {
      "selda" = {
        ...
        ] ++ pkgs.lib.optional (compiler.isGhc && compiler.version.lt "7.11") (hsPkgs.transformers)) ++ pkgs.lib.optional (compiler.isGhc && compiler.version.ge "8.2") (hsPkgs.hashable)) ++ pkgs.lib.optional (!_flags.haste && _flags.localcache) (hsPkgs.psqueues);
      };
    };
  }