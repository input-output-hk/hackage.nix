        ...
        exes = {
          git-annex = {
            depends  = ((((((((((((((((((((([
              ...
              hsPkgs.aws
            ]) ++ pkgs.lib.optional _flags.webdav hsPkgs.DAV) ++ (if _flags.assistant && (system.isLinux && _flags.inotify)
              ...
              hsPkgs.gnutls
              hsPkgs.xml-types
            ]) ++ pkgs.lib.optional _flags.dns hsPkgs.dns) ++ pkgs.lib.optional _flags.feed hsPkgs.feed) ++ pkgs.lib.optional _flags.quvi hsPkgs.aeson) ++ pkgs.lib.optional _flags.tahoe hsPkgs.aeson) ++ pkgs.lib.optional _flags.torrentparser hsPkgs.torrent) ++ optionals _flags.database [
              hsPkgs.esqueleto
              hsPkgs.persistent-sqlite
              hsPkgs.persistent
              hsPkgs.persistent-template
            ]) ++ pkgs.lib.optional _flags.concurrentoutput hsPkgs.concurrent-output) ++ pkgs.lib.optional _flags.ekg hsPkgs.ekg;
          };
        };
      };
    }