          ...
          git-annex = {
            depends  = (((((((((((((([
              ...
              then [ hsPkgs.hinotify ]
                ...
                else pkgs.lib.optional (!system.isWindows && !system.isSolaris && !system.isLinux && _flags.android) hsPkgs.hinotify)) ++ pkgs.lib.optional (system.isLinux && _flags.dbus) hsPkgs.dbus) ++ optionals _flags.webapp [
              hsPkgs.yesod
