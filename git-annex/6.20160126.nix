            ...
            depends  = (((((((((((((((([
              ...
              then [ hsPkgs.hinotify ]
                ...
                then [ hsPkgs.hfsevents ]
                  ...
                  else pkgs.lib.optional (!system.isSolaris && !system.isLinux && _flags.android) hsPkgs.hinotify)) ++ optionals system.isLinux [
              hsPkgs.dbus
              hsPkgs.fdo-notify
              ...
              hsPkgs.gnutls
              hsPkgs.xml-types
            ]) ++ pkgs.lib.optional _flags.torrentparser hsPkgs.torrent) ++ pkgs.lib.optional _flags.concurrentoutput hsPkgs.concurrent-output) ++ pkgs.lib.optional _flags.ekg hsPkgs.ekg) ++ optionals _flags.benchmark [
              hsPkgs.criterion
              hsPkgs.deepseq
            ];
          };
