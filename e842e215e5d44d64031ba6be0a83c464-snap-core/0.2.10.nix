    ...
    components = {
      "snap-core" = {
        depends  = ([
          ...
          (hsPkgs.unix-compat)
          (hsPkgs.zlib)
        ] ++ pkgs.lib.optional (_flags.testsuite) (hsPkgs.deepseq)) ++ pkgs.lib.optional (!(_flags.portable || system.isWindows)) (hsPkgs.bytestring-mmap);
      };
      exes = {
        "snap" = {
          depends  = [
            ...
            (hsPkgs.unix-compat)
            (hsPkgs.zlib)
          ] ++ pkgs.lib.optional (_flags.testsuite) (hsPkgs.deepseq);
        };
      };
    };
  }