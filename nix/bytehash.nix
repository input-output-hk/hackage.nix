{
  "0.1.0.0" = {
    ...
    revisions = {
      r0 = {
        outPath = "bytehash-0.1.0.0-r0-31d9018c896eff6170329774ec1c1b247712448871f2400a541e92e64286c610.nix";
        revNum = 0;
        sha256 = "31d9018c896eff6170329774ec1c1b247712448871f2400a541e92e64286c610";
        };
      r1 = {
        outPath = "bytehash-0.1.0.0-r1-3b0cf31be4b58bf77d0a2962f40d4bbfc547c8b226932ddd052c6cd5edb73772.nix";
        revNum = 1;
