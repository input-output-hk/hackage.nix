{
  "0.1" = {
    ...
    revisions = {
      r0 = {
        nix = import ../hackage/GenSmsPdu-0.1-r0-1b15b2da2dd6e72b695e8e3eb28d76cf70b2337b3b2f563ee9b85ada7a3682f5.nix;
        revNum = 0;
        sha256 = "1b15b2da2dd6e72b695e8e3eb28d76cf70b2337b3b2f563ee9b85ada7a3682f5";
        };
      default = "r0";
      };
    };
