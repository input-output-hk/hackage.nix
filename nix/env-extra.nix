{
  "1.0.0.0" = {
    ...
    revisions = {
      r0 = {
        outPath = "env-extra-1.0.0.0-r0-9e0b7c3cd28a5d7509ea642af21fea1307ecdb953548899487692fd4394be7d6.nix";
        revNum = 0;
        sha256 = "9e0b7c3cd28a5d7509ea642af21fea1307ecdb953548899487692fd4394be7d6";
        };
      r1 = {
        outPath = "env-extra-1.0.0.0-r1-2b5f58f5756dedf9956c2f5738920b082ab8e08a0b62b902b67f5134cecad00d.nix";
        revNum = 1;
