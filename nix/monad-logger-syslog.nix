{
  "0.1.0.0" = {
    ...
    revisions = {
      r0 = {
        outPath = "monad-logger-syslog-0.1.0.0-r0-60338d1d25c60087f88556518a92f3fdcb17d7c4a4976307345c48794d708d93.nix";
        revNum = 0;
        sha256 = "60338d1d25c60087f88556518a92f3fdcb17d7c4a4976307345c48794d708d93";
        };
      r1 = {
        outPath = "monad-logger-syslog-0.1.0.0-r1-93ac892b3e81cc44a8fc5ab63f0c6c5d0127602448dcf0984d37d8dd9d92000e.nix";
        revNum = 1;
  ...
  "0.1.1.0" = {
    ...
    revisions = {
      r0 = {
        outPath = "monad-logger-syslog-0.1.1.0-r0-d0158fba421612d67f37d83d884c3d599a530f1d234b1ea9667601d363a9f594.nix";
        revNum = 0;
  ...
  "0.1.1.1" = {
    ...
    revisions = {
      r0 = {
        outPath = "monad-logger-syslog-0.1.1.1-r0-aaa5b4aad874f0c97ae936ca1b84073eb8112329e956e04cacb79e5a7daa910a.nix";
        revNum = 0;
  ...
  "0.1.2.0" = {
    ...
    revisions = {
      r0 = {
        outPath = "monad-logger-syslog-0.1.2.0-r0-2d9922dd3c19ebfaa4b4c5578275b3004eb6eba2a9e172bee5531cb95c8f718e.nix";
        revNum = 0;
  ...
  "0.1.3.0" = {
    ...
    revisions = {
      r0 = {
        outPath = "monad-logger-syslog-0.1.3.0-r0-e9db357746c26820d700f2fbceb71edbd4ed280f7b04c88dd43565d6b9241fe0.nix";
        revNum = 0;
  ...
  "0.1.4.0" = {
    ...
    revisions = {
      r0 = {
        outPath = "monad-logger-syslog-0.1.4.0-r0-16925d3752cfd0e75669e3860d3bc7e8a26bf59eecf7f0a0edb6c27568cf11d2.nix";
        revNum = 0;
  ...
  "0.1.5.0" = {
    ...
    revisions = {
      r0 = {
        outPath = "monad-logger-syslog-0.1.5.0-r0-e1243f18761f420aaf396a26f797d9fa51e679ab6c80965d1080e0774b15a23c.nix";
        revNum = 0;
  ...
  "0.1.6.0" = {
    ...
    revisions = {
      r0 = {
        outPath = "monad-logger-syslog-0.1.6.0-r0-1cf459caea5b33f45364b6f73c9ff3128759a915788d0f8dc12033fb9da90abe.nix";
        revNum = 0;
        sha256 = "1cf459caea5b33f45364b6f73c9ff3128759a915788d0f8dc12033fb9da90abe";
        };
      r1 = {
        outPath = "monad-logger-syslog-0.1.6.0-r1-74bdaa20f3ccc4ec46af776d944437cc46eb16f6851191b64f44878460a9e704.nix";
        revNum = 1;
