{
  "1.0.0.0" = {
    ...
    revisions = {
      r0 = {
        outPath = "kademlia-1.0.0.0-r0-6d2337ce8ece88e19e73389b8c77a5b0fcf02aa1403be3d9b061e7e0f92d6d3d.nix";
        revNum = 0;
        sha256 = "6d2337ce8ece88e19e73389b8c77a5b0fcf02aa1403be3d9b061e7e0f92d6d3d";
        };
      r1 = {
        outPath = "kademlia-1.0.0.0-r1-2553e98d53372b8d4947c115dd696e33f526f0304e9ed39566e6beec276ca641.nix";
        revNum = 1;
  ...
  "1.1.0.0" = {
    ...
    revisions = {
      r0 = {
        outPath = "kademlia-1.1.0.0-r0-a50d13bc985acda13e17e2b5c6390f18c5362cc15ea38b762a3944c31e86f215.nix";
        revNum = 0;
