{
  "1.1" = {
    ...
    revisions = {
      r0 = {
        outPath = "hsmisc-1.1-r0-24a8119acd0d7b5303140083714cb386536cae042b236dd3b1c02ee73cb2d17b.nix";
        revNum = 0;
  ...
  "1.2" = {
    ...
    revisions = {
      r0 = {
        outPath = "hsmisc-1.2-r0-a59ed4e64977e38c35cc1eb209fe8b29e294ad92e85602fec86909682880a4aa.nix";
        revNum = 0;
