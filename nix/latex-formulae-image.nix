{
  "0.1.0.0" = {
    ...
    revisions = {
      r0 = {
        outPath = "latex-formulae-image-0.1.0.0-r0-0f747418e5280a521c0928748c55c502dfea30141966c06d5865fbb8b42e86af.nix";
        revNum = 0;
  ...
  "0.1.0.1" = {
    ...
    revisions = {
      r0 = {
        outPath = "latex-formulae-image-0.1.0.1-r0-cc0f53722e93b131a6b5c112c1aed2053f4841b68a42333497b367fb0b455530.nix";
        revNum = 0;
  ...
  "0.1.1.0" = {
    ...
    revisions = {
      r0 = {
        outPath = "latex-formulae-image-0.1.1.0-r0-2dd2a2d111f9e228495724dac16051f0a96135223ba0c19f89c6b6e1944dbcc4.nix";
        revNum = 0;
  ...
  "0.1.1.1" = {
    ...
    revisions = {
      r0 = {
        outPath = "latex-formulae-image-0.1.1.1-r0-92ee13de6bd93434a4d9f5819fee6bae153314e975073b6f5d15ce680d6eb009.nix";
        revNum = 0;
  ...
  "0.1.1.2" = {
    ...
    revisions = {
      r0 = {
        outPath = "latex-formulae-image-0.1.1.2-r0-4e3e2090d9219aeef28dbcc47b9a1cc85490c85e59e50be8259a6099837b4ee5.nix";
        revNum = 0;
  ...
  "0.1.1.3" = {
    ...
    revisions = {
      r0 = {
        outPath = "latex-formulae-image-0.1.1.3-r0-29ed9767d395eb2d6aaf311b52d158aff5a5c7379a333db5ad116903364919b7.nix";
        revNum = 0;
  ...
  "0.1.1.4" = {
    ...
    revisions = {
      r0 = {
        outPath = "latex-formulae-image-0.1.1.4-r0-48228b82fbc09ebb7551eaddfbd169a81027b504bd06349522daa4b141e215ee.nix";
        revNum = 0;
        sha256 = "48228b82fbc09ebb7551eaddfbd169a81027b504bd06349522daa4b141e215ee";
        };
      r1 = {
        outPath = "latex-formulae-image-0.1.1.4-r1-2df1a5ac8884ba9d82f42b85d378aade0ee5b25e4808a80b6c4551d5b36f2554.nix";
        revNum = 1;
