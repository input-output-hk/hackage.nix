{
  "0.0.1.0" = {
    ...
    revisions = {
      r0 = {
        outPath = "facts-0.0.1.0-r0-a6bc113b6a1b91cd028abab09f9e609c748abc13185b2478ef9d8d1acd58840d.nix";
        revNum = 0;
        sha256 = "a6bc113b6a1b91cd028abab09f9e609c748abc13185b2478ef9d8d1acd58840d";
        };
      r1 = {
        outPath = "facts-0.0.1.0-r1-97fe2f20dd9da98b19d42946d9431d9d45ccc2c8836fdacbdce6d348f7b8660f.nix";
        revNum = 1;
