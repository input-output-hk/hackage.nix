{
  "0.0.0" = {
    ...
    revisions = {
      r0 = {
        outPath = "workflow-types-0.0.0-r0-14ff7945c9c9668f8af796527d31a446d60005f55362644bedf2d287281ee13d.nix";
        revNum = 0;
  ...
  "0.0.1" = {
    ...
    revisions = {
      r0 = {
        outPath = "workflow-types-0.0.1-r0-d9b108cb953262eac754066acf25cf763a7299f4e237d766c6b071244ecd8dcd.nix";
        revNum = 0;
