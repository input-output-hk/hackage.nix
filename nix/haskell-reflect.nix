{
  "0.1" = {
    ...
    revisions = {
      r0 = {
        outPath = "haskell-reflect-0.1-r0-ca547e6f2227df026f5825316658d01caba3f2119b215fca2c943f93dd049d2d.nix";
        revNum = 0;
  ...
  "0.9" = {
    ...
    revisions = {
      r0 = {
        outPath = "haskell-reflect-0.9-r0-e8befd8024ea78c1f3f6816b53a2178659facad68ffc38b0829a0ce6a12d7a5e.nix";
        revNum = 0;
