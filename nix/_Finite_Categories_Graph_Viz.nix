{
  "0.1.0.0" = {
    ...
    revisions = {
      r0 = {
        nix = import ../hackage/FiniteCategoriesGraphViz-0.1.0.0-r0-a4d59bd1a5afc2bc694b13a4e2d9146e1add38b358dcde8f79dbfad74d015b05.nix;
        revNum = 0;
        sha256 = "a4d59bd1a5afc2bc694b13a4e2d9146e1add38b358dcde8f79dbfad74d015b05";
        };
      default = "r0";
      };
    };
