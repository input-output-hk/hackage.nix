{
  "0.2.0" = {
    ...
    revisions = {
      r0 = {
        outPath = "papa-base-implement-0.2.0-r0-f047c8faa8e51e274ca74b4d2fc1e5e56a4e36052f38dab9dbc150572b449db0.nix";
        revNum = 0;
        sha256 = "f047c8faa8e51e274ca74b4d2fc1e5e56a4e36052f38dab9dbc150572b449db0";
        };
      r1 = {
        outPath = "papa-base-implement-0.2.0-r1-e0bce83e04d2258364585033821dea273ea72e873cd362107444bdec505d66e5.nix";
        revNum = 1;
  ...
  "0.3.0" = {
    ...
    revisions = {
      r0 = {
        outPath = "papa-base-implement-0.3.0-r0-5c26470f554445d2fe2f7c1d8ef660a0925384cbb6d109d98ce9b5daa27a8fd3.nix";
        revNum = 0;
  ...
  "0.3.1" = {
    ...
    revisions = {
      r0 = {
        outPath = "papa-base-implement-0.3.1-r0-4aebf6c11be41d39af458f2fc3095fe427a577c537caf074d38f4988b1bdc0f5.nix";
        revNum = 0;
