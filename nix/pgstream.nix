{
  "0.1.0.3" = {
    ...
    revisions = {
      r0 = {
        outPath = "pgstream-0.1.0.3-r0-26217cbd33f1fee1751b77c211a8f7d6f6f29d5bdc92675bd785c7caf3c10a5d.nix";
        revNum = 0;
        sha256 = "26217cbd33f1fee1751b77c211a8f7d6f6f29d5bdc92675bd785c7caf3c10a5d";
        };
      r1 = {
        outPath = "pgstream-0.1.0.3-r1-6b08ae7064272e58cb3d6cd8df606d3d376de019febcffd042f8bbded7300426.nix";
        revNum = 1;
