{
  "0.0.1.0" = {
    ...
    revisions = {
      r0 = {
        outPath = "HPhone-0.0.1.0-r0-985588e0b2a400b65af107139ff8234cfb33e025e638912eb846e565400038ff.nix";
        revNum = 0;
  ...
  "0.0.1.1" = {
    ...
    revisions = {
      r0 = {
        outPath = "HPhone-0.0.1.1-r0-d11079e4be2f559145989fa393758a9dc0eb5d8e00f46c51b99ce5028816a48f.nix";
        revNum = 0;
        sha256 = "d11079e4be2f559145989fa393758a9dc0eb5d8e00f46c51b99ce5028816a48f";
        };
      r1 = {
        outPath = "HPhone-0.0.1.1-r1-7a1f8fcd862807860fe7369674d2e0a44dc8eb6850e756f17024a92da185470c.nix";
        revNum = 1;
  ...
  "0.0.1.2" = {
    ...
    revisions = {
      r0 = {
        outPath = "HPhone-0.0.1.2-r0-e2ffccb76dcceb691246e4db1420d0735369788305a3a40f90a20e94d6106ea9.nix";
        revNum = 0;
