{
  "0.0.0.1" = {
    ...
    revisions = {
      r0 = {
        outPath = "ca-0.0.0.1-r0-2129ad80e3130a3c9536f105de1bef17f0bb11fce95fc0da73761355e9b44acd.nix";
        revNum = 0;
        sha256 = "2129ad80e3130a3c9536f105de1bef17f0bb11fce95fc0da73761355e9b44acd";
        };
      r1 = {
        outPath = "ca-0.0.0.1-r1-bc13eba3a823b1fc16f26505e27ad75319f09cfc374be5aace981045a2ecf8e8.nix";
        revNum = 1;
