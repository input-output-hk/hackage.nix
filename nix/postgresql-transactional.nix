{
  "1.0.0" = {
    ...
    revisions = {
      r0 = {
        outPath = "postgresql-transactional-1.0.0-r0-9a9be90410c52493c638115855cb94487a4b97b29e363a7a781fa1f9046fdb9e.nix";
        revNum = 0;
  ...
  "1.1.1" = {
    ...
    revisions = {
      r0 = {
        outPath = "postgresql-transactional-1.1.1-r0-07d38a5322ee278abdc01bbb7068196718bf4d0d77b08e1d8af4ac19e01e2883.nix";
        revNum = 0;
