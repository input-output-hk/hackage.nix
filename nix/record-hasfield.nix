{
  "1.0" = {
    ...
    revisions = {
      r0 = {
        nix = import ../hackage/record-hasfield-1.0-r0-c7f39b8d3f9299c7361e115e97f3474274b3487233cb155c58eb0bec7625afcb.nix;
        revNum = 0;
        sha256 = "c7f39b8d3f9299c7361e115e97f3474274b3487233cb155c58eb0bec7625afcb";
        };
      default = "r0";
      };
    };
