{
  "0.1.0.0" = {
    ...
    revisions = {
      r0 = {
        nix = import ../hackage/cabal-info-0.1.0.0-r0-0bdef35f941a737c828ee873eb5708f0fc5b1cf52cc519aad424610ed891983b.nix;
        revNum = 0;
  ...
  "0.2.1" = {
    ...
    revisions = {
      r0 = {
        nix = import ../hackage/cabal-info-0.2.1-r0-98b6673015de8f9a92b5654000138c53e46aba48ecb8ba85608fd930def2cc2a.nix;
        revNum = 0;
