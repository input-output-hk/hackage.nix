{
  "1.2.1" = {
    ...
    revisions = {
      r0 = {
        outPath = "text-generic-pretty-1.2.1-r0-8bd6126f1f3f5cc29f12c1e8a22a520336bcaa584baf2e7e73f86ebc26249563.nix";
        revNum = 0;
        sha256 = "8bd6126f1f3f5cc29f12c1e8a22a520336bcaa584baf2e7e73f86ebc26249563";
        };
      r1 = {
        outPath = "text-generic-pretty-1.2.1-r1-bf2ffe6b6f4417c2fedeb94df078a993dfeab0bc0b048f4570e6135e9a15a1d4.nix";
        revNum = 1;
