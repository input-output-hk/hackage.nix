{
  "0.10.0" = {
    ...
    revisions = {
      r0 = {
        outPath = "cqrs-postgresql-0.10.0-r0-78a948fdb252182cf1bcc32261b4b6d07dba4aac083339b63a107eb0fcce8cbd.nix";
        revNum = 0;
  ...
  "0.9.0" = {
    ...
    revisions = {
      r0 = {
        outPath = "cqrs-postgresql-0.9.0-r0-e6d6dc6fdb18e8cc896d58e4b4b9707eac0695cc4a54232721131136397bf246.nix";
        revNum = 0;
