{
  "3.0.4" = {
    ...
    revisions = {
      r0 = {
        nix = import ../hackage/gi-soup3-3.0.4-r0-22459dab75bb19ec857959f6511f0e88a36974e458aecaf9cdc6f37830072bad.nix;
        revNum = 0;
        sha256 = "22459dab75bb19ec857959f6511f0e88a36974e458aecaf9cdc6f37830072bad";
      };
      default = "r0";
    };
  };
