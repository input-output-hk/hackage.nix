{
  "0" = {
    ...
    revisions = {
      r0 = {
        outPath = "hspec-parsec-0-r0-ede42f1b97529b5052ab45457643ecccf87a7f4ccdf1fb9598fc7450e89614fa.nix";
        revNum = 0;
        sha256 = "ede42f1b97529b5052ab45457643ecccf87a7f4ccdf1fb9598fc7450e89614fa";
        };
      r1 = {
        outPath = "hspec-parsec-0-r1-3469e0c2dbdbacc7adf27314a239c6d8a19790006a71dc82c0909b5b18efda0e.nix";
        revNum = 1;
