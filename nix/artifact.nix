{
  "0.0.0.0" = {
    ...
    revisions = {
      r0 = {
        outPath = "artifact-0.0.0.0-r0-56c541b2752364dfda6efe4d140701a0763282dd6b8c8ba5de863a91ebc4d7df.nix";
        revNum = 0;
        sha256 = "56c541b2752364dfda6efe4d140701a0763282dd6b8c8ba5de863a91ebc4d7df";
        };
      r1 = {
        outPath = "artifact-0.0.0.0-r1-a47962d51a45c390e060794442b7be75ada80fcbc9067efc9a007d473ae81526.nix";
        revNum = 1;
