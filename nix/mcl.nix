{
  "1.0.0" = {
    ...
    revisions = {
      r0 = {
        outPath = "mcl-1.0.0-r0-deced3506dfcb84371339ee6a23edf175077f2fd6a1111a9fa028d3690dc524c.nix";
        revNum = 0;
        sha256 = "deced3506dfcb84371339ee6a23edf175077f2fd6a1111a9fa028d3690dc524c";
        };
      r1 = {
        outPath = "mcl-1.0.0-r1-83f5ffc7a7dc60864fe53641b859426c5865b6044e788720fd9d7df30be448d2.nix";
        revNum = 1;
  ...
  "1.0.1" = {
    ...
    revisions = {
      r0 = {
        outPath = "mcl-1.0.1-r0-02a6819febe104926b5ddd767ce57adbd77dd3e24938f48af04f2515b2bcc979.nix";
        revNum = 0;
