{
  "1.8" = {
    ...
    revisions = {
      r0 = {
        outPath = "helium-1.8-r0-c215b0bfc8a1904e78d9806550323c6c6676a5f111716cb5638c85c2a321dd6a.nix";
        revNum = 0;
  ...
  "1.8.1" = {
    ...
    revisions = {
      r0 = {
        outPath = "helium-1.8.1-r0-f1a64a56451df33da5c70566800e89cdd3c5bde039110a66a1f5bfd843590a76.nix";
        revNum = 0;
