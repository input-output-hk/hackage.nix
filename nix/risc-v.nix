{
  "0.0.0.0" = {
    ...
    revisions = {
      r0 = {
        outPath = "risc-v-0.0.0.0-r0-ecef61208937639fea0736873964fa32fe2441585776f3120ebb771e20cd8a6d.nix";
        revNum = 0;
  ...
  "0.0.1.0" = {
    ...
    revisions = {
      r0 = {
        outPath = "risc-v-0.0.1.0-r0-dce9abc77c81c945e5844b95832d820fc4564b0b8a59b4fee2636f47503c17b8.nix";
        revNum = 0;
  ...
  "0.0.2.0" = {
    ...
    revisions = {
      r0 = {
        outPath = "risc-v-0.0.2.0-r0-cbe27136876abd1319b6fba60ed495e8ba444f91a4195c6c0330e4d72d8f40f2.nix";
        revNum = 0;
        sha256 = "cbe27136876abd1319b6fba60ed495e8ba444f91a4195c6c0330e4d72d8f40f2";
        };
      r1 = {
        outPath = "risc-v-0.0.2.0-r1-501086a3101f8c91813866ed58b30c4229e52ce022f87b9f40cd425188abe13e.nix";
        revNum = 1;
