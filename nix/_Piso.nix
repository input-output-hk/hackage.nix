{
  "0.1" = {
    ...
    revisions = {
      r0 = {
        outPath = "Piso-0.1-r0-a3a68056cce6d407e5a416daa7288da28c7fda20429673463dd0b7a88444f2d2.nix";
        revNum = 0;
        sha256 = "a3a68056cce6d407e5a416daa7288da28c7fda20429673463dd0b7a88444f2d2";
        };
      r1 = {
        outPath = "Piso-0.1-r1-77d29f8dce634a2f727ea0927a4da4fc3d09b9b28aeabfed8799fd6c8ba611f8.nix";
        revNum = 1;
  ...
  "0.2" = {
    ...
    revisions = {
      r0 = {
        outPath = "Piso-0.2-r0-167da0bf2c98d8f44615b3222eb82bf66567df4418980aa523af139fc971966b.nix";
        revNum = 0;
