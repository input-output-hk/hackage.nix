{
  "0.1.0.0" = {
    ...
    revisions = {
      r0 = {
        outPath = "hid-examples-0.1.0.0-r0-eacd29353eb0cbce86a2b4b16e793db8a9b506691ee050194a5fe8ed2500ea60.nix";
        revNum = 0;
        sha256 = "eacd29353eb0cbce86a2b4b16e793db8a9b506691ee050194a5fe8ed2500ea60";
        };
      r1 = {
        outPath = "hid-examples-0.1.0.0-r1-179421e3ddbbf06df5d6e753f63e70d1333e5ee9f3fd7e5bc407ee802a7ecc45.nix";
        revNum = 1;
  ...
  "0.2" = {
    ...
    revisions = {
      r0 = {
        outPath = "hid-examples-0.2-r0-b710b3b914a3066951fd7bbf3ea8891ba7bc53c24e4d4b4efeec0c8a8c4340a1.nix";
        revNum = 0;
  ...
  "0.3" = {
    ...
    revisions = {
      r0 = {
        outPath = "hid-examples-0.3-r0-f41f6736a7de6e252d7027181a280d637a3c02872738b8643a0d328815ce2989.nix";
        revNum = 0;
  ...
  "0.4" = {
    ...
    revisions = {
      r0 = {
        outPath = "hid-examples-0.4-r0-89578ad3f0a5617e5db67398f12bf01e896e2659bb89abd0de23f5e98dd8d0ce.nix";
        revNum = 0;
  ...
  "0.5" = {
    ...
    revisions = {
      r0 = {
        outPath = "hid-examples-0.5-r0-9c9cbd47e27ed9cd6a737ab37172fc8f363afb84e9955389d1c5339e81182fa4.nix";
        revNum = 0;
