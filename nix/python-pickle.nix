{
  "0.1.0" = {
    ...
    revisions = {
      r0 = {
        outPath = "python-pickle-0.1.0-r0-7ff6287d0cb20d3f3d78c00b000d257399b477977988946ba6b1657c122fb7fc.nix";
        revNum = 0;
  ...
  "0.2.0" = {
    ...
    revisions = {
      r0 = {
        outPath = "python-pickle-0.2.0-r0-fde05d4fd565b47460918986f19bd12f289b21d89634b749b57795f197b76780.nix";
        revNum = 0;
  ...
  "0.2.3" = {
    ...
    revisions = {
      r0 = {
        outPath = "python-pickle-0.2.3-r0-d2ca35e7c7a6e07f5ec9189e143352265fde4bf3927e4a4d409e58037e7fb47c.nix";
        revNum = 0;
