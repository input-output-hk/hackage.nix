{
  "0.1" = {
    ...
    revisions = {
      r0 = {
        outPath = "fitsio-0.1-r0-bce6ba708502b8f6e626f5dd4020b60e833202ce75b8351cddd1b33f7adf1eec.nix";
        revNum = 0;
  ...
  "0.2" = {
    ...
    revisions = {
      r0 = {
        outPath = "fitsio-0.2-r0-5631a49e28c999ac4d559acad161e9d1cbd56deeaa47ab24cfda26fe610db4eb.nix";
        revNum = 0;
