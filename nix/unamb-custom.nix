{
  "0.10" = {
    ...
    revisions = {
      r0 = {
        outPath = "unamb-custom-0.10-r0-223a26106ef5eaa3c60785b77a7b84d98eba27268c6c679b939362050f82312f.nix";
        revNum = 0;
  ...
  "0.12" = {
    ...
    revisions = {
      r0 = {
        outPath = "unamb-custom-0.12-r0-f5ed022c1babf6c2d1737bd56fe74cdfbf49bc9ad382cff572ebe7672f5069b8.nix";
        revNum = 0;
  ...
  "0.13" = {
    ...
    revisions = {
      r0 = {
        outPath = "unamb-custom-0.13-r0-756b3ffd5167083bce511e8920ba3caafbf070641ded31957f87db88a3470f3f.nix";
        revNum = 0;
