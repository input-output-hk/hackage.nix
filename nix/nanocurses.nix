{
  "1.5.1" = {
    ...
    revisions = {
      r0 = {
        outPath = "nanocurses-1.5.1-r0-9f665142425bd6fd22a1f2cbcdfa034678daf495f8bcfe48397a490ef1d64e5a.nix";
        revNum = 0;
  ...
  "1.5.2" = {
    ...
    revisions = {
      r0 = {
        outPath = "nanocurses-1.5.2-r0-35c6ebdbffdc149ebaf5ef31eb21ac04d033045cb63739d3049b64bff4e9d1d6.nix";
        revNum = 0;
