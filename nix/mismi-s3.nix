{
  "0.0.2" = {
    ...
    revisions = {
      r0 = {
        outPath = "mismi-s3-0.0.2-r0-5e305a416be6ae09356880fed6f57ed221b28bbe1486f56a96c95527934e0bdf.nix";
        revNum = 0;
  ...
  "0.0.3" = {
    ...
    revisions = {
      r0 = {
        outPath = "mismi-s3-0.0.3-r0-ca3f44e10f69cc9dd938425b463002e1baab3692b497e5b0257ee3706d64a47d.nix";
        revNum = 0;
