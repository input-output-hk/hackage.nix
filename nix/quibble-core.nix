{
  ...
  "0.1.0.2" = {
    ...
    revisions = {
      r0 = {
        nix = import ../hackage/quibble-core-0.1.0.2-r0-6309af1867dfee1dd86cae0e15f42f9eb007759239a4aa7724894031fd766feb.nix;
        revNum = 0;
        sha256 = "6309af1867dfee1dd86cae0e15f42f9eb007759239a4aa7724894031fd766feb";
      };
      default = "r0";
    };
  };
