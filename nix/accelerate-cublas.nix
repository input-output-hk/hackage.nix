{
  "0.0" = {
    ...
    revisions = {
      r0 = {
        outPath = "accelerate-cublas-0.0-r0-fc589e912e49e5ac825fd269e69549fb818642428e58ec22bbaabc8e878729bf.nix";
        revNum = 0;
  ...
  "0.1" = {
    ...
    revisions = {
      r0 = {
        outPath = "accelerate-cublas-0.1-r0-afd4e126c2217bda5441cd88e09027a202200e438637fead932b585a1fd39ac6.nix";
        revNum = 0;
