{
  "0.1.0" = {
    ...
    revisions = {
      r0 = {
        outPath = "distributed-process-task-0.1.0-r0-b5e7698cb7e26b1ca4b49ca498f516c158cc1226b18493e44741a42efe66fbe4.nix";
        revNum = 0;
  ...
  "0.1.1" = {
    ...
    revisions = {
      r0 = {
        outPath = "distributed-process-task-0.1.1-r0-33de4185e7c375d2238a0dc72ee24d2fd04e3a0042c4f3f1b1d5d7858ab29b47.nix";
        revNum = 0;
  ...
  "0.1.2.1" = {
    ...
    revisions = {
      r0 = {
        outPath = "distributed-process-task-0.1.2.1-r0-d80e94c0ed853d3a8efb5ef9e3a99768f694517ee0d04ba11f64d3d68be6c899.nix";
        revNum = 0;
  ...
  "0.1.2.2" = {
    ...
    revisions = {
      r0 = {
        outPath = "distributed-process-task-0.1.2.2-r0-dd68aeadc144bc4dab7c171fe8f172a79551d65dafc8527ee623f8f3a8657386.nix";
        revNum = 0;
        sha256 = "dd68aeadc144bc4dab7c171fe8f172a79551d65dafc8527ee623f8f3a8657386";
        };
      r1 = {
        outPath = "distributed-process-task-0.1.2.2-r1-2881a849616f0f38ece555040465acf23dc273964282be1a3a00521eb0929c26.nix";
        revNum = 1;
