{
  ...
  "5.3.1" = {
    ...
    revisions = {
      r0 = {
        nix = import ../hackage/lambdabot-reference-plugins-5.3.1-r0-5d9cec1d28e48ba52c2cd5d80ce0b57795d6e4f0d9dad583b2c04b4231eab058.nix;
        revNum = 0;
        sha256 = "5d9cec1d28e48ba52c2cd5d80ce0b57795d6e4f0d9dad583b2c04b4231eab058";
        };
      r1 = {
        nix = import ../hackage/lambdabot-reference-plugins-5.3.1-r1-8f2363f3b7bfaf2d5d236acc5bd8de46c205e072601e39a14364763fd16ebb85.nix;
        revNum = 1;
        sha256 = "8f2363f3b7bfaf2d5d236acc5bd8de46c205e072601e39a14364763fd16ebb85";
        };
      r2 = {
        nix = import ../hackage/lambdabot-reference-plugins-5.3.1-r2-f52898829c6e82b34c1715fcdfe6cffa348750f260779a834d57bd830b5fc5b0.nix;
        revNum = 2;
        sha256 = "f52898829c6e82b34c1715fcdfe6cffa348750f260779a834d57bd830b5fc5b0";
        };
      default = "r2";
      };
    };
  "5.3.1.1" = {
    ...
    revisions = {
      r0 = {
        nix = import ../hackage/lambdabot-reference-plugins-5.3.1.1-r0-4ba27f35033e23b705486725220bab4be1b9976847f0f1068533aee69eef0f48.nix;
        revNum = 0;
        sha256 = "4ba27f35033e23b705486725220bab4be1b9976847f0f1068533aee69eef0f48";
        };
      default = "r0";
      };
    };
  "5.3.1.2" = {
    ...
    revisions = {
      r0 = {
        nix = import ../hackage/lambdabot-reference-plugins-5.3.1.2-r0-1be229245ca2d9544d3dc5ccd33ca753b43e232466e56d6d3715b8dfb30611d3.nix;
        revNum = 0;
