{
  "1.0" = {
    ...
    revisions = {
      r0 = {
        nix = import ../hackage/reactive-banana-bunch-1.0-r0-270fe75fe05e92b6d0a512cb62b3e18765b78a68e6e13908eb96271ede1068f1.nix;
        revNum = 0;
        sha256 = "270fe75fe05e92b6d0a512cb62b3e18765b78a68e6e13908eb96271ede1068f1";
        };
      default = "r0";
      };
    };
  "1.0.0.1" = {
    ...
    revisions = {
      r0 = {
        nix = import ../hackage/reactive-banana-bunch-1.0.0.1-r0-2c8b1a49a334b23b1b5bc29daaa0fac4b4cd14d21679783e9f79e6784c42d951.nix;
        revNum = 0;
