{
  "1.2.0" = {
    ...
    revisions = {
      r0 = {
        outPath = "Hayoo-1.2.0-r0-c87fd078b996777d85820792a6ca77802c0b0ffbad3dcb9f66d3f4510f4fa02a.nix";
        revNum = 0;
  ...
  "1.2.3" = {
    ...
    revisions = {
      r0 = {
        outPath = "Hayoo-1.2.3-r0-ae1ec6816dba39757776b07d832597a4e66843135f95bcecf5d7ae6d59359ab3.nix";
        revNum = 0;
