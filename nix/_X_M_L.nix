{
  "0.0.0.0" = {
    ...
    revisions = {
      r0 = {
        outPath = "XML-0.0.0.0-r0-0f465b11f3a24dc008ff2b5e174bd85eb00a10337c4792f8f8b80f8c995ad5fc.nix";
        revNum = 0;
  ...
  "0.0.1.0" = {
    ...
    revisions = {
      r0 = {
        outPath = "XML-0.0.1.0-r0-34cab6dd166605e41bf81fc5278237493afbbf914428a05921f737e0a11a005f.nix";
        revNum = 0;
        sha256 = "34cab6dd166605e41bf81fc5278237493afbbf914428a05921f737e0a11a005f";
        };
      r1 = {
        outPath = "XML-0.0.1.0-r1-5c893453cbec83988aa40dce384ee2c2db18286b64db939dba7ca7272edb1d06.nix";
        revNum = 1;
