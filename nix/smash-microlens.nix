{
  "0.1.0.0" = {
    ...
    revisions = {
      r0 = {
        outPath = "smash-microlens-0.1.0.0-r0-5c9c9786700789f7928fd5e52acb6532b54dde8aba3a24bb34e5af3952c90fb5.nix";
        revNum = 0;
        sha256 = "5c9c9786700789f7928fd5e52acb6532b54dde8aba3a24bb34e5af3952c90fb5";
        };
      r1 = {
        outPath = "smash-microlens-0.1.0.0-r1-9a010bbebaa0439c075134b37f7be31a2af98c166eaf401f258856d817011908.nix";
        revNum = 1;
  ...
  "0.1.0.2" = {
    ...
    revisions = {
      r0 = {
        outPath = "smash-microlens-0.1.0.2-r0-1140585c7e9c52e3416a5a9a9f00843d2fe2ba034f44aadd6c21ff21a08a185c.nix";
        revNum = 0;
