{
  "0.5.0" = {
    ...
    revisions = {
      r0 = {
        outPath = "mucipher-0.5.0-r0-f3b2e12b0ab97af211bb6c713bab906dbbe796187ec99ddc2f7ff8a1a19113fd.nix";
        revNum = 0;
  ...
  "0.6.0" = {
    ...
    revisions = {
      r0 = {
        outPath = "mucipher-0.6.0-r0-9b1d8b0310af8d2179745d2268cc7b2cebeae3c06837581e4e76dbce3e47a67c.nix";
        revNum = 0;
