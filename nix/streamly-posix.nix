{
  "0.1.0.0" = {
    ...
    revisions = {
      r0 = {
        outPath = "streamly-posix-0.1.0.0-r0-f0bb5b9c45286f9debe5489f7344805dd185594e70ce5f0a73cd9a9707db0f06.nix";
        revNum = 0;
  ...
  "0.1.0.1" = {
    ...
    revisions = {
      r0 = {
        outPath = "streamly-posix-0.1.0.1-r0-5d89b806281035d34020387ed99dde1ddab282c7ed66df3b7cd010b38fd3517b.nix";
        revNum = 0;
        sha256 = "5d89b806281035d34020387ed99dde1ddab282c7ed66df3b7cd010b38fd3517b";
        };
      r1 = {
        outPath = "streamly-posix-0.1.0.1-r1-29cc4eeb309133e991a8e2d2ce55c947bef9d1675feb2d385b9773026bc51a12.nix";
        revNum = 1;
  ...
  "0.1.0.2" = {
    ...
    revisions = {
      r0 = {
        outPath = "streamly-posix-0.1.0.2-r0-0c715ea0972be4a12a28570e0327df19794b6ecc29c089bd13a47a92e6305ab6.nix";
        revNum = 0;
