{
  "0.0.1.0" = {
    ...
    revisions = {
      r0 = {
        outPath = "genesis-test-0.0.1.0-r0-7d6e4d053dcfb68fb1f7647f62a3f58fcd2df8af864f7f8eb3920c38f248e06e.nix";
        revNum = 0;
  ...
  "0.1.0.0" = {
    ...
    revisions = {
      r0 = {
        outPath = "genesis-test-0.1.0.0-r0-f1bab6e91845215345a83f3a0769ff1169a18c70e71b11c5869acd98e35275e1.nix";
        revNum = 0;
