{
  "1.0.0" = {
    ...
    revisions = {
      r0 = {
        outPath = "BiobaseHTTPTools-1.0.0-r0-efba517554cfdbafd583fad9ad8267e76ceb4d9531a36d51f16a9d7506430d22.nix";
        revNum = 0;
        sha256 = "efba517554cfdbafd583fad9ad8267e76ceb4d9531a36d51f16a9d7506430d22";
        };
      r1 = {
        outPath = "BiobaseHTTPTools-1.0.0-r1-bcee15edcac176830294f6618e751caaa6e3a6449638f719a10fc01578e32baa.nix";
        revNum = 1;
