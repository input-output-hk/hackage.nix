{
  "0.1.0.0" = {
    ...
    revisions = {
      r0 = {
        outPath = "util-exception-0.1.0.0-r0-1869d4c301fc3dab84dff952acdab01773d727c9b618bae7df875527a05b431e.nix";
        revNum = 0;
  ...
  "0.2.0.0" = {
    ...
    revisions = {
      r0 = {
        outPath = "util-exception-0.2.0.0-r0-a1a4ec0e9d7e1f462179d4f6314b04bf7783a67613d6a41762e5f5010694dcab.nix";
        revNum = 0;
        sha256 = "a1a4ec0e9d7e1f462179d4f6314b04bf7783a67613d6a41762e5f5010694dcab";
        };
      r1 = {
        outPath = "util-exception-0.2.0.0-r1-135b42c667453098c4a1c830b0518bf1a5b6a5a2e33e6a72b2eec793a5fcbc39.nix";
        revNum = 1;
        sha256 = "135b42c667453098c4a1c830b0518bf1a5b6a5a2e33e6a72b2eec793a5fcbc39";
        };
      r2 = {
        outPath = "util-exception-0.2.0.0-r2-a0aab6d5a90038077158896f995974ac052c48d69f9fd7cae02ebad7263ebac0.nix";
        revNum = 2;
