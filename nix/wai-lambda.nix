{
  "0.1.0.0" = {
    ...
    revisions = {
      r0 = {
        nix = import ../hackage/wai-lambda-0.1.0.0-r0-616174fabfd7e15b5446ae99e39b393457cb39841ecf492c95127670f6f4ae0b.nix;
        revNum = 0;
        sha256 = "616174fabfd7e15b5446ae99e39b393457cb39841ecf492c95127670f6f4ae0b";
        };
      default = "r0";
      };
    };
