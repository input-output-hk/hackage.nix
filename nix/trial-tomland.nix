{
  "0.0.0.0" = {
    ...
    revisions = {
      r0 = {
        outPath = "trial-tomland-0.0.0.0-r0-baf2f085376392e71bb725b8626dbfa5e91d2af4b2e5690c7c69574d2462497f.nix";
        revNum = 0;
        sha256 = "baf2f085376392e71bb725b8626dbfa5e91d2af4b2e5690c7c69574d2462497f";
        };
      r1 = {
        outPath = "trial-tomland-0.0.0.0-r1-743a9baaa36891ed3a44618fdfd5bc4ed9afc39cf9b9fa23ea1b96f3787f5ec0.nix";
        revNum = 1;
