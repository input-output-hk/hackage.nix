{
  "0.1.2" = {
    ...
    revisions = {
      r0 = {
        outPath = "WordNet-ghc74-0.1.2-r0-94cdcb7634a20569956109130681295d889cb81dce1c4209ad4a00dee5857799.nix";
        revNum = 0;
        sha256 = "94cdcb7634a20569956109130681295d889cb81dce1c4209ad4a00dee5857799";
        };
      r1 = {
        outPath = "WordNet-ghc74-0.1.2-r1-d805af5f64f63c122a18bccf9380386f52a023132a8388f7d3ae7d8b606ce5d0.nix";
        revNum = 1;
  ...
  "0.1.3" = {
    ...
    revisions = {
      r0 = {
        outPath = "WordNet-ghc74-0.1.3-r0-b394847a92314160bf137afade7b689f018b82751b6a97c796c2cbe1d1d74ad1.nix";
        revNum = 0;
        sha256 = "b394847a92314160bf137afade7b689f018b82751b6a97c796c2cbe1d1d74ad1";
        };
      r1 = {
        outPath = "WordNet-ghc74-0.1.3-r1-e3521acf8dc754305a4b967aeed68edec3e41adba4cd29c79f7cf76f7617bdf1.nix";
        revNum = 1;
