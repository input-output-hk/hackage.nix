{
  "0.0.0.10" = {
    ...
    revisions = {
      r0 = {
        outPath = "teleport-0.0.0.10-r0-eb3acf062b84d80af416958283c0cae286ee4056fe10b10d0303f193be72f51a.nix";
        revNum = 0;
  ...
  "0.0.0.9" = {
    ...
    revisions = {
      r0 = {
        outPath = "teleport-0.0.0.9-r0-bb87074f7cb1526f90bd9e628bff560295987ad775edf0be4be5b640eb5cfcdf.nix";
        revNum = 0;
