{
  "0.0.0.5" = {
    ...
    revisions = {
      r0 = {
        outPath = "LambdaDB-0.0.0.5-r0-32b318a058295442e2b2ffa6f26b65345a53652bdf142de4db7c476cf94c7bfe.nix";
        revNum = 0;
  ...
  "0.0.0.6" = {
    ...
    revisions = {
      r0 = {
        outPath = "LambdaDB-0.0.0.6-r0-3c4605630a06dec91aa88fb9e491f119c1c971d8459465262aa759849a84f617.nix";
        revNum = 0;
