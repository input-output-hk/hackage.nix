{
  "0.1.0.0" = {
    ...
    revisions = {
      r0 = {
        outPath = "polynom-0.1.0.0-r0-eb730ed0c6fa2622f9cac8b66b61c651e6a8b9ab797228e790785a435e22812b.nix";
        revNum = 0;
        sha256 = "eb730ed0c6fa2622f9cac8b66b61c651e6a8b9ab797228e790785a435e22812b";
        };
      r1 = {
        outPath = "polynom-0.1.0.0-r1-e36123666bb2de71621730dfaffb5b55c28a854e0d0c5def3289bf8cc8a5d959.nix";
        revNum = 1;
