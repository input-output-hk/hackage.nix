{
  "0.1.0.0" = {
    ...
    revisions = {
      r0 = {
        outPath = "data-standards-0.1.0.0-r0-b4abac1bffff16d8ec1e8d7f5973acb97af96e50cc1418b5e2e2b769dadf15e1.nix";
        revNum = 0;
        sha256 = "b4abac1bffff16d8ec1e8d7f5973acb97af96e50cc1418b5e2e2b769dadf15e1";
        };
      r1 = {
        outPath = "data-standards-0.1.0.0-r1-0774ed1aa58ed4af471914bf56ae143a4d2badd2caf05114fc244e3dbfa7903c.nix";
        revNum = 1;
  ...
  "0.1.0.1" = {
    ...
    revisions = {
      r0 = {
        outPath = "data-standards-0.1.0.1-r0-8e77f2c23be6b6cb7d3d28011d6f00f112854efbbf0bec25e48a42892a0a6bbe.nix";
        revNum = 0;
  ...
  "0.1.0.2" = {
    ...
    revisions = {
      r0 = {
        outPath = "data-standards-0.1.0.2-r0-67f5bca2c1da6d74645386a987ca15c95b986f232650ca1e4e4297bafcde9dea.nix";
        revNum = 0;
