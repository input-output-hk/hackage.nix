{
  "1.0.0.0" = {
    ...
    revisions = {
      r0 = {
        outPath = "pkcs7-1.0.0.0-r0-37f29f09856062f309ab0b9a44409745a20eff77e1c1d3eca095b47459b80962.nix";
        revNum = 0;
  ...
  "1.0.0.1" = {
    ...
    revisions = {
      r0 = {
        outPath = "pkcs7-1.0.0.1-r0-b26e5181868667abbde3ce17f9a61cf705eb695da073cdf82e1f9dfd6cc11176.nix";
        revNum = 0;
