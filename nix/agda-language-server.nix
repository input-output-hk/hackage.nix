{
  "0.0.3.0" = {
    ...
    revisions = {
      r0 = {
        outPath = "agda-language-server-0.0.3.0-r0-597c738a930f2895ed0fd8f055ca860c259d74dadaa67318fb96e17ac5d4effb.nix";
        revNum = 0;
  ...
  "0.2.0" = {
    ...
    revisions = {
      r0 = {
        outPath = "agda-language-server-0.2.0-r0-4b7730633f7e5b1f3e242038d535c7a3bacc62037492d07220dd4a082c8579a3.nix";
        revNum = 0;
  ...
  "0.2.1" = {
    ...
    revisions = {
      r0 = {
        outPath = "agda-language-server-0.2.1-r0-ea651b19ea29455c1ecd2359764fb9c83cd9e04094cf4d94241ae4e650672815.nix";
        revNum = 0;
