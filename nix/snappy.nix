{
  "0.1.0.0" = {
    ...
    revisions = {
      r0 = {
        outPath = "snappy-0.1.0.0-r0-7c298c33e325696a900466f0f2d0467eb6867186b6dab4407db541c9da151d7d.nix";
        revNum = 0;
  ...
  "0.2.0.0" = {
    ...
    revisions = {
      r0 = {
        outPath = "snappy-0.2.0.0-r0-37592731a8d3e11cf3e0bde4024b49692745a2d43def1b5b0ef993e3c5e45ead.nix";
        revNum = 0;
  ...
  "0.2.0.1" = {
    ...
    revisions = {
      r0 = {
        outPath = "snappy-0.2.0.1-r0-3186f323676010b9e3674f3ab4998024b09a70cfe890688c7b390b1c0cfe619e.nix";
        revNum = 0;
  ...
  "0.2.0.2" = {
    ...
    revisions = {
      r0 = {
        outPath = "snappy-0.2.0.2-r0-2931b03c5fdab2dac8d7eadb3be2f4ef8906666e43f1f1db65a06efd57ea701b.nix";
        revNum = 0;
