{
  ...
  "0.1.0.1" = {
    ...
    revisions = {
      r0 = {
        nix = import ../hackage/stakhanov-0.1.0.1-r0-b967012ed9059f2f04367e2e2f8a065695ed92e49177782af5eaa89f9af58df4.nix;
        revNum = 0;
        sha256 = "b967012ed9059f2f04367e2e2f8a065695ed92e49177782af5eaa89f9af58df4";
      };
      default = "r0";
    };
  };
  "0.1.1.0" = {
    ...
    revisions = {
      r0 = {
        nix = import ../hackage/stakhanov-0.1.1.0-r0-380538752108726d8edd858563010cd0fdaa2e7bd13518a2a228c859d669ce72.nix;
        revNum = 0;
        sha256 = "380538752108726d8edd858563010cd0fdaa2e7bd13518a2a228c859d669ce72";
      };
      default = "r0";
    };
  };
