{
  "0.3" = {
    ...
    revisions = {
      r0 = {
        outPath = "vec-lens-0.3-r0-deab73a1ccecc80b177ee46f71f65a7fce018ebdc2af5e495151cf6b5e49d16d.nix";
        revNum = 0;
        sha256 = "deab73a1ccecc80b177ee46f71f65a7fce018ebdc2af5e495151cf6b5e49d16d";
        };
      r1 = {
        outPath = "vec-lens-0.3-r1-f002e57f921e87da2add5e849654ae56f2723231441c6300ff4bbeb3960a323f.nix";
        revNum = 1;
  ...
  "0.4" = {
    ...
    revisions = {
      r0 = {
        outPath = "vec-lens-0.4-r0-2af5797fdd3777bf1da22ea8264e8269f76882f6321d822cd38bae301f8647b7.nix";
        revNum = 0;
        sha256 = "2af5797fdd3777bf1da22ea8264e8269f76882f6321d822cd38bae301f8647b7";
        };
      r1 = {
        outPath = "vec-lens-0.4-r1-a32ae456c2b6f8f04f7610a959a349f83688708bf1995ddd098da1b18254089c.nix";
        revNum = 1;
