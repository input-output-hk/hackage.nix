{
  "0.0.0.1" = {
    ...
    revisions = {
      r0 = {
        outPath = "gdp-0.0.0.1-r0-b8b06850ec95cb70ff4f24008e2f6cfcdc87b576a9505431e7e7ebeae795ef9a.nix";
        revNum = 0;
  ...
  "0.0.0.2" = {
    ...
    revisions = {
      r0 = {
        outPath = "gdp-0.0.0.2-r0-bf154ac08b0441dd62c60be2a6240cf679cb964c2239d1323ee03c3e698d56f8.nix";
        revNum = 0;
  ...
  "0.0.3.0" = {
    ...
    revisions = {
      r0 = {
        outPath = "gdp-0.0.3.0-r0-8633d032fb1e308418f327c9b7ce85c612a8b73f9056ea6a00e0f89d297ece0f.nix";
        revNum = 0;
