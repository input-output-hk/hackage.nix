{
  "0.0.0" = {
    ...
    revisions = {
      r0 = {
        outPath = "stackage-setup-0.0.0-r0-8ac4a60ca915da8df522704d2e7a8b4834bbc7115861eed9308c7adfdd351239.nix";
        revNum = 0;
  ...
  "0.0.0.1" = {
    ...
    revisions = {
      r0 = {
        outPath = "stackage-setup-0.0.0.1-r0-86c0e3392ff6a885f16a9c2a3a3d1dcb00f5470ceb94795c593fcb3eef3a9d5c.nix";
        revNum = 0;
  ...
  "0.0.1" = {
    ...
    revisions = {
      r0 = {
        outPath = "stackage-setup-0.0.1-r0-a8a7b09198f47478ab047897afb8f9a580b539a75e123a16fe0e7ce1fd942bd1.nix";
        revNum = 0;
        sha256 = "a8a7b09198f47478ab047897afb8f9a580b539a75e123a16fe0e7ce1fd942bd1";
        };
      r1 = {
        outPath = "stackage-setup-0.0.1-r1-951f86425eb01b40b359c4bea0066ecf2817920f24e55ecf407eec5f4cfac970.nix";
        revNum = 1;
  ...
  "0.0.2" = {
    ...
    revisions = {
      r0 = {
        outPath = "stackage-setup-0.0.2-r0-db476dcd26f526be878821a79311e97ed0af38a721fe08739919fcb7908aad56.nix";
        revNum = 0;
