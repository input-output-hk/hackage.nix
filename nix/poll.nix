{
  "0.0" = {
    ...
    revisions = {
      r0 = {
        outPath = "poll-0.0-r0-85c3e333e23aa53b223b0085bcd5282bad0fc5fecd357e4f10f929eb4cd1b55c.nix";
        revNum = 0;
  ...
  "0.0.0.1" = {
    ...
    revisions = {
      r0 = {
        outPath = "poll-0.0.0.1-r0-eeae185ceeae313250d750984483471ffcd6f6cad5657ab32c42138dedb1dd6e.nix";
        revNum = 0;
  ...
  "0.0.0.2" = {
    ...
    revisions = {
      r0 = {
        outPath = "poll-0.0.0.2-r0-6079190e040fa4f08462aca90614948f190c944570793105a7158560ecc3003e.nix";
        revNum = 0;
        sha256 = "6079190e040fa4f08462aca90614948f190c944570793105a7158560ecc3003e";
        };
      r1 = {
        outPath = "poll-0.0.0.2-r1-58b81442490a9d059330efbd114440492a693a68b2ea4eb941f981cb14daf015.nix";
        revNum = 1;
