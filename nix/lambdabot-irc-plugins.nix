{
  "5.0" = {
    ...
    revisions = {
      r0 = {
        outPath = "lambdabot-irc-plugins-5.0-r0-ba180ee5b02723c4d12c58655cf6cbb6b3b1fb1a7703f8b46095d65735592d27.nix";
        revNum = 0;
        sha256 = "ba180ee5b02723c4d12c58655cf6cbb6b3b1fb1a7703f8b46095d65735592d27";
        };
      r1 = {
        outPath = "lambdabot-irc-plugins-5.0-r1-ff8fb71249c0b77e9a6a32312b4f2d5b7b79f628fe770ff8d1d2e65371e28272.nix";
        revNum = 1;
  ...
  "5.0.1" = {
    ...
    revisions = {
      r0 = {
        outPath = "lambdabot-irc-plugins-5.0.1-r0-2653ec4db65a1d8ee455c599201160c988ab0c8890bf1d3f84e44a143be1f8c5.nix";
        revNum = 0;
  ...
  "5.0.3" = {
    ...
    revisions = {
      r0 = {
        outPath = "lambdabot-irc-plugins-5.0.3-r0-0d91b6fd2ee2c1ee058902a981bc84ccca32c373527695cd03fb5dac24688cef.nix";
        revNum = 0;
  ...
  "5.1" = {
    ...
    revisions = {
      r0 = {
        outPath = "lambdabot-irc-plugins-5.1-r0-def8c1d91182bf4bde86368d4935b7a0f3ea1e32217010c0baf78de0732991c9.nix";
        revNum = 0;
  ...
  "5.1.0.1" = {
    ...
    revisions = {
      r0 = {
        outPath = "lambdabot-irc-plugins-5.1.0.1-r0-2ec43fd1187999503a34d4ca768766c6315e1a3f45dd512e79c868af7fe61790.nix";
        revNum = 0;
  ...
  "5.1.0.4" = {
    ...
    revisions = {
      r0 = {
        outPath = "lambdabot-irc-plugins-5.1.0.4-r0-0d3c057eb07ab048232bcbc3afddae0152b66fea84a8d50054091eef6520fbfa.nix";
        revNum = 0;
  ...
  "5.2" = {
    ...
    revisions = {
      r0 = {
        outPath = "lambdabot-irc-plugins-5.2-r0-4cf7753d2fba02c04e0f77daff8d08043809e5e6e069fdd95e9489bb7f2b9971.nix";
        revNum = 0;
  ...
  "5.3" = {
    ...
    revisions = {
      r0 = {
        outPath = "lambdabot-irc-plugins-5.3-r0-05936ba5c38462bafa5f1881b6ce076a4eab237e7b7bed72643034e98dceda93.nix";
        revNum = 0;
  ...
  "5.3.0.2" = {
    ...
    revisions = {
      r0 = {
        outPath = "lambdabot-irc-plugins-5.3.0.2-r0-48993e9613b8af1e60023d3bf3c0c40a8cffa047fb1f42a5367296d7b035c608.nix";
        revNum = 0;
