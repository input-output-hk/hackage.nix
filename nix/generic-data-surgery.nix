{
  "0.1.0.0" = {
    ...
    revisions = {
      r0 = {
        outPath = "generic-data-surgery-0.1.0.0-r0-cb42f0e4c3474172232b8a13056282d9a172c3800952a8b42cb360fe68f74daa.nix";
        revNum = 0;
        sha256 = "cb42f0e4c3474172232b8a13056282d9a172c3800952a8b42cb360fe68f74daa";
        };
      r1 = {
        outPath = "generic-data-surgery-0.1.0.0-r1-36d10a25a42386ee1a9a59916391e47cc8b3f91815180e3835b980909d5aaa80.nix";
        revNum = 1;
  ...
  "0.2.0.0" = {
    ...
    revisions = {
      r0 = {
        outPath = "generic-data-surgery-0.2.0.0-r0-30ef73df8b1a6259139290e4333910bc378d397c886566369b1037d94d61cab6.nix";
        revNum = 0;
  ...
  "0.2.1.0" = {
    ...
    revisions = {
      r0 = {
        outPath = "generic-data-surgery-0.2.1.0-r0-12dd6af95b8d5aac32bd86c51c0e934072476ab3d45305c859b258dd815c6330.nix";
        revNum = 0;
  ...
  "0.3.0.0" = {
    ...
    revisions = {
      r0 = {
        outPath = "generic-data-surgery-0.3.0.0-r0-b0bc01418e70fc89f891322b0598553c3ecebf76d281a17a879146d0ff376d10.nix";
        revNum = 0;
