{
  "0.1" = {
    ...
    revisions = {
      r0 = {
        outPath = "goal-core-0.1-r0-22a7614b2a2f2460db7d6ffbf82895df79396eb0bcd02c4839e48cd839dbd7b0.nix";
        revNum = 0;
  ...
  "0.20" = {
    ...
    revisions = {
      r0 = {
        outPath = "goal-core-0.20-r0-ab7b0be0d013dd95a13fec1bb3fc2bdc2a69b0d6ca2421ecabb19508b6f83bcd.nix";
        revNum = 0;
