{
  "0" = {
    ...
    revisions = {
      r0 = {
        outPath = "aws-lambda-runtime-0-r0-9fa5054b28db0ad426291d4291d2e5e73add07696240d0acf8c6fba6a8c81285.nix";
        revNum = 0;
  ...
  "0.0.0.1" = {
    ...
    revisions = {
      r0 = {
        outPath = "aws-lambda-runtime-0.0.0.1-r0-353b0c9176f24cfb4b321d2e86292cf8b83219d9e1e886781b9a5067e8dcbe4b.nix";
        revNum = 0;
        sha256 = "353b0c9176f24cfb4b321d2e86292cf8b83219d9e1e886781b9a5067e8dcbe4b";
        };
      r1 = {
        outPath = "aws-lambda-runtime-0.0.0.1-r1-5eda8c7f265242b5651fe4db888c99137bc106cdc742fd03118f750a5132ae3e.nix";
        revNum = 1;
