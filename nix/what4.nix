{
  "1.0" = {
    ...
    revisions = {
      r0 = {
        outPath = "what4-1.0-r0-fa7f10aeb595829fe228e27c10cb5ed0affdd99432b2b8332d4f31eb7b6ff4d5.nix";
        revNum = 0;
        sha256 = "fa7f10aeb595829fe228e27c10cb5ed0affdd99432b2b8332d4f31eb7b6ff4d5";
        };
      r1 = {
        outPath = "what4-1.0-r1-ae5e7363ba9edf6a179d63fa4bea20a90a084fc86c5692b65c633d6bb7454b11.nix";
        revNum = 1;
  ...
  "1.1" = {
    ...
    revisions = {
      r0 = {
        outPath = "what4-1.1-r0-f7b17576cdeb20f0e36fb8547c1578ad38dcbe5678f30dfee947e05e2735ad3a.nix";
        revNum = 0;
  ...
  "1.2" = {
    ...
    revisions = {
      r0 = {
        outPath = "what4-1.2-r0-a736fb2933f00c0ad743c830f3af2d521734b7db6e353b7897bd4fdc78b1f4a1.nix";
        revNum = 0;
  ...
  "1.2.1" = {
    ...
    revisions = {
      r0 = {
        outPath = "what4-1.2.1-r0-25825c81d3862d82a53fe3ddb6d6aa9e53c536dc79946d1d841d532943539d67.nix";
        revNum = 0;
  ...
  "1.3" = {
    ...
    revisions = {
      r0 = {
        outPath = "what4-1.3-r0-cc0b7a8ca310f1bfa41d5a8cee6c53529707955c7a70000f016819e04004f30f.nix";
        revNum = 0;
