{
  "0.14" = {
    ...
    revisions = {
      r0 = {
        outPath = "hmt-diagrams-0.14-r0-db55f691ebcb9363cd0b600c5dabe9ae828d0a149792910d794b3074f601ead4.nix";
        revNum = 0;
  ...
  "0.15" = {
    ...
    revisions = {
      r0 = {
        outPath = "hmt-diagrams-0.15-r0-27c89d12722f760666e6d1dcd5820c023d5afecafa2388bfe849c4883e665990.nix";
        revNum = 0;
