{
  "0.6" = {
    ...
    revisions = {
      r0 = {
        outPath = "atomic-primops-foreign-0.6-r0-09ad688d5f765d5e142d544626dfdce0b329d121a44f8b4ca6f582bfb1cae5b6.nix";
        revNum = 0;
  ...
  "0.6.1" = {
    ...
    revisions = {
      r0 = {
        outPath = "atomic-primops-foreign-0.6.1-r0-5c11cbae75556081502b9e0ac8e22fb56d4c32030c857c243436cb9660704938.nix";
        revNum = 0;
  ...
  "0.6.2" = {
    ...
    revisions = {
      r0 = {
        outPath = "atomic-primops-foreign-0.6.2-r0-b0d18643484add51a59a9c1407e75488029eb0a783a33bad95f1223cd444dea9.nix";
        revNum = 0;
        sha256 = "b0d18643484add51a59a9c1407e75488029eb0a783a33bad95f1223cd444dea9";
        };
      r1 = {
        outPath = "atomic-primops-foreign-0.6.2-r1-fd1067adbd96e923226347dccaa9e3e221439702fe7824c86db44eb5b7f6c318.nix";
        revNum = 1;
