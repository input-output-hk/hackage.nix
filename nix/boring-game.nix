{
  "0.1.0.0" = {
    ...
    revisions = {
      r0 = {
        outPath = "boring-game-0.1.0.0-r0-c2aa14a4e0d6dda88ab1a6def9de36acea463c5f187d93c9ef729abf7d201212.nix";
        revNum = 0;
        sha256 = "c2aa14a4e0d6dda88ab1a6def9de36acea463c5f187d93c9ef729abf7d201212";
        };
      r1 = {
        outPath = "boring-game-0.1.0.0-r1-3a2aaa5cca7ccb83b4efc1bfdc5bbe350e7d489ec79104457fad91b2e71e38d0.nix";
        revNum = 1;
  ...
  "0.1.0.1" = {
    ...
    revisions = {
      r0 = {
        outPath = "boring-game-0.1.0.1-r0-75696d04f15fbf4f186e69b118abbe61e3e233b31e4fc1b584a87ee97d336eb5.nix";
        revNum = 0;
