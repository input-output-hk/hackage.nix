{
  "1" = {
    ...
    revisions = {
      r0 = {
        outPath = "xorshift-1-r0-e0f70da0953cbe3011d0c2c57169852b17d5111b94d104ef28c3aac78398958b.nix";
        revNum = 0;
  ...
  "2" = {
    ...
    revisions = {
      r0 = {
        outPath = "xorshift-2-r0-6cd0b8dc5d1fbb86cf59a68a0967f3a152e44e2080ba1f35f1d0dce68137972c.nix";
        revNum = 0;
  ...
  "2.0.1" = {
    ...
    revisions = {
      r0 = {
        outPath = "xorshift-2.0.1-r0-90fb03d2388068a61ef2f22db0a5d10d43b7befa60d552e4884e4b81c4abcb52.nix";
        revNum = 0;
