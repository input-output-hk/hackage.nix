{
  "0.0.0.1" = {
    ...
    revisions = {
      r0 = {
        outPath = "quiver-http-0.0.0.1-r0-2249637b6a84d4b4b71590b1ab66cb18643b7b49cb48678107137bfa218189fa.nix";
        revNum = 0;
        sha256 = "2249637b6a84d4b4b71590b1ab66cb18643b7b49cb48678107137bfa218189fa";
        };
      r1 = {
        outPath = "quiver-http-0.0.0.1-r1-9c606f97bbd6d72acf6d148dcb9fab7e366d2c4614a63468dffaa6ec525e9f69.nix";
        revNum = 1;
  ...
  "0.0.0.2" = {
    ...
    revisions = {
      r0 = {
        outPath = "quiver-http-0.0.0.2-r0-566e0f26acb9b74ef4f577f7567b12d10ec50641c07634d7c8b20821ecb7e58a.nix";
        revNum = 0;
        sha256 = "566e0f26acb9b74ef4f577f7567b12d10ec50641c07634d7c8b20821ecb7e58a";
        };
      r1 = {
        outPath = "quiver-http-0.0.0.2-r1-ca7fe920bd4fd519db582ca6fcfdc82f5e62563df3e29827f523acf423f43380.nix";
        revNum = 1;
        sha256 = "ca7fe920bd4fd519db582ca6fcfdc82f5e62563df3e29827f523acf423f43380";
        };
      r2 = {
        outPath = "quiver-http-0.0.0.2-r2-25c3ec8b9fe27ef80eb8b2c2918676437a7c79b4504e419c319593262c61b3e1.nix";
        revNum = 2;
