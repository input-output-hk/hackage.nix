{
  "2.1" = {
    ...
    revisions = {
      r0 = {
        outPath = "COrdering-2.1-r0-ee1271046c033d1d76d312d5c7fdadcab6caf7bb119b713a0f75bd00ec3502fa.nix";
        revNum = 0;
  ...
  "2.2" = {
    ...
    revisions = {
      r0 = {
        outPath = "COrdering-2.2-r0-0e9b8536da31ecd2f8751c293f344e2b4b7e5cfef163e5647f137969e3e601a5.nix";
        revNum = 0;
  ...
  "2.3" = {
    ...
    revisions = {
      r0 = {
        outPath = "COrdering-2.3-r0-e539beab07d37b9de4698e22da3e8ab6331d04fc9afed071eedd36dbffce6c2f.nix";
        revNum = 0;
