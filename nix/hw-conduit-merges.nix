{
  "0.2.0.0" = {
    ...
    revisions = {
      r0 = {
        outPath = "hw-conduit-merges-0.2.0.0-r0-117ef4b004c29f8219fdf3fd55904c9f4cbe2003954181e17ea876ec3b232405.nix";
        revNum = 0;
        sha256 = "117ef4b004c29f8219fdf3fd55904c9f4cbe2003954181e17ea876ec3b232405";
        };
      r1 = {
        outPath = "hw-conduit-merges-0.2.0.0-r1-6c5f4ef342841463462cd887352e16940a85eee178412dda93f879c0fe89f2ab.nix";
        revNum = 1;
  ...
  "0.2.1.0" = {
    ...
    revisions = {
      r0 = {
        outPath = "hw-conduit-merges-0.2.1.0-r0-ee5d63522fa85c48d9c20e8dd6fa5f2ac901d17d52f650c959f9a22040308bc8.nix";
        revNum = 0;
