{
  "1.0.1" = {
    ...
    revisions = {
      r0 = {
        outPath = "hg-buildpackage-1.0.1-r0-60637a0d353ebd56068270ba70268083b71dde38c525eef8960cc042e341f662.nix";
        revNum = 0;
  ...
  "1.0.4" = {
    ...
    revisions = {
      r0 = {
        outPath = "hg-buildpackage-1.0.4-r0-e760a66d05a613324fc6f2d309bb649b7f7e3bc06f2a1a60a418cf6ad31662cd.nix";
        revNum = 0;
