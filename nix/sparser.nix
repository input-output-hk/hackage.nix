{
  "0.6" = {
    ...
    revisions = {
      r0 = {
        outPath = "sparser-0.6-r0-700a81321d038c9e92858f18aba327e749cb7edae67239a0d96cafa52d592bb1.nix";
        revNum = 0;
  ...
  "0.6.1" = {
    ...
    revisions = {
      r0 = {
        outPath = "sparser-0.6.1-r0-6e9326cb8221d445e0af403b78ebb5b47b8a238f9dc9669c9592f077d2f1f6ef.nix";
        revNum = 0;
