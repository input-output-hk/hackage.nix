{
  "1.7" = {
    ...
    revisions = {
      r0 = {
        outPath = "hsql-mysql-1.7-r0-1024de3e7e5ca03686f2128898a68073fbf8d1d83218483351b1a7dc88d557d0.nix";
        revNum = 0;
  ...
  "1.7.1" = {
    ...
    revisions = {
      r0 = {
        outPath = "hsql-mysql-1.7.1-r0-4b6869123f2f7be527b1e774768d890b385d943a84b9a666e8d6724002e8612c.nix";
        revNum = 0;
  ...
  "1.8.1" = {
    ...
    revisions = {
      r0 = {
        outPath = "hsql-mysql-1.8.1-r0-43c8795ee0a1e4003c299eba88441437693f1d7f2c6e8fe35ea3d63f4ef488bc.nix";
        revNum = 0;
  ...
  "1.8.2" = {
    ...
    revisions = {
      r0 = {
        outPath = "hsql-mysql-1.8.2-r0-eb829afcf64fe521bb5dd7c2b9a74a1eecea533d065d63b4c0966c8cf105fec9.nix";
        revNum = 0;
  ...
  "1.8.3" = {
    ...
    revisions = {
      r0 = {
        outPath = "hsql-mysql-1.8.3-r0-55c4c12a199f7bceb1e9a9219ff1b1ed841dd442882b39b69194a7840523e022.nix";
        revNum = 0;
        sha256 = "55c4c12a199f7bceb1e9a9219ff1b1ed841dd442882b39b69194a7840523e022";
        };
      r1 = {
        outPath = "hsql-mysql-1.8.3-r1-e1bbb71ecb6e310acf23a93e4a5e0121c8bd332e7a81dfa5bfe27ae94cbf14ab.nix";
        revNum = 1;
