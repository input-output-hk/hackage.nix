{
  "0.1.0.0" = {
    ...
    revisions = {
      r0 = {
        nix = import ../hackage/bbcode-0.1.0.0-r0-8f31693ab5856a31497348a442d2c5c82a0bd2776427bcf54bc4d5cc84fa20ca.nix;
        revNum = 0;
        sha256 = "8f31693ab5856a31497348a442d2c5c82a0bd2776427bcf54bc4d5cc84fa20ca";
        };
      default = "r0";
      };
    };
  "0.1.0.1" = {
    ...
    revisions = {
      r0 = {
        nix = import ../hackage/bbcode-0.1.0.1-r0-9cdf7199140823bdf92b0a1aa97ca1f1cc23ebfc624dce306b702d3fa394dfbc.nix;
        revNum = 0;
        sha256 = "9cdf7199140823bdf92b0a1aa97ca1f1cc23ebfc624dce306b702d3fa394dfbc";
        };
      default = "r0";
      };
    };
