{
  ...
  "0.0.3.0" = {
    ...
    revisions = {
      r0 = {
        nix = import ../hackage/utxorpc-server-0.0.3.0-r0-a1135a92a0f9d86b3a8dde4ea71c415c762e9ac22ba2327a4da4236443fad72f.nix;
        revNum = 0;
        sha256 = "a1135a92a0f9d86b3a8dde4ea71c415c762e9ac22ba2327a4da4236443fad72f";
      };
      default = "r0";
    };
  };
  "0.0.4.1" = {
    ...
    revisions = {
      r0 = {
        nix = import ../hackage/utxorpc-server-0.0.4.1-r0-b597a3275b6e70ee650a0312cdc3db6e63a39494776844c9eadd001589a63fa8.nix;
        revNum = 0;
        sha256 = "b597a3275b6e70ee650a0312cdc3db6e63a39494776844c9eadd001589a63fa8";
      };
      default = "r0";
    };
  };
  "0.0.5.0" = {
    sha256 = "cdc5fab2e4251165a60bdfb333c0ab1e779dc74db6f45ae24b9f05c5cc5166c2";
    revisions = {
      r0 = {
        nix = import ../hackage/utxorpc-server-0.0.5.0-r0-7913e25449576d46785eb09b4090796977ed51527b88258b0ed3ff307ebfac2f.nix;
        revNum = 0;
        sha256 = "7913e25449576d46785eb09b4090796977ed51527b88258b0ed3ff307ebfac2f";
      };
      default = "r0";
    };
  };
