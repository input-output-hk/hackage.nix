{
  "0.0.0" = {
    ...
    revisions = {
      r0 = {
        outPath = "apis-0.0.0-r0-297b7e3db0653c18d97865ceac324ca9ca72e4c5db9a7fcb1706f01b14f504ce.nix";
        revNum = 0;
        sha256 = "297b7e3db0653c18d97865ceac324ca9ca72e4c5db9a7fcb1706f01b14f504ce";
        };
      r1 = {
        outPath = "apis-0.0.0-r1-946d15c620efc9f6050bc02708abac6ab6788678b9160e57a78c99a87d33424a.nix";
        revNum = 1;
  ...
  "0.0.1" = {
    ...
    revisions = {
      r0 = {
        outPath = "apis-0.0.1-r0-68393bf71356f777701bf65465bcca786bc7819f4db68bec5c175c743e519a6b.nix";
        revNum = 0;
