{
  "0.1.0.0" = {
    ...
    revisions = {
      r0 = {
        outPath = "stm-queue-extras-0.1.0.0-r0-d81b75888eb52d5add0a2dff2983ca76ec8206d2dc248991a69a7f52c59c409f.nix";
        revNum = 0;
        sha256 = "d81b75888eb52d5add0a2dff2983ca76ec8206d2dc248991a69a7f52c59c409f";
        };
      r1 = {
        outPath = "stm-queue-extras-0.1.0.0-r1-68bb5f0534de817d76805718b12295e82d976a687a490ca2a0d8c898bbda7a94.nix";
        revNum = 1;
  ...
  "0.2.0.0" = {
    ...
    revisions = {
      r0 = {
        outPath = "stm-queue-extras-0.2.0.0-r0-0c90122c2c5998a0b60d00506effde335dbd71ad60bc1b798759a05d4fb3193b.nix";
        revNum = 0;
  ...
  "0.2.0.0.1" = {
    ...
    revisions = {
      r0 = {
        outPath = "stm-queue-extras-0.2.0.0.1-r0-fdb4332e8503507b77ef0825c7d831a0dee988456f64cd5c3c7fd3976e950c88.nix";
        revNum = 0;
