{
  "0.0.0.1" = {
    ...
    revisions = {
      r0 = {
        outPath = "lol-repa-0.0.0.1-r0-387f8f73be09c240d8e325534a96402ad164db1751da9534d7ed87e227afd132.nix";
        revNum = 0;
        sha256 = "387f8f73be09c240d8e325534a96402ad164db1751da9534d7ed87e227afd132";
        };
      r1 = {
        outPath = "lol-repa-0.0.0.1-r1-6082d774d54e60d6e57db0dd2038df69bb8d27f8ecccca1cfa593aa4b36b869e.nix";
        revNum = 1;
  ...
  "0.0.0.2" = {
    ...
    revisions = {
      r0 = {
        outPath = "lol-repa-0.0.0.2-r0-a0152515cc615ba621f4100ad12b329e8f61a6adc4d457c7616da913318ce197.nix";
        revNum = 0;
