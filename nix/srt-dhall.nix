{
  "0.1.0.0" = {
    ...
    revisions = {
      r0 = {
        outPath = "srt-dhall-0.1.0.0-r0-e7904022c10f3a82fa56af3a7ad1a3a1fd033285ae6b9b1ef45cb42244f2f85d.nix";
        revNum = 0;
        sha256 = "e7904022c10f3a82fa56af3a7ad1a3a1fd033285ae6b9b1ef45cb42244f2f85d";
        };
      r1 = {
        outPath = "srt-dhall-0.1.0.0-r1-0e79eae95b4982d0c268c9bdc1094bdeba10c471dca630b7464769586b313d78.nix";
        revNum = 1;
