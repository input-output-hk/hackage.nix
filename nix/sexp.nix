{
  "0.5" = {
    ...
    revisions = {
      r0 = {
        outPath = "sexp-0.5-r0-272d6f2e4241e5a1d6baf1f65351135c5ab904b37737118f1a734799a27b9b89.nix";
        revNum = 0;
  ...
  "0.6" = {
    ...
    revisions = {
      r0 = {
        outPath = "sexp-0.6-r0-51304dbf5c5950cc7c6358e5cfa0edff0ce13f994bc08d687f9f43e913df4abd.nix";
        revNum = 0;
  ...
  "0.7" = {
    ...
    revisions = {
      r0 = {
        outPath = "sexp-0.7-r0-0fef328a621ec00ea27bb94e39675c85c607061b667f560577fb47e4cff9229e.nix";
        revNum = 0;
