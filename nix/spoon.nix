{
  "0.1" = {
    ...
    revisions = {
      r0 = {
        outPath = "spoon-0.1-r0-22f094659a88effbeb1732e08f172849362134382f47348d475e99fb8d35d759.nix";
        revNum = 0;
  ...
  "0.2" = {
    ...
    revisions = {
      r0 = {
        outPath = "spoon-0.2-r0-5ae0df59dcc877a99b4de5548e2a50433d799155da8ab5d39f15f30398020a97.nix";
        revNum = 0;
  ...
  "0.3" = {
    ...
    revisions = {
      r0 = {
        outPath = "spoon-0.3-r0-aca466cb28ac71e1741fa0fee9e8e460092e5e1db4ece11db9304c23328aa1d1.nix";
        revNum = 0;
  ...
  "0.3.1" = {
    ...
    revisions = {
      r0 = {
        outPath = "spoon-0.3.1-r0-ec87537cb4f93193d9d11814a25d592f79ac3f621e00d17e4242950400e56b74.nix";
        revNum = 0;
        sha256 = "ec87537cb4f93193d9d11814a25d592f79ac3f621e00d17e4242950400e56b74";
        };
      r1 = {
        outPath = "spoon-0.3.1-r1-e46c5e919cc9d0c7b0f671cddb631ef0979622a1e2250c59c7e491a799944527.nix";
        revNum = 1;
