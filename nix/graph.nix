{
  "0.0.0.0" = {
    ...
    revisions = {
      r0 = {
        outPath = "graph-0.0.0.0-r0-8cea51075b9daf3ec2d19f4540a9ff5e5c3028885daec23685303d60215b1642.nix";
        revNum = 0;
        sha256 = "8cea51075b9daf3ec2d19f4540a9ff5e5c3028885daec23685303d60215b1642";
        };
      r1 = {
        outPath = "graph-0.0.0.0-r1-896c932df46201bd9777282a37e8ad544a8b682379f342b776d4ccf16dd34846.nix";
        revNum = 1;
