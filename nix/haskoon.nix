{
  "0.1" = {
    ...
    revisions = {
      r0 = {
        outPath = "haskoon-0.1-r0-329206f2a7d2184a83eff38b4edb674787465251ae32be072775344af102a221.nix";
        revNum = 0;
  ...
  "0.3.1.1" = {
    ...
    revisions = {
      r0 = {
        outPath = "haskoon-0.3.1.1-r0-fc1b45205dc6cf34f4bae2156d5dc3f5f0491e92805ea410c3219e524e6845ea.nix";
        revNum = 0;
