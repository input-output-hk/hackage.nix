{
  "0.2.0.0" = {
    ...
    revisions = {
      r0 = {
        outPath = "reflex-backend-socket-0.2.0.0-r0-9587dee97dcab50153192ec942b26974b8d10c9e88f5622194ffd0b297d4fc9e.nix";
        revNum = 0;
        sha256 = "9587dee97dcab50153192ec942b26974b8d10c9e88f5622194ffd0b297d4fc9e";
        };
      r1 = {
        outPath = "reflex-backend-socket-0.2.0.0-r1-fd3d377d7200238ba1e77fc9010991b3b3cd38add98423ce6ebb72408ffc5c87.nix";
        revNum = 1;
  ...
  "0.2.0.1" = {
    ...
    revisions = {
      r0 = {
        outPath = "reflex-backend-socket-0.2.0.1-r0-f3379188b3dd03529ac805fe97d583932d4d729901637fdcd051ba6e29c688f5.nix";
        revNum = 0;
