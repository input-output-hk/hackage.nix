{
  "0.0.0.1" = {
    ...
    revisions = {
      r0 = {
        outPath = "datafix-0.0.0.1-r0-6f62420503d22dc6ab5116488470ade8395a8cc285128c3a99bbfe25d2f809f9.nix";
        revNum = 0;
  ...
  "0.0.0.2" = {
    ...
    revisions = {
      r0 = {
        outPath = "datafix-0.0.0.2-r0-856552f13a9492bc45e8b3edebc7bdbffa97ff82f226da7de9e5cc7e160dedc4.nix";
        revNum = 0;
  ...
  "0.0.1.0" = {
    ...
    revisions = {
      r0 = {
        outPath = "datafix-0.0.1.0-r0-dabdbe3cd89dbf18f3e82ef02cb7ea973bf523dec8dc3a2704c46c46bb0a20d1.nix";
        revNum = 0;
        sha256 = "dabdbe3cd89dbf18f3e82ef02cb7ea973bf523dec8dc3a2704c46c46bb0a20d1";
        };
      r1 = {
        outPath = "datafix-0.0.1.0-r1-d658337cc7cd229972a71161ceaaeb4bf03586bd1f2cf1791155495ab39da03f.nix";
        revNum = 1;
