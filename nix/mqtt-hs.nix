{
  "0.2.0" = {
    ...
    revisions = {
      r0 = {
        outPath = "mqtt-hs-0.2.0-r0-aa246df0da5b68f52dbf81c6dc2942bf882544cbc8a199b73e3703798e6584f7.nix";
        revNum = 0;
        sha256 = "aa246df0da5b68f52dbf81c6dc2942bf882544cbc8a199b73e3703798e6584f7";
        };
      r1 = {
        outPath = "mqtt-hs-0.2.0-r1-aa0a2e9ea99cfbed4646ac02625b66361f8175ae2d70efc041dc517119706439.nix";
        revNum = 1;
  ...
  "1.0.0" = {
    ...
    revisions = {
      r0 = {
        outPath = "mqtt-hs-1.0.0-r0-1a355e45b83c405aacc0cabf0fe9d522acd50d3ab65c42a8709c896acea1cf81.nix";
        revNum = 0;
  ...
  "1.0.1" = {
    ...
    revisions = {
      r0 = {
        outPath = "mqtt-hs-1.0.1-r0-6202907f8e036475d2d9f62385f9669f97921031612725597ee3eb08d14d19c5.nix";
        revNum = 0;
  ...
  "1.0.2" = {
    ...
    revisions = {
      r0 = {
        outPath = "mqtt-hs-1.0.2-r0-db49cf78d8fb9dbffc01c2bc8cb4f8657b796865fdb7c4711ed59cddd8418f87.nix";
        revNum = 0;
