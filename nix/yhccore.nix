{
  "0.9" = {
    ...
    revisions = {
      r0 = {
        outPath = "yhccore-0.9-r0-0e54e2328cd79dc3fb3aa209cbe6572def2ea4e2ae61b1f096e768dea126cdc6.nix";
        revNum = 0;
  ...
  "0.9.1" = {
    ...
    revisions = {
      r0 = {
        outPath = "yhccore-0.9.1-r0-110a6c0900ee680e38c57b31e704704945b41ddf4fd2de097c4b18d8aab69ef2.nix";
        revNum = 0;
