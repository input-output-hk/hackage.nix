{
  "0.1.0" = {
    ...
    revisions = {
      r0 = {
        outPath = "hinit-0.1.0-r0-051016b6edeccec12c90a570d8bcc14669a8855d4ad5e5fe1e3382aa811f3e68.nix";
        revNum = 0;
        sha256 = "051016b6edeccec12c90a570d8bcc14669a8855d4ad5e5fe1e3382aa811f3e68";
        };
      r1 = {
        outPath = "hinit-0.1.0-r1-5ee919738b20103767d33bbd67ffd5e75cee384d3df9f2b742af22d3876bcb4f.nix";
        revNum = 1;
  ...
  "0.2.0" = {
    ...
    revisions = {
      r0 = {
        outPath = "hinit-0.2.0-r0-82cb5b944dcb6f5e000fdc056100f96ea300e3bdcc8b1ed82af6b49c2cb0a4dd.nix";
        revNum = 0;
  ...
  "0.2.1" = {
    ...
    revisions = {
      r0 = {
        outPath = "hinit-0.2.1-r0-9cea637f8b4e7c7f086fc5cf5f2256d524cfb3213f6312fb8b288d3b2aac923e.nix";
        revNum = 0;
  ...
  "0.2.2" = {
    ...
    revisions = {
      r0 = {
        outPath = "hinit-0.2.2-r0-9ec134d918c679a85b64278ddbfc17f18edf56c5ef6b9b12e18b4abd2b27be18.nix";
        revNum = 0;
