{
  "1.3" = {
    ...
    revisions = {
      r0 = {
        outPath = "satchmo-funsat-1.3-r0-25ed42d96f5b25fc4bd1d31bdae91c8ed23bb4d9abfb938492499138d6111a7d.nix";
        revNum = 0;
  ...
  "1.4" = {
    ...
    revisions = {
      r0 = {
        outPath = "satchmo-funsat-1.4-r0-d3a0d185a934ae02c3cac7225a83e300e15fb58af4e34719a53222f4bde9fcd4.nix";
        revNum = 0;
