{
  "0.1.0.6" = {
    ...
    revisions = {
      r0 = {
        nix = import ../hackage/typelevel-tools-yj-0.1.0.6-r0-33f336a1cea83dda17d6e1be1b184d7696c988fe7ee056b3b7e0be33a416eefe.nix;
        revNum = 0;
        sha256 = "33f336a1cea83dda17d6e1be1b184d7696c988fe7ee056b3b7e0be33a416eefe";
      };
      default = "r0";
    };
  };
  ...
  "0.1.0.9" = {
    ...
    revisions = {
      r0 = {
        nix = import ../hackage/typelevel-tools-yj-0.1.0.9-r0-4579961d93b3b97b677b69bcc0316689fae6e064dced12799a0ee99478170596.nix;
        revNum = 0;
        sha256 = "4579961d93b3b97b677b69bcc0316689fae6e064dced12799a0ee99478170596";
      };
      default = "r0";
    };
  };
