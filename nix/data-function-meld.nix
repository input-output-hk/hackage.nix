{
  "0.1.0.0" = {
    ...
    revisions = {
      r0 = {
        outPath = "data-function-meld-0.1.0.0-r0-dca8dded9eafd9719a6db10639beaf0842a522ac387f9aeb80b65ebebb45df32.nix";
        revNum = 0;
        sha256 = "dca8dded9eafd9719a6db10639beaf0842a522ac387f9aeb80b65ebebb45df32";
        };
      r1 = {
        outPath = "data-function-meld-0.1.0.0-r1-7c644b5b5aba58028446255e1bfbf2e2aa832aa27fd3de943d34b047537ec4c9.nix";
        revNum = 1;
  ...
  "0.1.1.0" = {
    ...
    revisions = {
      r0 = {
        outPath = "data-function-meld-0.1.1.0-r0-4aab4ddee7da043988598989caf657844fec7fd7aef394ca92ab1e6c96b1eefb.nix";
        revNum = 0;
