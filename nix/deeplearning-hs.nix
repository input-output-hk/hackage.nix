{
  "0.1.0.0" = {
    ...
    revisions = {
      r0 = {
        outPath = "deeplearning-hs-0.1.0.0-r0-b706cdce23365aed169b8d666f4b005ea319a21e968ec66a1952e890db9614a6.nix";
        revNum = 0;
  ...
  "0.1.0.1" = {
    ...
    revisions = {
      r0 = {
        outPath = "deeplearning-hs-0.1.0.1-r0-a1575f2b4845a5ee726fc2d9c2e8c0856470092633395392c696ebc021b5fa28.nix";
        revNum = 0;
  ...
  "0.1.0.2" = {
    ...
    revisions = {
      r0 = {
        outPath = "deeplearning-hs-0.1.0.2-r0-c122a378642d640599028bd4407eee9505819edd3875abbe7a691592436558da.nix";
        revNum = 0;
        sha256 = "c122a378642d640599028bd4407eee9505819edd3875abbe7a691592436558da";
        };
      r1 = {
        outPath = "deeplearning-hs-0.1.0.2-r1-eca23efe079b6311afd52bf1a70f8b9617c2b943e13b2ddb0ac2be5249622afa.nix";
        revNum = 1;
