{
  "1.6.0" = {
    ...
    revisions = {
      r0 = {
        nix = import ../hackage/amazonka-autoscaling-plans-1.6.0-r0-58582b9abee49b4b9e1560aae4d63ae7cfc165b83deaa5a4b2a9a8f50bc87712.nix;
        revNum = 0;
        sha256 = "58582b9abee49b4b9e1560aae4d63ae7cfc165b83deaa5a4b2a9a8f50bc87712";
      };
      default = "r0";
    };
  };
  "1.6.1" = {
    ...
    revisions = {
      r0 = {
        nix = import ../hackage/amazonka-autoscaling-plans-1.6.1-r0-62897a281e81f3ba04aec4b6a637e65a1350a94bfdb8674c0173aa71dbc2ea83.nix;
        revNum = 0;
        sha256 = "62897a281e81f3ba04aec4b6a637e65a1350a94bfdb8674c0173aa71dbc2ea83";
      };
      default = "r0";
    };
  };
