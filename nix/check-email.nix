{
  "0.1" = {
    ...
    revisions = {
      r0 = {
        outPath = "check-email-0.1-r0-50a89d60373ef1145b212c8f89fe39493487956686526db43556ef329de74704.nix";
        revNum = 0;
  ...
  "1.0" = {
    ...
    revisions = {
      r0 = {
        outPath = "check-email-1.0-r0-4e1c8715c826700dfe65c737816ac40086730e64a6a4336592db60f0ef75aee3.nix";
        revNum = 0;
        sha256 = "4e1c8715c826700dfe65c737816ac40086730e64a6a4336592db60f0ef75aee3";
        };
      r1 = {
        outPath = "check-email-1.0-r1-39f8616eeee765838400cd6754f864e9e65e8a89123327161227b6a424c20d75.nix";
        revNum = 1;
  ...
  "1.0.2" = {
    ...
    revisions = {
      r0 = {
        outPath = "check-email-1.0.2-r0-ca97466ec7fde38d42202916859171f19ce3d1bb0b3437135b902a2a64d01e5c.nix";
        revNum = 0;
