{
  "0.11" = {
    ...
    revisions = {
      r0 = {
        outPath = "hydrogen-cli-0.11-r0-a65adac0131b632f22d53a3bd37b5be2f8be0a76bc78daab847bb9cb66668cb4.nix";
        revNum = 0;
  ...
  "0.12" = {
    ...
    revisions = {
      r0 = {
        outPath = "hydrogen-cli-0.12-r0-235fed11e36fabcd30df041d71b8e16820a0be74554109340a9ebb16af31d46a.nix";
        revNum = 0;
  ...
  "0.14" = {
    ...
    revisions = {
      r0 = {
        outPath = "hydrogen-cli-0.14-r0-a941e9a7bb1c9120286118c4607aa99429878b65debc2778003ac6eb07d710ad.nix";
        revNum = 0;
