{
  "0.10" = {
    ...
    revisions = {
      r0 = {
        outPath = "haskelldb-dynamic-0.10-r0-8818d4e9bf2e36ea2607444a307c90cfea9c09229f74105b98ee84f6c3ab501e.nix";
        revNum = 0;
  ...
  "1.0.0" = {
    ...
    revisions = {
      r0 = {
        outPath = "haskelldb-dynamic-1.0.0-r0-fc9dc27731220d732034f062fad6e5eb50e3eb0ece5b1acc24cae25fab6051d7.nix";
        revNum = 0;
