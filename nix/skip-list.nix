{
  "0.1.0.0" = {
    ...
    revisions = {
      r0 = {
        outPath = "skip-list-0.1.0.0-r0-93ed523a02f602622c57b3741820d877c7b49094aa200d9ed666dec02d545be7.nix";
        revNum = 0;
        sha256 = "93ed523a02f602622c57b3741820d877c7b49094aa200d9ed666dec02d545be7";
        };
      r1 = {
        outPath = "skip-list-0.1.0.0-r1-8885c64a8798929fe9ecafd1e88e55133232e50dbf30e439c10026e266502331.nix";
        revNum = 1;
  ...
  "0.1.0.1" = {
    ...
    revisions = {
      r0 = {
        outPath = "skip-list-0.1.0.1-r0-88283e675b04120625c21388398b0fceb9b8a988d3fa2e023029073af5070c4d.nix";
        revNum = 0;
