{
  "1.0.0" = {
    ...
    revisions = {
      r0 = {
        outPath = "stc-lang-1.0.0-r0-b3e3d02e3338caeb1c6241fcff3ca606a21b95248a87c5536eb6fbe76d80567d.nix";
        revNum = 0;
        sha256 = "b3e3d02e3338caeb1c6241fcff3ca606a21b95248a87c5536eb6fbe76d80567d";
        };
      r1 = {
        outPath = "stc-lang-1.0.0-r1-7594add72637b9773d458f1c573337268f79513315abeae21e860809a6c853ba.nix";
        revNum = 1;
