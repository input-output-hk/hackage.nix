{
  "9.0.1" = {
    ...
    revisions = {
      r0 = {
        outPath = "ghc-heap-9.0.1-r0-519c0c21b8b75923da56e803d48ed223975550be555faa328952aab492b1f522.nix";
        revNum = 0;
  ...
  "9.2.1" = {
    ...
    revisions = {
      r0 = {
        outPath = "ghc-heap-9.2.1-r0-3dd9243cf5e16a8db70851acc59795e120b2f404f5639fea2276876f79205db2.nix";
        revNum = 0;
        sha256 = "3dd9243cf5e16a8db70851acc59795e120b2f404f5639fea2276876f79205db2";
        };
      r1 = {
        outPath = "ghc-heap-9.2.1-r1-26fa2972b4137447891f8c8aca85100c9328452f7f817ae96912cc6d129b7c86.nix";
        revNum = 1;
  ...
  "9.2.2" = {
    ...
    revisions = {
      r0 = {
        outPath = "ghc-heap-9.2.2-r0-03b9b1db02c02db279a9cdbf9589966a869a5537103199bc507bcb5169999117.nix";
        revNum = 0;
