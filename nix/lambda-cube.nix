{
  "0.1.0.0" = {
    ...
    revisions = {
      r0 = {
        outPath = "lambda-cube-0.1.0.0-r0-a11097c6aca44cbfde2ed370819cd1fcdb68c261601fcb53557994fcb099b094.nix";
        revNum = 0;
        sha256 = "a11097c6aca44cbfde2ed370819cd1fcdb68c261601fcb53557994fcb099b094";
        };
      r1 = {
        outPath = "lambda-cube-0.1.0.0-r1-2b3e9fa85897d04529c010efd24ee36e5d4916a14e304eb8bf078efb2673ce83.nix";
        revNum = 1;
        sha256 = "2b3e9fa85897d04529c010efd24ee36e5d4916a14e304eb8bf078efb2673ce83";
        };
      r2 = {
        outPath = "lambda-cube-0.1.0.0-r2-3982f6574741b81d131bee2db2237ff7e1f623125742ab6d1c2481b330bb2b7f.nix";
        revNum = 2;
        sha256 = "3982f6574741b81d131bee2db2237ff7e1f623125742ab6d1c2481b330bb2b7f";
        };
      r3 = {
        outPath = "lambda-cube-0.1.0.0-r3-c041f1cf761b50c6f1c30d38ef6334f0d84dacd2a67189095ffa839724718a79.nix";
        revNum = 3;
  ...
  "0.2.0.0" = {
    ...
    revisions = {
      r0 = {
        outPath = "lambda-cube-0.2.0.0-r0-39c2afcca88f5e481ec8be0279b0a533e313a363ef868da8cda2a580a33ac5e9.nix";
        revNum = 0;
  ...
  "0.3.0.0" = {
    ...
    revisions = {
      r0 = {
        outPath = "lambda-cube-0.3.0.0-r0-a5c36e481214dc0a68599b20730289139bce80f4b0e8ce807fcfe67254e1eb0f.nix";
        revNum = 0;
