{
  "0.1.0.0" = {
    ...
    revisions = {
      ...
      r3 = {
        nix = import ../hackage/monad-ste-0.1.0.0-r3-6619b33c3a3aa94cc2d2272a50fe49a68a0adc2587131aad744fe7d0658f287f.nix;
        revNum = 3;
        sha256 = "6619b33c3a3aa94cc2d2272a50fe49a68a0adc2587131aad744fe7d0658f287f";
      };
      default = "r3";
    };
  };
