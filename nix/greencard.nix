{
  "3.0.1" = {
    ...
    revisions = {
      r0 = {
        outPath = "greencard-3.0.1-r0-a85b98f5de7a834d954480bf4366c0bc76e24f482a6efa8649805f482bf14620.nix";
        revNum = 0;
  ...
  "3.0.1.1" = {
    ...
    revisions = {
      r0 = {
        outPath = "greencard-3.0.1.1-r0-8ae13876ac8c618fe039ea10d5e32c50a6c670ef0f43e04d13ec7acebdec094b.nix";
        revNum = 0;
  ...
  "3.0.2" = {
    ...
    revisions = {
      r0 = {
        outPath = "greencard-3.0.2-r0-195c48367076c787bc992f915c06fc8e2b3e4625d9d40a703a5b897c4dcc8f3b.nix";
        revNum = 0;
  ...
  "3.0.3" = {
    ...
    revisions = {
      r0 = {
        outPath = "greencard-3.0.3-r0-8a742d9a8a42c6dbc1cbd59e579bdc95638908a49618b0056a9ef7a8b1016a80.nix";
        revNum = 0;
  ...
  "3.0.4" = {
    ...
    revisions = {
      r0 = {
        outPath = "greencard-3.0.4-r0-bd1c4fa69da9553db295324f81c94dcaf16ca17962bd1a7a01f226505fd2e60a.nix";
        revNum = 0;
  ...
  "3.0.4.1" = {
    ...
    revisions = {
      r0 = {
        outPath = "greencard-3.0.4.1-r0-8597ec4836f418550516ae022530cef53bc5e9daabeec0afa5345b9a6df78a41.nix";
        revNum = 0;
  ...
  "3.0.4.2" = {
    ...
    revisions = {
      r0 = {
        outPath = "greencard-3.0.4.2-r0-50967245d12ff8ed11ad1eb9201480b41dbab8dbd8e5a9e6c345ac907a044716.nix";
        revNum = 0;
