{
  "0.11" = {
    ...
    revisions = {
      r0 = {
        outPath = "hls-0.11-r0-8f2b071aa6e49036859df2b62927bc427a24dfcdd1dc41d29a8dc38435f809bb.nix";
        revNum = 0;
  ...
  "0.14" = {
    ...
    revisions = {
      r0 = {
        outPath = "hls-0.14-r0-946bd42819c021dc5d6d7fcadca9fed3aa51db1811c08761767212fc752ee3f0.nix";
        revNum = 0;
  ...
  "0.15" = {
    ...
    revisions = {
      r0 = {
        outPath = "hls-0.15-r0-e8c52556f45124302c2665be205e14857094b2f077f930a31805e95a8aa758e2.nix";
        revNum = 0;
