{
  "0.1.1.0" = {
    ...
    revisions = {
      r0 = {
        nix = import ../hackage/snaplet-wordpress-0.1.1.0-r0-5815e1453c22ceedce2198b7e17f7fb2c7da11ed1a010f93f1e3b4bcd3a016f1.nix;
        revNum = 0;
  ...
  "0.1.1.1" = {
    ...
    revisions = {
      r0 = {
        nix = import ../hackage/snaplet-wordpress-0.1.1.1-r0-5e5ff66f88f1c8288806fdf350bd7f65dabe9bdde0680efe9dc4010c96a6f956.nix;
        revNum = 0;
  ...
  "0.1.1.2" = {
    ...
    revisions = {
      r0 = {
        nix = import ../hackage/snaplet-wordpress-0.1.1.2-r0-bbf264116eeb393c878401a929d646b9a4f8a4a9977ef06ee38b622f2af2683e.nix;
        revNum = 0;
