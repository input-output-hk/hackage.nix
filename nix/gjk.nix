{
  "0.0.0.1" = {
    ...
    revisions = {
      r0 = {
        outPath = "gjk-0.0.0.1-r0-6c24a80f81a5662b2a613ccc2f03ac90c623f300562d9e36ee39035e36ccf796.nix";
        revNum = 0;
  ...
  "0.0.0.2" = {
    ...
    revisions = {
      r0 = {
        outPath = "gjk-0.0.0.2-r0-b4cbede620df1d2572a8025387c3dfb72110ef0707e5489fad8e6763c9244e60.nix";
        revNum = 0;
