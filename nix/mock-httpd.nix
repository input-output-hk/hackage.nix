{
  "0.0.0.0" = {
    ...
    revisions = {
      r0 = {
        outPath = "mock-httpd-0.0.0.0-r0-2f4263c7627f41bae1af7a1e160ab65b71f8004831f7e112b07ccc05d92dbc67.nix";
        revNum = 0;
  ...
  "1.0.0" = {
    ...
    revisions = {
      r0 = {
        outPath = "mock-httpd-1.0.0-r0-49dbc7296e5975773c11acac9f162923604380aa4dfb256682afa96c34807a6a.nix";
        revNum = 0;
