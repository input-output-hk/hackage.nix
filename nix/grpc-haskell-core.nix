{
  "0.0.0.0" = {
    ...
    revisions = {
      r0 = {
        outPath = "grpc-haskell-core-0.0.0.0-r0-4bacd90915321750db570042cd05ada01b9b83c79f6bf6b6ccdef1889b383efa.nix";
        revNum = 0;
  ...
  "0.1.0" = {
    ...
    revisions = {
      r0 = {
        outPath = "grpc-haskell-core-0.1.0-r0-50adbefd11be9e8b72ea98b7c3b5a4b2879fea211de4552b9759b91f2d4d8c51.nix";
        revNum = 0;
