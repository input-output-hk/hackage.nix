{
  "0.0.0.1" = {
    ...
    revisions = {
      r0 = {
        outPath = "spir-v-0.0.0.1-r0-6a597d09a19f97bf1f0f0f8183d56f4f6a71890e3a6144c1a73f621c69189bd0.nix";
        revNum = 0;
  ...
  "0.0.0.2" = {
    ...
    revisions = {
      r0 = {
        outPath = "spir-v-0.0.0.2-r0-7684d736edf3b07751ec13fdae0eebd2882cfd2d8580d0a347070c30f723a02e.nix";
        revNum = 0;
        sha256 = "7684d736edf3b07751ec13fdae0eebd2882cfd2d8580d0a347070c30f723a02e";
        };
      r1 = {
        outPath = "spir-v-0.0.0.2-r1-71fa7971fad8f2ce6d0eab96c2e817235822e5e0e048a844ac1288d35dee278f.nix";
        revNum = 1;
  ...
  "0.0.1.0" = {
    ...
    revisions = {
      r0 = {
        outPath = "spir-v-0.0.1.0-r0-abdc223cd4a183e48cd0a47c22c9334f53056fdf69f25419a51df7060583fa69.nix";
        revNum = 0;
