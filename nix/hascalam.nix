{
  "0.1.1.0" = {
    ...
    revisions = {
      r0 = {
        nix = import ../hackage/hascalam-0.1.1.0-r0-d415fbdf1c940178786f5afda631f96208cd0a882035e1d4db03acdf7e9a071e.nix;
        revNum = 0;
        sha256 = "d415fbdf1c940178786f5afda631f96208cd0a882035e1d4db03acdf7e9a071e";
      };
      default = "r0";
    };
  };
