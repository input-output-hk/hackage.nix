      ...
      components = {
        postgresql-typed = {
          depends  = (([
            ...
            else (pkgs.lib.optional _flags.text hsPkgs.text ++ pkgs.lib.optional _flags.uuid hsPkgs.uuid) ++ pkgs.lib.optional _flags.scientific hsPkgs.scientific)) ++ pkgs.lib.optional _flags.aeson hsPkgs.aeson;
        };
        tests = {
          test = {
            depends  = [
