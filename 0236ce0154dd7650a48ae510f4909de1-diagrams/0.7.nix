    ...
    in {
      ...
      components = {
        diagrams = {
          ...
          ] ++ pkgs.lib.optional _flags.cairo hsPkgs.diagrams-cairo) ++ pkgs.lib.optional _flags.svg hsPkgs.diagrams-svg) ++ pkgs.lib.optional _flags.ps hsPkgs.diagrams-postscript;
        };
      };
    }