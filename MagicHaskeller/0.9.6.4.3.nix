        ...
        exes = {
          MagicHaskeller = {
            depends  = (((([
              ...
              hsPkgs.ghc-paths
              hsPkgs.ghc
            ] ++ pkgs.lib.optional (!system.isWindows) hsPkgs.unix) ++ pkgs.lib.optional _flags.tfrandom hsPkgs.tf-random) ++ pkgs.lib.optional _flags.readfile hsPkgs.haskell-src) ++ pkgs.lib.optional _flags.ghc7 hsPkgs.ghc) ++ [
              hsPkgs.network
              hsPkgs.network-uri
            ];
          };
