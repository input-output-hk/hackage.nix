        ...
        "git-annex" = {
          depends  = ((((((((((([
            ...
            then [
              ...
              (hsPkgs.unix)
            ])) ++ pkgs.lib.optional (_flags.s3) (hsPkgs.aws)) ++ pkgs.lib.optional (_flags.webdav) (hsPkgs.DAV)) ++ pkgs.lib.optionals (_flags.assistant && !system.isSolaris && !system.isHurd) ([
            (hsPkgs.mountpoints)
          ] ++ (if system.isLinux || _flags.android
