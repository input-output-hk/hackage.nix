        ...
        exes = {
          git-annex = {
            depends  = (((((((((((((((([
              ...
              hsPkgs.gnutls
              hsPkgs.xml-types
            ]) ++ pkgs.lib.optional _flags.torrentparser hsPkgs.torrent) ++ pkgs.lib.optional _flags.concurrentoutput hsPkgs.concurrent-output) ++ pkgs.lib.optional _flags.ekg hsPkgs.ekg) ++ pkgs.lib.optionals _flags.benchmark [
              hsPkgs.criterion
              hsPkgs.deepseq
            ];
          };
