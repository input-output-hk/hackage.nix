          ...
          "git-annex" = {
            depends  = (((((((((((((([
              ...
              then [ hsPkgs.hinotify ]
                ...
                else pkgs.lib.optionals (!system.isWindows && !system.isSolaris && !system.isLinux) (pkgs.lib.optional _flags.android hsPkgs.hinotify))) ++ pkgs.lib.optional (system.isLinux && _flags.dbus) hsPkgs.dbus) ++ pkgs.lib.optionals _flags.webapp [
              hsPkgs.yesod
