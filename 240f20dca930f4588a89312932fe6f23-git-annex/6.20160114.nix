        ...
        exes = {
          "git-annex" = {
            depends  = ((((((((((((((((((((([
              ...
              hsPkgs.aws
            ]) ++ pkgs.lib.optional _flags.webdav hsPkgs.DAV) ++ pkgs.lib.optionals _flags.assistant (if system.isLinux
              ...
              hsPkgs.gnutls
              hsPkgs.xml-types
            ]) ++ pkgs.lib.optional _flags.dns hsPkgs.dns) ++ pkgs.lib.optional _flags.feed hsPkgs.feed) ++ pkgs.lib.optional _flags.quvi hsPkgs.aeson) ++ pkgs.lib.optional _flags.tahoe hsPkgs.aeson) ++ pkgs.lib.optional _flags.torrentparser hsPkgs.torrent) ++ pkgs.lib.optional _flags.concurrentoutput hsPkgs.concurrent-output) ++ pkgs.lib.optional _flags.ekg hsPkgs.ekg) ++ pkgs.lib.optionals _flags.benchmark [
              hsPkgs.criterion
              hsPkgs.deepseq
            ];
          };
