        ...
        exes = {
          git-annex = {
            depends  = ((((((([
              ...
              hsPkgs.async
            ] ++ pkgs.lib.optional _flags.s3 hsPkgs.hS3) ++ pkgs.lib.optional (_flags.assistant && !system.isWindows && !system.isSolaris) hsPkgs.stm) ++ pkgs.lib.optional (system.isLinux && _flags.inotify) hsPkgs.hinotify) ++ pkgs.lib.optional (system.isLinux && _flags.dbus) hsPkgs.dbus) ++ optionals (_flags.webapp && _flags.assistant) [
              hsPkgs.yesod
              hsPkgs.yesod-static
