    ...
    components = {
      "pandoc" = {
        depends  = ((([
          ...
          (hsPkgs.basement)
          (hsPkgs.foundation)
        ]) ++ pkgs.lib.optional (compiler.isGhc && compiler.version.lt "8.4") (hsPkgs.base-compat)) ++ pkgs.lib.optional (!system.isWindows) (hsPkgs.unix)) ++ pkgs.lib.optional (_flags.embed_data_files) (hsPkgs.file-embed);
      };
      exes = {
        "pandoc" = {
          depends  = ([
